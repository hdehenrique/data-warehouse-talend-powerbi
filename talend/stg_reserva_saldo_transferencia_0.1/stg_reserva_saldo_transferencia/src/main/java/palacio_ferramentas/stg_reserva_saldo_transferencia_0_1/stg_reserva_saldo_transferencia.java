...
package palacio_ferramentas.stg_reserva_saldo_transferencia_0_1;
...
/**
 * Job: stg_reserva_saldo_transferencia Purpose: <br>
 * Description:  <br>
 * @author talend@talend.com
 * @version 8.0.1.20230922_0317-SNAPSHOT
 * @status 
 */
public class stg_reserva_saldo_transferencia implements TalendJob {
...
public String getJDBC_PARAMETERS(){
	...
	private final String jobName = "stg_reserva_saldo_transferencia";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				stg_reserva_saldo_transferencia.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(stg_reserva_saldo_transferencia.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_PALACIO_FERRAMENTAS_stg_reserva_saldo_transferencia = new byte[0];
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_stg_reserva_saldo_transferencia = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PALACIO_FERRAMENTAS_stg_reserva_saldo_transferencia.length) {
				if(length < 1024 && commonByteArray_PALACIO_FERRAMENTAS_stg_reserva_saldo_transferencia.length == 0) {
   					commonByteArray_PALACIO_FERRAMENTAS_stg_reserva_saldo_transferencia = new byte[1024];
				} else {
   					commonByteArray_PALACIO_FERRAMENTAS_stg_reserva_saldo_transferencia = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PALACIO_FERRAMENTAS_stg_reserva_saldo_transferencia, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_stg_reserva_saldo_transferencia, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PALACIO_FERRAMENTAS_stg_reserva_saldo_transferencia, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_stg_reserva_saldo_transferencia, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PALACIO_FERRAMENTAS_stg_reserva_saldo_transferencia) {
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_1=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_1 = "tHashFile_stg_reserva_saldo_transferencia_" + pid + "_tHashOutput_1";
...
public static class TABLEStruct implements routines.system.IPersistableRow<TABLEStruct> {
    ...
    public String loopKey;
			    ...
			    public String AUTINC;

				public String getAUTINC () {
					return this.AUTINC;
				}

				public Boolean AUTINCIsNullable(){
				    return false;
				}
				public Boolean AUTINCIsKey(){
				    return true;
				}
				public Integer AUTINCLength(){
				    return 20;
				}
				public Integer AUTINCPrecision(){
				    return 0;
				}
				public String AUTINCDefault(){
				
					return null;
				
				}
				public String AUTINCComment(){
				
				    return "";
				
				}
				public String AUTINCPattern(){
				
					return "";
				
				}
				public String AUTINCOriginalDbColumnName(){
				...
				public Boolean CODEMPIsNullable(){
				    return false;
				}
				public Boolean CODEMPIsKey(){
				    return true;
				}
				public Integer CODEMPLength(){
				    return 3;
				}
				public Integer CODEMPPrecision(){
				    return 0;
				}
				public String CODEMPDefault(){
				
					return null;
				
				}
				public String CODEMPComment(){
				
				    return "";
				
				}
				public String CODEMPPattern(){
				
					return "";
				
				}
				public String CODEMPOriginalDbColumnName(){
			    ...
			    public BigDecimal SALRES;

				public BigDecimal getSALRES () {
					return this.SALRES;
				}

				public Boolean SALRESIsNullable(){
				    return true;
				}
				public Boolean SALRESIsKey(){
				    return false;
				}
				public Integer SALRESLength(){
				    return 14;
				}
				public Integer SALRESPrecision(){
				    return 4;
				}
				public String SALRESDefault(){
				
					return "0.0000";
				
				}
				public String SALRESComment(){
				
				    return "";
				
				}
				public String SALRESPattern(){
				
					return "";
				
				}
				public String SALRESOriginalDbColumnName(){
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.AUTINC == null) ? 0 : this.AUTINC.hashCode());
					
						result = prime * result + ((this.TABELA == null) ? 0 : this.TABELA.hashCode());
					
						result = prime * result + ((this.CODITE == null) ? 0 : this.CODITE.hashCode());
					
						result = prime * result + ((this.CODEMP == null) ? 0 : this.CODEMP.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final TABLEStruct other = (TABLEStruct) obj;
						...
						if (this.AUTINC == null) {
							if (other.AUTINC != null)
								return false;
						
						} else if (!this.AUTINC.equals(other.AUTINC))
						...
						} else if (!this.TABELA.equals(other.TABELA))
						...
						} else if (!this.CODEMP.equals(other.CODEMP))
	...
	public void copyDataTo(TABLEStruct other) {
		...
		other.AUTINC = this.AUTINC;
	            other.TABELA = this.TABELA;
	            other.CODITE = this.CODITE;
	            other.CODEMP = this.CODEMP;
	            other.SALRES = this.SALRES;
		...
		synchronized(commonByteArrayLock_PALACIO_FERRAMENTAS_stg_reserva_saldo_transferencia) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.AUTINC = readString(dis);
					
					this.TABELA = readString(dis);
					
					this.CODITE = readString(dis);
					
					this.CODEMP = readString(dis);
					
						this.SALRES = (BigDecimal) dis.readObject();
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.CODEMP,dos);
					
					// BigDecimal
				
       			    	dos.writeObject(this.SALRES);
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("AUTINC="+AUTINC);
		sb.append(",TABELA="+TABELA);
		sb.append(",CODITE="+CODITE);
		sb.append(",CODEMP="+CODEMP);
		sb.append(",SALRES="+String.valueOf(SALRES));
	    sb.append("]");
    ...
    public int compareTo(TABLEStruct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.AUTINC, other.AUTINC);
						if(returnValue != 0) {
							return returnValue;
						}

					
						returnValue = checkNullsAndCompare(this.TABELA, other.TABELA);
						if(returnValue != 0) {
							return returnValue;
						}
						...
						returnValue = checkNullsAndCompare(this.CODEMP, other.CODEMP);
						if(returnValue != 0) {
							return returnValue;
						}
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_2=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_2 = "tHashFile_stg_reserva_saldo_transferencia_" + pid + "_tHashOutput_2";
 ...
 */
	...
	currentComponent="tDBInput_3";
		...
		int tos_count_tDBInput_3 = 0;
		    ...
		    String dbquery_tDBInput_3 = "\nSELECT AUTINC,\n       TABELA,\n       CODITE,\n       CODEMP,\n       SALRES\nFROM RESERVA_SALDO_TRANSFERENCIA\n";
        	...
        	row5.AUTINC = routines.system.JDBCUtil.getString(rs_tDBInput_3, 1, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 2) {
								row5.TABELA = null;
							} else {
	                         		
        	row5.TABELA = routines.system.JDBCUtil.getString(rs_tDBInput_3, 2, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 3) {
								row5.CODITE = null;
							} else {
	                         		
        	row5.CODITE = routines.system.JDBCUtil.getString(rs_tDBInput_3, 3, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 4) {
								row5.CODEMP = null;
							} else {
	                         		
        	row5.CODEMP = routines.system.JDBCUtil.getString(rs_tDBInput_3, 4, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 5) {
								row5.SALRES = null;
							} else {
		                          
            row5.SALRES = rs_tDBInput_3.getBigDecimal(5);
...
// # Output table : 'TABLE'
TABLE_tmp.AUTINC = row5.AUTINC ;
TABLE_tmp.TABELA = row5.TABELA ;
TABLE_tmp.CODITE = row5.CODITE ;
TABLE_tmp.CODEMP = row5.CODEMP ;
TABLE_tmp.SALRES = row5.SALRES ;
TABLE = TABLE_tmp;
// ###############################
...
if(TABLE != null) { 
	...
	currentComponent="tHashOutput_2";
		...
		TABLEStruct oneRow_tHashOutput_2 = new TABLEStruct();
					...
					oneRow_tHashOutput_2.AUTINC = TABLE.AUTINC;
					oneRow_tHashOutput_2.TABELA = TABLE.TABELA;
					oneRow_tHashOutput_2.CODITE = TABLE.CODITE;
					oneRow_tHashOutput_2.CODEMP = TABLE.CODEMP;
					oneRow_tHashOutput_2.SALRES = TABLE.SALRES;
...
if(dbschema_tDBOutput_4 == null || dbschema_tDBOutput_4.trim().length() == 0) {
	tableName_tDBOutput_4 = ("stg_reserva_saldo_transferencia").toLowerCase();
} else {
	tableName_tDBOutput_4 = dbschema_tDBOutput_4 + "\".\"" + ("stg_reserva_saldo_transferencia").toLowerCase();
}
...
int count_tDBOutput_4=0;
        ...
        sb_tDBOutput_4.append("INSERT INTO \"").append(tableName_tDBOutput_4).append("\" (\"autinc\",\"tabela\",\"codite\",\"codemp\",\"salres\") VALUES (?,?,?,?,?)");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<TABLEStruct> tHashFile_tHashInput_2 = mf_tHashInput_2.getAdvancedMemoryHashFile("tHashFile_stg_reserva_saldo_transferencia_" + pid +"_tHashOutput_2");
...
while (iterator_tHashInput_2.hasNext()) {
	...
	row2.AUTINC = next_tHashInput_2.AUTINC;
	row2.TABELA = next_tHashInput_2.TABELA;
	row2.CODITE = next_tHashInput_2.CODITE;
	row2.CODEMP = next_tHashInput_2.CODEMP;
	row2.SALRES = next_tHashInput_2.SALRES;
...
insert_table_tmp.AUTINC = row2.AUTINC ;
insert_table_tmp.TABELA = row2.TABELA ;
insert_table_tmp.CODITE = row2.CODITE ;
insert_table_tmp.CODEMP = row2.CODEMP ;
insert_table_tmp.SALRES = row2.SALRES ;
...
if(insert_table != null) { 
	...
	currentComponent="tDBOutput_4";
        ...
        whetherReject_tDBOutput_4 = false;
                    if(insert_table.AUTINC == null) {
pstmt_tDBOutput_4.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(1, insert_table.AUTINC);
}

                    if(insert_table.TABELA == null) {
pstmt_tDBOutput_4.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(2, insert_table.TABELA);
}

                    if(insert_table.CODITE == null) {
pstmt_tDBOutput_4.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(3, insert_table.CODITE);
}

                    if(insert_table.CODEMP == null) {
pstmt_tDBOutput_4.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(4, insert_table.CODEMP);
}

                    pstmt_tDBOutput_4.setBigDecimal(5, insert_table.SALRES);
 ...
 */
	...
	currentComponent="tHashInput_2";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_stg_reserva_saldo_transferencia_" + pid +"_tHashOutput_2");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row1Struct> tHashFile_tHashInput_1 = mf_tHashInput_1.getAdvancedMemoryHashFile("tHashFile_stg_reserva_saldo_transferencia_" + pid +"_tHashOutput_1");
 ...
 */
	...
	currentComponent="tHashInput_1";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_stg_reserva_saldo_transferencia_" + pid +"_tHashOutput_1");
 ...
 */
    ...
    public static void main(String[] args){
        final stg_reserva_saldo_transferencia stg_reserva_saldo_transferenciaClass = new stg_reserva_saldo_transferencia();

        int exitCode = stg_reserva_saldo_transferenciaClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = stg_reserva_saldo_transferencia.class.getClassLoader().getResourceAsStream("palacio_ferramentas/stg_reserva_saldo_transferencia_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = stg_reserva_saldo_transferencia.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : stg_reserva_saldo_transferencia");
        }
...
/************************************************************************************************
 *     231404 characters generated by Talend Open Studio for Big Data 
 *     on the 21 de maio de 2024 09:07:55 BRT
 ************************************************************************************************/