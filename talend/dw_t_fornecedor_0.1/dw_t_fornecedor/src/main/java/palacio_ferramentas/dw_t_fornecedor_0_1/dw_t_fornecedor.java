...
package palacio_ferramentas.dw_t_fornecedor_0_1;
...
/**
 * Job: dw_t_fornecedor Purpose: <br>
 * Description:  <br>
 * @author talend@talend.com
 * @version 8.0.1.20230922_0317-SNAPSHOT
 * @status 
 */
public class dw_t_fornecedor implements TalendJob {
...
public String getJDBC_PARAMETERS(){
	...
	private final String jobName = "dw_t_fornecedor";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				dw_t_fornecedor.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(dw_t_fornecedor.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tDBConnection_1";
		...
		int tos_count_tDBConnection_1 = 0;
            ...
            String dbProperties_tDBConnection_1 = "ApplicationName=dw_t_fornecedor";
...
public static class row16Struct implements routines.system.IPersistableRow<row16Struct> {
    final static byte[] commonByteArrayLock_PALACIO_FERRAMENTAS_dw_t_fornecedor = new byte[0];
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_dw_t_fornecedor = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PALACIO_FERRAMENTAS_dw_t_fornecedor.length) {
				if(length < 1024 && commonByteArray_PALACIO_FERRAMENTAS_dw_t_fornecedor.length == 0) {
   					commonByteArray_PALACIO_FERRAMENTAS_dw_t_fornecedor = new byte[1024];
				} else {
   					commonByteArray_PALACIO_FERRAMENTAS_dw_t_fornecedor = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PALACIO_FERRAMENTAS_dw_t_fornecedor, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_dw_t_fornecedor, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PALACIO_FERRAMENTAS_dw_t_fornecedor, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_dw_t_fornecedor, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PALACIO_FERRAMENTAS_dw_t_fornecedor) {
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_1=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_1 = "tHashFile_dw_t_fornecedor_" + pid + "_tHashOutput_1";
...
public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
    ...
    public int compareTo(out1Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.CD_FORNECEDOR, other.CD_FORNECEDOR);
						if(returnValue != 0) {
							return returnValue;
						}
...
if(dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
	tableName_tDBOutput_2 = ("dw_t_fornecedor").toLowerCase();
} else {
	tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "\".\"" + ("dw_t_fornecedor").toLowerCase();
}
...
int count_tDBOutput_2=0;
        ...
        sb_tDBOutput_2.append("INSERT INTO \"").append(tableName_tDBOutput_2).append("\" (\"cd_fornecedor\",\"nm_fornecedor\",\"nm_fantasia\",\"dt_cadastro\",\"cd_comprador\",\"nm_comprador\",\"dt_atualizacao\") VALUES (?,?,?,?,?,?,?)");
 ...
 */
	...
	currentComponent="tDBInput_2";
		...
		int tos_count_tDBInput_2 = 0;
		    ...
		    String dbquery_tDBInput_2 = "\nSELECT \n       F.FOR_CODFOR CD_FORNECEDOR, \n       F.FOR_NOMFOR NM_FORNECEDOR, \n       F.FOR_NOMFAN NM_FANTASIA,\n"
+"       F.FOR_DTACAD DT_CADASTRO,\n       F.FOR_COMPRA CD_COMPRADOR,\n       OPE.OPE_NOMOPE  NM_COMPRADOR,\n       F.FOR_"
+"DTAALT DT_ATUALIZACAO\nFROM CADFOR F\nLEFT JOIN CADOPE OPE ON OPE.OPE_CODOPE = F.FOR_COMPRA\n";
        	...
        	row1.CD_FORNECEDOR = routines.system.JDBCUtil.getString(rs_tDBInput_2, 1, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 2) {
								row1.NM_FORNECEDOR = null;
							} else {
	                         		
        	row1.NM_FORNECEDOR = routines.system.JDBCUtil.getString(rs_tDBInput_2, 2, false);
		                    }
        	...
        	row1.NM_FANTASIA = routines.system.JDBCUtil.getString(rs_tDBInput_2, 3, false);
				...
				if(rs_tDBInput_2.getString(4) != null) {
					...
					if (!("0000-00-00").equals(dateString_tDBInput_2) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_2)) {
						row1.DT_CADASTRO = rs_tDBInput_2.getTimestamp(4);
					} else {
					...
					row1.DT_CADASTRO =  null;
							...
							if(colQtyInRs_tDBInput_2 < 5) {
								row1.CD_COMPRADOR = null;
							} else {
	                         		
        	row1.CD_COMPRADOR = routines.system.JDBCUtil.getString(rs_tDBInput_2, 5, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 6) {
								row1.NM_COMPRADOR = null;
							} else {
	                         		
        	row1.NM_COMPRADOR = routines.system.JDBCUtil.getString(rs_tDBInput_2, 6, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 7) {
								row1.DT_ATUALIZACAO = null;
							} else {
										
				if(rs_tDBInput_2.getString(7) != null) {
					String dateString_tDBInput_2 = rs_tDBInput_2.getString(7);
					if (!("0000-00-00").equals(dateString_tDBInput_2) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_2)) {
						row1.DT_ATUALIZACAO = rs_tDBInput_2.getTimestamp(7);
					} else {
						row1.DT_ATUALIZACAO = (java.util.Date) year0_tDBInput_2.clone();
					}
				} else {
					row1.DT_ATUALIZACAO =  null;
				}
...
if(row1.CD_FORNECEDOR == null){
	finder_tUniqRow_1.CD_FORNECEDOR = null;
}else{
	finder_tUniqRow_1.CD_FORNECEDOR = row1.CD_FORNECEDOR.toLowerCase();
}	
...
if(row1.CD_FORNECEDOR == null){
	new_tUniqRow_1.CD_FORNECEDOR = null;
}else{
	new_tUniqRow_1.CD_FORNECEDOR = row1.CD_FORNECEDOR.toLowerCase();
}
		
		keystUniqRow_1.add(new_tUniqRow_1);if(row3 == null){ 
	
	row3 = new row3Struct();
}row3.CD_FORNECEDOR = row1.CD_FORNECEDOR;			row3.NM_FORNECEDOR = row1.NM_FORNECEDOR;			row3.NM_FANTASIA = row1.NM_FANTASIA;			row3.DT_CADASTRO = row1.DT_CADASTRO;			row3.CD_COMPRADOR = row1.CD_COMPRADOR;			row3.NM_COMPRADOR = row1.NM_COMPRADOR;			row3.DT_ATUALIZACAO = row1.DT_ATUALIZACAO;					
...
// # Output table : 'out1'
out1_tmp.CD_FORNECEDOR = row3.CD_FORNECEDOR ;
out1_tmp.NM_FORNECEDOR = row3.NM_FORNECEDOR ;
out1_tmp.NM_FANTASIA = row3.NM_FANTASIA ;
out1_tmp.DT_CADASTRO = row3.DT_CADASTRO ;
out1_tmp.CD_COMPRADOR = row3.CD_COMPRADOR ;
out1_tmp.NM_COMPRADOR = row3.NM_COMPRADOR ;
out1_tmp.DT_ATUALIZACAO = row3.DT_ATUALIZACAO ;
out1 = out1_tmp;
// ###############################
...
if(out1 != null) { 
	...
	currentComponent="tDBOutput_2";
        ...
        whetherReject_tDBOutput_2 = false;
                    if(out1.CD_FORNECEDOR == null) {
pstmt_tDBOutput_2.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(1, out1.CD_FORNECEDOR);
}

                    if(out1.NM_FORNECEDOR == null) {
pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(2, out1.NM_FORNECEDOR);
}

                    if(out1.NM_FANTASIA == null) {
pstmt_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(3, out1.NM_FANTASIA);
}

                    if(out1.DT_CADASTRO != null) {
pstmt_tDBOutput_2.setTimestamp(4, new java.sql.Timestamp(out1.DT_CADASTRO.getTime()));
} else {
pstmt_tDBOutput_2.setNull(4, java.sql.Types.TIMESTAMP);
}

                    if(out1.CD_COMPRADOR == null) {
pstmt_tDBOutput_2.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(5, out1.CD_COMPRADOR);
}

                    if(out1.NM_COMPRADOR == null) {
pstmt_tDBOutput_2.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(6, out1.NM_COMPRADOR);
}

                    if(out1.DT_ATUALIZACAO != null) {
pstmt_tDBOutput_2.setTimestamp(7, new java.sql.Timestamp(out1.DT_ATUALIZACAO.getTime()));
} else {
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row16Struct> tHashFile_tHashInput_1 = mf_tHashInput_1.getAdvancedMemoryHashFile("tHashFile_dw_t_fornecedor_" + pid +"_tHashOutput_1");
 ...
 */
	...
	currentComponent="tHashInput_1";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_dw_t_fornecedor_" + pid +"_tHashOutput_1");
 ...
 */
    ...
    public static void main(String[] args){
        final dw_t_fornecedor dw_t_fornecedorClass = new dw_t_fornecedor();

        int exitCode = dw_t_fornecedorClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = dw_t_fornecedor.class.getClassLoader().getResourceAsStream("palacio_ferramentas/dw_t_fornecedor_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = dw_t_fornecedor.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dw_t_fornecedor");
        }
...
/************************************************************************************************
 *     219665 characters generated by Talend Open Studio for Big Data 
 *     on the 20 de maio de 2024 15:26:29 BRT
 ************************************************************************************************/