...
package palacio_ferramentas.bi_t_cliente_0_1;
...
public String getJDBC_PARAMETERS(){
	...
	private final String jobName = "bi_t_cliente";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(bi_t_cliente.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row16Struct implements routines.system.IPersistableRow<row16Struct> {
    final static byte[] commonByteArrayLock_PALACIO_FERRAMENTAS_bi_t_cliente = new byte[0];
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_bi_t_cliente = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PALACIO_FERRAMENTAS_bi_t_cliente.length) {
				if(length < 1024 && commonByteArray_PALACIO_FERRAMENTAS_bi_t_cliente.length == 0) {
   					commonByteArray_PALACIO_FERRAMENTAS_bi_t_cliente = new byte[1024];
				} else {
   					commonByteArray_PALACIO_FERRAMENTAS_bi_t_cliente = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PALACIO_FERRAMENTAS_bi_t_cliente, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_bi_t_cliente, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PALACIO_FERRAMENTAS_bi_t_cliente, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_bi_t_cliente, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PALACIO_FERRAMENTAS_bi_t_cliente) {
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_5=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_5 = "tHashFile_bi_t_cliente_" + pid + "_tHashOutput_5";
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_11=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_11 = "tHashFile_bi_t_cliente_" + pid + "_tHashOutput_11";
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row9Struct> tHashFile_tHashInput_11 = mf_tHashInput_11.getAdvancedMemoryHashFile("tHashFile_bi_t_cliente_" + pid +"_tHashOutput_4");
 ...
 */
	...
	currentComponent="tHashInput_11";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_bi_t_cliente_" + pid +"_tHashOutput_4");
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    ...
    public String loopKey;
			    ...
			    public String CURVA_VALOR;

				public String getCURVA_VALOR () {
					return this.CURVA_VALOR;
				}

				public Boolean CURVA_VALORIsNullable(){
				    return true;
				}
				public Boolean CURVA_VALORIsKey(){
				    return false;
				}
				public Integer CURVA_VALORLength(){
				    return 3;
				}
				public Integer CURVA_VALORPrecision(){
				    return null;
				}
				public String CURVA_VALORDefault(){
				
					return null;
				
				}
				public String CURVA_VALORComment(){
				
				    return "";
				
				}
				public String CURVA_VALORPattern(){
				
					return "";
				
				}
				public String CURVA_VALOROriginalDbColumnName(){
	...
	public void copyDataTo(row2Struct other) {
		...
		other.CD_CLIENTE = this.CD_CLIENTE;
	            ...
	            other.DT_ULTIMA_COMPRA = this.DT_ULTIMA_COMPRA;
	            other.VL_ULTIMA_COMPRA = this.VL_ULTIMA_COMPRA;
	            other.CURVA_VALOR = this.CURVA_VALOR;
		...
		synchronized(commonByteArrayLock_PALACIO_FERRAMENTAS_bi_t_cliente) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.CURVA_VALOR = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.CURVA_VALOR,dos);
    ...
    public String toString() {
		...
		sb.append(",DT_ULTIMA_COMPRA="+String.valueOf(DT_ULTIMA_COMPRA));
		sb.append(",VL_ULTIMA_COMPRA="+String.valueOf(VL_ULTIMA_COMPRA));
		sb.append(",CURVA_VALOR="+CURVA_VALOR);
	    sb.append("]");
...
if(dbschema_tDBOutput_4 == null || dbschema_tDBOutput_4.trim().length() == 0) {
	tableName_tDBOutput_4 = ("bi_t_cliente").toLowerCase();
} else {
	tableName_tDBOutput_4 = dbschema_tDBOutput_4 + "\".\"" + ("bi_t_cliente").toLowerCase();
}
...
int count_tDBOutput_4=0;
        ...
        sb_tDBOutput_4.append("INSERT INTO \"").append(tableName_tDBOutput_4).append("\" (\"cd_cliente\",\"nome_cliente\",\"atividade\",\"tipo_pessoa\",\"nm_documento\",\"dt_nascimento\",\"cep\",\"cidade\",\"estado\",\"regiao\",\"telefone\",\"celular\",\"email\",\"dt_cadastro\",\"dt_primeira_compra\",\"dt_ultima_compra\",\"vl_ultima_compra\",\"curva_valor\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<out4Struct> tHashFile_tHashInput_4 = mf_tHashInput_4.getAdvancedMemoryHashFile("tHashFile_bi_t_cliente_" + pid +"_tHashOutput_11");
...
out1_tmp.CEP = row12.CEP_RESIDENCIAL;
out1_tmp.CIDADE = row12.CIDADE;
out1_tmp.ESTADO = row12.UF;
out1_tmp.REGIAO = row12.REGIAO;
out1_tmp.TELEFONE = row12.TELEFONE_1;
out1_tmp.CELULAR = row12.CELULAR;
out1_tmp.EMAIL = row12.EMAIL_1;
...
if(out1.CD_CLIENTE == null){
	...
	finder_tUniqRow_1.CD_CLIENTE = out1.CD_CLIENTE.toLowerCase();
}	
...
if(out1.CD_CLIENTE == null){
	...
	new_tUniqRow_1.CD_CLIENTE = out1.CD_CLIENTE.toLowerCase();
}
		
		keystUniqRow_1.add(new_tUniqRow_1);if(row2 == null){ 
	
	row2 = new row2Struct();
}row2.CD_CLIENTE = out1.CD_CLIENTE;			row2.NOME_CLIENTE = out1.NOME_CLIENTE;			row2.ATIVIDADE = out1.ATIVIDADE;			row2.TIPO_PESSOA = out1.TIPO_PESSOA;			row2.NM_DOCUMENTO = out1.NM_DOCUMENTO;			row2.DT_NASCIMENTO = out1.DT_NASCIMENTO;			row2.CEP = out1.CEP;			row2.CIDADE = out1.CIDADE;			row2.ESTADO = out1.ESTADO;			row2.REGIAO = out1.REGIAO;			row2.TELEFONE = out1.TELEFONE;			row2.CELULAR = out1.CELULAR;			row2.EMAIL = out1.EMAIL;			row2.DT_CADASTRO = out1.DT_CADASTRO;			row2.DT_PRIMEIRA_COMPRA = out1.DT_PRIMEIRA_COMPRA;			row2.DT_ULTIMA_COMPRA = out1.DT_ULTIMA_COMPRA;			row2.VL_ULTIMA_COMPRA = out1.VL_ULTIMA_COMPRA;			row2.CURVA_VALOR = out1.CURVA_VALOR;					
...
} else {pstmt_tDBOutput_4.setString(1, row2.CD_CLIENTE);
}

                    if(row2.NOME_CLIENTE == null) {
pstmt_tDBOutput_4.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(2, row2.NOME_CLIENTE);
}

                    if(row2.ATIVIDADE == null) {
pstmt_tDBOutput_4.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(3, row2.ATIVIDADE);
}

                    if(row2.TIPO_PESSOA == null) {
pstmt_tDBOutput_4.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(4, row2.TIPO_PESSOA);
}

                    if(row2.NM_DOCUMENTO == null) {
pstmt_tDBOutput_4.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(5, row2.NM_DOCUMENTO);
}

                    if(row2.DT_NASCIMENTO != null) {
pstmt_tDBOutput_4.setTimestamp(6, new java.sql.Timestamp(row2.DT_NASCIMENTO.getTime()));
} else {
...
} else {pstmt_tDBOutput_4.setString(7, row2.CEP);
}

                    if(row2.CIDADE == null) {
pstmt_tDBOutput_4.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(8, row2.CIDADE);
}

                    if(row2.ESTADO == null) {
pstmt_tDBOutput_4.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(9, row2.ESTADO);
}

                    if(row2.REGIAO == null) {
pstmt_tDBOutput_4.setNull(10, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(10, row2.REGIAO);
}

                    if(row2.TELEFONE == null) {
pstmt_tDBOutput_4.setNull(11, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(11, row2.TELEFONE);
}

                    if(row2.CELULAR == null) {
pstmt_tDBOutput_4.setNull(12, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(12, row2.CELULAR);
}

                    if(row2.EMAIL == null) {
pstmt_tDBOutput_4.setNull(13, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(13, row2.EMAIL);
}

                    if(row2.DT_CADASTRO != null) {
pstmt_tDBOutput_4.setTimestamp(14, new java.sql.Timestamp(row2.DT_CADASTRO.getTime()));
} else {
pstmt_tDBOutput_4.setNull(14, java.sql.Types.TIMESTAMP);
}

                    if(row2.DT_PRIMEIRA_COMPRA != null) {
pstmt_tDBOutput_4.setTimestamp(15, new java.sql.Timestamp(row2.DT_PRIMEIRA_COMPRA.getTime()));
} else {
pstmt_tDBOutput_4.setNull(15, java.sql.Types.TIMESTAMP);
}

                    if(row2.DT_ULTIMA_COMPRA != null) {
pstmt_tDBOutput_4.setTimestamp(16, new java.sql.Timestamp(row2.DT_ULTIMA_COMPRA.getTime()));
} else {
pstmt_tDBOutput_4.setNull(16, java.sql.Types.TIMESTAMP);
}

                    if(row2.VL_ULTIMA_COMPRA == null) {
pstmt_tDBOutput_4.setNull(17, java.sql.Types.DOUBLE);
} else {pstmt_tDBOutput_4.setDouble(17, row2.VL_ULTIMA_COMPRA);
}

                    if(row2.CURVA_VALOR == null) {
pstmt_tDBOutput_4.setNull(18, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(18, row2.CURVA_VALOR);
}
 ...
 */
	...
	currentComponent="tHashInput_4";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_bi_t_cliente_" + pid +"_tHashOutput_11");
...
query_tDBRow_1 = "\nUPDATE BI_T_CLIENTE SET CURVA_VALOR = 'C' WHERE CURVA_VALOR IS NULL;\nCOMMIT;\n\n";
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row16Struct> tHashFile_tHashInput_6 = mf_tHashInput_6.getAdvancedMemoryHashFile("tHashFile_bi_t_cliente_" + pid +"_tHashOutput_5");
 ...
 */
	...
	currentComponent="tHashInput_6";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_bi_t_cliente_" + pid +"_tHashOutput_5");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row30Struct> tHashFile_tHashInput_12 = mf_tHashInput_12.getAdvancedMemoryHashFile("tHashFile_bi_t_cliente_" + pid +"_tHashOutput_10");
 ...
 */
	...
	currentComponent="tHashInput_12";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_bi_t_cliente_" + pid +"_tHashOutput_10");
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_10=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_10 = "tHashFile_bi_t_cliente_" + pid + "_tHashOutput_10";
 ...
 */
	...
	currentComponent="tDBInput_8";
		...
		int tos_count_tDBInput_8 = 0;
		    ...
		    String dbquery_tDBInput_8 = "select cd_cliente from bi_t_cliente";
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_4=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_4 = "tHashFile_bi_t_cliente_" + pid + "_tHashOutput_4";
 ...
 */
    ...
    public static void main(String[] args){
        final bi_t_cliente bi_t_clienteClass = new bi_t_cliente();

        int exitCode = bi_t_clienteClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = bi_t_cliente.class.getClassLoader().getResourceAsStream("palacio_ferramentas/bi_t_cliente_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = bi_t_cliente.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : bi_t_cliente");
        }
...
/************************************************************************************************
 *     527613 characters generated by Talend Open Studio for Big Data 
 *     on the 26 de junho de 2024 13:18:56 BRT
 ************************************************************************************************/