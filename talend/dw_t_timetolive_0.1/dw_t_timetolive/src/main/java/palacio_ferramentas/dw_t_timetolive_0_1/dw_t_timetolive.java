...
package palacio_ferramentas.dw_t_timetolive_0_1;
...
/**
 * Job: dw_t_timetolive Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 8.0.1.20230922_0317-SNAPSHOT
 * @status 
 */
public class dw_t_timetolive implements TalendJob {
...
public String getPOSTGRES_PASSWORD(){
	...
	private final String jobName = "dw_t_timetolive";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				dw_t_timetolive.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(dw_t_timetolive.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_PALACIO_FERRAMENTAS_dw_t_timetolive = new byte[0];
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_dw_t_timetolive = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PALACIO_FERRAMENTAS_dw_t_timetolive.length) {
				if(length < 1024 && commonByteArray_PALACIO_FERRAMENTAS_dw_t_timetolive.length == 0) {
   					commonByteArray_PALACIO_FERRAMENTAS_dw_t_timetolive = new byte[1024];
				} else {
   					commonByteArray_PALACIO_FERRAMENTAS_dw_t_timetolive = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PALACIO_FERRAMENTAS_dw_t_timetolive, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_dw_t_timetolive, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PALACIO_FERRAMENTAS_dw_t_timetolive, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_dw_t_timetolive, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PALACIO_FERRAMENTAS_dw_t_timetolive) {
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_1=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_1 = "tHashFile_dw_t_timetolive_" + pid + "_tHashOutput_1";
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    ...
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_dw_t_timetolive = new byte[0];
			    ...
			    public Integer CD_TABELA;

				public Integer getCD_TABELA () {
					return this.CD_TABELA;
				}

				public Boolean CD_TABELAIsNullable(){
				    return true;
				}
				public Boolean CD_TABELAIsKey(){
				    return false;
				}
				public Integer CD_TABELALength(){
				    return null;
				}
				public Integer CD_TABELAPrecision(){
				    return null;
				}
				public String CD_TABELADefault(){
				
					return null;
				
				}
				public String CD_TABELAComment(){
				
				    return "";
				
				}
				public String CD_TABELAPattern(){
				
					return "";
				
				}
				public String CD_TABELAOriginalDbColumnName(){
			    ...
			    public String DESC_TABELA;

				public String getDESC_TABELA () {
					return this.DESC_TABELA;
				}

				public Boolean DESC_TABELAIsNullable(){
				    return true;
				}
				public Boolean DESC_TABELAIsKey(){
				    return false;
				}
				public Integer DESC_TABELALength(){
				    return null;
				}
				public Integer DESC_TABELAPrecision(){
				    return null;
				}
				public String DESC_TABELADefault(){
				
					return null;
				
				}
				public String DESC_TABELAComment(){
				
				    return "";
				
				}
				public String DESC_TABELAPattern(){
				
					return "";
				
				}
				public String DESC_TABELAOriginalDbColumnName(){
			    ...
			    public Integer DIAS_LIMPEZA;

				public Integer getDIAS_LIMPEZA () {
					return this.DIAS_LIMPEZA;
				}

				public Boolean DIAS_LIMPEZAIsNullable(){
				    return true;
				}
				public Boolean DIAS_LIMPEZAIsKey(){
				    return false;
				}
				public Integer DIAS_LIMPEZALength(){
				    return null;
				}
				public Integer DIAS_LIMPEZAPrecision(){
				    return null;
				}
				public String DIAS_LIMPEZADefault(){
				
					return null;
				
				}
				public String DIAS_LIMPEZAComment(){
				
				    return "";
				
				}
				public String DIAS_LIMPEZAPattern(){
				
					return "";
				
				}
				public String DIAS_LIMPEZAOriginalDbColumnName(){
		...
		synchronized(commonByteArrayLock_PALACIO_FERRAMENTAS_dw_t_timetolive) {
        	...
        	try {
        		...
        		int length = 0;
						...
						this.CD_TABELA = readInteger(dis);
					
					this.DESC_TABELA = readString(dis);
					
						this.DIAS_LIMPEZA = readInteger(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Integer
						...
						writeInteger(this.CD_TABELA,dos);
					
					// String
				
						writeString(this.DESC_TABELA,dos);
					
					// Integer
				
						writeInteger(this.DIAS_LIMPEZA,dos);
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("CD_TABELA="+String.valueOf(CD_TABELA));
		sb.append(",DESC_TABELA="+DESC_TABELA);
		sb.append(",DIAS_LIMPEZA="+String.valueOf(DIAS_LIMPEZA));
		sb.append(",Data="+Data);
	    sb.append("]");
 ...
 */
	...
	currentComponent="tDBInput_2";
		...
		int tos_count_tDBInput_2 = 0;
		    ...
		    String dbquery_tDBInput_2 = "select CD_TABELA,DESC_TABELA,DIAS_LIMPEZA, Data from dw_t_timetolive";
            ...
            row1.CD_TABELA = rs_tDBInput_2.getInt(1);
            if(rs_tDBInput_2.wasNull()){
                    row1.CD_TABELA = null;
            }
		                    }
							if(colQtyInRs_tDBInput_2 < 2) {
								row1.DESC_TABELA = null;
							} else {
	                         		
        	row1.DESC_TABELA = routines.system.JDBCUtil.getString(rs_tDBInput_2, 2, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 3) {
								row1.DIAS_LIMPEZA = null;
							} else {
		                          
            row1.DIAS_LIMPEZA = rs_tDBInput_2.getInt(3);
            if(rs_tDBInput_2.wasNull()){
                    row1.DIAS_LIMPEZA = null;
            }
		                    }
        	...
        	row1.Data = routines.system.JDBCUtil.getString(rs_tDBInput_2, 4, false);
		                    }
 ...
 */
	...
	currentComponent="tFlowToIterate_1";
            ...
            globalMap.put("row1.CD_TABELA", row1.CD_TABELA);
    	            
            globalMap.put("row1.DESC_TABELA", row1.DESC_TABELA);
    	            
            globalMap.put("row1.DIAS_LIMPEZA", row1.DIAS_LIMPEZA);
 ...
 */
	...
	int count_tDBRow_2 = 0;
				conn_tDBRow_2 = (java.sql.Connection)globalMap.get("conn_tDBConnection_3");
...
query_tDBRow_2 = "DELETE FROM "+((String)globalMap.get("row1.DESC_TABELA"))+" WHERE "+((String)globalMap.get("row1.Data"))+" < CURRENT_DATE - (INTERVAL '"+((Integer)globalMap.get("row1.DIAS_LIMPEZA"))+" days')";
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row4Struct> tHashFile_tHashInput_1 = mf_tHashInput_1.getAdvancedMemoryHashFile("tHashFile_dw_t_timetolive_" + pid +"_tHashOutput_1");
 ...
 */
	...
	currentComponent="tHashInput_1";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_dw_t_timetolive_" + pid +"_tHashOutput_1");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row4Struct> tHashFile_tHashInput_2 = mf_tHashInput_2.getAdvancedMemoryHashFile("tHashFile_dw_t_timetolive_" + pid +"_tHashOutput_1");
 ...
 */
    ...
    public static void main(String[] args){
        final dw_t_timetolive dw_t_timetoliveClass = new dw_t_timetolive();

        int exitCode = dw_t_timetoliveClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = dw_t_timetolive.class.getClassLoader().getResourceAsStream("palacio_ferramentas/dw_t_timetolive_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = dw_t_timetolive.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dw_t_timetolive");
        }
...
/************************************************************************************************
 *     281374 characters generated by Talend Open Studio for Big Data 
 *     on the 19 de março de 2024 14:55:39 BRT
 ************************************************************************************************/