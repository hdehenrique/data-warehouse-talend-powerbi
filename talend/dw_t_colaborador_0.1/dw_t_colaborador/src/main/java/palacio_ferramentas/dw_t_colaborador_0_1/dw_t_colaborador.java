...
package palacio_ferramentas.dw_t_colaborador_0_1;
...
/**
 * Job: dw_t_colaborador Purpose: <br>
 * Description:  <br>
 * @author talend@talend.com
 * @version 8.0.1.20230922_0317-SNAPSHOT
 * @status 
 */
public class dw_t_colaborador implements TalendJob {
...
public String getJDBC_PARAMETERS(){
	...
	private final String jobName = "dw_t_colaborador";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				dw_t_colaborador.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(dw_t_colaborador.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tDBConnection_3";
		...
		int tos_count_tDBConnection_3 = 0;
            ...
            String dbProperties_tDBConnection_3 = "ApplicationName=dw_t_colaborador";
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_PALACIO_FERRAMENTAS_dw_t_colaborador = new byte[0];
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_dw_t_colaborador = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PALACIO_FERRAMENTAS_dw_t_colaborador.length) {
				if(length < 1024 && commonByteArray_PALACIO_FERRAMENTAS_dw_t_colaborador.length == 0) {
   					commonByteArray_PALACIO_FERRAMENTAS_dw_t_colaborador = new byte[1024];
				} else {
   					commonByteArray_PALACIO_FERRAMENTAS_dw_t_colaborador = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PALACIO_FERRAMENTAS_dw_t_colaborador, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_dw_t_colaborador, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PALACIO_FERRAMENTAS_dw_t_colaborador, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_dw_t_colaborador, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PALACIO_FERRAMENTAS_dw_t_colaborador) {
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_1=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_1 = "tHashFile_dw_t_colaborador_" + pid + "_tHashOutput_1";
...
if(dbschema_tDBOutput_5 == null || dbschema_tDBOutput_5.trim().length() == 0) {
	tableName_tDBOutput_5 = ("dw_log_execucao").toLowerCase();
} else {
	tableName_tDBOutput_5 = dbschema_tDBOutput_5 + "\".\"" + ("dw_log_execucao").toLowerCase();
}
...
int count_tDBOutput_5=0;
        ...
        sb_tDBOutput_5.append("INSERT INTO \"").append(tableName_tDBOutput_5).append("\" (\"nm_programa\",\"data_inicio_execucao\",\"data_termino_execucao\",\"mensagem\",\"uuid\",\"versao\") VALUES (?,?,?,?,?,?)");
...
} else {pstmt_tDBOutput_5.setString(1, insert_log.nm_programa);
}

                    if(insert_log.data_inicio_execucao != null) {
pstmt_tDBOutput_5.setTimestamp(2, new java.sql.Timestamp(insert_log.data_inicio_execucao.getTime()));
} else {
pstmt_tDBOutput_5.setNull(2, java.sql.Types.TIMESTAMP);
}

                    if(insert_log.data_termino_execucao != null) {
pstmt_tDBOutput_5.setTimestamp(3, new java.sql.Timestamp(insert_log.data_termino_execucao.getTime()));
} else {
...
} else {pstmt_tDBOutput_5.setString(4, insert_log.mensagem);
}

                    if(insert_log.uuid == null) {
pstmt_tDBOutput_5.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_5.setString(5, insert_log.uuid);
}

                    if(insert_log.versao == null) {
pstmt_tDBOutput_5.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_5.setString(6, insert_log.versao);
}
...
public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
    ...
    public String loopKey;
			    ...
			    public String CD_DEPARTAMENTO;

				public String getCD_DEPARTAMENTO () {
					return this.CD_DEPARTAMENTO;
				}

				public Boolean CD_DEPARTAMENTOIsNullable(){
				    return true;
				}
				public Boolean CD_DEPARTAMENTOIsKey(){
				    return false;
				}
				public Integer CD_DEPARTAMENTOLength(){
				    return 3;
				}
				public Integer CD_DEPARTAMENTOPrecision(){
				    return null;
				}
				public String CD_DEPARTAMENTODefault(){
				
					return null;
				
				}
				public String CD_DEPARTAMENTOComment(){
				
				    return "";
				
				}
				public String CD_DEPARTAMENTOPattern(){
				
					return "";
				
				}
				public String CD_DEPARTAMENTOOriginalDbColumnName(){
	...
	public void copyDataTo(out1Struct other) {
		...
		other.CD_VENDEDOR = this.CD_VENDEDOR;
	            other.NM_VENDEDOR = this.NM_VENDEDOR;
	            other.STATUS = this.STATUS;
	            other.CD_DEPARTAMENTO = this.CD_DEPARTAMENTO;
		...
		synchronized(commonByteArrayLock_PALACIO_FERRAMENTAS_dw_t_colaborador) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.CD_DEPARTAMENTO = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.CD_DEPARTAMENTO,dos);
    ...
    public String toString() {
		...
		sb.append(",CD_DEPARTAMENTO="+CD_DEPARTAMENTO);
    ...
    public int compareTo(out1Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.CD_VENDEDOR, other.CD_VENDEDOR);
						if(returnValue != 0) {
							return returnValue;
						}
...
if(dbschema_tDBOutput_3 == null || dbschema_tDBOutput_3.trim().length() == 0) {
	tableName_tDBOutput_3 = ("dw_t_colaborador").toLowerCase();
} else {
	tableName_tDBOutput_3 = dbschema_tDBOutput_3 + "\".\"" + ("dw_t_colaborador").toLowerCase();
}
...
int count_tDBOutput_3=0;
        ...
        sb_tDBOutput_3.append("INSERT INTO \"").append(tableName_tDBOutput_3).append("\" (\"cd_vendedor\",\"nm_vendedor\",\"status\",\"cd_departamento\",\"departamento\") VALUES (?,?,?,?,?)");
		...
		class KeyStruct_tUniqRow_1 {
			...
			public int hashCode() {
				if (this.hashCodeDirty) {
					...
					int result = DEFAULT_HASHCODE;
								...
								result = prime * result + ((this.CD_DEPARTAMENTO == null) ? 0 : this.CD_DEPARTAMENTO.hashCode());
			...
			public boolean equals(Object obj) {
				...
				final KeyStruct_tUniqRow_1 other = (KeyStruct_tUniqRow_1) obj;
									...
									if (this.CD_DEPARTAMENTO == null) {
										if (other.CD_DEPARTAMENTO != null) 
											return false;
								
									} else if (!this.CD_DEPARTAMENTO.equals(other.CD_DEPARTAMENTO))
 ...
 */
	...
	currentComponent="tDBInput_2";
		...
		int tos_count_tDBInput_2 = 0;
		    ...
		    String dbquery_tDBInput_2 = "\nselect CO.OPE_CODOPE                         CD_VENDEDOR,\n       LTRIM(REPLACE(OPE_NOMOPE , '*', ' ')) NM_VENDEDOR,"
+"\n       CO.OPE_STATUS                         STATUS,\n       CO.OPE_CODDEP                         CD_DEPARTAMENTO,\n  "
+"     CD.DEP_DESCRI                         DEPARTAMENTO\n  from CADOPE CO\n   left join CADDEP CD on CO.OPE_CODDEP  = CD"
+".DEP_CODIGO\n--       where CO.OPE_CODOPE IN ('002', '599', '619', '914', '988', 'A42')\n";
        	...
        	row1.NM_VENDEDOR = routines.system.JDBCUtil.getString(rs_tDBInput_2, 2, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 3) {
								row1.STATUS = null;
							} else {
	                         		
        	row1.STATUS = routines.system.JDBCUtil.getString(rs_tDBInput_2, 3, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 4) {
								row1.CD_DEPARTAMENTO = null;
							} else {
	                         		
        	row1.CD_DEPARTAMENTO = routines.system.JDBCUtil.getString(rs_tDBInput_2, 4, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 5) {
								row1.DEPARTAMENTO = null;
							} else {
	                         		
        	row1.DEPARTAMENTO = routines.system.JDBCUtil.getString(rs_tDBInput_2, 5, false);
		                    }
...
if(row1.NM_VENDEDOR == null){
	finder_tUniqRow_1.NM_VENDEDOR = null;
}else{
	finder_tUniqRow_1.NM_VENDEDOR = row1.NM_VENDEDOR.toLowerCase();
}
if(row1.STATUS == null){
	finder_tUniqRow_1.STATUS = null;
}else{
	finder_tUniqRow_1.STATUS = row1.STATUS.toLowerCase();
}
if(row1.CD_DEPARTAMENTO == null){
	finder_tUniqRow_1.CD_DEPARTAMENTO = null;
}else{
	finder_tUniqRow_1.CD_DEPARTAMENTO = row1.CD_DEPARTAMENTO.toLowerCase();
}
if(row1.DEPARTAMENTO == null){
	finder_tUniqRow_1.DEPARTAMENTO = null;
}else{
	finder_tUniqRow_1.DEPARTAMENTO = row1.DEPARTAMENTO.toLowerCase();
}	
...
if(row1.NM_VENDEDOR == null){
	...
	new_tUniqRow_1.NM_VENDEDOR = row1.NM_VENDEDOR.toLowerCase();
}
if(row1.STATUS == null){
	new_tUniqRow_1.STATUS = null;
}else{
	new_tUniqRow_1.STATUS = row1.STATUS.toLowerCase();
}
if(row1.CD_DEPARTAMENTO == null){
	new_tUniqRow_1.CD_DEPARTAMENTO = null;
}else{
	new_tUniqRow_1.CD_DEPARTAMENTO = row1.CD_DEPARTAMENTO.toLowerCase();
}
if(row1.DEPARTAMENTO == null){
	new_tUniqRow_1.DEPARTAMENTO = null;
}else{
	new_tUniqRow_1.DEPARTAMENTO = row1.DEPARTAMENTO.toLowerCase();
}
		
		keystUniqRow_1.add(new_tUniqRow_1);if(row3 == null){ 
	
	row3 = new row3Struct();
}row3.CD_VENDEDOR = row1.CD_VENDEDOR;			row3.NM_VENDEDOR = row1.NM_VENDEDOR;			row3.STATUS = row1.STATUS;			row3.CD_DEPARTAMENTO = row1.CD_DEPARTAMENTO;			row3.DEPARTAMENTO = row1.DEPARTAMENTO;					
...
out1_tmp.NM_VENDEDOR = row3.NM_VENDEDOR ;
out1_tmp.STATUS = row3.STATUS ;
out1_tmp.CD_DEPARTAMENTO = row3.CD_DEPARTAMENTO ;
out1_tmp.DEPARTAMENTO = row3.DEPARTAMENTO ;
out1 = out1_tmp;
// ###############################
...
if(out1 != null) { 
	...
	currentComponent="tDBOutput_3";
        ...
        whetherReject_tDBOutput_3 = false;
                    if(out1.CD_VENDEDOR == null) {
pstmt_tDBOutput_3.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(1, out1.CD_VENDEDOR);
}

                    if(out1.NM_VENDEDOR == null) {
pstmt_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(2, out1.NM_VENDEDOR);
}

                    if(out1.STATUS == null) {
pstmt_tDBOutput_3.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(3, out1.STATUS);
}

                    if(out1.CD_DEPARTAMENTO == null) {
pstmt_tDBOutput_3.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(4, out1.CD_DEPARTAMENTO);
}

                    if(out1.DEPARTAMENTO == null) {
pstmt_tDBOutput_3.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(5, out1.DEPARTAMENTO);
}
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row4Struct> tHashFile_tHashInput_1 = mf_tHashInput_1.getAdvancedMemoryHashFile("tHashFile_dw_t_colaborador_" + pid +"_tHashOutput_1");
 ...
 */
	...
	currentComponent="tHashInput_1";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_dw_t_colaborador_" + pid +"_tHashOutput_1");
 ...
 */
    ...
    public static void main(String[] args){
        final dw_t_colaborador dw_t_colaboradorClass = new dw_t_colaborador();

        int exitCode = dw_t_colaboradorClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = dw_t_colaborador.class.getClassLoader().getResourceAsStream("palacio_ferramentas/dw_t_colaborador_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = dw_t_colaborador.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dw_t_colaborador");
        }
...
/************************************************************************************************
 *     209708 characters generated by Talend Open Studio for Big Data 
 *     on the 20 de maio de 2024 15:26:18 BRT
 ************************************************************************************************/