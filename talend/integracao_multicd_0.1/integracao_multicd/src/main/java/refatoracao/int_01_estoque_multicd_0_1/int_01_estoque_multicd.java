...
package refatoracao.int_01_estoque_multicd_0_1;
...
/**
 * Job: int_01_estoque_multicd Purpose: integracao_estoque_multicd<br>
 * Description:  <br>
 * @author luisll@uol.com.br
 * @version 8.0.1.20230922_0317-SNAPSHOT
 * @status 
 */
public class int_01_estoque_multicd implements TalendJob {
...
public String getJDBC_PARAMETERS(){
	...
	private final String jobName = "int_01_estoque_multicd";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				int_01_estoque_multicd.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(int_01_estoque_multicd.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row16Struct implements routines.system.IPersistableRow<row16Struct> {
    final static byte[] commonByteArrayLock_REFATORACAO_int_01_estoque_multicd = new byte[0];
    static byte[] commonByteArray_REFATORACAO_int_01_estoque_multicd = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_REFATORACAO_int_01_estoque_multicd.length) {
				if(length < 1024 && commonByteArray_REFATORACAO_int_01_estoque_multicd.length == 0) {
   					commonByteArray_REFATORACAO_int_01_estoque_multicd = new byte[1024];
				} else {
   					commonByteArray_REFATORACAO_int_01_estoque_multicd = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_REFATORACAO_int_01_estoque_multicd, 0, length);
			strReturn = new String(commonByteArray_REFATORACAO_int_01_estoque_multicd, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_REFATORACAO_int_01_estoque_multicd, 0, length);
			strReturn = new String(commonByteArray_REFATORACAO_int_01_estoque_multicd, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_REFATORACAO_int_01_estoque_multicd) {
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_5=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_5 = "tHashFile_int_01_estoque_multicd_" + pid + "_tHashOutput_5";
...
public static class row20Struct implements routines.system.IPersistableRow<row20Struct> {
    ...
    static byte[] commonByteArray_REFATORACAO_int_01_estoque_multicd = new byte[0];
			    ...
			    public Integer SALDO_001;

				public Integer getSALDO_001 () {
					return this.SALDO_001;
				}

				public Boolean SALDO_001IsNullable(){
				    return true;
				}
				public Boolean SALDO_001IsKey(){
				    return false;
				}
				public Integer SALDO_001Length(){
				    return 12;
				}
				public Integer SALDO_001Precision(){
				    return null;
				}
				public String SALDO_001Default(){
				
					return null;
				
				}
				public String SALDO_001Comment(){
				
				    return "";
				
				}
				public String SALDO_001Pattern(){
				
					return "";
				
				}
				public String SALDO_001OriginalDbColumnName(){
			    ...
			    public String EMP_010;

				public String getEMP_010 () {
					return this.EMP_010;
				}

				public Boolean EMP_010IsNullable(){
				    return true;
				}
				public Boolean EMP_010IsKey(){
				    return false;
				}
				public Integer EMP_010Length(){
				    return 12;
				}
				public Integer EMP_010Precision(){
				    return null;
				}
				public String EMP_010Default(){
				
					return null;
				
				}
				public String EMP_010Comment(){
				
				    return "";
				
				}
				public String EMP_010Pattern(){
				
					return "";
				
				}
				public String EMP_010OriginalDbColumnName(){
			    ...
			    public Integer SALDO_010;

				public Integer getSALDO_010 () {
					return this.SALDO_010;
				}

				public Boolean SALDO_010IsNullable(){
				    return true;
				}
				public Boolean SALDO_010IsKey(){
				    return false;
				}
				public Integer SALDO_010Length(){
				    return 12;
				}
				public Integer SALDO_010Precision(){
				    return null;
				}
				public String SALDO_010Default(){
				
					return null;
				
				}
				public String SALDO_010Comment(){
				
				    return "";
				
				}
				public String SALDO_010Pattern(){
				
					return "";
				
				}
				public String SALDO_010OriginalDbColumnName(){
        	...
        	try {
        		...
        		int length = 0;
					...
					this.DESC_ITEM = readString(dis);
						...
						this.SALDO_001 = readInteger(dis);
					
					this.EMP_010 = readString(dis);
					
						this.SALDO_010 = readInteger(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Integer
						...
						writeInteger(this.SALDO_001,dos);
					
					// String
				
						writeString(this.EMP_010,dos);
					
					// Integer
				
						writeInteger(this.SALDO_010,dos);
    ...
    public String toString() {
		...
		sb.append(",CD_ITEM="+CD_ITEM);
		sb.append(",DESC_ITEM="+DESC_ITEM);
		sb.append(",SALDO_001="+String.valueOf(SALDO_001));
		sb.append(",EMP_010="+EMP_010);
		sb.append(",SALDO_010="+String.valueOf(SALDO_010));
		sb.append(",DATA_ULT_ATUALIZACAO="+String.valueOf(DATA_ULT_ATUALIZACAO));
		sb.append(",SALDO_ATUAL="+String.valueOf(SALDO_ATUAL));
	    sb.append("]");
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_6=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<out4Struct> tHashFile_tHashOutput_6 = null;
		String hashKey_tHashOutput_6 = "tHashFile_int_01_estoque_multicd_" + pid + "_tHashOutput_6";
			synchronized(org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.get(hashKey_tHashOutput_6)){
			    if(mf_tHashOutput_6.getResourceMap().get(hashKey_tHashOutput_6) == null){
	      		    mf_tHashOutput_6.getResourceMap().put(hashKey_tHashOutput_6, new org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<out4Struct>(org.talend.designer.components.hashfile.common.MATCHING_MODE.KEEP_ALL));
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row6Struct> tHashFile_tHashInput_5 = mf_tHashInput_5.getAdvancedMemoryHashFile("tHashFile_int_01_estoque_multicd_" + pid +"_tHashOutput_7");
if(tHashFile_tHashInput_5==null) {
	throw new RuntimeException("The hash is not initialized : The hash must exist before you read from it");
}
java.util.Iterator<row6Struct> iterator_tHashInput_5 = tHashFile_tHashInput_5.iterator();
while (iterator_tHashInput_5.hasNext()) {
    row6Struct next_tHashInput_5 = iterator_tHashInput_5.next();

	row21.CD_EMP = next_tHashInput_5.CD_EMP;
	row21.CD_ITEM = next_tHashInput_5.CD_ITEM;
	row21.DESC_ITEM = next_tHashInput_5.DESC_ITEM;
	row21.SALDO_ATUAL = next_tHashInput_5.SALDO_ATUAL;
	row21.DATA_ULT_ATUALIZACAO = next_tHashInput_5.DATA_ULT_ATUALIZACAO;
 					    ...
 					    boolean forceLooprow22 = false;
 							...
 							row22Struct row22ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_8 = false;
                        		    		    ...
                        		    		    row22HashKey.CD_ITEM = row21.CD_ITEM ;
								  ...
								  if(!tHash_Lookup_row22.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row22 != null && tHash_Lookup_row22.getCount(row22HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row22' and it contains more one result from keys :  row22.CD_ITEM = '" + row22HashKey.CD_ITEM + "'");
								} // G 071
...
// # Output table : 'out2'
out2_tmp.CD_EMP = row21.CD_EMP ;
out2_tmp.CD_ITEM = row21.CD_ITEM ;
out2_tmp.DESC_ITEM = row21.DESC_ITEM ;
out2_tmp.SALDO_001 = row21.SALDO_ATUAL ;
out2_tmp.EMP_010 = row22.CD_EMP ;
out2_tmp.SALDO_010 = row22.SALDO_ATUAL ;
out2_tmp.DATA_ULT_ATUALIZACAO = row21.DATA_ULT_ATUALIZACAO ;
out2 = out2_tmp;
...
row20.SALDO_001 = out2.SALDO_001;
row20.EMP_010 = out2.EMP_010;
row20.SALDO_010 = out2.SALDO_010;
row20.DATA_ULT_ATUALIZACAO = out2.DATA_ULT_ATUALIZACAO;

if (out2.SALDO_010 > 0) {
row20.SALDO_ATUAL = row20.SALDO_010;
} else{
row20.SALDO_ATUAL = out2.SALDO_001;
}
    nb_line_tJavaRow_4++;   
...
// # Output table : 'out4'
out4_tmp.CD_EMP = row20.CD_EMP;
out4_tmp.CD_ITEM = row20.CD_ITEM;
out4_tmp.DESC_ITEM = row20.DESC_ITEM;
out4_tmp.SALDO_ATUAL = row20.SALDO_ATUAL;
out4_tmp.DATA_ULT_ATUALIZACAO = row20.DATA_ULT_ATUALIZACAO;
out4 = out4_tmp;
// ###############################
...
if(out4 != null) { 
	...
	currentComponent="tHashOutput_6";
		...
		out4Struct oneRow_tHashOutput_6 = new out4Struct();
				
					oneRow_tHashOutput_6.CD_EMP = out4.CD_EMP;
					oneRow_tHashOutput_6.CD_ITEM = out4.CD_ITEM;
					oneRow_tHashOutput_6.DESC_ITEM = out4.DESC_ITEM;
					oneRow_tHashOutput_6.SALDO_ATUAL = out4.SALDO_ATUAL;
					oneRow_tHashOutput_6.DATA_ULT_ATUALIZACAO = out4.DATA_ULT_ATUALIZACAO;
 ...
 */
	...
	currentComponent="tHashInput_5";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_int_01_estoque_multicd_" + pid +"_tHashOutput_7");
...
public static class row7Struct implements routines.system.IPersistableRow<row7Struct> {
    ...
    public String loopKey;
			    ...
			    public java.util.Date dt_atualizacao_saldo;

				public java.util.Date getDt_atualizacao_saldo () {
					return this.dt_atualizacao_saldo;
				}

				public Boolean dt_atualizacao_saldoIsNullable(){
				    return true;
				}
				public Boolean dt_atualizacao_saldoIsKey(){
				    return false;
				}
				public Integer dt_atualizacao_saldoLength(){
				    return null;
				}
				public Integer dt_atualizacao_saldoPrecision(){
				    return null;
				}
				public String dt_atualizacao_saldoDefault(){
				
					return null;
				
				}
				public String dt_atualizacao_saldoComment(){
				
				    return "";
				
				}
				public String dt_atualizacao_saldoPattern(){
				
					return "yyyy-MM-dd HH:mm:ss";
				
				}
				public String dt_atualizacao_saldoOriginalDbColumnName(){
				
					return "dt_atualizacao_saldo";
	...
	public void copyDataTo(row7Struct other) {
		...
		other.cd_emp = this.cd_emp;
	            ...
	            other.dt_atualizacao_saldo = this.dt_atualizacao_saldo;
		...
		synchronized(commonByteArrayLock_REFATORACAO_int_01_estoque_multicd) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.dt_atualizacao_saldo = readDate(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// java.util.Date
						...
						writeDate(this.dt_atualizacao_saldo,dos);
    ...
    public String toString() {
		...
		sb.append(",dt_atualizacao_saldo="+String.valueOf(dt_atualizacao_saldo));
	    sb.append("]");
...
public static class estoque_empresaStruct implements routines.system.IPersistableRow<estoque_empresaStruct> {
    final static byte[] commonByteArrayLock_REFATORACAO_int_01_estoque_multicd = new byte[0];
    static byte[] commonByteArray_REFATORACAO_int_01_estoque_multicd = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final estoque_empresaStruct other = (estoque_empresaStruct) obj;
	...
	public void copyDataTo(estoque_empresaStruct other) {
	...
	public void copyKeysDataTo(estoque_empresaStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(estoque_empresaStruct other) {
...
estoque_empresaStruct estoque_empresa = new estoque_empresaStruct();
...
if(dbschema_tDBOutput_4 == null || dbschema_tDBOutput_4.trim().length() == 0) {
	tableName_tDBOutput_4 = ("product_stock_uuid_emp").toLowerCase();
} else {
	tableName_tDBOutput_4 = dbschema_tDBOutput_4 + "\".\"" + ("product_stock_uuid_emp").toLowerCase();
}
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("control_price_multicd").toLowerCase();
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("control_price_multicd").toLowerCase();
}
...
int count_tDBOutput_1=0;
	    String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"estoque\" = ?,\"dt_atualizacao_saldo\" = ? WHERE \"cd_emp\" = ? AND \"cd_produto\" = ?";
 ...
 */
	...
	currentComponent="tFilterRow_2";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"estoque_empresa");
					}
...
estoque_empresaStruct estoque_empresa_tmp = new estoque_empresaStruct();
// ###############################
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<out4Struct> tHashFile_tHashInput_9 = mf_tHashInput_9.getAdvancedMemoryHashFile("tHashFile_int_01_estoque_multicd_" + pid +"_tHashOutput_6");
if(tHashFile_tHashInput_9==null) {
	throw new RuntimeException("The hash is not initialized : The hash must exist before you read from it");
}
java.util.Iterator<out4Struct> iterator_tHashInput_9 = tHashFile_tHashInput_9.iterator();
while (iterator_tHashInput_9.hasNext()) {
    out4Struct next_tHashInput_9 = iterator_tHashInput_9.next();
...
// # Output table : 'estoque_empresa'
estoque_empresa_tmp.cd_emp = OUT10.cd_emp;
estoque_empresa_tmp.cd_produto = OUT10.cd_produto;
estoque_empresa_tmp.estoque = OUT10.saldo_atual;
estoque_empresa_tmp.dt_atualizacao_saldo = TalendDate.getCurrentDate();
estoque_empresa = estoque_empresa_tmp;
// ###############################
...
// Start of branch "estoque_empresa"
if(estoque_empresa != null) { 
    ...
    Operator_tFilterRow_2 ope_tFilterRow_2 = new Operator_tFilterRow_2("&&");
            ope_tFilterRow_2.matches((estoque_empresa.cd_emp == null? false : estoque_empresa.cd_emp.compareTo("010") == 0)
                           , "cd_emp.compareTo(\"010\") == 0 failed");
    
    if (ope_tFilterRow_2.getMatchFlag()) {
              if(row7 == null){ 
                row7 = new row7Struct();
              }
               row7.cd_emp = estoque_empresa.cd_emp;
               row7.cd_produto = estoque_empresa.cd_produto;
               row7.estoque = estoque_empresa.estoque;
               row7.dt_atualizacao_saldo = estoque_empresa.dt_atualizacao_saldo;    
...
if(row7 != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(row7.estoque == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(1, row7.estoque);
}

                    if(row7.dt_atualizacao_saldo != null) {
pstmt_tDBOutput_1.setTimestamp(2, new java.sql.Timestamp(row7.dt_atualizacao_saldo.getTime()));
} else {
...
} else {pstmt_tDBOutput_1.setString(3 + count_tDBOutput_1, row7.cd_emp);
}


                    if(row7.cd_produto == null) {
pstmt_tDBOutput_1.setNull(4 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4 + count_tDBOutput_1, row7.cd_produto);
}
 ...
 */
	...
	currentComponent="tHashInput_9";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_int_01_estoque_multicd_" + pid +"_tHashOutput_6");
 ...
 */
    ...
    globalMap.put("tFilterRow_2_NB_LINE_REJECT", nb_line_reject_tFilterRow_2);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"estoque_empresa");
			  	}
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row16Struct> tHashFile_tHashInput_4 = mf_tHashInput_4.getAdvancedMemoryHashFile("tHashFile_int_01_estoque_multicd_" + pid +"_tHashOutput_5");
 ...
 */
	...
	currentComponent="tHashInput_4";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_int_01_estoque_multicd_" + pid +"_tHashOutput_5");
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row5";
		...
		int tos_count_tAdvancedHash_row5 = 0;
			   		...
			   		// linked node: tMap_3 - inputs:(OUT10,row5) outputs:(out1,estoque_empresa)
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row4Struct> tHashFile_tHashInput_1 = mf_tHashInput_1.getAdvancedMemoryHashFile("tHashFile_int_01_estoque_multicd_" + pid +"_tHashOutput_4");
 ...
 */
	...
	currentComponent="tHashInput_1";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_int_01_estoque_multicd_" + pid +"_tHashOutput_4");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row4Struct> tHashFile_tHashInput_10 = mf_tHashInput_10.getAdvancedMemoryHashFile("tHashFile_int_01_estoque_multicd_" + pid +"_tHashOutput_4");
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row22";
		...
		int tos_count_tAdvancedHash_row22 = 0;
			   		...
			   		// source node:tHashInput_6 - inputs:(after_tHashInput_5) outputs:(row22,row22) | target node:tAdvancedHash_row22 - inputs:(row22) outputs:()
			   		// linked node: tMap_8 - inputs:(row21,row22) outputs:(out2)
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row18Struct> tHashFile_tHashInput_6 = mf_tHashInput_6.getAdvancedMemoryHashFile("tHashFile_int_01_estoque_multicd_" + pid +"_tHashOutput_2");
...
while (iterator_tHashInput_6.hasNext()) {
	...
	row22.CD_EMP = next_tHashInput_6.CD_EMP;
	row22.CD_ITEM = next_tHashInput_6.CD_ITEM;
	row22.DESC_ITEM = next_tHashInput_6.DESC_ITEM;
	row22.SALDO_ATUAL = next_tHashInput_6.SALDO_ATUAL;
	row22.DATA_ULT_ATUALIZACAO = next_tHashInput_6.DATA_ULT_ATUALIZACAO;
 ...
 */
	...
	currentComponent="tAdvancedHash_row22";
				...
				row22_HashRow.CD_EMP = row22.CD_EMP;
				
				row22_HashRow.CD_ITEM = row22.CD_ITEM;
				
				row22_HashRow.DESC_ITEM = row22.DESC_ITEM;
				
				row22_HashRow.SALDO_ATUAL = row22.SALDO_ATUAL;
				
				row22_HashRow.DATA_ULT_ATUALIZACAO = row22.DATA_ULT_ATUALIZACAO;
 ...
 */
	...
	currentComponent="tHashInput_6";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_int_01_estoque_multicd_" + pid +"_tHashOutput_2");
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_4=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_4 = "tHashFile_int_01_estoque_multicd_" + pid + "_tHashOutput_4";
 ...
 */
	...
	currentComponent="tDBInput_3";
		...
		int tos_count_tDBInput_3 = 0;
		    ...
		    String dbquery_tDBInput_3 = "select cd_emp ,\n          cd_produto,\n          saldo_atual as saldo_anterior\n  from product_stock_uuid_emp ps\nwher"
+"e ps.dt_criacao  in ( \nselect max(st1.dt_criacao)  from product_stock_uuid_emp st1\n where st1.cd_produto = ps.cd_produ"
+"to )\n-- and ps.cd_produto in ('01105','01163','01558');\n";
...
// ------------
	...
	class AggOperationStruct_tAggregateRow_1 { // G_OutBegin_AggR_100
	    ...
	    public boolean hashCodeDirty = true;
StringBuilder ITE_CODITE_list = new StringBuilder();
           			boolean ITE_CODITE_list_firstEmpty = false;
 ...
 */
	...
	currentComponent="tDBInput_5";
		...
		int tos_count_tDBInput_5 = 0;
		    ...
		    String dbquery_tDBInput_5 = "\n\nSELECT DISTINCT CI.ITE_CODITE       \n  FROM CADITE CI \n INNER JOIN ITEGER IG ON CI.ITE_CODITE = IG.ITE_CODITE \n "
+"WHERE IG.ITE_CODEMP IN ('010','001')\n   AND CI.ITE_EXPSIT= 'S'\n--   AND CI.ITE_CODITE IN ('01105','01163','01558')\n  "
+" AND (IG.ITE_DHUALT >= SUBDATE(CURDATE(),1) OR CI.ITE_DTAALT >= SUBDATE(CURDATE(), 1))\n";
		    ...
		    while (rs_tDBInput_5.next()) {
		        nb_line_tDBInput_5++;
							...
							if(colQtyInRs_tDBInput_5 < 1) {
								row2.ITE_CODITE = null;
							} else {
	                         		
        	row2.ITE_CODITE = routines.system.JDBCUtil.getString(rs_tDBInput_5, 1, false);
		                    }
 ...
 */
	...
	if(operation_result_tAggregateRow_1 == null) { // G_OutMain_AggR_001
		...
		hash_tAggregateRow_1.put(operation_result_tAggregateRow_1, operation_result_tAggregateRow_1);
				...
				if(operation_result_tAggregateRow_1.ITE_CODITE_list.length() > 0) {
					operation_result_tAggregateRow_1.ITE_CODITE_list.append(",");
				} 
				else if(operation_result_tAggregateRow_1.ITE_CODITE_list_firstEmpty){
					operation_result_tAggregateRow_1.ITE_CODITE_list.append(",");
				}
					if(operation_result_tAggregateRow_1.ITE_CODITE_list != null) {
						if(operation_result_tAggregateRow_1.ITE_CODITE_list_firstEmpty==false && ("").equals(String.valueOf(row2.ITE_CODITE))){
							operation_result_tAggregateRow_1.ITE_CODITE_list_firstEmpty = true;
						}
						operation_result_tAggregateRow_1.ITE_CODITE_list = operation_result_tAggregateRow_1.ITE_CODITE_list.append(String.valueOf(row2.ITE_CODITE));
					}
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_9=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row27Struct> tHashFile_tHashOutput_9 = null;
		String hashKey_tHashOutput_9 = "tHashFile_int_01_estoque_multicd_" + pid + "_tHashOutput_9";
			synchronized(org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.get(hashKey_tHashOutput_9)){
			    if(mf_tHashOutput_9.getResourceMap().get(hashKey_tHashOutput_9) == null){
	      		    mf_tHashOutput_9.getResourceMap().put(hashKey_tHashOutput_9, new org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row27Struct>(org.talend.designer.components.hashfile.common.MATCHING_MODE.KEEP_ALL));
 ...
 */
	...
	currentComponent="tAggregateRow_1_AGGIN";
    								...
    								row27.ITE_CODITE = aggregated_row_tAggregateRow_1.ITE_CODITE_list.toString();
 ...
 */
	...
	currentComponent="tHashOutput_9";
		...
		row27Struct oneRow_tHashOutput_9 = new row27Struct();
				
					oneRow_tHashOutput_9.ITE_CODITE = row27.ITE_CODITE;
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_3=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_3 = "tHashFile_int_01_estoque_multicd_" + pid + "_tHashOutput_3";
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_1=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_1 = "tHashFile_int_01_estoque_multicd_" + pid + "_tHashOutput_1";
 ...
 */
	...
	currentComponent="tDBInput_1";
		...
		int tos_count_tDBInput_1 = 0;
		    ...
		    String dbquery_tDBInput_1 = "SELECT ITEM.CD_COMBO      CD_COMBO,\n       ITEM.CD_EMPRESA             CD_EMPRESA,\n              CASE WHEN MIN(ESTOQU"
+"E_COMBO) < 0 THEN 0\n       ELSE MIN(ESTOQUE_COMBO)\n        END ESTOQUE_COMBO\n  FROM (\nSELECT GM.GMT_CODITE CD_COMBO,"
+"\n       G.ITE_CODEMP  CD_EMPRESA,\n       DM.DMT_ITESUB CD_PRODUTO,\n       CE.ITE_DESITE DESCRICAO,\n       GM.GMT_REF"
+"ERE MARCA,\n       DM.DMT_QTDITE QTDE,\n       floor((G.ITE_SALDOS - ITE_QTPD_P - (ITE_QTPD_V+ITE_QTPD_F) - ITE_QTPD_E -"
+" ITE_SALREG - ITE_SALEXT)/DM.DMT_QTDITE) ESTOQUE_COMBO\n  FROM GERMAT GM\n INNER JOIN DETMAT DM ON GM.AUTOINCREM = DM.DM"
+"T_SEQGER\n INNER JOIN CADITE CE ON GM.GMT_CODITE = CE.ITE_CODITE\n INNER JOIN ITEGER G  ON G.ITE_CODITE = DM.DMT_ITESUB"
+"\n WHERE G.ITE_CODEMP = '010') ITEM\n GROUP BY ITEM.CD_COMBO,\n          ITEM.CD_EMPRESA";
        	...
        	row8.CD_COMBO = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								row8.CD_EMPRESA = null;
							} else {
	                         		
        	row8.CD_EMPRESA = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 3) {
								row8.ESTOQUE_COMBO = null;
							} else {
		                          
            row8.ESTOQUE_COMBO = rs_tDBInput_1.getInt(3);
 ...
 */
	...
	currentComponent="tHashOutput_1";
		...
		row8Struct oneRow_tHashOutput_1 = new row8Struct();
					...
					oneRow_tHashOutput_1.CD_COMBO = row8.CD_COMBO;
					oneRow_tHashOutput_1.CD_EMPRESA = row8.CD_EMPRESA;
					oneRow_tHashOutput_1.ESTOQUE_COMBO = row8.ESTOQUE_COMBO;
...
public static class copyOfsaidaStruct implements routines.system.IPersistableRow<copyOfsaidaStruct> {
    final static byte[] commonByteArrayLock_REFATORACAO_int_01_estoque_multicd = new byte[0];
    static byte[] commonByteArray_REFATORACAO_int_01_estoque_multicd = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(copyOfsaidaStruct other) {
...
copyOfsaidaStruct copyOfsaida = new copyOfsaidaStruct();
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row27Struct> tHashFile_tHashInput_7 = mf_tHashInput_7.getAdvancedMemoryHashFile("tHashFile_int_01_estoque_multicd_" + pid +"_tHashOutput_9");
if(tHashFile_tHashInput_7==null) {
	throw new RuntimeException("The hash is not initialized : The hash must exist before you read from it");
}
java.util.Iterator<row27Struct> iterator_tHashInput_7 = tHashFile_tHashInput_7.iterator();
while (iterator_tHashInput_7.hasNext()) {
    row27Struct next_tHashInput_7 = iterator_tHashInput_7.next();

	row24.ITE_CODITE = next_tHashInput_7.ITE_CODITE;
 ...
 */
	...
	currentComponent="tFlowToIterate_1";
            ...
            globalMap.put("row24.ITE_CODITE", row24.ITE_CODITE);
 ...
 */
	NB_ITERATE_tDBInput_6++;
					...
					if(execStat){				
	       				runStat.updateStatOnConnection("saida", 3, 0);
					}           			
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_7=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row6Struct> tHashFile_tHashOutput_7 = null;
		String hashKey_tHashOutput_7 = "tHashFile_int_01_estoque_multicd_" + pid + "_tHashOutput_7";
			synchronized(org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.get(hashKey_tHashOutput_7)){
			    if(mf_tHashOutput_7.getResourceMap().get(hashKey_tHashOutput_7) == null){
	      		    mf_tHashOutput_7.getResourceMap().put(hashKey_tHashOutput_7, new org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row6Struct>(org.talend.designer.components.hashfile.common.MATCHING_MODE.KEEP_ALL));
...
+"E \nWHERE IG.ITE_CODEMP IN ('001')\n   AND CI.ITE_EXPSIT= 'S'\n   AND CI.ITE_CODITE in ("+((String)globalMap.get("row24.ITE_CODITE"))+") \n--   AND (IG.ITE_DHUALT >= SUBDATE(CURDATE(),120) OR CI.ITE_DTAALT >= SUBDATE(CURDATE(), 120))\n) base";
 ...
 */
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(row6 == null){ 
               ...
               row6.CD_EMP = row11.CD_EMP;
               row6.CD_ITEM = row11.CD_ITEM;
               row6.DESC_ITEM = row11.DESC_ITEM;
               row6.SALDO_ATUAL = row11.SALDO_ATUAL;
               row6.DATA_ULT_ATUALIZACAO = row11.DATA_ULT_ATUALIZACAO;    
...
if(row6 != null) { 
	...
	currentComponent="tHashOutput_7";
		...
		row6Struct oneRow_tHashOutput_7 = new row6Struct();
				
					oneRow_tHashOutput_7.CD_EMP = row6.CD_EMP;
					oneRow_tHashOutput_7.CD_ITEM = row6.CD_ITEM;
					oneRow_tHashOutput_7.DESC_ITEM = row6.DESC_ITEM;
					oneRow_tHashOutput_7.SALDO_ATUAL = row6.SALDO_ATUAL;
					oneRow_tHashOutput_7.DATA_ULT_ATUALIZACAO = row6.DATA_ULT_ATUALIZACAO;
 ...
 */
	...
	NB_ITERATE_tDBInput_4++;
					...
					if(execStat){				
	       				runStat.updateStatOnConnection("copyOfsaida", 3, 0);
					}           			
				...
				if(execStat){
					runStat.updateStatOnConnection("iterate2", 1, "exec" + NB_ITERATE_tDBInput_4);
					//Thread.sleep(1000);
				}				
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_2=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row18Struct> tHashFile_tHashOutput_2 = null;
		String hashKey_tHashOutput_2 = "tHashFile_int_01_estoque_multicd_" + pid + "_tHashOutput_2";
			synchronized(org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.get(hashKey_tHashOutput_2)){
			    if(mf_tHashOutput_2.getResourceMap().get(hashKey_tHashOutput_2) == null){
	      		    mf_tHashOutput_2.getResourceMap().put(hashKey_tHashOutput_2, new org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row18Struct>(org.talend.designer.components.hashfile.common.MATCHING_MODE.KEEP_ALL));
 ...
 */
	...
	currentComponent="tJavaRow_2";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"copyOfsaida");
					}
...
// ###############################
// # Outputs initialization
copyOfsaidaStruct copyOfsaida_tmp = new copyOfsaidaStruct();
// ###############################
 ...
 */
	...
	currentComponent="tDBInput_4";
		...
		int tos_count_tDBInput_4 = 0;
		    ...
		    String dbquery_tDBInput_4 = "select base.CD_EMP,\n	   base.CD_ITEM,\n	   base.DESC_ITEM,\n       CASE WHEN base.SALDO_ATUAL < 0 THEN 0\n            "
+"           ELSE base.SALDO_ATUAL\n                         END SALDO_ATUAL,\n	   base.DATA_EXECUCAO\n  from (\nSELECT IG"
+".ITE_CODEMP AS CD_EMP,\n       CI.ITE_CODITE AS CD_ITEM,\n       CI.ITE_DESITE AS DESC_ITEM,\n       IG.ITE_SALDOS - IG."
+"ITE_SALEXT - IFNULL(IG.ITE_SALREG,0) - (IFNULL(IG.ITE_QTPD_V,0) + IFNULL(IG.ITE_QTPD_F,0) + IFNULL(IG.ITE_QTPD_P,0)) AS "
+"SALDO_ATUAL,\n      IG.ITE_DHUALT DATA_EXECUCAO\n  FROM CADITE CI \nINNER JOIN ITEGER IG ON CI.ITE_CODITE = IG.ITE_CODIT"
+"E \nWHERE IG.ITE_CODEMP IN ('010')\n   AND CI.ITE_EXPSIT= 'S'\n   AND CI.ITE_CODITE in ("+((String)globalMap.get("row24.ITE_CODITE"))+")\n--   AND (IG.ITE_DHUALT >= SUBDATE(CURDATE(),120) OR CI.ITE_DTAALT >= SUBDATE(CURDATE(), 120))\n) base";
        	...
        	row9.CD_EMP = routines.system.JDBCUtil.getString(rs_tDBInput_4, 1, false);
		                    }
							if(colQtyInRs_tDBInput_4 < 2) {
								row9.CD_ITEM = null;
							} else {
	                         		
        	row9.CD_ITEM = routines.system.JDBCUtil.getString(rs_tDBInput_4, 2, false);
		                    }
							if(colQtyInRs_tDBInput_4 < 3) {
								row9.DESC_ITEM = null;
							} else {
	                         		
        	row9.DESC_ITEM = routines.system.JDBCUtil.getString(rs_tDBInput_4, 3, false);
		                    }
							if(colQtyInRs_tDBInput_4 < 4) {
								row9.SALDO_ATUAL = null;
							} else {
		                          
            row9.SALDO_ATUAL = rs_tDBInput_4.getInt(4);
            if(rs_tDBInput_4.wasNull()){
                    row9.SALDO_ATUAL = null;
            }
		                    }
							if(colQtyInRs_tDBInput_4 < 5) {
								row9.DATA_ULT_ATUALIZACAO = null;
							} else {
				...
				if(rs_tDBInput_4.getString(5) != null) {
					...
					if (!("0000-00-00").equals(dateString_tDBInput_4) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_4)) {
						row9.DATA_ULT_ATUALIZACAO = rs_tDBInput_4.getTimestamp(5);
					} else {
						row9.DATA_ULT_ATUALIZACAO = (java.util.Date) year0_tDBInput_4.clone();
					}
				} else {
					row9.DATA_ULT_ATUALIZACAO =  null;
				}
 					    ...
 					    boolean forceLooprow19 = false;
 							...
 							row19Struct row19ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_7 = false;
                        		    		    ...
                        		    		    row19HashKey.CD_COMBO = row9.CD_ITEM ;
                        		    		
                        		    		    row19HashKey.CD_EMPRESA = row9.CD_EMP ;
				           		...
				           		if(tHash_Lookup_row19 != null && tHash_Lookup_row19.getCount(row19HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row19' and it contains more one result from keys :  row19.CD_COMBO = '" + row19HashKey.CD_COMBO + "', row19.CD_EMPRESA = '" + row19HashKey.CD_EMPRESA + "'");
								} // G 071
...
// # Output table : 'copyOfsaida'
copyOfsaida_tmp.CD_EMP = row9.CD_EMP;
copyOfsaida_tmp.CD_ITEM = row9.CD_ITEM;
copyOfsaida_tmp.DESC_ITEM = row9.DESC_ITEM ;
copyOfsaida_tmp.SALDO_ATUAL = row19.ESTOQUE_COMBO ;
copyOfsaida_tmp.DATA_ULT_ATUALIZACAO = row9.DATA_ULT_ATUALIZACAO;
copyOfsaida_tmp.SALDO_ATUAL_AUTCOM = row9.SALDO_ATUAL ;
copyOfsaida = copyOfsaida_tmp;
// ###############################
...
if(copyOfsaida != null) { 
    ...
    //Code generated according to input schema and output schema
row13.CD_EMP = copyOfsaida.CD_EMP;
row13.CD_ITEM = copyOfsaida.CD_ITEM;
row13.DESC_ITEM = copyOfsaida.DESC_ITEM;
//row13.SALDO_ATUAL = copyOfsaida.SALDO_ATUAL;

if (copyOfsaida.SALDO_ATUAL != null) {
row13.SALDO_ATUAL = copyOfsaida.SALDO_ATUAL;
} else{
row13.SALDO_ATUAL = copyOfsaida.SALDO_ATUAL_AUTCOM;
}

row13.DATA_ULT_ATUALIZACAO = copyOfsaida.DATA_ULT_ATUALIZACAO;
//row13.SALDO_ATUAL_A = copyOfsaida.SALDO_ATUAL_A;
 ...
 */
    ...
    if (ope_tFilterRow_3.getMatchFlag()) {
              if(row18 == null){ 
               ...
               row18.CD_EMP = row13.CD_EMP;
               row18.CD_ITEM = row13.CD_ITEM;
               row18.DESC_ITEM = row13.DESC_ITEM;
               row18.SALDO_ATUAL = row13.SALDO_ATUAL;
               row18.DATA_ULT_ATUALIZACAO = row13.DATA_ULT_ATUALIZACAO;    
...
if(row18 != null) { 
	...
	currentComponent="tHashOutput_2";
		...
		row18Struct oneRow_tHashOutput_2 = new row18Struct();
				
					oneRow_tHashOutput_2.CD_EMP = row18.CD_EMP;
					oneRow_tHashOutput_2.CD_ITEM = row18.CD_ITEM;
					oneRow_tHashOutput_2.DESC_ITEM = row18.DESC_ITEM;
					oneRow_tHashOutput_2.SALDO_ATUAL = row18.SALDO_ATUAL;
					oneRow_tHashOutput_2.DATA_ULT_ATUALIZACAO = row18.DATA_ULT_ATUALIZACAO;
...
globalMap.put("tJavaRow_2_NB_LINE",nb_line_tJavaRow_2);
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"copyOfsaida");
			  	}
 ...
 */
						...
						if(execStat){
							runStat.updateStatOnConnection("iterate2", 2, "exec" + NB_ITERATE_tDBInput_4);
						}				
 ...
 */
	...
	currentComponent="tHashInput_7";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_int_01_estoque_multicd_" + pid +"_tHashOutput_9");
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row10";
		...
		int tos_count_tAdvancedHash_row10 = 0;
			   		...
			   		// source node:tHashInput_2 - inputs:(after_tHashInput_7) outputs:(row10,row10) | target node:tAdvancedHash_row10 - inputs:(row10) outputs:()
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row3Struct> tHashFile_tHashInput_2 = mf_tHashInput_2.getAdvancedMemoryHashFile("tHashFile_int_01_estoque_multicd_" + pid +"_tHashOutput_3");
 ...
 */
	...
	currentComponent="tHashInput_2";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_int_01_estoque_multicd_" + pid +"_tHashOutput_3");
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row19";
		...
		int tos_count_tAdvancedHash_row19 = 0;
			   		...
			   		// source node:tHashInput_3 - inputs:(after_tHashInput_7) outputs:(row19,row19) | target node:tAdvancedHash_row19 - inputs:(row19) outputs:()
			   		// linked node: tMap_7 - inputs:(row9,row19) outputs:(copyOfsaida)
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row8Struct> tHashFile_tHashInput_3 = mf_tHashInput_3.getAdvancedMemoryHashFile("tHashFile_int_01_estoque_multicd_" + pid +"_tHashOutput_1");
...
while (iterator_tHashInput_3.hasNext()) {
	...
	row19.CD_COMBO = next_tHashInput_3.CD_COMBO;
	row19.CD_EMPRESA = next_tHashInput_3.CD_EMPRESA;
	row19.ESTOQUE_COMBO = next_tHashInput_3.ESTOQUE_COMBO;
 ...
 */
	...
	currentComponent="tAdvancedHash_row19";
				...
				row19_HashRow.CD_COMBO = row19.CD_COMBO;
				
				row19_HashRow.CD_EMPRESA = row19.CD_EMPRESA;
				
				row19_HashRow.ESTOQUE_COMBO = row19.ESTOQUE_COMBO;
 ...
 */
	...
	currentComponent="tHashInput_3";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_int_01_estoque_multicd_" + pid +"_tHashOutput_1");
 ...
 */
    ...
    public static void main(String[] args){
        final int_01_estoque_multicd int_01_estoque_multicdClass = new int_01_estoque_multicd();

        int exitCode = int_01_estoque_multicdClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = int_01_estoque_multicd.class.getClassLoader().getResourceAsStream("refatoracao/int_01_estoque_multicd_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = int_01_estoque_multicd.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : int_01_estoque_multicd");
        }
...
/************************************************************************************************
 *     758495 characters generated by Talend Open Studio for Big Data 
 *     on the 24 de abril de 2025 14:25:27 BRT
 ************************************************************************************************/