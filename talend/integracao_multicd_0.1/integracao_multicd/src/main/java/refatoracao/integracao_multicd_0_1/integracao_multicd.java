...
package refatoracao.integracao_multicd_0_1;
...
/**
 * Job: integracao_multicd Purpose: <br>
 * Description:  <br>
 * @author luisll@uol.com.br
 * @version 8.0.1.20230922_0317-SNAPSHOT
 * @status 
 */
public class integracao_multicd implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "integracao_multicd";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				integracao_multicd.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(integracao_multicd.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
System.out.println("******************************************************");
System.out.println("*          Iniciado o processo de integracao         *");
System.out.println("*                                                    *");
System.out.println("*                  Iniciado o JOB 1/3                *");
System.out.println("*     Iniciado o job integracao_estoque_multicd      *");
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		refatoracao.int_01_estoque_multicd_0_1.int_01_estoque_multicd childJob_tRunJob_1 = new refatoracao.int_01_estoque_multicd_0_1.int_01_estoque_multicd();
	    // pass DataSources
...
System.out.println("************************************************************");
System.out.println("*                                                          *");
System.out.println("*                     Iniciado o JOB 2/3                   *");
System.out.println("*     Iniciado o update control_price_multicd              *");
System.out.println("*            "+TalendDate.getCurrentDate()+"               *");
System.out.println("*                                                          *");
System.out.println("************************************************************");
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		refatoracao.jobp_02_updated_tabela_controle_multicd_0_1.JOBP_02_updated_tabela_controle_multicd childJob_tRunJob_2 = new refatoracao.jobp_02_updated_tabela_controle_multicd_0_1.JOBP_02_updated_tabela_controle_multicd();
	    // pass DataSources
...
System.out.println("************************************************************");
System.out.println("*                                                          *");
System.out.println("*                     Iniciado o JOB 3/3                   *");
System.out.println("*            Iniciado o insert product_price_uuid_emp      *");
System.out.println("*            "+TalendDate.getCurrentDate()+"               *");
System.out.println("*                                                          *");
System.out.println("************************************************************");
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		refatoracao.int_03_integracao_preco_magento_uuid_0_1.int_03_integracao_preco_magento_uuid childJob_tRunJob_3 = new refatoracao.int_03_integracao_preco_magento_uuid_0_1.int_03_integracao_preco_magento_uuid();
	    // pass DataSources
...
System.out.println("******************************************************");
System.out.println("*         Finalizado o processo de integracao        *");
System.out.println("*                                                    *");
System.out.println("*            "+TalendDate.getCurrentDate()+"           *");
System.out.println("*                                                    *");
System.out.println("******************************************************");
 ...
 */
    ...
    public static void main(String[] args){
        final integracao_multicd integracao_multicdClass = new integracao_multicd();

        int exitCode = integracao_multicdClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = integracao_multicd.class.getClassLoader().getResourceAsStream("refatoracao/integracao_multicd_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = integracao_multicd.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : integracao_multicd");
        }
...
/************************************************************************************************
 *     63671 characters generated by Talend Open Studio for Big Data 
