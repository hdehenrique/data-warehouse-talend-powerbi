...
package refatoracao.int_02_updated_preco_tabela_controle_multicd_010_0_1;
...
/**
 * Job: int_02_updated_preco_tabela_controle_multicd_010 Purpose: updated_preco_tabela_controle_multicd_010<br>
 * Description:  <br>
 * @author luisll@uol.com.br
 * @version 8.0.1.20230922_0317-SNAPSHOT
 * @status 
 */
public class int_02_updated_preco_tabela_controle_multicd_010 implements TalendJob {
...
public String getJDBC_PARAMETERS(){
	...
	private final String jobName = "int_02_updated_preco_tabela_controle_multicd_010";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				int_02_updated_preco_tabela_controle_multicd_010.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(int_02_updated_preco_tabela_controle_multicd_010.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row21Struct implements routines.system.IPersistableRow<row21Struct> {
    final static byte[] commonByteArrayLock_REFATORACAO_int_02_updated_preco_tabela_controle_multicd_010 = new byte[0];
    static byte[] commonByteArray_REFATORACAO_int_02_updated_preco_tabela_controle_multicd_010 = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_REFATORACAO_int_02_updated_preco_tabela_controle_multicd_010.length) {
				if(length < 1024 && commonByteArray_REFATORACAO_int_02_updated_preco_tabela_controle_multicd_010.length == 0) {
   					commonByteArray_REFATORACAO_int_02_updated_preco_tabela_controle_multicd_010 = new byte[1024];
				} else {
   					commonByteArray_REFATORACAO_int_02_updated_preco_tabela_controle_multicd_010 = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_REFATORACAO_int_02_updated_preco_tabela_controle_multicd_010, 0, length);
			strReturn = new String(commonByteArray_REFATORACAO_int_02_updated_preco_tabela_controle_multicd_010, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_REFATORACAO_int_02_updated_preco_tabela_controle_multicd_010, 0, length);
			strReturn = new String(commonByteArray_REFATORACAO_int_02_updated_preco_tabela_controle_multicd_010, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_REFATORACAO_int_02_updated_preco_tabela_controle_multicd_010) {
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_7=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_7 = "tHashFile_int_02_updated_preco_tabela_controle_multicd_010_" + pid + "_tHashOutput_7";
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_5=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_5 = "tHashFile_int_02_updated_preco_tabela_controle_multicd_010_" + pid + "_tHashOutput_5";
 ...
 */
	...
	currentComponent="tUnite_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"row14","row13","row12");
					}
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row10Struct> tHashFile_tHashInput_1 = mf_tHashInput_1.getAdvancedMemoryHashFile("tHashFile_int_02_updated_preco_tabela_controle_multicd_010_" + pid +"_tHashOutput_1");
 ...
 */
	...
	currentComponent="tHashInput_1";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_int_02_updated_preco_tabela_controle_multicd_010_" + pid +"_tHashOutput_1");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row3Struct> tHashFile_tHashInput_3 = mf_tHashInput_3.getAdvancedMemoryHashFile("tHashFile_int_02_updated_preco_tabela_controle_multicd_010_" + pid +"_tHashOutput_2");
 ...
 */
	...
	currentComponent="tHashInput_3";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_int_02_updated_preco_tabela_controle_multicd_010_" + pid +"_tHashOutput_2");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row6Struct> tHashFile_tHashInput_4 = mf_tHashInput_4.getAdvancedMemoryHashFile("tHashFile_int_02_updated_preco_tabela_controle_multicd_010_" + pid +"_tHashOutput_4");
 ...
 */
	...
	currentComponent="tHashInput_4";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_int_02_updated_preco_tabela_controle_multicd_010_" + pid +"_tHashOutput_4");
...
globalMap.put("tUnite_1_NB_LINE", nb_line_tUnite_1);
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"row14","row13","row12");
			  	}
...
int count_tDBOutput_2=0;
	    String update_tDBOutput_2 = "UPDATE \"" + tableName_tDBOutput_2 + "\" SET \"valor_atual_010\" = ?,\"vl_arredondamento_010\" = ?,\"vl_anterior_010\" = ?,\"dt_atualizacao_preco\" = ?,\"situacao\" = ? WHERE \"cd_emp\" = ? AND \"cd_produto\" = ?";
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row17Struct> tHashFile_tHashInput_2 = mf_tHashInput_2.getAdvancedMemoryHashFile("tHashFile_int_02_updated_preco_tabela_controle_multicd_010_" + pid +"_tHashOutput_5");
 					    ...
 					    boolean forceLooprow19 = false;
 							...
 							row19Struct row19ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_4 = false;
                        		    		    ...
                        		    		    row19HashKey.cd_emp = row2.ITE_CODEMP ;
...
// # Output table : 'out3'
out3_tmp.cd_emp = row2.ITE_CODEMP ;
out3_tmp.cd_produto = row2.CD_PRODUTO;
out3_tmp.valor_atual_010 = row2.VL_ATUAL ;
out3_tmp.vl_arredondamento_010 = row2.VL_ARREDONDAMENTO ;
out3_tmp.vl_anterior_010 = row2.ALT_VE7ANT ;
out3_tmp.dt_atualizacao_preco = TalendDate.getCurrentDate();
out3_tmp.SITUACAO = row2.SITUACAO ;
out3 = out3_tmp;
...
if(out3 != null) { 
	...
	currentComponent="tDBOutput_2";
        ...
        whetherReject_tDBOutput_2 = false;
                    pstmt_tDBOutput_2.setBigDecimal(1, out3.valor_atual_010);

                    pstmt_tDBOutput_2.setBigDecimal(2, out3.vl_arredondamento_010);

                    pstmt_tDBOutput_2.setBigDecimal(3, out3.vl_anterior_010);
 ...
 */
	...
	currentComponent="tHashInput_2";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_int_02_updated_preco_tabela_controle_multicd_010_" + pid +"_tHashOutput_5");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row21Struct> tHashFile_tHashInput_7 = mf_tHashInput_7.getAdvancedMemoryHashFile("tHashFile_int_02_updated_preco_tabela_controle_multicd_010_" + pid +"_tHashOutput_7");
 ...
 */
	...
	currentComponent="tHashInput_7";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_int_02_updated_preco_tabela_controle_multicd_010_" + pid +"_tHashOutput_7");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row18Struct> tHashFile_tHashInput_6 = mf_tHashInput_6.getAdvancedMemoryHashFile("tHashFile_int_02_updated_preco_tabela_controle_multicd_010_" + pid +"_tHashOutput_6");
 ...
 */
	...
	currentComponent="tHashInput_6";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_int_02_updated_preco_tabela_controle_multicd_010_" + pid +"_tHashOutput_6");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row11Struct> tHashFile_tHashInput_5 = mf_tHashInput_5.getAdvancedMemoryHashFile("tHashFile_int_02_updated_preco_tabela_controle_multicd_010_" + pid +"_tHashOutput_3");
 ...
 */
	...
	currentComponent="tHashInput_5";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_int_02_updated_preco_tabela_controle_multicd_010_" + pid +"_tHashOutput_3");
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_2=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_2 = "tHashFile_int_02_updated_preco_tabela_controle_multicd_010_" + pid + "_tHashOutput_2";
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_4=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_4 = "tHashFile_int_02_updated_preco_tabela_controle_multicd_010_" + pid + "_tHashOutput_4";
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_1=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_1 = "tHashFile_int_02_updated_preco_tabela_controle_multicd_010_" + pid + "_tHashOutput_1";
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_3=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_3 = "tHashFile_int_02_updated_preco_tabela_controle_multicd_010_" + pid + "_tHashOutput_3";
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_6=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_6 = "tHashFile_int_02_updated_preco_tabela_controle_multicd_010_" + pid + "_tHashOutput_6";
 ...
 */
    ...
    public static void main(String[] args){
        final int_02_updated_preco_tabela_controle_multicd_010 int_02_updated_preco_tabela_controle_multicd_010Class = new int_02_updated_preco_tabela_controle_multicd_010();

        int exitCode = int_02_updated_preco_tabela_controle_multicd_010Class.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = int_02_updated_preco_tabela_controle_multicd_010.class.getClassLoader().getResourceAsStream("refatoracao/int_02_updated_preco_tabela_controle_multicd_010_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = int_02_updated_preco_tabela_controle_multicd_010.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : int_02_updated_preco_tabela_controle_multicd_010");
        }
...
/************************************************************************************************
 *     679631 characters generated by Talend Open Studio for Big Data 
