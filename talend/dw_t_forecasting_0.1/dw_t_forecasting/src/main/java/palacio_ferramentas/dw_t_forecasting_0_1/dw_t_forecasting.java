...
package palacio_ferramentas.dw_t_forecasting_0_1;
...
public String getJDBC_PARAMETERS(){
	...
	private final String jobName = "dw_t_forecasting";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				dw_t_forecasting.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(dw_t_forecasting.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row16Struct implements routines.system.IPersistableRow<row16Struct> {
    final static byte[] commonByteArrayLock_PALACIO_FERRAMENTAS_dw_t_forecasting = new byte[0];
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_dw_t_forecasting = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PALACIO_FERRAMENTAS_dw_t_forecasting.length) {
				if(length < 1024 && commonByteArray_PALACIO_FERRAMENTAS_dw_t_forecasting.length == 0) {
   					commonByteArray_PALACIO_FERRAMENTAS_dw_t_forecasting = new byte[1024];
				} else {
   					commonByteArray_PALACIO_FERRAMENTAS_dw_t_forecasting = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PALACIO_FERRAMENTAS_dw_t_forecasting, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_dw_t_forecasting, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PALACIO_FERRAMENTAS_dw_t_forecasting, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_dw_t_forecasting, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PALACIO_FERRAMENTAS_dw_t_forecasting) {
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_2=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_2 = "tHashFile_dw_t_forecasting_" + pid + "_tHashOutput_2";
...
public static class updateStruct implements routines.system.IPersistableRow<updateStruct> {
    ...
    public String loopKey;
			    ...
			    public Integer ano_mes;

				public Integer getAno_mes () {
					return this.ano_mes;
				}

				public Boolean ano_mesIsNullable(){
				    return true;
				}
				public Boolean ano_mesIsKey(){
				    return true;
				}
				public Integer ano_mesLength(){
				    return null;
				}
				public Integer ano_mesPrecision(){
				    return null;
				}
				public String ano_mesDefault(){
				
					return null;
				
				}
				public String ano_mesComment(){
				
				    return "";
				
				}
				public String ano_mesPattern(){
				
					return "";
				
				}
				public String ano_mesOriginalDbColumnName(){
				...
				public Boolean TOTAL_DIASIsNullable(){
				    return true;
				}
				public Boolean TOTAL_DIASIsKey(){
				    return false;
				}
				public Integer TOTAL_DIASLength(){
				    return null;
				}
				public Integer TOTAL_DIASPrecision(){
				    return null;
				}
				public String TOTAL_DIASDefault(){
				
					return null;
				
				}
				public String TOTAL_DIASComment(){
				
				    return "";
				
				}
				public String TOTAL_DIASPattern(){
				
					return "";
				
				}
				public String TOTAL_DIASOriginalDbColumnName(){
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.ano_mes == null) ? 0 : this.ano_mes.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final updateStruct other = (updateStruct) obj;
						...
						if (this.ano_mes == null) {
							if (other.ano_mes != null)
								return false;
						
						} else if (!this.ano_mes.equals(other.ano_mes))
	...
	public void copyDataTo(updateStruct other) {
		...
		other.CD_EMPRESA = this.CD_EMPRESA;
	            ...
	            other.ano_mes = this.ano_mes;
	            other.TOTAL_DIAS = this.TOTAL_DIAS;
        	...
        	try {
        		...
        		int length = 0;
					...
					this.CD_PRODUTO = readString(dis);
						...
						this.ano_mes = readInteger(dis);
					
						this.TOTAL_DIAS = readInteger(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Integer
						...
						writeInteger(this.ano_mes,dos);
					
					// Integer
				
						writeInteger(this.TOTAL_DIAS,dos);
    ...
    public String toString() {
		...
		sb.append(",ano_mes="+String.valueOf(ano_mes));
		sb.append(",TOTAL_DIAS="+String.valueOf(TOTAL_DIAS));
    ...
    public int compareTo(updateStruct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.ano_mes, other.ano_mes);
						if(returnValue != 0) {
							return returnValue;
						}
...
if(dbschema_tDBOutput_3 == null || dbschema_tDBOutput_3.trim().length() == 0) {
	tableName_tDBOutput_3 = ("dw_t_forecasting").toLowerCase();
} else {
	tableName_tDBOutput_3 = dbschema_tDBOutput_3 + "\".\"" + ("dw_t_forecasting").toLowerCase();
}
...
int count_tDBOutput_3=0;
	    String update_tDBOutput_3 = "UPDATE \"" + tableName_tDBOutput_3 + "\" SET \"total_dias\" = ?,\"data_atualizacao\" = ? WHERE \"cd_empresa\" = ? AND \"cd_produto\" = ? AND \"ano_mes\" = ?";
 ...
 */
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"insert_");
					}
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("dw_t_forecasting").toLowerCase();
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("dw_t_forecasting").toLowerCase();
}
...
int count_tDBOutput_1=0;
        ...
        sb_tDBOutput_1.append("INSERT INTO \"").append(tableName_tDBOutput_1).append("\" (\"cd_empresa\",\"cd_produto\",\"ano_mes\",\"total_dias\",\"data_atualizacao\") VALUES (?,?,?,?,?)");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<insertStruct> tHashFile_tHashInput_2 = mf_tHashInput_2.getAdvancedMemoryHashFile("tHashFile_dw_t_forecasting_" + pid +"_tHashOutput_1");
...
while (iterator_tHashInput_2.hasNext()) {
	...
	row2.CD_EMPRESA = next_tHashInput_2.CD_EMPRESA;
	row2.CD_PRODUTO = next_tHashInput_2.CD_PRODUTO;
	row2.MES = next_tHashInput_2.MES;
	row2.TOTAL_DIAS = next_tHashInput_2.TOTAL_DIAS;
	row2.DATA_ATUALIZACAO = next_tHashInput_2.DATA_ATUALIZACAO;
 					    ...
 					    boolean forceLooprow4 = false;
 							...
 							row4Struct row4ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_3 = false;
                        		    		    ...
                        		    		    row4HashKey.CD_PRODUTO = row2.CD_PRODUTO ;
                        		    		
                        		    		    row4HashKey.ano_mes = row2.MES ;
...
// # Output table : 'update'
update_tmp.CD_EMPRESA = row2.CD_EMPRESA ;
update_tmp.CD_PRODUTO = row2.CD_PRODUTO;
update_tmp.ano_mes = row2.MES ;
update_tmp.TOTAL_DIAS = row2.TOTAL_DIAS;
update_tmp.DATA_ATUALIZACAO = row2.DATA_ATUALIZACAO;
update = update_tmp;
} // closing inner join bracket (1)
// ###### START REJECTS ##### 

// # Output reject table : 'insert_'
// # Filter conditions 
if( rejectedInnerJoin_tMap_3 ) {
insert__tmp.CD_EMPRESA = row2.CD_EMPRESA ;
insert__tmp.CD_PRODUTO = row2.CD_PRODUTO;
insert__tmp.ano_mes = row2.MES ;
insert__tmp.TOTAL_DIAS = row2.TOTAL_DIAS;
insert__tmp.DATA_ATUALIZACAO = row2.DATA_ATUALIZACAO;
insert_ = insert__tmp;
...
if(update != null) { 
	...
	currentComponent="tDBOutput_3";
        ...
        whetherReject_tDBOutput_3 = false;
                    if(update.TOTAL_DIAS == null) {
pstmt_tDBOutput_3.setNull(1, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_3.setInt(1, update.TOTAL_DIAS);
}

                    if(update.DATA_ATUALIZACAO != null) {
pstmt_tDBOutput_3.setTimestamp(2, new java.sql.Timestamp(update.DATA_ATUALIZACAO.getTime()));
} else {
pstmt_tDBOutput_3.setNull(2, java.sql.Types.TIMESTAMP);
}

                    if(update.CD_EMPRESA == null) {
pstmt_tDBOutput_3.setNull(3 + count_tDBOutput_3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(3 + count_tDBOutput_3, update.CD_EMPRESA);
}


                    if(update.CD_PRODUTO == null) {
pstmt_tDBOutput_3.setNull(4 + count_tDBOutput_3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(4 + count_tDBOutput_3, update.CD_PRODUTO);
}


                    if(update.ano_mes == null) {
pstmt_tDBOutput_3.setNull(5 + count_tDBOutput_3, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_3.setInt(5 + count_tDBOutput_3, update.ano_mes);
}
...
if(insert_ != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(insert_.CD_EMPRESA == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, insert_.CD_EMPRESA);
}

                    if(insert_.CD_PRODUTO == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, insert_.CD_PRODUTO);
}

                    if(insert_.ano_mes == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(3, insert_.ano_mes);
}

                    if(insert_.TOTAL_DIAS == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(4, insert_.TOTAL_DIAS);
}

                    if(insert_.DATA_ATUALIZACAO != null) {
pstmt_tDBOutput_1.setTimestamp(5, new java.sql.Timestamp(insert_.DATA_ATUALIZACAO.getTime()));
} else {
 ...
 */
	...
	currentComponent="tHashInput_2";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_dw_t_forecasting_" + pid +"_tHashOutput_1");
...
globalMap.put("tDBOutput_1_ERROR_MESSAGE",e_tDBOutput_1.getMessage());
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"insert_");
			  	}
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row16Struct> tHashFile_tHashInput_1 = mf_tHashInput_1.getAdvancedMemoryHashFile("tHashFile_dw_t_forecasting_" + pid +"_tHashOutput_2");
 ...
 */
	...
	currentComponent="tHashInput_1";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_dw_t_forecasting_" + pid +"_tHashOutput_2");
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row4";
		...
		int tos_count_tAdvancedHash_row4 = 0;
			   		...
			   		// source node:tHashInput_3 - inputs:(after_tHashInput_2) outputs:(row4,row4) | target node:tAdvancedHash_row4 - inputs:(row4) outputs:()
			   		// linked node: tMap_3 - inputs:(row2,row4) outputs:(update,insert_)
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row3Struct> tHashFile_tHashInput_3 = mf_tHashInput_3.getAdvancedMemoryHashFile("tHashFile_dw_t_forecasting_" + pid +"_tHashOutput_3");
...
while (iterator_tHashInput_3.hasNext()) {
	...
	row4.CD_EMPRESA = next_tHashInput_3.CD_EMPRESA;
	row4.CD_PRODUTO = next_tHashInput_3.CD_PRODUTO;
	row4.ano_mes = next_tHashInput_3.MES;
 ...
 */
	...
	currentComponent="tAdvancedHash_row4";
				...
				row4_HashRow.CD_EMPRESA = row4.CD_EMPRESA;
				
				row4_HashRow.CD_PRODUTO = row4.CD_PRODUTO;
				
				row4_HashRow.ano_mes = row4.ano_mes;
 ...
 */
	...
	currentComponent="tHashInput_3";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_dw_t_forecasting_" + pid +"_tHashOutput_3");
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_1=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<insertStruct> tHashFile_tHashOutput_1 = null;
		String hashKey_tHashOutput_1 = "tHashFile_dw_t_forecasting_" + pid + "_tHashOutput_1";
			synchronized(org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.get(hashKey_tHashOutput_1)){
			    if(mf_tHashOutput_1.getResourceMap().get(hashKey_tHashOutput_1) == null){
	      		    mf_tHashOutput_1.getResourceMap().put(hashKey_tHashOutput_1, new org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<insertStruct>(org.talend.designer.components.hashfile.common.MATCHING_MODE.KEEP_ALL));
 ...
 */
	...
	currentComponent="tDBInput_1";
		...
		int tos_count_tDBInput_1 = 0;
		    ...
		    String dbquery_tDBInput_1 = "\n SELECT CD_EMPRESA,\n        CD_PRODUTO,\n        TO_CHAR(DIA, 'YYYYMM') AS MES,\n        COUNT(DISTINCT DIA) AS TOTA"
+"L_DIAS,\n        CURRENT_TIMESTAMP DATA_ATUALIZACAO\n   from  DW_T_INDICADOR_ESTOQUE_DIARIO IED\n  WHERE DATE_TRUNC('MON"
+"TH', DIA) = DATE_TRUNC('MONTH', CURRENT_DATE)\n    AND CD_EMPRESA IN ('001', '002', '006', '007', '008', '009', '010', '"
+"201')\n    AND ATIVO_VENDA = 'S'\n    AND SALDO_DISPONIVEL > 0\nGROUP BY CD_EMPRESA, CD_PRODUTO, TO_CHAR(DIA, 'YYYYMM');"
+"\n   \n";
        	...
        	row1.CD_EMPRESA = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								row1.CD_PRODUTO = null;
							} else {
	                         		
        	row1.CD_PRODUTO = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
		                    }
            ...
            if(rs_tDBInput_1.wasNull()){
                    row1.MES = null;
							...
							if(colQtyInRs_tDBInput_1 < 4) {
								row1.TOTAL_DIAS = null;
							} else {
		                          
            row1.TOTAL_DIAS = rs_tDBInput_1.getInt(4);
            if(rs_tDBInput_1.wasNull()){
                    row1.TOTAL_DIAS = null;
            }
		                    }
			...
			row1.DATA_ATUALIZACAO = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 5);
		                    }
...
insert_tmp.MES = row1.MES ;
insert_tmp.TOTAL_DIAS = row1.TOTAL_DIAS ;
insert_tmp.DATA_ATUALIZACAO = row1.DATA_ATUALIZACAO ;
insert = insert_tmp;
// ###############################
...
if(insert != null) { 
	...
	currentComponent="tHashOutput_1";
		...
		insertStruct oneRow_tHashOutput_1 = new insertStruct();
				
					oneRow_tHashOutput_1.CD_EMPRESA = insert.CD_EMPRESA;
					oneRow_tHashOutput_1.CD_PRODUTO = insert.CD_PRODUTO;
					oneRow_tHashOutput_1.MES = insert.MES;
					oneRow_tHashOutput_1.TOTAL_DIAS = insert.TOTAL_DIAS;
					oneRow_tHashOutput_1.DATA_ATUALIZACAO = insert.DATA_ATUALIZACAO;
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_3=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_3 = "tHashFile_dw_t_forecasting_" + pid + "_tHashOutput_3";
 ...
 */
	...
	currentComponent="tHashOutput_3";
		...
		row3Struct oneRow_tHashOutput_3 = new row3Struct();
					...
					oneRow_tHashOutput_3.CD_PRODUTO = row3.CD_PRODUTO;
					oneRow_tHashOutput_3.MES = row3.MES;
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_4=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();
		...
		mf_tHashOutput_4.getKeyMap().put("tHashFile_dw_t_forecasting_" +pid + "_tHashOutput_4", "tHashFile_dw_t_forecasting_" + pid + "_tHashOutput_3");
 ...
 */
	...
	currentComponent="tDBInput_2";
		...
		int tos_count_tDBInput_2 = 0;
		    ...
		    String dbquery_tDBInput_2 = "\nSELECT CD_EMPRESA, CD_PRODUTO, ANO_MES\nFROM DW_T_FORECASTING \nWHERE ANO_MES = EXTRACT(YEAR FROM CURRENT_DATE) * 100"
		    ...
		    while (rs_tDBInput_2.next()) {
		        nb_line_tDBInput_2++;
							...
							if(colQtyInRs_tDBInput_2 < 1) {
								row5.CD_EMPRESA = null;
							} else {
	                         		
        	row5.CD_EMPRESA = routines.system.JDBCUtil.getString(rs_tDBInput_2, 1, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 2) {
								row5.CD_PRODUTO = null;
							} else {
	                         		
        	row5.CD_PRODUTO = routines.system.JDBCUtil.getString(rs_tDBInput_2, 2, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 3) {
								row5.ANO_MES = null;
							} else {
		                          
            row5.ANO_MES = rs_tDBInput_2.getInt(3);
 ...
 */
	...
	currentComponent="tHashOutput_4";
		...
		if(tHashFile_tHashOutput_4 == null){
			tHashFile_tHashOutput_4 = mf_tHashOutput_4.getAdvancedMemoryHashFile("tHashFile_dw_t_forecasting_" + pid +"_tHashOutput_3");
			mf_tHashOutput_4.getResourceMap().put("tHashFile_dw_t_forecasting_" + pid +"_tHashOutput_4", tHashFile_tHashOutput_4);
		}
		row3Struct oneRow_tHashOutput_4 = new row3Struct();
			oneRow_tHashOutput_4.CD_EMPRESA = row5.CD_EMPRESA;
			oneRow_tHashOutput_4.CD_PRODUTO = row5.CD_PRODUTO;
			oneRow_tHashOutput_4.MES = row5.ANO_MES;
 ...
 */
    ...
    public static void main(String[] args){
        final dw_t_forecasting dw_t_forecastingClass = new dw_t_forecasting();

        int exitCode = dw_t_forecastingClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = dw_t_forecasting.class.getClassLoader().getResourceAsStream("palacio_ferramentas/dw_t_forecasting_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = dw_t_forecasting.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dw_t_forecasting");
        }
...
/************************************************************************************************
 *     333490 characters generated by Talend Open Studio for Big Data 
 *     on the 28 de março de 2025 22:46:44 BRT
 ************************************************************************************************/