...
package palacio_ferramentas.integracao_estoque_streaming_0_1;
...
/**
 * Job: integracao_estoque_streaming Purpose: integracao_estoque_streaming<br>
 * Description:  <br>
 * @author luisll@uol.com.br
 * @version 8.0.1.20230922_0317-SNAPSHOT
 * @status 
 */
public class integracao_estoque_streaming implements TalendJob {
...
public String getJDBC_PARAMETERS(){
	...
	private final String jobName = "integracao_estoque_streaming";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				integracao_estoque_streaming.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(integracao_estoque_streaming.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row16Struct implements routines.system.IPersistableRow<row16Struct> {
    final static byte[] commonByteArrayLock_PALACIO_FERRAMENTAS_integracao_estoque_streaming = new byte[0];
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_integracao_estoque_streaming = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PALACIO_FERRAMENTAS_integracao_estoque_streaming.length) {
				if(length < 1024 && commonByteArray_PALACIO_FERRAMENTAS_integracao_estoque_streaming.length == 0) {
   					commonByteArray_PALACIO_FERRAMENTAS_integracao_estoque_streaming = new byte[1024];
				} else {
   					commonByteArray_PALACIO_FERRAMENTAS_integracao_estoque_streaming = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PALACIO_FERRAMENTAS_integracao_estoque_streaming, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_integracao_estoque_streaming, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PALACIO_FERRAMENTAS_integracao_estoque_streaming, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_integracao_estoque_streaming, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PALACIO_FERRAMENTAS_integracao_estoque_streaming) {
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_5=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_5 = "tHashFile_integracao_estoque_streaming_" + pid + "_tHashOutput_5";
...
// ------------
	...
	class AggOperationStruct_tAggregateRow_1 { // G_OutBegin_AggR_100
	    ...
	    public boolean hashCodeDirty = true;
    				...
    				Integer SALDO_ATUAL;
         			java.util.Date DATA_ULT_ATUALIZACAO_max;
            ...
            if(rs_tDBInput_1.wasNull()){
                    row4.SALDO_ATUAL = null;
							...
							if(colQtyInRs_tDBInput_1 < 5) {
								row4.DATA_ULT_ATUALIZACAO = null;
							} else {
										
			row4.DATA_ULT_ATUALIZACAO = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 5);
		                    }
...
operation_finder_tAggregateRow_1.CD_EMP = row4.CD_EMP;
			operation_finder_tAggregateRow_1.CD_ITEM = row4.CD_ITEM;
			operation_finder_tAggregateRow_1.SALDO_ANTERIOR = row4.SALDO_ANTERIOR;
			operation_finder_tAggregateRow_1.SALDO_ATUAL = row4.SALDO_ATUAL;
	...
	if(operation_result_tAggregateRow_1 == null) { // G_OutMain_AggR_001
		...
		operation_result_tAggregateRow_1.CD_EMP = operation_finder_tAggregateRow_1.CD_EMP;
				operation_result_tAggregateRow_1.CD_ITEM = operation_finder_tAggregateRow_1.CD_ITEM;
				operation_result_tAggregateRow_1.SALDO_ANTERIOR = operation_finder_tAggregateRow_1.SALDO_ANTERIOR;
				operation_result_tAggregateRow_1.SALDO_ATUAL = operation_finder_tAggregateRow_1.SALDO_ATUAL;
		...
		hash_tAggregateRow_1.put(operation_result_tAggregateRow_1, operation_result_tAggregateRow_1);
					...
					if( 
							...
							operation_result_tAggregateRow_1.DATA_ULT_ATUALIZACAO_max == null || row4.DATA_ULT_ATUALIZACAO.compareTo(operation_result_tAggregateRow_1.DATA_ULT_ATUALIZACAO_max) > 0
						
					) {
						operation_result_tAggregateRow_1.DATA_ULT_ATUALIZACAO_max = row4.DATA_ULT_ATUALIZACAO;
					}
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_1=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_1 = "tHashFile_integracao_estoque_streaming_" + pid + "_tHashOutput_1";
 ...
 */
	...
	currentComponent="tAggregateRow_1_AGGIN";
            				    ...
            				    row23.CD_EMP = aggregated_row_tAggregateRow_1.CD_EMP;
            				    
            				    row23.CD_ITEM = aggregated_row_tAggregateRow_1.CD_ITEM;
            				    
            				    row23.SALDO_ANTERIOR = aggregated_row_tAggregateRow_1.SALDO_ANTERIOR;
            				    
            				    row23.SALDO_ATUAL = aggregated_row_tAggregateRow_1.SALDO_ATUAL;
            				    
                                row23.DATA_ULT_ATUALIZACAO = aggregated_row_tAggregateRow_1.DATA_ULT_ATUALIZACAO_max;
 ...
 */
	...
	currentComponent="tHashOutput_1";
		...
		row23Struct oneRow_tHashOutput_1 = new row23Struct();
					...
					oneRow_tHashOutput_1.CD_EMP = row23.CD_EMP;
					oneRow_tHashOutput_1.CD_ITEM = row23.CD_ITEM;
					oneRow_tHashOutput_1.SALDO_ANTERIOR = row23.SALDO_ANTERIOR;
					oneRow_tHashOutput_1.SALDO_ATUAL = row23.SALDO_ATUAL;
					oneRow_tHashOutput_1.DATA_ULT_ATUALIZACAO = row23.DATA_ULT_ATUALIZACAO;
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row11Struct> tHashFile_tHashInput_6 = mf_tHashInput_6.getAdvancedMemoryHashFile("tHashFile_integracao_estoque_streaming_" + pid +"_tHashOutput_7");
 ...
 */
	...
	currentComponent="tHashInput_6";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_integracao_estoque_streaming_" + pid +"_tHashOutput_7");
...
public static class row19Struct implements routines.system.IPersistableRow<row19Struct> {
    ...
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_integracao_estoque_streaming = new byte[0];
			    ...
			    public Integer MEDIA_VENDA;

				public Integer getMEDIA_VENDA () {
					return this.MEDIA_VENDA;
				}

				public Boolean MEDIA_VENDAIsNullable(){
				    return true;
				}
				public Boolean MEDIA_VENDAIsKey(){
				    return false;
				}
				public Integer MEDIA_VENDALength(){
				    return null;
				}
				public Integer MEDIA_VENDAPrecision(){
				    return null;
				}
				public String MEDIA_VENDADefault(){
				
					return null;
				
				}
				public String MEDIA_VENDAComment(){
				
				    return "";
				
				}
				public String MEDIA_VENDAPattern(){
				
					return "";
				
				}
				public String MEDIA_VENDAOriginalDbColumnName(){
        	...
        	try {
        		...
        		int length = 0;
					...
					this.DESC_ITEM = readString(dis);
						...
						this.MEDIA_VENDA = readInteger(dis);
					
						this.PARAMETRO = readInteger(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Integer
						...
						writeInteger(this.MEDIA_VENDA,dos);
					
					// Integer
				
						writeInteger(this.PARAMETRO,dos);
    ...
    public String toString() {
		...
		sb.append(",DESC_ITEM="+DESC_ITEM);
		sb.append(",SALDO_ATUAL="+String.valueOf(SALDO_ATUAL));
		sb.append(",MEDIA_VENDA="+String.valueOf(MEDIA_VENDA));
...
public static class saldo_mediaStruct implements routines.system.IPersistableRow<saldo_mediaStruct> {
    final static byte[] commonByteArrayLock_PALACIO_FERRAMENTAS_integracao_estoque_streaming = new byte[0];
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_integracao_estoque_streaming = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(saldo_mediaStruct other) {
...
saldo_mediaStruct saldo_media = new saldo_mediaStruct();
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_6=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row19Struct> tHashFile_tHashOutput_6 = null;
		String hashKey_tHashOutput_6 = "tHashFile_integracao_estoque_streaming_" + pid + "_tHashOutput_6";
			synchronized(org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.get(hashKey_tHashOutput_6)){
			    if(mf_tHashOutput_6.getResourceMap().get(hashKey_tHashOutput_6) == null){
	      		    mf_tHashOutput_6.getResourceMap().put(hashKey_tHashOutput_6, new org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row19Struct>(org.talend.designer.components.hashfile.common.MATCHING_MODE.KEEP_ALL));
 ...
 */
	...
	currentComponent="tJavaRow_2";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"saldo_media");
					}
...
// ###############################
// # Outputs initialization
saldo_mediaStruct saldo_media_tmp = new saldo_mediaStruct();
// ###############################
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row11Struct> tHashFile_tHashInput_9 = mf_tHashInput_9.getAdvancedMemoryHashFile("tHashFile_integracao_estoque_streaming_" + pid +"_tHashOutput_7");
...
while (iterator_tHashInput_9.hasNext()) {
	...
	row13.CD_EMP = next_tHashInput_9.CD_EMP;
	row13.CD_ITEM = next_tHashInput_9.CD_ITEM;
	row13.DESC_ITEM = next_tHashInput_9.DESC_ITEM;
	row13.SALDO_ATUAL = next_tHashInput_9.SALDO_ATUAL;
	row13.DATA_ULT_ATUALIZACAO = next_tHashInput_9.DATA_ULT_ATUALIZACAO;
 					    ...
 					    boolean forceLooprow14 = false;
 							...
 							row14Struct row14ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_9 = false;
                        		    		    ...
                        		    		    row14HashKey.EMPRESA = row13.CD_EMP ;
                        		    		
                        		    		    row14HashKey.COD_ITEM = row13.CD_ITEM ;
				           		...
				           		if(tHash_Lookup_row14 != null && tHash_Lookup_row14.getCount(row14HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row14' and it contains more one result from keys :  row14.EMPRESA = '" + row14HashKey.EMPRESA + "', row14.COD_ITEM = '" + row14HashKey.COD_ITEM + "'");
								} // G 071
...
// # Output table : 'saldo_media'
saldo_media_tmp.CD_EMP = row13.CD_EMP ;
saldo_media_tmp.CD_ITEM = row13.CD_ITEM ;
saldo_media_tmp.DESC_ITEM = row13.DESC_ITEM ;
saldo_media_tmp.SALDO_ATUAL = row13.SALDO_ATUAL ;
saldo_media_tmp.MEDIA_VENDA = row14.MEDIA_VENDA ;
saldo_media = saldo_media_tmp;
// ###############################
...
row18.CD_EMP = saldo_media.CD_EMP;
row18.CD_ITEM = saldo_media.CD_ITEM;
row18.DESC_ITEM = saldo_media.DESC_ITEM;
row18.SALDO_ATUAL = saldo_media.SALDO_ATUAL;


if (saldo_media.MEDIA_VENDA == null) {

row18.MEDIA_VENDA = 0;

} else{

row18.MEDIA_VENDA = saldo_media.MEDIA_VENDA;
 ...
 */
    ...
    //Code generated according to input schema and output schema
row19.CD_EMP = row18.CD_EMP;
row19.CD_ITEM = row18.CD_ITEM;
row19.DESC_ITEM = row18.DESC_ITEM;
row19.SALDO_ATUAL = row18.SALDO_ATUAL;
row19.MEDIA_VENDA = row18.MEDIA_VENDA;


if(row18.MEDIA_VENDA == 0) {
	row19.PARAMETRO = row18.SALDO_ATUAL / 1;
} else if(row18.SALDO_ATUAL == 0) {
	row19.PARAMETRO = 0;
} else {
	row19.PARAMETRO = row18.SALDO_ATUAL / row18.MEDIA_VENDA;
}
    nb_line_tJavaRow_3++;   
 ...
 */
	...
	currentComponent="tHashOutput_6";
		...
		row19Struct oneRow_tHashOutput_6 = new row19Struct();
				
					oneRow_tHashOutput_6.CD_EMP = row19.CD_EMP;
					oneRow_tHashOutput_6.CD_ITEM = row19.CD_ITEM;
					oneRow_tHashOutput_6.DESC_ITEM = row19.DESC_ITEM;
					oneRow_tHashOutput_6.SALDO_ATUAL = row19.SALDO_ATUAL;
					oneRow_tHashOutput_6.MEDIA_VENDA = row19.MEDIA_VENDA;
					oneRow_tHashOutput_6.PARAMETRO = row19.PARAMETRO;
...
globalMap.put("tJavaRow_2_NB_LINE",nb_line_tJavaRow_2);
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"saldo_media");
			  	}
...
public static class insert_dwStruct implements routines.system.IPersistableRow<insert_dwStruct> {
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.DATA_ULT_ATUALIZACAO == null) ? 0 : this.DATA_ULT_ATUALIZACAO.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final insert_dwStruct other = (insert_dwStruct) obj;
						...
						if (this.DATA_ULT_ATUALIZACAO == null) {
							if (other.DATA_ULT_ATUALIZACAO != null)
								return false;
						
						} else if (!this.DATA_ULT_ATUALIZACAO.equals(other.DATA_ULT_ATUALIZACAO))
    ...
    public int compareTo(insert_dwStruct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.DATA_ULT_ATUALIZACAO, other.DATA_ULT_ATUALIZACAO);
						if(returnValue != 0) {
							return returnValue;
						}
...
public static class insert_winspareStruct implements routines.system.IPersistableRow<insert_winspareStruct> {
    final static byte[] commonByteArrayLock_PALACIO_FERRAMENTAS_integracao_estoque_streaming = new byte[0];
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_integracao_estoque_streaming = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final insert_winspareStruct other = (insert_winspareStruct) obj;
	...
	public void copyDataTo(insert_winspareStruct other) {
	...
	public void copyKeysDataTo(insert_winspareStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(insert_winspareStruct other) {
...
public static class out2Struct implements routines.system.IPersistableRow<out2Struct> {
	...
	public void copyDataTo(out2Struct other) {
		...
		other.CD_EMP = this.CD_EMP;
	            ...
	            other.DATA_ULT_ATUALIZACAO = this.DATA_ULT_ATUALIZACAO;
	            other.DATA_EXECUCAO = this.DATA_EXECUCAO;
	            other.MEDIA_VENDA = this.MEDIA_VENDA;
...
insert_winspareStruct insert_winspare = new insert_winspareStruct();
...
int count_tDBOutput_5=0;
        ...
        sb_tDBOutput_5.append("INSERT INTO \"").append(tableName_tDBOutput_5).append("\" (\"cd_emp\",\"cd_item\",\"desc_item\",\"saldo_anterior\",\"saldo_atual\",\"data_ult_atualizacao\",\"data_execucao\") VALUES (?,?,?,?,?,?,?)");
 ...
 */
	...
	currentComponent="tHashOutput_2";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"insert_winspare");
					}
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_2=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<insert_winspareStruct> tHashFile_tHashOutput_2 = null;
		String hashKey_tHashOutput_2 = "tHashFile_integracao_estoque_streaming_" + pid + "_tHashOutput_2";
			synchronized(org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.get(hashKey_tHashOutput_2)){
			    if(mf_tHashOutput_2.getResourceMap().get(hashKey_tHashOutput_2) == null){
	      		    mf_tHashOutput_2.getResourceMap().put(hashKey_tHashOutput_2, new org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<insert_winspareStruct>(org.talend.designer.components.hashfile.common.MATCHING_MODE.KEEP_ALL));
...
insert_winspareStruct insert_winspare_tmp = new insert_winspareStruct();
// ###############################
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row11Struct> tHashFile_tHashInput_1 = mf_tHashInput_1.getAdvancedMemoryHashFile("tHashFile_integracao_estoque_streaming_" + pid +"_tHashOutput_7");
 					    ...
 					    boolean forceLooprow21 = false;
 							...
 							row21Struct row21ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_10 = false;
                        		    		    ...
                        		    		    row21HashKey.CD_EMP = Atualizacao1.CD_EMP ;
                        		    		
                        		    		    row21HashKey.CD_ITEM = Atualizacao1.CD_ITEM ;
								  ...
								  if(!tHash_Lookup_row21.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row21 != null && tHash_Lookup_row21.getCount(row21HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row21' and it contains more one result from keys :  row21.CD_EMP = '" + row21HashKey.CD_EMP + "', row21.CD_ITEM = '" + row21HashKey.CD_ITEM + "'");
								} // G 071
...
// # Output table : 'out2'
out2_tmp.CD_EMP = Atualizacao1.CD_EMP;
out2_tmp.CD_ITEM = Atualizacao1.CD_ITEM;
out2_tmp.DESC_ITEM = Atualizacao1.DESC_ITEM;
out2_tmp.SALDO_ANTERIOR = Atualizacao1.SALDO_ANTERIOR;
out2_tmp.SALDO_ATUAL = Atualizacao1.SALDO_ATUAL;
out2_tmp.DATA_ULT_ATUALIZACAO = Atualizacao1.DATA_ULT_ATUALIZACAO;
out2_tmp.DATA_EXECUCAO = Atualizacao1.DATA_EXECUCAO;
out2_tmp.MEDIA_VENDA = row21.MEDIA_VENDA ;
out2_tmp.PARAMETRO = row21.PARAMETRO ;
out2 = out2_tmp;
...
if(out2 != null) { 
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(row20 == null){ 
               ...
               row20.CD_EMP = out2.CD_EMP;
               row20.CD_ITEM = out2.CD_ITEM;
               row20.DESC_ITEM = out2.DESC_ITEM;
               row20.SALDO_ANTERIOR = out2.SALDO_ANTERIOR;
               row20.SALDO_ATUAL = out2.SALDO_ATUAL;
               row20.DATA_ULT_ATUALIZACAO = out2.DATA_ULT_ATUALIZACAO;
               row20.DATA_EXECUCAO = out2.DATA_EXECUCAO;
               row20.MEDIA_VENDA = out2.MEDIA_VENDA;
               row20.PARAMETRO = out2.PARAMETRO;    
...
insert_dw = null;
insert_winspare = null;


// # Output table : 'insert_dw'
insert_dw_tmp.CD_EMP = row20.CD_EMP;
insert_dw_tmp.CD_ITEM = row20.CD_ITEM;
insert_dw_tmp.DESC_ITEM = row20.DESC_ITEM;
insert_dw_tmp.SALDO_ANTERIOR = row20.SALDO_ANTERIOR;
insert_dw_tmp.SALDO_ATUAL = row20.SALDO_ATUAL;
insert_dw_tmp.DATA_ULT_ATUALIZACAO = row20.DATA_ULT_ATUALIZACAO;
insert_dw_tmp.DATA_EXECUCAO = row20.DATA_EXECUCAO;
insert_dw = insert_dw_tmp;

// # Output table : 'insert_winspare'
insert_winspare_tmp.CD_EMP = row20.CD_EMP;
insert_winspare_tmp.CD_ITEM = row20.CD_ITEM;
insert_winspare_tmp.DESC_ITEM = row20.DESC_ITEM;
insert_winspare_tmp.SALDO_ANTERIOR = row20.SALDO_ANTERIOR;
insert_winspare_tmp.SALDO_ATUAL = row20.SALDO_ATUAL;
insert_winspare_tmp.DATA_ULT_ATUALIZACAO = row20.DATA_ULT_ATUALIZACAO;
insert_winspare_tmp.DATA_EXECUCAO = row20.DATA_EXECUCAO;
insert_winspare = insert_winspare_tmp;
// ###############################
...
if(insert_dw != null) { 
	...
	currentComponent="tDBOutput_5";
        ...
        whetherReject_tDBOutput_5 = false;
                    if(insert_dw.CD_EMP == null) {
pstmt_tDBOutput_5.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_5.setString(1, insert_dw.CD_EMP);
}

                    if(insert_dw.CD_ITEM == null) {
pstmt_tDBOutput_5.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_5.setString(2, insert_dw.CD_ITEM);
}

                    if(insert_dw.DESC_ITEM == null) {
pstmt_tDBOutput_5.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_5.setString(3, insert_dw.DESC_ITEM);
}

                    if(insert_dw.SALDO_ANTERIOR == null) {
pstmt_tDBOutput_5.setNull(4, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_5.setInt(4, insert_dw.SALDO_ANTERIOR);
}

                    if(insert_dw.SALDO_ATUAL == null) {
pstmt_tDBOutput_5.setNull(5, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_5.setInt(5, insert_dw.SALDO_ATUAL);
}

                    if(insert_dw.DATA_ULT_ATUALIZACAO != null) {
pstmt_tDBOutput_5.setTimestamp(6, new java.sql.Timestamp(insert_dw.DATA_ULT_ATUALIZACAO.getTime()));
} else {
pstmt_tDBOutput_5.setNull(6, java.sql.Types.TIMESTAMP);
}

                    if(insert_dw.DATA_EXECUCAO != null) {
pstmt_tDBOutput_5.setTimestamp(7, new java.sql.Timestamp(insert_dw.DATA_EXECUCAO.getTime()));
} else {
...
// Start of branch "insert_winspare"
if(insert_winspare != null) { 
	...
	currentComponent="tHashOutput_2";
		...
		insert_winspareStruct oneRow_tHashOutput_2 = new insert_winspareStruct();
				
					oneRow_tHashOutput_2.CD_EMP = insert_winspare.CD_EMP;
					oneRow_tHashOutput_2.CD_ITEM = insert_winspare.CD_ITEM;
					oneRow_tHashOutput_2.DESC_ITEM = insert_winspare.DESC_ITEM;
					oneRow_tHashOutput_2.SALDO_ANTERIOR = insert_winspare.SALDO_ANTERIOR;
					oneRow_tHashOutput_2.SALDO_ATUAL = insert_winspare.SALDO_ATUAL;
					oneRow_tHashOutput_2.DATA_ULT_ATUALIZACAO = insert_winspare.DATA_ULT_ATUALIZACAO;
					oneRow_tHashOutput_2.DATA_EXECUCAO = insert_winspare.DATA_EXECUCAO;
...
globalMap.put("tHashOutput_2_NB_LINE", nb_line_tHashOutput_2);
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"insert_winspare");
			  	}
		...
		class KeyStruct_tUniqRow_1 {
			...
			public int hashCode() {
				if (this.hashCodeDirty) {
					...
					int result = DEFAULT_HASHCODE;
								...
								result = prime * result + ((this.DESC_ITEM == null) ? 0 : this.DESC_ITEM.hashCode());
			...
			public boolean equals(Object obj) {
				...
				final KeyStruct_tUniqRow_1 other = (KeyStruct_tUniqRow_1) obj;
									...
									if (this.DESC_ITEM == null) {
										if (other.DESC_ITEM != null) 
											return false;
								
									} else if (!this.DESC_ITEM.equals(other.DESC_ITEM))
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<insert_winspareStruct> tHashFile_tHashInput_7 = mf_tHashInput_7.getAdvancedMemoryHashFile("tHashFile_integracao_estoque_streaming_" + pid +"_tHashOutput_2");
if(tHashFile_tHashInput_7==null) {
	throw new RuntimeException("The hash is not initialized : The hash must exist before you read from it");
}
java.util.Iterator<insert_winspareStruct> iterator_tHashInput_7 = tHashFile_tHashInput_7.iterator();
while (iterator_tHashInput_7.hasNext()) {
    insert_winspareStruct next_tHashInput_7 = iterator_tHashInput_7.next();
...
if(Insert.CD_EMP == null){
	finder_tUniqRow_1.CD_EMP = null;
}else{
	finder_tUniqRow_1.CD_EMP = Insert.CD_EMP.toLowerCase();
}
if(Insert.CD_ITEM == null){
	finder_tUniqRow_1.CD_ITEM = null;
}else{
	finder_tUniqRow_1.CD_ITEM = Insert.CD_ITEM.toLowerCase();
}
if(Insert.DESC_ITEM == null){
	finder_tUniqRow_1.DESC_ITEM = null;
}else{
	finder_tUniqRow_1.DESC_ITEM = Insert.DESC_ITEM.toLowerCase();
}
finder_tUniqRow_1.SALDO_ANTERIOR = Insert.SALDO_ANTERIOR;
finder_tUniqRow_1.SALDO_ATUAL = Insert.SALDO_ATUAL;	
...
if(Insert.CD_EMP == null){
	new_tUniqRow_1.CD_EMP = null;
}else{
	new_tUniqRow_1.CD_EMP = Insert.CD_EMP.toLowerCase();
}
if(Insert.CD_ITEM == null){
	new_tUniqRow_1.CD_ITEM = null;
}else{
	new_tUniqRow_1.CD_ITEM = Insert.CD_ITEM.toLowerCase();
}
if(Insert.DESC_ITEM == null){
	new_tUniqRow_1.DESC_ITEM = null;
}else{
	new_tUniqRow_1.DESC_ITEM = Insert.DESC_ITEM.toLowerCase();
}
new_tUniqRow_1.SALDO_ANTERIOR = Insert.SALDO_ANTERIOR;
new_tUniqRow_1.SALDO_ATUAL = Insert.SALDO_ATUAL;
		
		keystUniqRow_1.add(new_tUniqRow_1);if(row22 == null){ 
	
	row22 = new row22Struct();
}row22.CD_EMP = Insert.CD_EMP;			row22.CD_ITEM = Insert.CD_ITEM;			row22.DESC_ITEM = Insert.DESC_ITEM;			row22.SALDO_ANTERIOR = Insert.SALDO_ANTERIOR;			row22.SALDO_ATUAL = Insert.SALDO_ATUAL;			row22.DATA_EXECUCAO = Insert.DATA_EXECUCAO;					
...
if(row22 != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(row22.CD_EMP == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, row22.CD_EMP);
}

                    if(row22.CD_ITEM == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, row22.CD_ITEM);
}

                    if(row22.DESC_ITEM == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, row22.DESC_ITEM);
}

                    if(row22.SALDO_ANTERIOR == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(4, row22.SALDO_ANTERIOR);
}

                    if(row22.SALDO_ATUAL == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(5, row22.SALDO_ATUAL);
}

                    if(row22.DATA_EXECUCAO != null) {
pstmt_tDBOutput_1.setTimestamp(6, new java.sql.Timestamp(row22.DATA_EXECUCAO.getTime()));
} else {
 ...
 */
	...
	currentComponent="tHashInput_7";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_integracao_estoque_streaming_" + pid +"_tHashOutput_2");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row16Struct> tHashFile_tHashInput_4 = mf_tHashInput_4.getAdvancedMemoryHashFile("tHashFile_integracao_estoque_streaming_" + pid +"_tHashOutput_5");
 ...
 */
	...
	currentComponent="tHashInput_4";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_integracao_estoque_streaming_" + pid +"_tHashOutput_5");
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
						...
						this.DATA_ULT_ATUALIZACAO = readDate(dis,ois);
    ...
    public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
        try {
			int length = 0;
						...
						this.DATA_ULT_ATUALIZACAO = readDate(dis,objectIn);
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
					...
					writeInteger(this.SALDO_ANTERIOR, dos, oos);
						...
						writeDate(this.DATA_ULT_ATUALIZACAO, dos, oos);
    ...
    public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut){
                try {
					...
					writeInteger(this.SALDO_ANTERIOR, dos, objectOut);
						...
						writeDate(this.DATA_ULT_ATUALIZACAO, dos, objectOut);
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row23Struct> tHashFile_tHashInput_3 = mf_tHashInput_3.getAdvancedMemoryHashFile("tHashFile_integracao_estoque_streaming_" + pid +"_tHashOutput_1");
if(tHashFile_tHashInput_3==null) {
	throw new RuntimeException("The hash is not initialized : The hash must exist before you read from it");
}
java.util.Iterator<row23Struct> iterator_tHashInput_3 = tHashFile_tHashInput_3.iterator();
while (iterator_tHashInput_3.hasNext()) {
    row23Struct next_tHashInput_3 = iterator_tHashInput_3.next();
	...
	row6.DATA_ULT_ATUALIZACAO = next_tHashInput_3.DATA_ULT_ATUALIZACAO;
 ...
 */
	...
	currentComponent="tAdvancedHash_row6";
				...
				row6_HashRow.DATA_ULT_ATUALIZACAO = row6.DATA_ULT_ATUALIZACAO;
 ...
 */
	...
	currentComponent="tHashInput_3";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_integracao_estoque_streaming_" + pid +"_tHashOutput_1");
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row9";
		...
		int tos_count_tAdvancedHash_row9 = 0;
			   		...
			   		// linked node: tMap_7 - inputs:(Atualizacao,row9) outputs:(Atualizacao1)
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row23Struct> tHashFile_tHashInput_5 = mf_tHashInput_5.getAdvancedMemoryHashFile("tHashFile_integracao_estoque_streaming_" + pid +"_tHashOutput_1");
...
public static class row21Struct implements routines.system.IPersistableComparableLookupRow<row21Struct> {
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
						...
						this.DESC_ITEM = readString(dis,ois);
					
						this.SALDO_ATUAL = readInteger(dis,ois);
					
						this.MEDIA_VENDA = readInteger(dis,ois);
					
						this.PARAMETRO = readInteger(dis,ois);
    ...
    public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
        try {
			int length = 0;
						...
						this.DESC_ITEM = readString(dis,objectIn);
					
						this.SALDO_ATUAL = readInteger(dis,objectIn);
					
						this.MEDIA_VENDA = readInteger(dis,objectIn);
					
						this.PARAMETRO = readInteger(dis,objectIn);
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
						...
						writeString(this.DESC_ITEM, dos, oos);
					
					writeInteger(this.SALDO_ATUAL, dos, oos);
					
					writeInteger(this.MEDIA_VENDA, dos, oos);
					
					writeInteger(this.PARAMETRO, dos, oos);
    ...
    public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut){
                try {
						...
						writeString(this.DESC_ITEM, dos, objectOut);
					
					writeInteger(this.SALDO_ATUAL, dos, objectOut);
					
					writeInteger(this.MEDIA_VENDA, dos, objectOut);
					
					writeInteger(this.PARAMETRO, dos, objectOut);
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row21";
		...
		int tos_count_tAdvancedHash_row21 = 0;
			   		...
			   		// source node:tHashInput_11 - inputs:(after_tHashInput_1) outputs:(row21,row21) | target node:tAdvancedHash_row21 - inputs:(row21) outputs:()
			   		// linked node: tMap_10 - inputs:(Atualizacao1,row21) outputs:(out2)
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row19Struct> tHashFile_tHashInput_11 = mf_tHashInput_11.getAdvancedMemoryHashFile("tHashFile_integracao_estoque_streaming_" + pid +"_tHashOutput_6");
if(tHashFile_tHashInput_11==null) {
	throw new RuntimeException("The hash is not initialized : The hash must exist before you read from it");
}
java.util.Iterator<row19Struct> iterator_tHashInput_11 = tHashFile_tHashInput_11.iterator();
while (iterator_tHashInput_11.hasNext()) {
    row19Struct next_tHashInput_11 = iterator_tHashInput_11.next();

	row21.CD_EMP = next_tHashInput_11.CD_EMP;
	row21.CD_ITEM = next_tHashInput_11.CD_ITEM;
	row21.DESC_ITEM = next_tHashInput_11.DESC_ITEM;
	row21.SALDO_ATUAL = next_tHashInput_11.SALDO_ATUAL;
	row21.MEDIA_VENDA = next_tHashInput_11.MEDIA_VENDA;
	row21.PARAMETRO = next_tHashInput_11.PARAMETRO;
 ...
 */
	...
	currentComponent="tAdvancedHash_row21";
				...
				row21_HashRow.CD_EMP = row21.CD_EMP;
				
				row21_HashRow.CD_ITEM = row21.CD_ITEM;
				
				row21_HashRow.DESC_ITEM = row21.DESC_ITEM;
				
				row21_HashRow.SALDO_ATUAL = row21.SALDO_ATUAL;
				
				row21_HashRow.MEDIA_VENDA = row21.MEDIA_VENDA;
				
				row21_HashRow.PARAMETRO = row21.PARAMETRO;
 ...
 */
	...
	currentComponent="tHashInput_11";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_integracao_estoque_streaming_" + pid +"_tHashOutput_6");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row23Struct> tHashFile_tHashInput_8 = mf_tHashInput_8.getAdvancedMemoryHashFile("tHashFile_integracao_estoque_streaming_" + pid +"_tHashOutput_1");
if(tHashFile_tHashInput_8==null) {
	throw new RuntimeException("The hash is not initialized : The hash must exist before you read from it");
}
java.util.Iterator<row23Struct> iterator_tHashInput_8 = tHashFile_tHashInput_8.iterator();
while (iterator_tHashInput_8.hasNext()) {
    row23Struct next_tHashInput_8 = iterator_tHashInput_8.next();
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row14";
		...
		int tos_count_tAdvancedHash_row14 = 0;
			   		...
			   		// linked node: tMap_9 - inputs:(row13,row14) outputs:(saldo_media)
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<MEDIA_VENDAStruct> tHashFile_tHashInput_10 = mf_tHashInput_10.getAdvancedMemoryHashFile("tHashFile_integracao_estoque_streaming_" + pid +"_tHashOutput_4");
if(tHashFile_tHashInput_10==null) {
	throw new RuntimeException("The hash is not initialized : The hash must exist before you read from it");
}
java.util.Iterator<MEDIA_VENDAStruct> iterator_tHashInput_10 = tHashFile_tHashInput_10.iterator();
while (iterator_tHashInput_10.hasNext()) {
    MEDIA_VENDAStruct next_tHashInput_10 = iterator_tHashInput_10.next();

	row14.EMPRESA = next_tHashInput_10.EMPRESA;
	row14.COD_ITEM = next_tHashInput_10.COD_ITEM;
	row14.MEDIA_VENDA = next_tHashInput_10.MEDIA_VENDA;
 ...
 */
	...
	currentComponent="tAdvancedHash_row14";
				...
				row14_HashRow.EMPRESA = row14.EMPRESA;
				
				row14_HashRow.COD_ITEM = row14.COD_ITEM;
				
				row14_HashRow.MEDIA_VENDA = row14.MEDIA_VENDA;
 ...
 */
	...
	currentComponent="tHashInput_10";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_integracao_estoque_streaming_" + pid +"_tHashOutput_4");
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_3=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_3 = "tHashFile_integracao_estoque_streaming_" + pid + "_tHashOutput_3";
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_7=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_7 = "tHashFile_integracao_estoque_streaming_" + pid + "_tHashOutput_7";
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row3Struct> tHashFile_tHashInput_2 = mf_tHashInput_2.getAdvancedMemoryHashFile("tHashFile_integracao_estoque_streaming_" + pid +"_tHashOutput_3");
 ...
 */
	...
	currentComponent="tHashInput_2";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_integracao_estoque_streaming_" + pid +"_tHashOutput_3");
...
public static class MEDIA_VENDAStruct implements routines.system.IPersistableRow<MEDIA_VENDAStruct> {
    final static byte[] commonByteArrayLock_PALACIO_FERRAMENTAS_integracao_estoque_streaming = new byte[0];
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_integracao_estoque_streaming = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(MEDIA_VENDAStruct other) {
...
MEDIA_VENDAStruct MEDIA_VENDA = new MEDIA_VENDAStruct();
	...
	currentComponent="tHashOutput_4";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"MEDIA_VENDA");
					}
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_4=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<MEDIA_VENDAStruct> tHashFile_tHashOutput_4 = null;
		String hashKey_tHashOutput_4 = "tHashFile_integracao_estoque_streaming_" + pid + "_tHashOutput_4";
			synchronized(org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.get(hashKey_tHashOutput_4)){
			    if(mf_tHashOutput_4.getResourceMap().get(hashKey_tHashOutput_4) == null){
	      		    mf_tHashOutput_4.getResourceMap().put(hashKey_tHashOutput_4, new org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<MEDIA_VENDAStruct>(org.talend.designer.components.hashfile.common.MATCHING_MODE.KEEP_ALL));
...
// ###############################
// # Outputs initialization
MEDIA_VENDAStruct MEDIA_VENDA_tmp = new MEDIA_VENDAStruct();
// ###############################
 ...
 */
	...
	currentComponent="tDBInput_3";
		...
		int tos_count_tDBInput_3 = 0;
		    ...
		    String dbquery_tDBInput_3 = "\n  SELECT EMPRESA,    \n		 FAT.COD_ITEM,\n		 ROUND(SUM(FAT.QTD_ITEM)/90) AS MEDIA_VENDA\n   FROM VW_FATURAMENTO FAT\n "
+" WHERE FAT.DATA >= SUBDATE(CURDATE(),90)\n  AND FAT.TOTAL_VENDA > 0\n  AND EMPRESA = '001'\n-- AND COD_ITEM  IN ('62969'"
+")\nGROUP BY EMPRESA, FAT.COD_ITEM\n";
        	...
        	row12.EMPRESA = routines.system.JDBCUtil.getString(rs_tDBInput_3, 1, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 2) {
								row12.COD_ITEM = null;
							} else {
	                         		
        	row12.COD_ITEM = routines.system.JDBCUtil.getString(rs_tDBInput_3, 2, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 3) {
								row12.MEDIA_VENDA = null;
							} else {
		                          
            row12.MEDIA_VENDA = rs_tDBInput_3.getInt(3);
...
// # Output table : 'MEDIA_VENDA'
MEDIA_VENDA_tmp.EMPRESA = row12.EMPRESA;
MEDIA_VENDA_tmp.COD_ITEM = row12.COD_ITEM;
MEDIA_VENDA_tmp.MEDIA_VENDA = row12.MEDIA_VENDA;
MEDIA_VENDA = MEDIA_VENDA_tmp;
// ###############################
...
if(MEDIA_VENDA != null) { 
	...
	currentComponent="tHashOutput_4";
		...
		MEDIA_VENDAStruct oneRow_tHashOutput_4 = new MEDIA_VENDAStruct();
				
					oneRow_tHashOutput_4.EMPRESA = MEDIA_VENDA.EMPRESA;
					oneRow_tHashOutput_4.COD_ITEM = MEDIA_VENDA.COD_ITEM;
					oneRow_tHashOutput_4.MEDIA_VENDA = MEDIA_VENDA.MEDIA_VENDA;
...
globalMap.put("tHashOutput_4_NB_LINE", nb_line_tHashOutput_4);
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"MEDIA_VENDA");
			  	}
 ...
 */
    ...
    public static void main(String[] args){
        final integracao_estoque_streaming integracao_estoque_streamingClass = new integracao_estoque_streaming();

        int exitCode = integracao_estoque_streamingClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = integracao_estoque_streaming.class.getClassLoader().getResourceAsStream("palacio_ferramentas/integracao_estoque_streaming_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = integracao_estoque_streaming.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : integracao_estoque_streaming");
        }
...
/************************************************************************************************
 *     876737 characters generated by Talend Open Studio for Big Data 
 *     on the 18 de outubro de 2024 08:56:09 BRT
 ************************************************************************************************/