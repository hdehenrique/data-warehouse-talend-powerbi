...
package palacio_ferramentas.dw_autovacuum_0_1;
...
public String getAUTCOM_USER(){
	...
	private final String jobName = "dw_autovacuum";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				dw_autovacuum.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(dw_autovacuum.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row5Struct implements routines.system.IPersistableRow<row5Struct> {
    final static byte[] commonByteArrayLock_PALACIO_FERRAMENTAS_dw_autovacuum = new byte[0];
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_dw_autovacuum = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PALACIO_FERRAMENTAS_dw_autovacuum.length) {
				if(length < 1024 && commonByteArray_PALACIO_FERRAMENTAS_dw_autovacuum.length == 0) {
   					commonByteArray_PALACIO_FERRAMENTAS_dw_autovacuum = new byte[1024];
				} else {
   					commonByteArray_PALACIO_FERRAMENTAS_dw_autovacuum = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PALACIO_FERRAMENTAS_dw_autovacuum, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_dw_autovacuum, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PALACIO_FERRAMENTAS_dw_autovacuum, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_dw_autovacuum, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PALACIO_FERRAMENTAS_dw_autovacuum) {
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_1=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_1 = "tHashFile_dw_autovacuum_" + pid + "_tHashOutput_1";
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row5Struct> tHashFile_tHashInput_1 = mf_tHashInput_1.getAdvancedMemoryHashFile("tHashFile_dw_autovacuum_" + pid +"_tHashOutput_1");
 ...
 */
	...
	currentComponent="tHashInput_1";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_dw_autovacuum_" + pid +"_tHashOutput_1");
 ...
 */
    ...
    public static void main(String[] args){
        final dw_autovacuum dw_autovacuumClass = new dw_autovacuum();

        int exitCode = dw_autovacuumClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = dw_autovacuum.class.getClassLoader().getResourceAsStream("palacio_ferramentas/dw_autovacuum_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = dw_autovacuum.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dw_autovacuum");
        }
...
/************************************************************************************************
 *     145881 characters generated by Talend Open Studio for Big Data 
 *     on the 7 de março de 2025 18:24:39 BRT
 ************************************************************************************************/