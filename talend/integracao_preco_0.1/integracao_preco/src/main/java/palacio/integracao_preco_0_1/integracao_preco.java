...
package palacio.integracao_preco_0_1;
...
public static class row16Struct implements routines.system.IPersistableRow<row16Struct> {
    final static byte[] commonByteArrayLock_PALACIO_integracao_preco = new byte[0];
    static byte[] commonByteArray_PALACIO_integracao_preco = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PALACIO_integracao_preco.length) {
				if(length < 1024 && commonByteArray_PALACIO_integracao_preco.length == 0) {
   					commonByteArray_PALACIO_integracao_preco = new byte[1024];
				} else {
   					commonByteArray_PALACIO_integracao_preco = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PALACIO_integracao_preco, 0, length);
			strReturn = new String(commonByteArray_PALACIO_integracao_preco, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PALACIO_integracao_preco, 0, length);
			strReturn = new String(commonByteArray_PALACIO_integracao_preco, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PALACIO_integracao_preco) {
 ...
 */
	...
	currentComponent="tUnite_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"row11","row12","row13","row25","row24");
					}
...
globalMap.put("tUnite_1_NB_LINE", nb_line_tUnite_1);
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"row11","row12","row13","row25","row24");
			  	}
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		palacio.integracao_preco_amazom_0_1.integracao_preco_amazom childJob_tRunJob_1 = new palacio.integracao_preco_amazom_0_1.integracao_preco_amazom();
	    // pass DataSources
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = integracao_preco.class.getClassLoader().getResourceAsStream("palacio/integracao_preco_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     666009 characters generated by Talend Open Studio for Big Data 
 *     on the 22 de abril de 2024 09:47:13 BRT
 ************************************************************************************************/