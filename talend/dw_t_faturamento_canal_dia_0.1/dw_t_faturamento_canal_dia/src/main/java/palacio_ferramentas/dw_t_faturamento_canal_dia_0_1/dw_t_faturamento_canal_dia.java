...
package palacio_ferramentas.dw_t_faturamento_canal_dia_0_1;
...
/**
 * Job: dw_t_faturamento_canal_dia Purpose: <br>
 * Description:  <br>
 * @author henriquesantos@palaciodasferramentas.com.br
 * @version 8.0.1.20230922_0317-SNAPSHOT
 * @status 
 */
public class dw_t_faturamento_canal_dia implements TalendJob {
...
public String getPOSTGRES_PASSWORD(){
	...
	private final String jobName = "dw_t_faturamento_canal_dia";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				dw_t_faturamento_canal_dia.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(dw_t_faturamento_canal_dia.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_PALACIO_FERRAMENTAS_dw_t_faturamento_canal_dia = new byte[0];
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_dw_t_faturamento_canal_dia = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PALACIO_FERRAMENTAS_dw_t_faturamento_canal_dia.length) {
				if(length < 1024 && commonByteArray_PALACIO_FERRAMENTAS_dw_t_faturamento_canal_dia.length == 0) {
   					commonByteArray_PALACIO_FERRAMENTAS_dw_t_faturamento_canal_dia = new byte[1024];
				} else {
   					commonByteArray_PALACIO_FERRAMENTAS_dw_t_faturamento_canal_dia = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PALACIO_FERRAMENTAS_dw_t_faturamento_canal_dia, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_dw_t_faturamento_canal_dia, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PALACIO_FERRAMENTAS_dw_t_faturamento_canal_dia, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_dw_t_faturamento_canal_dia, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PALACIO_FERRAMENTAS_dw_t_faturamento_canal_dia) {
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_1=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_1 = "tHashFile_dw_t_faturamento_canal_dia_" + pid + "_tHashOutput_1";
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_5=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_5 = "tHashFile_dw_t_faturamento_canal_dia_" + pid + "_tHashOutput_5";
...
+"OME_VENDEDOR CANAL,\n	   FAT.EMPRESA EMPRESA,\n	   	   (\n	SELECT\n		F.FOR_NOMFOR\n	FROM\n		CADFOR F\n	WHERE\n		FAT.COD_"
+"FORNECEDOR = F.FOR_CODFOR) FORNECEDOR,\n	   (\n	SELECT\n		M.MAR_DESMAR\n	FROM\n		CADMAR M\n	WHERE\n		M.MAR_CODMAR = ITEM"
+".ITE_CODMAR) MARCA,\n	   (\n	SELECT\n		CL.GRU_DESGRU\n	FROM\n		CADGRU CL\n	WHERE\n		CL.GRU_CODGRU = CONCAT(LEFT(ITEM.ITE"
+"_CODGRU, 3), '000')) CATEGORIA,\n	SUM(FAT.TOTAL_VENDA) FATURAMENTO,\n	SUM(FAT.QTD_ITEM) QTD_PECAS\nFROM\n	VW_FATURAMENTO"
+" FAT,\n	   CADITE ITEM\nWHERE\n	FAT.COD_ITEM = ITEM.ITE_CODITE\n	AND FAT.DATA_ANO >= YEAR(SUBDATE(CURDATE(), 1))\n	AND F"
+"AT.DATA_MES >= MONTH(SUBDATE(CURDATE(), 1))\n	AND FAT.DATA = SUBDATE(CURDATE(), 1)\nGROUP BY FAT.COD_ITEM, FAT.NOME_VEND"
+"EDOR,	DATA;\n";
		    ...
		    while (rs_tDBInput_3.next()) {
				...
				if(rs_tDBInput_3.getString(1) != null) {
					...
					if (!("0000-00-00").equals(dateString_tDBInput_3) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_3)) {
						row1.DATA = rs_tDBInput_3.getTimestamp(1);
					} else {
						row1.DATA = (java.util.Date) year0_tDBInput_3.clone();
					}
				} else {
					row1.DATA =  null;
				}
 ...
 */
	...
	currentComponent="tHashOutput_5";
		...
		row1Struct oneRow_tHashOutput_5 = new row1Struct();
					...
					oneRow_tHashOutput_5.DATA = row1.DATA;
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_6=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_6 = "tHashFile_dw_t_faturamento_canal_dia_" + pid + "_tHashOutput_6";
...
if(dbschema_tDBOutput_4 == null || dbschema_tDBOutput_4.trim().length() == 0) {
	tableName_tDBOutput_4 = ("dw_t_faturamento_canal_dia").toLowerCase();
} else {
	tableName_tDBOutput_4 = dbschema_tDBOutput_4 + "\".\"" + ("dw_t_faturamento_canal_dia").toLowerCase();
}
...
int count_tDBOutput_4=0;
        ...
        sb_tDBOutput_4.append("INSERT INTO \"").append(tableName_tDBOutput_4).append("\" (\"data\",\"empresa\",\"sku\",\"descricao\",\"curva\",\"cod_vendedor\",\"canal\",\"fornecedor\",\"marca\",\"categoria\",\"faturamento\",\"qtd_pecas\",\"dt_ult_atualizacao\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row1Struct> tHashFile_tHashInput_6 = mf_tHashInput_6.getAdvancedMemoryHashFile("tHashFile_dw_t_faturamento_canal_dia_" + pid +"_tHashOutput_5");
...
while (iterator_tHashInput_6.hasNext()) {
	...
	row12.DATA = next_tHashInput_6.DATA;
...
if(insert != null) { 
	...
	currentComponent="tDBOutput_4";
        ...
        whetherReject_tDBOutput_4 = false;
                    if(insert.DATA != null) {
pstmt_tDBOutput_4.setTimestamp(1, new java.sql.Timestamp(insert.DATA.getTime()));
} else {
 ...
 */
	...
	currentComponent="tHashInput_6";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_dw_t_faturamento_canal_dia_" + pid +"_tHashOutput_5");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row4Struct> tHashFile_tHashInput_1 = mf_tHashInput_1.getAdvancedMemoryHashFile("tHashFile_dw_t_faturamento_canal_dia_" + pid +"_tHashOutput_1");
 ...
 */
	...
	currentComponent="tHashInput_1";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_dw_t_faturamento_canal_dia_" + pid +"_tHashOutput_1");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row3Struct> tHashFile_tHashInput_7 = mf_tHashInput_7.getAdvancedMemoryHashFile("tHashFile_dw_t_faturamento_canal_dia_" + pid +"_tHashOutput_6");
 ...
 */
	...
	currentComponent="tHashInput_7";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_dw_t_faturamento_canal_dia_" + pid +"_tHashOutput_6");
 ...
 */
    ...
    public static void main(String[] args){
        final dw_t_faturamento_canal_dia dw_t_faturamento_canal_diaClass = new dw_t_faturamento_canal_dia();

        int exitCode = dw_t_faturamento_canal_diaClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = dw_t_faturamento_canal_dia.class.getClassLoader().getResourceAsStream("palacio_ferramentas/dw_t_faturamento_canal_dia_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = dw_t_faturamento_canal_dia.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dw_t_faturamento_canal_dia");
        }
...
/************************************************************************************************
 *     335813 characters generated by Talend Open Studio for Big Data 
 *     on the 15 de janeiro de 2025 14:35:00 BRT
 ************************************************************************************************/