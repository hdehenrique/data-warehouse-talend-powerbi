...
package palacio_ferramentas.vw_pedidos_pendentes_0_1;
...
/**
 * Job: vw_pedidos_pendentes Purpose: <br>
 * Description:  <br>
 * @author talend@talend.com
 * @version 8.0.1.20230922_0317-SNAPSHOT
 * @status 
 */
public class vw_pedidos_pendentes implements TalendJob {
...
public String getPOSTGRES_USER(){
	...
	private final String jobName = "vw_pedidos_pendentes";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				vw_pedidos_pendentes.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(vw_pedidos_pendentes.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_PALACIO_FERRAMENTAS_vw_pedidos_pendentes = new byte[0];
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_vw_pedidos_pendentes = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PALACIO_FERRAMENTAS_vw_pedidos_pendentes.length) {
				if(length < 1024 && commonByteArray_PALACIO_FERRAMENTAS_vw_pedidos_pendentes.length == 0) {
   					commonByteArray_PALACIO_FERRAMENTAS_vw_pedidos_pendentes = new byte[1024];
				} else {
   					commonByteArray_PALACIO_FERRAMENTAS_vw_pedidos_pendentes = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PALACIO_FERRAMENTAS_vw_pedidos_pendentes, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_vw_pedidos_pendentes, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PALACIO_FERRAMENTAS_vw_pedidos_pendentes, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_vw_pedidos_pendentes, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PALACIO_FERRAMENTAS_vw_pedidos_pendentes) {
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_1=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_1 = "tHashFile_vw_pedidos_pendentes_" + pid + "_tHashOutput_1";
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    ...
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_vw_pedidos_pendentes = new byte[0];
				...
				public Boolean PEDIDOIsNullable(){
				    return true;
				}
				public Boolean PEDIDOIsKey(){
				    return false;
				}
				public Integer PEDIDOLength(){
				    return 12;
				}
				public Integer PEDIDOPrecision(){
				    return 0;
				}
				public String PEDIDODefault(){
				
					return null;
				
				}
				public String PEDIDOComment(){
				
				    return "";
				
				}
				public String PEDIDOPattern(){
				
					return "";
				
				}
				public String PEDIDOOriginalDbColumnName(){
			    ...
			    public Integer QTD_RECEBIDO;

				public Integer getQTD_RECEBIDO () {
					return this.QTD_RECEBIDO;
				}

				public Boolean QTD_RECEBIDOIsNullable(){
				    return true;
				}
				public Boolean QTD_RECEBIDOIsKey(){
				    return false;
				}
				public Integer QTD_RECEBIDOLength(){
				    return 12;
				}
				public Integer QTD_RECEBIDOPrecision(){
				    return null;
				}
				public String QTD_RECEBIDODefault(){
				
					return null;
				
				}
				public String QTD_RECEBIDOComment(){
				
				    return "";
				
				}
				public String QTD_RECEBIDOPattern(){
				
					return "";
				
				}
				public String QTD_RECEBIDOOriginalDbColumnName(){
			    ...
			    public Integer QTD_ABERTO;

				public Integer getQTD_ABERTO () {
					return this.QTD_ABERTO;
				}

				public Boolean QTD_ABERTOIsNullable(){
				    return true;
				}
				public Boolean QTD_ABERTOIsKey(){
				    return false;
				}
				public Integer QTD_ABERTOLength(){
				    return 13;
				}
				public Integer QTD_ABERTOPrecision(){
				    return null;
				}
				public String QTD_ABERTODefault(){
				
					return null;
				
				}
				public String QTD_ABERTOComment(){
				
				    return "";
				
				}
				public String QTD_ABERTOPattern(){
				
					return "";
				
				}
				public String QTD_ABERTOOriginalDbColumnName(){
				...
				public Boolean COMPRADORIsNullable(){
				    return true;
				}
				public Boolean COMPRADORIsKey(){
				    return false;
				}
				public Integer COMPRADORLength(){
				    return 34;
				}
				public Integer COMPRADORPrecision(){
				    return null;
				}
				public String COMPRADORDefault(){
				
					return null;
				
				}
				public String COMPRADORComment(){
				
				    return "";
				
				}
				public String COMPRADORPattern(){
				
					return "";
				
				}
				public String COMPRADOROriginalDbColumnName(){
			    ...
			    public java.util.Date DATA_PREVISAO;

				public java.util.Date getDATA_PREVISAO () {
					return this.DATA_PREVISAO;
				}

				public Boolean DATA_PREVISAOIsNullable(){
				    return true;
				}
				public Boolean DATA_PREVISAOIsKey(){
				    return false;
				}
				public Integer DATA_PREVISAOLength(){
				    return null;
				}
				public Integer DATA_PREVISAOPrecision(){
				    return null;
				}
				public String DATA_PREVISAODefault(){
				
					return null;
				
				}
				public String DATA_PREVISAOComment(){
				
				    return "";
				
				}
				public String DATA_PREVISAOPattern(){
				
					return "dd-MM-yyyy";
				
				}
				public String DATA_PREVISAOOriginalDbColumnName(){
			    ...
			    public java.util.Date DATA_PEDIDO;

				public java.util.Date getDATA_PEDIDO () {
		...
		synchronized(commonByteArrayLock_PALACIO_FERRAMENTAS_vw_pedidos_pendentes) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.PEDIDO = readString(dis);
					
						this.QTD_RECEBIDO = readInteger(dis);
					
						this.QTD_ABERTO = readInteger(dis);
					
					this.FORNECEDOR = readString(dis);
					
					this.COMPRADOR = readString(dis);
					
					this.DATA_PREVISAO = readDate(dis);
					
					this.DATA_PEDIDO = readDate(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.PEDIDO,dos);
					
					// Integer
				
						writeInteger(this.QTD_RECEBIDO,dos);
					
					// Integer
				
						writeInteger(this.QTD_ABERTO,dos);
					...
					// String
						...
						writeString(this.COMPRADOR,dos);
					
					// java.util.Date
				
						writeDate(this.DATA_PREVISAO,dos);
					
					// java.util.Date
				
						writeDate(this.DATA_PEDIDO,dos);
    ...
    public String toString() {
		...
		sb.append(",QTD_RECEBIDO="+String.valueOf(QTD_RECEBIDO));
		sb.append(",QTD_ABERTO="+String.valueOf(QTD_ABERTO));
		sb.append(",FORNECEDOR="+FORNECEDOR);
		sb.append(",COMPRADOR="+COMPRADOR);
		sb.append(",DATA_PREVISAO="+String.valueOf(DATA_PREVISAO));
		sb.append(",DATA_PEDIDO="+String.valueOf(DATA_PEDIDO));
...
if(dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
	tableName_tDBOutput_2 = ("vw_pedidos_pendentes").toLowerCase();
} else {
	tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "\".\"" + ("vw_pedidos_pendentes").toLowerCase();
}
...
int count_tDBOutput_2=0;
        ...
        sb_tDBOutput_2.append("INSERT INTO \"").append(tableName_tDBOutput_2).append("\" (\"item\",\"pedido\",\"qtd_recebido\",\"qtd_aberto\",\"fornecedor\",\"comprador\",\"data_previsao\",\"data_pedido\",\"codigo_empresa\") VALUES (?,?,?,?,?,?,?,?,?)");
...
+"ATE(CURDATE(),180)";
        	...
        	row1.ITEM = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								row1.PEDIDO = null;
							} else {
	                         		
        	row1.PEDIDO = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 3) {
								row1.QTD_RECEBIDO = null;
							} else {
		                          
            row1.QTD_RECEBIDO = rs_tDBInput_1.getInt(3);
            if(rs_tDBInput_1.wasNull()){
                    row1.QTD_RECEBIDO = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 4) {
								row1.QTD_ABERTO = null;
							} else {
		                          
            row1.QTD_ABERTO = rs_tDBInput_1.getInt(4);
            if(rs_tDBInput_1.wasNull()){
                    row1.QTD_ABERTO = null;
            }
		                    }
        	...
        	row1.FORNECEDOR = routines.system.JDBCUtil.getString(rs_tDBInput_1, 5, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 6) {
								row1.COMPRADOR = null;
							} else {
	                         		
        	row1.COMPRADOR = routines.system.JDBCUtil.getString(rs_tDBInput_1, 6, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 7) {
								row1.DATA_PREVISAO = null;
							} else {
				...
				if(rs_tDBInput_1.getString(7) != null) {
					...
					if (!("0000-00-00").equals(dateString_tDBInput_1) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_1)) {
						row1.DATA_PREVISAO = rs_tDBInput_1.getTimestamp(7);
					} else {
						row1.DATA_PREVISAO = (java.util.Date) year0_tDBInput_1.clone();
					}
				} else {
					row1.DATA_PREVISAO =  null;
				}
							...
							if(colQtyInRs_tDBInput_1 < 8) {
								row1.DATA_PEDIDO = null;
							} else {
										
				if(rs_tDBInput_1.getString(8) != null) {
					String dateString_tDBInput_1 = rs_tDBInput_1.getString(8);
					if (!("0000-00-00").equals(dateString_tDBInput_1) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_1)) {
						row1.DATA_PEDIDO = rs_tDBInput_1.getTimestamp(8);
					} else {
						row1.DATA_PEDIDO = (java.util.Date) year0_tDBInput_1.clone();
					}
				} else {
					row1.DATA_PEDIDO =  null;
				}
							...
							if(colQtyInRs_tDBInput_1 < 9) {
								row1.CODIGO_EMPRESA = null;
							} else {
	                         		
        	row1.CODIGO_EMPRESA = routines.system.JDBCUtil.getString(rs_tDBInput_1, 9, false);
		                    }
...
} else {pstmt_tDBOutput_2.setString(1, row1.ITEM);
}

                    if(row1.PEDIDO == null) {
pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(2, row1.PEDIDO);
}

                    if(row1.QTD_RECEBIDO == null) {
pstmt_tDBOutput_2.setNull(3, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_2.setInt(3, row1.QTD_RECEBIDO);
}

                    if(row1.QTD_ABERTO == null) {
pstmt_tDBOutput_2.setNull(4, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_2.setInt(4, row1.QTD_ABERTO);
}

                    if(row1.FORNECEDOR == null) {
pstmt_tDBOutput_2.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(5, row1.FORNECEDOR);
}

                    if(row1.COMPRADOR == null) {
pstmt_tDBOutput_2.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(6, row1.COMPRADOR);
}

                    if(row1.DATA_PREVISAO != null) {
pstmt_tDBOutput_2.setTimestamp(7, new java.sql.Timestamp(row1.DATA_PREVISAO.getTime()));
} else {
pstmt_tDBOutput_2.setNull(7, java.sql.Types.TIMESTAMP);
}

                    if(row1.DATA_PEDIDO != null) {
pstmt_tDBOutput_2.setTimestamp(8, new java.sql.Timestamp(row1.DATA_PEDIDO.getTime()));
} else {
pstmt_tDBOutput_2.setNull(8, java.sql.Types.TIMESTAMP);
}

                    if(row1.CODIGO_EMPRESA == null) {
pstmt_tDBOutput_2.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(9, row1.CODIGO_EMPRESA);
}
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row4Struct> tHashFile_tHashInput_1 = mf_tHashInput_1.getAdvancedMemoryHashFile("tHashFile_vw_pedidos_pendentes_" + pid +"_tHashOutput_1");
 ...
 */
	...
	currentComponent="tHashInput_1";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_vw_pedidos_pendentes_" + pid +"_tHashOutput_1");
 ...
 */
    ...
    public static void main(String[] args){
        final vw_pedidos_pendentes vw_pedidos_pendentesClass = new vw_pedidos_pendentes();

        int exitCode = vw_pedidos_pendentesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = vw_pedidos_pendentes.class.getClassLoader().getResourceAsStream("palacio_ferramentas/vw_pedidos_pendentes_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = vw_pedidos_pendentes.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : vw_pedidos_pendentes");
        }
...
/************************************************************************************************
 *     186155 characters generated by Talend Open Studio for Big Data 
 *     on the 20 de maio de 2024 15:29:21 BRT
 ************************************************************************************************/