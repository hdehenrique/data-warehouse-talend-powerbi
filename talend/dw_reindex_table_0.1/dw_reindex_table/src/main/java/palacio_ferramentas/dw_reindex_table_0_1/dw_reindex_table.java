...
package palacio_ferramentas.dw_reindex_table_0_1;
...
public String getAUTCOM_USER(){
	...
	private final String jobName = "dw_reindex_table";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				dw_reindex_table.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(dw_reindex_table.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row5Struct implements routines.system.IPersistableRow<row5Struct> {
    final static byte[] commonByteArrayLock_PALACIO_FERRAMENTAS_dw_reindex_table = new byte[0];
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_dw_reindex_table = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PALACIO_FERRAMENTAS_dw_reindex_table.length) {
				if(length < 1024 && commonByteArray_PALACIO_FERRAMENTAS_dw_reindex_table.length == 0) {
   					commonByteArray_PALACIO_FERRAMENTAS_dw_reindex_table = new byte[1024];
				} else {
   					commonByteArray_PALACIO_FERRAMENTAS_dw_reindex_table = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PALACIO_FERRAMENTAS_dw_reindex_table, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_dw_reindex_table, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PALACIO_FERRAMENTAS_dw_reindex_table, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_dw_reindex_table, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PALACIO_FERRAMENTAS_dw_reindex_table) {
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_1=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_1 = "tHashFile_dw_reindex_table_" + pid + "_tHashOutput_1";
...
query_tDBRow_1 = "\nreindex table dw_t_indicador_estoque_diario;\ncommit;\nreindex table stg_movdet ;\nreindex table stg_movger ;\nreinde"
+"x table vw_faturamento_compras ;\nreindex table vw_faturamento ;\nreindex table stg_fatgor ;\nreindex table stg_fatdor ;"
+"\nreindex table gr_media_tempo ;\nreindex table dw_t_fato_venda ;\nreindex table dw_t_cliente ;\nreindex table dw_t_pedi"
+"do ;\nreindex table dw_t_item_pedido ;\nreindex table bi_t_cliente ;\nreindex table stg_t_produto_empresa ;\nreindex tab"
+"le dw_t_produto_empresa;\nreindex table stg_cadpag ;\nreindex table bi_painel_controle_vendas ;\nreindex table dw_t_esto"
+"que_valor ;\nreindex table dw_t_faturamento_canal_dia ;\ncommit;\nreindex table vw_custo_efetivo_mg;\nreindex table vw_c"
+"usto_efetivo;\ncommit;\n";
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row5Struct> tHashFile_tHashInput_1 = mf_tHashInput_1.getAdvancedMemoryHashFile("tHashFile_dw_reindex_table_" + pid +"_tHashOutput_1");
 ...
 */
	...
	currentComponent="tHashInput_1";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_dw_reindex_table_" + pid +"_tHashOutput_1");
 ...
 */
    ...
    public static void main(String[] args){
        final dw_reindex_table dw_reindex_tableClass = new dw_reindex_table();

        int exitCode = dw_reindex_tableClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = dw_reindex_table.class.getClassLoader().getResourceAsStream("palacio_ferramentas/dw_reindex_table_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = dw_reindex_table.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dw_reindex_table");
        }
...
/************************************************************************************************
 *     146865 characters generated by Talend Open Studio for Big Data 
 *     on the 15 de abril de 2025 22:45:40 BRT
 ************************************************************************************************/