...
package palacio_ferramentas.vw_custo_efetivo_0_1;
...
/**
 * Job: vw_custo_efetivo Purpose: <br>
 * Description:  <br>
 * @author talend@talend.com
 * @version 8.0.1.20230922_0317-SNAPSHOT
 * @status 
 */
public class vw_custo_efetivo implements TalendJob {
...
public Integer getDias(){
	...
	private final String jobName = "vw_custo_efetivo";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				vw_custo_efetivo.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(vw_custo_efetivo.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class map3Struct implements routines.system.IPersistableRow<map3Struct> {
    final static byte[] commonByteArrayLock_PALACIO_FERRAMENTAS_vw_custo_efetivo = new byte[0];
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_vw_custo_efetivo = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PALACIO_FERRAMENTAS_vw_custo_efetivo) {
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_1=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_1 = "tHashFile_vw_custo_efetivo_" + pid + "_tHashOutput_1";
 ...
 */
	...
	currentComponent="tDBInput_1";
		...
		int tos_count_tDBInput_1 = 0;
		    ...
		    String dbquery_tDBInput_1 = "\nSELECT YEAR(CURRENT_DATE()) ANO, (MONTH(CURRENT_DATE()) ) MES, SUBDATE(CURDATE(), 2)PARAMETRO, NOW() AS DATA_START\n"
+"\n";
...
public static class row5Struct implements routines.system.IPersistableRow<row5Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PALACIO_FERRAMENTAS_vw_custo_efetivo.length) {
				if(length < 1024 && commonByteArray_PALACIO_FERRAMENTAS_vw_custo_efetivo.length == 0) {
   					commonByteArray_PALACIO_FERRAMENTAS_vw_custo_efetivo = new byte[1024];
				} else {
   					commonByteArray_PALACIO_FERRAMENTAS_vw_custo_efetivo = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PALACIO_FERRAMENTAS_vw_custo_efetivo, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_vw_custo_efetivo, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PALACIO_FERRAMENTAS_vw_custo_efetivo, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_vw_custo_efetivo, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_2=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_2 = "tHashFile_vw_custo_efetivo_" + pid + "_tHashOutput_2";
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row8Struct> tHashFile_tHashInput_1 = mf_tHashInput_1.getAdvancedMemoryHashFile("tHashFile_vw_custo_efetivo_" + pid +"_tHashOutput_1");
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_6=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_6 = "tHashFile_vw_custo_efetivo_" + pid + "_tHashOutput_6";
...
+"TDENT	,\nCSTENT	,\nTOTENT	,\nICMENT	,\nRETENT	,\nIPIENT	,\nP_CENT	,\nLIQENT	,\nVAL_ST	,\nVAL_OP	,\nVALORES	,\nVALCOM	,\n"
+"ICMEN2	,\nRESSAR	,\nMAROPE	,\nPERMAR	,\nCSTCOM	,\nCST1	,\nCST2	,\nMAROPE_MG	,\nPERMAR_MG	,\nRESSA2	,\nIPISAI	,\nVLRVII	,"
+"\nCODIGO_PRODUTO,\nName_exp_43,\nName_exp_44\nFROM VW_CUSTO_EFETIVO\n WHERE DTASAI >= DATE_SUB(CURDATE(), INTERVAL 2 DAY"
+");\n\n";
        	...
        	row16.NUMPED = routines.system.JDBCUtil.getString(rs_tDBInput_5, 2, false);
		                    }
							if(colQtyInRs_tDBInput_5 < 3) {
								row16.ESTADO = null;
							} else {
	                         		
        	row16.ESTADO = routines.system.JDBCUtil.getString(rs_tDBInput_5, 3, false);
		                    }
							if(colQtyInRs_tDBInput_5 < 4) {
								row16.CODVEN = null;
							} else {
	                         		
        	row16.CODVEN = routines.system.JDBCUtil.getString(rs_tDBInput_5, 4, false);
		                    }
							if(colQtyInRs_tDBInput_5 < 5) {
								row16.VLRTNF = null;
							} else {
		                          
            row16.VLRTNF = rs_tDBInput_5.getBigDecimal(5);
            if(rs_tDBInput_5.wasNull()){
				...
				if(rs_tDBInput_5.getString(6) != null) {
					...
					if (!("0000-00-00").equals(dateString_tDBInput_5) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_5)) {
						row16.DTASAI = rs_tDBInput_5.getTimestamp(6);
					} else {
        	...
        	row16.CODITE = routines.system.JDBCUtil.getString(rs_tDBInput_5, 7, false);
		                    }
							if(colQtyInRs_tDBInput_5 < 8) {
								row16.CODMAR = null;
							} else {
	                         		
        	row16.CODMAR = routines.system.JDBCUtil.getString(rs_tDBInput_5, 8, false);
		                    }
							if(colQtyInRs_tDBInput_5 < 9) {
								row16.DESCRI = null;
							} else {
	                         		
        	row16.DESCRI = routines.system.JDBCUtil.getString(rs_tDBInput_5, 9, false);
		                    }
							if(colQtyInRs_tDBInput_5 < 10) {
								row16.QTDSAI = null;
							} else {
		                          
            row16.QTDSAI = rs_tDBInput_5.getBigDecimal(10);
            if(rs_tDBInput_5.wasNull()){
                    row16.QTDSAI = null;
            }
		                    }
            ...
            row16.UNISAI = rs_tDBInput_5.getBigDecimal(11);
            if(rs_tDBInput_5.wasNull()){
                    row16.UNISAI = null;
            }
		                    }
            ...
            row16.TOTSAI = rs_tDBInput_5.getBigDecimal(12);
            if(rs_tDBInput_5.wasNull()){
                    row16.TOTSAI = null;
            }
		                    }
            ...
            row16.ICMSAI = rs_tDBInput_5.getBigDecimal(13);
            if(rs_tDBInput_5.wasNull()){
                    row16.ICMSAI = null;
            }
		                    }
            ...
            row16.FCPSAI = rs_tDBInput_5.getBigDecimal(14);
            if(rs_tDBInput_5.wasNull()){
                    row16.FCPSAI = null;
            }
		                    }
            ...
            row16.RETSAI = rs_tDBInput_5.getBigDecimal(15);
            if(rs_tDBInput_5.wasNull()){
                    row16.RETSAI = null;
            }
		                    }
            ...
            row16.TOTFRE = rs_tDBInput_5.getBigDecimal(16);
            if(rs_tDBInput_5.wasNull()){
            ...
            row16.P_CSAI = rs_tDBInput_5.getBigDecimal(17);
            if(rs_tDBInput_5.wasNull()){
                    row16.P_CSAI = null;
            }
		                    }
            ...
            row16.DIFSAI = rs_tDBInput_5.getBigDecimal(18);
            if(rs_tDBInput_5.wasNull()){
                    row16.DIFSAI = null;
            }
		                    }
            ...
            row16.LIQSAI2 = rs_tDBInput_5.getBigDecimal(19);
            if(rs_tDBInput_5.wasNull()){
                    row16.LIQSAI2 = null;
            }
		                    }
        	...
        	row16.TESTE = routines.system.JDBCUtil.getString(rs_tDBInput_5, 20, false);
		                    }
							if(colQtyInRs_tDBInput_5 < 21) {
								row16.LIQSAI = null;
							} else {
		                          
            row16.LIQSAI = rs_tDBInput_5.getBigDecimal(21);
            if(rs_tDBInput_5.wasNull()){
                    row16.LIQSAI = null;
            }
		                    }
        	...
        	row16.NUMENT = routines.system.JDBCUtil.getString(rs_tDBInput_5, 22, false);
		                    }
							if(colQtyInRs_tDBInput_5 < 23) {
								row16.DTAENT = null;
							} else {
										
				if(rs_tDBInput_5.getString(23) != null) {
					String dateString_tDBInput_5 = rs_tDBInput_5.getString(23);
					if (!("0000-00-00").equals(dateString_tDBInput_5) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_5)) {
						row16.DTAENT = rs_tDBInput_5.getTimestamp(23);
					} else {
            ...
            row16.QTDENT = rs_tDBInput_5.getBigDecimal(24);
            if(rs_tDBInput_5.wasNull()){
                    row16.QTDENT = null;
            }
		                    }
        	...
        	row16.CSTENT = routines.system.JDBCUtil.getString(rs_tDBInput_5, 25, false);
		                    }
							if(colQtyInRs_tDBInput_5 < 26) {
								row16.TOTENT = null;
							} else {
		                          
            row16.TOTENT = rs_tDBInput_5.getBigDecimal(26);
            if(rs_tDBInput_5.wasNull()){
                    row16.TOTENT = null;
            }
		                    }
            ...
            row16.ICMENT = rs_tDBInput_5.getBigDecimal(27);
            if(rs_tDBInput_5.wasNull()){
                    row16.ICMENT = null;
            }
		                    }
            ...
            row16.RETENT = rs_tDBInput_5.getBigDecimal(28);
            if(rs_tDBInput_5.wasNull()){
                    row16.RETENT = null;
            }
		                    }
            ...
            row16.IPIENT = rs_tDBInput_5.getBigDecimal(29);
            if(rs_tDBInput_5.wasNull()){
                    row16.IPIENT = null;
            }
		                    }
            ...
            row16.P_CENT = rs_tDBInput_5.getBigDecimal(30);
            if(rs_tDBInput_5.wasNull()){
                    row16.P_CENT = null;
            }
		                    }
            ...
            row16.LIQENT = rs_tDBInput_5.getBigDecimal(31);
            if(rs_tDBInput_5.wasNull()){
                    row16.LIQENT = null;
            }
		                    }
            ...
            row16.VAL_ST = rs_tDBInput_5.getBigDecimal(32);
            if(rs_tDBInput_5.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row16.VAL_OP = rs_tDBInput_5.getBigDecimal(33);
            if(rs_tDBInput_5.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row16.VALORES = routines.system.JDBCUtil.getString(rs_tDBInput_5, 34, false);
		                    }
							if(colQtyInRs_tDBInput_5 < 35) {
								row16.VALCOM = null;
							} else {
		                          
            row16.VALCOM = rs_tDBInput_5.getBigDecimal(35);
            if(rs_tDBInput_5.wasNull()){
                    row16.VALCOM = null;
            }
		                    }
            ...
            row16.ICMEN2 = rs_tDBInput_5.getBigDecimal(36);
            if(rs_tDBInput_5.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row16.RESSAR = rs_tDBInput_5.getBigDecimal(37);
            if(rs_tDBInput_5.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row16.MAROPE = rs_tDBInput_5.getBigDecimal(38);
            if(rs_tDBInput_5.wasNull()){
                    row16.MAROPE = null;
            }
		                    }
            ...
            row16.PERMAR = rs_tDBInput_5.getBigDecimal(39);
            if(rs_tDBInput_5.wasNull()){
                    row16.PERMAR = null;
            }
		                    }
        	...
        	row16.CSTCOM = routines.system.JDBCUtil.getString(rs_tDBInput_5, 40, false);
		                    }
							if(colQtyInRs_tDBInput_5 < 41) {
								row16.CST1 = null;
							} else {
	                         		
        	row16.CST1 = routines.system.JDBCUtil.getString(rs_tDBInput_5, 41, false);
		                    }
							if(colQtyInRs_tDBInput_5 < 42) {
								row16.CST2 = null;
							} else {
	                         		
        	row16.CST2 = routines.system.JDBCUtil.getString(rs_tDBInput_5, 42, false);
		                    }
							if(colQtyInRs_tDBInput_5 < 43) {
								row16.MAROPE_MG = null;
							} else {
		                          
            row16.MAROPE_MG = rs_tDBInput_5.getBigDecimal(43);
            if(rs_tDBInput_5.wasNull()){
                    row16.MAROPE_MG = null;
            }
		                    }
							if(colQtyInRs_tDBInput_5 < 44) {
								row16.PERMAR_MG = null;
							} else {
		                          
            row16.PERMAR_MG = rs_tDBInput_5.getBigDecimal(44);
            if(rs_tDBInput_5.wasNull()){
                    row16.PERMAR_MG = null;
            }
		                    }
            ...
            row16.RESSA2 = rs_tDBInput_5.getBigDecimal(45);
            if(rs_tDBInput_5.wasNull()){
                    row16.RESSA2 = null;
            }
		                    }
            ...
            row16.IPISAI = rs_tDBInput_5.getBigDecimal(46);
            if(rs_tDBInput_5.wasNull()){
                    row16.IPISAI = null;
            }
		                    }
            ...
            row16.VLRVII = rs_tDBInput_5.getBigDecimal(47);
            if(rs_tDBInput_5.wasNull()){
                    row16.VLRVII = null;
            }
		                    }
							if(colQtyInRs_tDBInput_5 < 48) {
								row16.CODIGO_PRODUTO = null;
							} else {
	                         		
        	row16.CODIGO_PRODUTO = routines.system.JDBCUtil.getString(rs_tDBInput_5, 48, false);
		                    }
							if(colQtyInRs_tDBInput_5 < 49) {
								row16.Name_exp_43 = null;
							} else {
		                          
            row16.Name_exp_43 = rs_tDBInput_5.getInt(49);
            if(rs_tDBInput_5.wasNull()){
                    row16.Name_exp_43 = null;
            }
		                    }
							if(colQtyInRs_tDBInput_5 < 50) {
								row16.Name_exp_44 = null;
							} else {
		                          
            row16.Name_exp_44 = rs_tDBInput_5.getInt(50);
            if(rs_tDBInput_5.wasNull()){
                    row16.Name_exp_44 = null;
            }
		                    }
 ...
 */
	...
	currentComponent="tHashOutput_6";
		...
		row16Struct oneRow_tHashOutput_6 = new row16Struct();
					...
					oneRow_tHashOutput_6.NUMPED = row16.NUMPED;
					...
					oneRow_tHashOutput_6.TESTE = row16.TESTE;
					...
					oneRow_tHashOutput_6.MAROPE_MG = row16.MAROPE_MG;
					oneRow_tHashOutput_6.PERMAR_MG = row16.PERMAR_MG;
					oneRow_tHashOutput_6.RESSA2 = row16.RESSA2;
					oneRow_tHashOutput_6.IPISAI = row16.IPISAI;
					oneRow_tHashOutput_6.VLRVII = row16.VLRVII;
					oneRow_tHashOutput_6.CODIGO_PRODUTO = row16.CODIGO_PRODUTO;
					oneRow_tHashOutput_6.Name_exp_43 = row16.Name_exp_43;
					oneRow_tHashOutput_6.Name_exp_44 = row16.Name_exp_44;
 ...
 */
	...
	currentComponent="tHashInput_1";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_vw_custo_efetivo_" + pid +"_tHashOutput_1");
...
int count_tDBOutput_7=0;
	    java.sql.PreparedStatement pstmt_tDBOutput_7 = conn_tDBOutput_7.prepareStatement("SELECT COUNT(1) FROM \"" + tableName_tDBOutput_7 + "\" WHERE \"numdoc\" = ? AND \"numped\" = ? AND \"codite\" = ?");
	    ...
	    String update_tDBOutput_7 = "UPDATE \"" + tableName_tDBOutput_7 + "\" SET \"estado\" = ?,\"codven\" = ?,\"vlrtnf\" = ?,\"dtasai\" = ?,\"codmar\" = ?,\"descri\" = ?,\"qtdsai\" = ?,\"unisai\" = ?,\"totsai\" = ?,\"icmsai\" = ?,\"fcpsai\" = ?,\"retsai\" = ?,\"totfre\" = ?,\"p_csai\" = ?,\"difsai\" = ?,\"liqsai2\" = ?,\"teste\" = ?,\"liqsai\" = ?,\"nument\" = ?,\"dtaent\" = ?,\"qtdent\" = ?,\"cstent\" = ?,\"totent\" = ?,\"icment\" = ?,\"retent\" = ?,\"ipient\" = ?,\"p_cent\" = ?,\"liqent\" = ?,\"val_st\" = ?,\"val_op\" = ?,\"valores\" = ?,\"valcom\" = ?,\"icmen2\" = ?,\"ressar\" = ?,\"marope\" = ?,\"permar\" = ?,\"cstcom\" = ?,\"cst1\" = ?,\"cst2\" = ?,\"marope_mg\" = ?,\"permar_mg\" = ?,\"ressa2\" = ?,\"ipisai\" = ?,\"vlrvii\" = ?,\"codigo_produto\" = ?,\"name_exp_43\" = ?,\"name_exp_44\" = ? WHERE \"numdoc\" = ? AND \"numped\" = ? AND \"codite\" = ?";
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row16Struct> tHashFile_tHashInput_6 = mf_tHashInput_6.getAdvancedMemoryHashFile("tHashFile_vw_custo_efetivo_" + pid +"_tHashOutput_6");
...
while (iterator_tHashInput_6.hasNext()) {
	...
	row17.NUMPED = next_tHashInput_6.NUMPED;
	...
	row17.TESTE = next_tHashInput_6.TESTE;
	...
	row17.MAROPE_MG = next_tHashInput_6.MAROPE_MG;
	row17.PERMAR_MG = next_tHashInput_6.PERMAR_MG;
	row17.RESSA2 = next_tHashInput_6.RESSA2;
	row17.IPISAI = next_tHashInput_6.IPISAI;
	row17.VLRVII = next_tHashInput_6.VLRVII;
	row17.CODIGO_PRODUTO = next_tHashInput_6.CODIGO_PRODUTO;
	row17.Name_exp_43 = next_tHashInput_6.Name_exp_43;
	row17.Name_exp_44 = next_tHashInput_6.Name_exp_44;
...
copyOfcopyOfcopyOfcopyOfinsert_tmp.NUMPED = row17.NUMPED;
...
copyOfcopyOfcopyOfcopyOfinsert_tmp.TESTE = row17.TESTE;
...
copyOfcopyOfcopyOfcopyOfinsert_tmp.MAROPE_MG = row17.MAROPE_MG ;
copyOfcopyOfcopyOfcopyOfinsert_tmp.PERMAR_MG = row17.PERMAR_MG ;
...
copyOfcopyOfcopyOfcopyOfinsert_tmp.CODIGO_PRODUTO = row17.CODIGO_PRODUTO ;
copyOfcopyOfcopyOfcopyOfinsert_tmp.Name_exp_43 = row17.Name_exp_43 ;
copyOfcopyOfcopyOfcopyOfinsert_tmp.Name_exp_44 = row17.Name_exp_44 ;
...
} else {pstmt_tDBOutput_7.setString(2, row18.NUMPED);
}

                    if(row18.CODITE == null) {
pstmt_tDBOutput_7.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_7.setString(3, row18.CODITE);
}
...
} else {pstmtUpdate_tDBOutput_7.setString(1, row18.ESTADO);
}

                        if(row18.CODVEN == null) {
pstmtUpdate_tDBOutput_7.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_7.setString(2, row18.CODVEN);
}

                        pstmtUpdate_tDBOutput_7.setBigDecimal(3, row18.VLRTNF);

                        if(row18.DTASAI != null) {
pstmtUpdate_tDBOutput_7.setTimestamp(4, new java.sql.Timestamp(row18.DTASAI.getTime()));
} else {
pstmtUpdate_tDBOutput_7.setNull(4, java.sql.Types.TIMESTAMP);
}

                        if(row18.CODMAR == null) {
pstmtUpdate_tDBOutput_7.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_7.setString(5, row18.CODMAR);
}

                        if(row18.DESCRI == null) {
pstmtUpdate_tDBOutput_7.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_7.setString(6, row18.DESCRI);
}

                        pstmtUpdate_tDBOutput_7.setBigDecimal(7, row18.QTDSAI);

                        pstmtUpdate_tDBOutput_7.setBigDecimal(8, row18.UNISAI);

                        pstmtUpdate_tDBOutput_7.setBigDecimal(9, row18.TOTSAI);

                        pstmtUpdate_tDBOutput_7.setBigDecimal(10, row18.ICMSAI);

                        pstmtUpdate_tDBOutput_7.setBigDecimal(11, row18.FCPSAI);

                        pstmtUpdate_tDBOutput_7.setBigDecimal(12, row18.RETSAI);

                        pstmtUpdate_tDBOutput_7.setBigDecimal(13, row18.TOTFRE);

                        pstmtUpdate_tDBOutput_7.setBigDecimal(14, row18.P_CSAI);

                        pstmtUpdate_tDBOutput_7.setBigDecimal(15, row18.DIFSAI);

                        pstmtUpdate_tDBOutput_7.setBigDecimal(16, row18.LIQSAI2);

                        if(row18.TESTE == null) {
pstmtUpdate_tDBOutput_7.setNull(17, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_7.setString(17, row18.TESTE);
}

                        pstmtUpdate_tDBOutput_7.setBigDecimal(18, row18.LIQSAI);

                        if(row18.NUMENT == null) {
pstmtUpdate_tDBOutput_7.setNull(19, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_7.setString(19, row18.NUMENT);
}

                        if(row18.DTAENT != null) {
pstmtUpdate_tDBOutput_7.setTimestamp(20, new java.sql.Timestamp(row18.DTAENT.getTime()));
} else {
pstmtUpdate_tDBOutput_7.setNull(20, java.sql.Types.TIMESTAMP);
}

                        pstmtUpdate_tDBOutput_7.setBigDecimal(21, row18.QTDENT);

                        if(row18.CSTENT == null) {
pstmtUpdate_tDBOutput_7.setNull(22, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_7.setString(22, row18.CSTENT);
}

                        pstmtUpdate_tDBOutput_7.setBigDecimal(23, row18.TOTENT);

                        pstmtUpdate_tDBOutput_7.setBigDecimal(24, row18.ICMENT);

                        pstmtUpdate_tDBOutput_7.setBigDecimal(25, row18.RETENT);

                        pstmtUpdate_tDBOutput_7.setBigDecimal(26, row18.IPIENT);

                        pstmtUpdate_tDBOutput_7.setBigDecimal(27, row18.P_CENT);

                        pstmtUpdate_tDBOutput_7.setBigDecimal(28, row18.LIQENT);

                        pstmtUpdate_tDBOutput_7.setBigDecimal(29, row18.VAL_ST);

                        pstmtUpdate_tDBOutput_7.setBigDecimal(30, row18.VAL_OP);

                        if(row18.VALORES == null) {
pstmtUpdate_tDBOutput_7.setNull(31, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_7.setString(31, row18.VALORES);
}

                        pstmtUpdate_tDBOutput_7.setBigDecimal(32, row18.VALCOM);

                        pstmtUpdate_tDBOutput_7.setBigDecimal(33, row18.ICMEN2);

                        pstmtUpdate_tDBOutput_7.setBigDecimal(34, row18.RESSAR);

                        pstmtUpdate_tDBOutput_7.setBigDecimal(35, row18.MAROPE);

                        pstmtUpdate_tDBOutput_7.setBigDecimal(36, row18.PERMAR);

                        if(row18.CSTCOM == null) {
pstmtUpdate_tDBOutput_7.setNull(37, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_7.setString(37, row18.CSTCOM);
}

                        if(row18.CST1 == null) {
pstmtUpdate_tDBOutput_7.setNull(38, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_7.setString(38, row18.CST1);
}

                        if(row18.CST2 == null) {
pstmtUpdate_tDBOutput_7.setNull(39, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_7.setString(39, row18.CST2);
}

                        pstmtUpdate_tDBOutput_7.setBigDecimal(40, row18.MAROPE_MG);

                        pstmtUpdate_tDBOutput_7.setBigDecimal(41, row18.PERMAR_MG);

                        pstmtUpdate_tDBOutput_7.setBigDecimal(42, row18.RESSA2);

                        pstmtUpdate_tDBOutput_7.setBigDecimal(43, row18.IPISAI);

                        pstmtUpdate_tDBOutput_7.setBigDecimal(44, row18.VLRVII);

                        if(row18.CODIGO_PRODUTO == null) {
pstmtUpdate_tDBOutput_7.setNull(45, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_7.setString(45, row18.CODIGO_PRODUTO);
}

                        if(row18.Name_exp_43 == null) {
pstmtUpdate_tDBOutput_7.setNull(46, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_7.setInt(46, row18.Name_exp_43);
}

                        if(row18.Name_exp_44 == null) {
pstmtUpdate_tDBOutput_7.setNull(47, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_7.setInt(47, row18.Name_exp_44);
}

                        if(row18.NUMDOC == null) {
pstmtUpdate_tDBOutput_7.setNull(48 + count_tDBOutput_7, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_7.setString(48 + count_tDBOutput_7, row18.NUMDOC);
}

                        if(row18.NUMPED == null) {
pstmtUpdate_tDBOutput_7.setNull(49 + count_tDBOutput_7, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_7.setString(49 + count_tDBOutput_7, row18.NUMPED);
}
 ...
 */
	...
	currentComponent="tHashInput_6";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_vw_custo_efetivo_" + pid +"_tHashOutput_6");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row5Struct> tHashFile_tHashInput_2 = mf_tHashInput_2.getAdvancedMemoryHashFile("tHashFile_vw_custo_efetivo_" + pid +"_tHashOutput_2");
 ...
 */
	...
	currentComponent="tHashInput_2";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_vw_custo_efetivo_" + pid +"_tHashOutput_2");
 ...
 */
    ...
    public static void main(String[] args){
        final vw_custo_efetivo vw_custo_efetivoClass = new vw_custo_efetivo();

        int exitCode = vw_custo_efetivoClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = vw_custo_efetivo.class.getClassLoader().getResourceAsStream("palacio_ferramentas/vw_custo_efetivo_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = vw_custo_efetivo.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : vw_custo_efetivo");
        }
...
/************************************************************************************************
 *     556809 characters generated by Talend Open Studio for Big Data 
 *     on the 16 de abril de 2025 16:29:19 BRT
 ************************************************************************************************/