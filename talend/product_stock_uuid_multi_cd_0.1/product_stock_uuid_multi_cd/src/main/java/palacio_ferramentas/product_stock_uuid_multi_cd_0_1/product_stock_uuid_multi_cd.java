...
package palacio_ferramentas.product_stock_uuid_multi_cd_0_1;
...
/**
 * Job: product_stock_uuid_multi_cd Purpose: product_stock_uuid_multi_cd<br>
 * Description:  <br>
 * @author henriquesantos@palaciodasferramentas.com.br
 * @version 8.0.1.20230922_0317-SNAPSHOT
 * @status 
 */
public class product_stock_uuid_multi_cd implements TalendJob {
...
public String getJDBC_PARAMETERS(){
	...
	private final String jobName = "product_stock_uuid_multi_cd";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				product_stock_uuid_multi_cd.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(product_stock_uuid_multi_cd.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row16Struct implements routines.system.IPersistableRow<row16Struct> {
    final static byte[] commonByteArrayLock_PALACIO_FERRAMENTAS_product_stock_uuid_multi_cd = new byte[0];
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_product_stock_uuid_multi_cd = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PALACIO_FERRAMENTAS_product_stock_uuid_multi_cd.length) {
				if(length < 1024 && commonByteArray_PALACIO_FERRAMENTAS_product_stock_uuid_multi_cd.length == 0) {
   					commonByteArray_PALACIO_FERRAMENTAS_product_stock_uuid_multi_cd = new byte[1024];
				} else {
   					commonByteArray_PALACIO_FERRAMENTAS_product_stock_uuid_multi_cd = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PALACIO_FERRAMENTAS_product_stock_uuid_multi_cd, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_product_stock_uuid_multi_cd, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PALACIO_FERRAMENTAS_product_stock_uuid_multi_cd, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_product_stock_uuid_multi_cd, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PALACIO_FERRAMENTAS_product_stock_uuid_multi_cd) {
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_5=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_5 = "tHashFile_product_stock_uuid_multi_cd_" + pid + "_tHashOutput_5";
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_6=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_6 = "tHashFile_product_stock_uuid_multi_cd_" + pid + "_tHashOutput_6";
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row6Struct> tHashFile_tHashInput_5 = mf_tHashInput_5.getAdvancedMemoryHashFile("tHashFile_product_stock_uuid_multi_cd_" + pid +"_tHashOutput_7");
 ...
 */
	...
	currentComponent="tHashInput_5";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_product_stock_uuid_multi_cd_" + pid +"_tHashOutput_7");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<out4Struct> tHashFile_tHashInput_9 = mf_tHashInput_9.getAdvancedMemoryHashFile("tHashFile_product_stock_uuid_multi_cd_" + pid +"_tHashOutput_6");
 					    ...
 					    boolean forceLooprow14 = false;
 							...
 							row14Struct row14ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row14HashKey.cd_emp = row12.CD_EMP ;
...
if(out1 != null) { 
    ...
    if (ope_tFilterRow_2.getMatchFlag()) {
              if(row7 == null){ 
               ...
               row7.uuid = out1.uuid;
               row7.dt_criacao = out1.dt_criacao;
               row7.dt_ultima_atualizacao_autcom = out1.dt_ultima_atualizacao_autcom;
               row7.cd_emp = out1.cd_emp;
               row7.cd_produto = out1.cd_produto;
               row7.desc_produto = out1.desc_produto;
               row7.saldo_anterior = out1.saldo_anterior;
               row7.saldo_atual = out1.saldo_atual;
               row7.api = out1.api;
               row7.dt_integracao = out1.dt_integracao;
               row7.mensagem = out1.mensagem;
               row7.request = out1.request;
               row7.response = out1.response;    
...
} else {pstmt_tDBOutput_4.setString(1, row7.uuid);
}

                    if(row7.dt_criacao != null) {
pstmt_tDBOutput_4.setTimestamp(2, new java.sql.Timestamp(row7.dt_criacao.getTime()));
} else {
pstmt_tDBOutput_4.setNull(2, java.sql.Types.TIMESTAMP);
}

                    if(row7.dt_ultima_atualizacao_autcom != null) {
pstmt_tDBOutput_4.setTimestamp(3, new java.sql.Timestamp(row7.dt_ultima_atualizacao_autcom.getTime()));
} else {
...
} else {pstmt_tDBOutput_4.setString(4, row7.cd_emp);
}

                    if(row7.cd_produto == null) {
pstmt_tDBOutput_4.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(5, row7.cd_produto);
}

                    if(row7.desc_produto == null) {
pstmt_tDBOutput_4.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(6, row7.desc_produto);
}

                    if(row7.saldo_anterior == null) {
pstmt_tDBOutput_4.setNull(7, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_4.setInt(7, row7.saldo_anterior);
}

                    if(row7.saldo_atual == null) {
pstmt_tDBOutput_4.setNull(8, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_4.setInt(8, row7.saldo_atual);
}

                    if(row7.api == null) {
pstmt_tDBOutput_4.setNull(9, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_4.setInt(9, row7.api);
}

                    if(row7.dt_integracao != null) {
pstmt_tDBOutput_4.setTimestamp(10, new java.sql.Timestamp(row7.dt_integracao.getTime()));
} else {
pstmt_tDBOutput_4.setNull(10, java.sql.Types.TIMESTAMP);
}

                    if(row7.mensagem == null) {
pstmt_tDBOutput_4.setNull(11, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(11, row7.mensagem);
}

                    if(row7.request == null) {
pstmt_tDBOutput_4.setNull(12, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(12, row7.request);
}

                    if(row7.response == null) {
pstmt_tDBOutput_4.setNull(13, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(13, row7.response);
}
...
globalMap.put("tDBOutput_4_ERROR_MESSAGE",e.getMessage());
                ...
                whetherReject_tDBOutput_4 = true;
                        row23 = new row23Struct();
                            row23.uuid = row7.uuid;
                            row23.dt_criacao = row7.dt_criacao;
                            row23.dt_ultima_atualizacao_autcom = row7.dt_ultima_atualizacao_autcom;
                            row23.cd_emp = row7.cd_emp;
                            row23.cd_produto = row7.cd_produto;
                            row23.desc_produto = row7.desc_produto;
                            row23.saldo_anterior = row7.saldo_anterior;
                            row23.saldo_atual = row7.saldo_atual;
                            row23.api = row7.api;
                            row23.dt_integracao = row7.dt_integracao;
                            row23.mensagem = row7.mensagem;
                            row23.request = row7.request;
                            row23.response = row7.response;
                        rejectedCount_tDBOutput_4 = rejectedCount_tDBOutput_4 + 1;
                        row23.errorCode = ((java.sql.SQLException)e).getSQLState();
                        row23.errorMessage = e.getMessage() + " - Line: " + tos_count_tDBOutput_4;
            }
 ...
 */
	...
	currentComponent="tHashInput_9";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_product_stock_uuid_multi_cd_" + pid +"_tHashOutput_6");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row16Struct> tHashFile_tHashInput_4 = mf_tHashInput_4.getAdvancedMemoryHashFile("tHashFile_product_stock_uuid_multi_cd_" + pid +"_tHashOutput_5");
 ...
 */
	...
	currentComponent="tHashInput_4";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_product_stock_uuid_multi_cd_" + pid +"_tHashOutput_5");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row4Struct> tHashFile_tHashInput_1 = mf_tHashInput_1.getAdvancedMemoryHashFile("tHashFile_product_stock_uuid_multi_cd_" + pid +"_tHashOutput_4");
 ...
 */
	...
	currentComponent="tHashInput_1";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_product_stock_uuid_multi_cd_" + pid +"_tHashOutput_4");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row4Struct> tHashFile_tHashInput_10 = mf_tHashInput_10.getAdvancedMemoryHashFile("tHashFile_product_stock_uuid_multi_cd_" + pid +"_tHashOutput_4");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row18Struct> tHashFile_tHashInput_6 = mf_tHashInput_6.getAdvancedMemoryHashFile("tHashFile_product_stock_uuid_multi_cd_" + pid +"_tHashOutput_2");
 ...
 */
	...
	currentComponent="tHashInput_6";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_product_stock_uuid_multi_cd_" + pid +"_tHashOutput_2");
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_4=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_4 = "tHashFile_product_stock_uuid_multi_cd_" + pid + "_tHashOutput_4";
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_9=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_9 = "tHashFile_product_stock_uuid_multi_cd_" + pid + "_tHashOutput_9";
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_3=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_3 = "tHashFile_product_stock_uuid_multi_cd_" + pid + "_tHashOutput_3";
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_1=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_1 = "tHashFile_product_stock_uuid_multi_cd_" + pid + "_tHashOutput_1";
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row27Struct> tHashFile_tHashInput_7 = mf_tHashInput_7.getAdvancedMemoryHashFile("tHashFile_product_stock_uuid_multi_cd_" + pid +"_tHashOutput_9");
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_7=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_7 = "tHashFile_product_stock_uuid_multi_cd_" + pid + "_tHashOutput_7";
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_2=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_2 = "tHashFile_product_stock_uuid_multi_cd_" + pid + "_tHashOutput_2";
 ...
 */
	...
	currentComponent="tHashInput_7";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_product_stock_uuid_multi_cd_" + pid +"_tHashOutput_9");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row3Struct> tHashFile_tHashInput_2 = mf_tHashInput_2.getAdvancedMemoryHashFile("tHashFile_product_stock_uuid_multi_cd_" + pid +"_tHashOutput_3");
 ...
 */
	...
	currentComponent="tHashInput_2";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_product_stock_uuid_multi_cd_" + pid +"_tHashOutput_3");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row8Struct> tHashFile_tHashInput_3 = mf_tHashInput_3.getAdvancedMemoryHashFile("tHashFile_product_stock_uuid_multi_cd_" + pid +"_tHashOutput_1");
 ...
 */
	...
	currentComponent="tHashInput_3";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_product_stock_uuid_multi_cd_" + pid +"_tHashOutput_1");
 ...
 */
    ...
    public static void main(String[] args){
        final product_stock_uuid_multi_cd product_stock_uuid_multi_cdClass = new product_stock_uuid_multi_cd();

        int exitCode = product_stock_uuid_multi_cdClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = product_stock_uuid_multi_cd.class.getClassLoader().getResourceAsStream("palacio_ferramentas/product_stock_uuid_multi_cd_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = product_stock_uuid_multi_cd.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : product_stock_uuid_multi_cd");
        }
...
/************************************************************************************************
 *     776324 characters generated by Talend Open Studio for Big Data 
 *     on the 7 de fevereiro de 2025 15:42:31 BRT
 ************************************************************************************************/