...
package palacio_ferramentas.faturamento_compras_ano_0_1;
...
/**
 * Job: faturamento_compras_ano Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 8.0.1.20230922_0317-SNAPSHOT
 * @status 
 */
public class faturamento_compras_ano implements TalendJob {
...
public Integer getDias(){
	...
	private final String jobName = "faturamento_compras_ano";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				faturamento_compras_ano.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(faturamento_compras_ano.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
System.out.println("*********** 02 - vw_faturamento_compras ***********");
System.out.println("Iniciando JOB2 atualização vw_faturamento_compras");
...
public static class map3Struct implements routines.system.IPersistableRow<map3Struct> {
    final static byte[] commonByteArrayLock_PALACIO_FERRAMENTAS_faturamento_compras_ano = new byte[0];
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_faturamento_compras_ano = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PALACIO_FERRAMENTAS_faturamento_compras_ano) {
...
map3Struct map3 = new map3Struct();
	...
	class Util_tLogRow_2 {
		...
		public String print(String[] row, int nbLine){
			...
			//for(int i=0; i<row.length; i++){
				sb.append("| " + "date");
				for(int i=0; i<titleWidth -"date".length()+ 1 ;i++)
					sb.append(" ");
				sb.append("| " + row[2]);
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_2=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_2 = "tHashFile_faturamento_compras_ano_" + pid + "_tHashOutput_2";
 ...
 */
	...
	currentComponent="tDBInput_2";
		...
		int tos_count_tDBInput_2 = 0;
		    ...
		    String dbquery_tDBInput_2 = "\nSELECT YEAR(CURRENT_DATE()) ANO, (MONTH(CURRENT_DATE())-1 ) MES, SUBDATE(CURDATE(), 1)PARAMETRO, NOW() AS DATA_START"
+"\n\n";
...
///////////////////////		
				...
				strBuffer_tLogRow_2.append(
								FormatterUtils.format_Date(map3.date, "yyyy-MM-dd")				
				);
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PALACIO_FERRAMENTAS_faturamento_compras_ano.length) {
				if(length < 1024 && commonByteArray_PALACIO_FERRAMENTAS_faturamento_compras_ano.length == 0) {
   					commonByteArray_PALACIO_FERRAMENTAS_faturamento_compras_ano = new byte[1024];
				} else {
   					commonByteArray_PALACIO_FERRAMENTAS_faturamento_compras_ano = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PALACIO_FERRAMENTAS_faturamento_compras_ano, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_faturamento_compras_ano, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PALACIO_FERRAMENTAS_faturamento_compras_ano, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_faturamento_compras_ano, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_1=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_1 = "tHashFile_faturamento_compras_ano_" + pid + "_tHashOutput_1";
...
public static class cadcndStruct implements routines.system.IPersistableRow<cadcndStruct> {
    final static byte[] commonByteArrayLock_PALACIO_FERRAMENTAS_faturamento_compras_ano = new byte[0];
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_faturamento_compras_ano = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(cadcndStruct other) {
...
cadcndStruct cadcnd = new cadcndStruct();
	...
	currentComponent="tHashOutput_4";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"cadcnd");
					}
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_4=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<cadcndStruct> tHashFile_tHashOutput_4 = null;
		String hashKey_tHashOutput_4 = "tHashFile_faturamento_compras_ano_" + pid + "_tHashOutput_4";
			synchronized(org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.get(hashKey_tHashOutput_4)){
			    if(mf_tHashOutput_4.getResourceMap().get(hashKey_tHashOutput_4) == null){
	      		    mf_tHashOutput_4.getResourceMap().put(hashKey_tHashOutput_4, new org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<cadcndStruct>(org.talend.designer.components.hashfile.common.MATCHING_MODE.KEEP_ALL));
...
// ###############################
// # Outputs initialization
cadcndStruct cadcnd_tmp = new cadcndStruct();
// ###############################
 ...
 */
	...
	currentComponent="tDBInput_1";
		...
		int tos_count_tDBInput_1 = 0;
		    ...
		    String dbquery_tDBInput_1 = "SELECT CND_CODIGO, CND_DESCRI FROM CADCND";
		    ...
		    while (rs_tDBInput_1.next()) {
		        nb_line_tDBInput_1++;
							...
							if(colQtyInRs_tDBInput_1 < 1) {
								row2.CND_CODIGO = null;
							} else {
	                         		
        	row2.CND_CODIGO = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								row2.CND_DESCRI = null;
							} else {
	                         		
        	row2.CND_DESCRI = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
		                    }
...
// # Output table : 'cadcnd'
cadcnd_tmp.CND_CODIGO = row2.CND_CODIGO ;
cadcnd_tmp.CND_DESCRI = row2.CND_DESCRI ;
cadcnd = cadcnd_tmp;
// ###############################
...
if(cadcnd != null) { 
	...
	currentComponent="tHashOutput_4";
		...
		cadcndStruct oneRow_tHashOutput_4 = new cadcndStruct();
				
					oneRow_tHashOutput_4.CND_CODIGO = cadcnd.CND_CODIGO;
					oneRow_tHashOutput_4.CND_DESCRI = cadcnd.CND_DESCRI;
...
globalMap.put("tHashOutput_4_NB_LINE", nb_line_tHashOutput_4);
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"cadcnd");
			  	}
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row8Struct> tHashFile_tHashInput_1 = mf_tHashInput_1.getAdvancedMemoryHashFile("tHashFile_faturamento_compras_ano_" + pid +"_tHashOutput_2");
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_3=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_3 = "tHashFile_faturamento_compras_ano_" + pid + "_tHashOutput_3";
...
+"RA,\nCOND_PAGTO,\nCODCND,\nDT_PEDIDO\nFROM VW_FATURAMENTO\nWHERE DATA_ANO = EXTRACT(YEAR FROM CURRENT_DATE);\n";
        	...
        	row1.EMPRESA = routines.system.JDBCUtil.getString(rs_tDBInput_5, 1, false);
		                    }
							if(colQtyInRs_tDBInput_5 < 2) {
								row1.NUMERO_NOTA_FISCAL = null;
							} else {
	                         		
        	row1.NUMERO_NOTA_FISCAL = routines.system.JDBCUtil.getString(rs_tDBInput_5, 2, false);
		                    }
							if(colQtyInRs_tDBInput_5 < 3) {
								row1.SERIE = null;
							} else {
	                         		
        	row1.SERIE = routines.system.JDBCUtil.getString(rs_tDBInput_5, 3, false);
		                    }
							if(colQtyInRs_tDBInput_5 < 4) {
								row1.COD_VENDEDOR = null;
							} else {
	                         		
        	row1.COD_VENDEDOR = routines.system.JDBCUtil.getString(rs_tDBInput_5, 4, false);
		                    }
							if(colQtyInRs_tDBInput_5 < 5) {
								row1.NOME_VENDEDOR = null;
							} else {
	                         		
        	row1.NOME_VENDEDOR = routines.system.JDBCUtil.getString(rs_tDBInput_5, 5, false);
		                    }
							if(colQtyInRs_tDBInput_5 < 6) {
								row1.CD_COMBO_ORIGEM = null;
							} else {
	                         		
        	row1.CD_COMBO_ORIGEM = routines.system.JDBCUtil.getString(rs_tDBInput_5, 6, false);
		                    }
							if(colQtyInRs_tDBInput_5 < 7) {
								row1.VL_COMBO_ORIGEM = null;
							} else {
		                          
            row1.VL_COMBO_ORIGEM = rs_tDBInput_5.getBigDecimal(7);
        	...
        	row1.COD_ITEM = routines.system.JDBCUtil.getString(rs_tDBInput_5, 8, false);
		                    }
							if(colQtyInRs_tDBInput_5 < 9) {
								row1.ITEM = null;
							} else {
	                         		
        	row1.ITEM = routines.system.JDBCUtil.getString(rs_tDBInput_5, 9, false);
		                    }
							if(colQtyInRs_tDBInput_5 < 10) {
								row1.DATA = null;
							} else {
										
			row1.DATA = routines.system.JDBCUtil.getDate(rs_tDBInput_5, 10);
		                    }
							if(colQtyInRs_tDBInput_5 < 11) {
								row1.DATA_ANO = null;
							} else {
		                          
            row1.DATA_ANO = rs_tDBInput_5.getInt(11);
            if(rs_tDBInput_5.wasNull()){
                    row1.DATA_ANO = null;
            }
		                    }
            ...
            row1.DATA_MES = rs_tDBInput_5.getInt(12);
            if(rs_tDBInput_5.wasNull()){
                    row1.DATA_MES = null;
            }
		                    }
            ...
            row1.QTD_ITEM = rs_tDBInput_5.getBigDecimal(13);
            if(rs_tDBInput_5.wasNull()){
                    row1.QTD_ITEM = null;
            }
		                    }
            ...
            row1.VALOR_UNITARIO = rs_tDBInput_5.getBigDecimal(14);
            if(rs_tDBInput_5.wasNull()){
                    row1.VALOR_UNITARIO = null;
            }
		                    }
            ...
            row1.TOTAL_CUSTO = rs_tDBInput_5.getBigDecimal(15);
            if(rs_tDBInput_5.wasNull()){
                    row1.TOTAL_CUSTO = null;
            }
		                    }
            ...
            row1.TOTAL_CUSTO_MEDIO = rs_tDBInput_5.getBigDecimal(16);
            if(rs_tDBInput_5.wasNull()){
                    row1.TOTAL_CUSTO_MEDIO = null;
            }
		                    }
            ...
            row1.TOTAL_LITROS = rs_tDBInput_5.getBigDecimal(17);
            if(rs_tDBInput_5.wasNull()){
                    row1.TOTAL_LITROS = null;
            }
		                    }
            ...
            row1.TOTAL_VENDA = rs_tDBInput_5.getBigDecimal(18);
            if(rs_tDBInput_5.wasNull()){
                    row1.TOTAL_VENDA = null;
            }
		                    }
            ...
            row1.TOTAL_IMPOSTOS_SAIDA = rs_tDBInput_5.getBigDecimal(19);
            if(rs_tDBInput_5.wasNull()){
        	...
        	row1.CIDADE = routines.system.JDBCUtil.getString(rs_tDBInput_5, 20, false);
		                    }
							if(colQtyInRs_tDBInput_5 < 21) {
								row1.ESTADO = null;
							} else {
	                         		
        	row1.ESTADO = routines.system.JDBCUtil.getString(rs_tDBInput_5, 21, false);
		                    }
							if(colQtyInRs_tDBInput_5 < 22) {
								row1.COD_CLIENTE = null;
							} else {
	                         		
        	row1.COD_CLIENTE = routines.system.JDBCUtil.getString(rs_tDBInput_5, 22, false);
		                    }
							if(colQtyInRs_tDBInput_5 < 23) {
								row1.CLIENTE = null;
							} else {
	                         		
        	row1.CLIENTE = routines.system.JDBCUtil.getString(rs_tDBInput_5, 23, false);
		                    }
							if(colQtyInRs_tDBInput_5 < 24) {
								row1.COD_FORNECEDOR = null;
							} else {
	                         		
        	row1.COD_FORNECEDOR = routines.system.JDBCUtil.getString(rs_tDBInput_5, 24, false);
		                    }
							if(colQtyInRs_tDBInput_5 < 25) {
								row1.FORNECEDOR = null;
							} else {
	                         		
        	row1.FORNECEDOR = routines.system.JDBCUtil.getString(rs_tDBInput_5, 25, false);
		                    }
							if(colQtyInRs_tDBInput_5 < 26) {
								row1.DATA_E_HORA = null;
							} else {
										
			row1.DATA_E_HORA = routines.system.JDBCUtil.getDate(rs_tDBInput_5, 26);
		                    }
							if(colQtyInRs_tDBInput_5 < 27) {
								row1.COND_PAGTO = null;
							} else {
	                         		
        	row1.COND_PAGTO = routines.system.JDBCUtil.getString(rs_tDBInput_5, 27, false);
		                    }
							if(colQtyInRs_tDBInput_5 < 28) {
								row1.CODCND = null;
							} else {
	                         		
        	row1.CODCND = routines.system.JDBCUtil.getString(rs_tDBInput_5, 28, false);
		                    }
							if(colQtyInRs_tDBInput_5 < 29) {
								row1.DT_PEDIDO = null;
							} else {
										
			row1.DT_PEDIDO = routines.system.JDBCUtil.getDate(rs_tDBInput_5, 29);
		                    }
...
insert_tmp.CD_COMBO_ORIGEM = row1.CD_COMBO_ORIGEM ;
insert_tmp.VL_COMBO_ORIGEM = row1.VL_COMBO_ORIGEM ;
...
insert_tmp.COND_PAGTO = row1.COND_PAGTO ;
insert_tmp.CODCND = row1.CODCND ;
insert_tmp.DT_PEDIDO = row1.DT_PEDIDO ;
insert = insert_tmp;
// ###############################
...
if(insert != null) { 
	...
	currentComponent="tHashOutput_3";
		...
		insertStruct oneRow_tHashOutput_3 = new insertStruct();
					...
					oneRow_tHashOutput_3.NUMERO_NOTA_FISCAL = insert.NUMERO_NOTA_FISCAL;
					oneRow_tHashOutput_3.SERIE = insert.SERIE;
					oneRow_tHashOutput_3.COD_VENDEDOR = insert.COD_VENDEDOR;
					oneRow_tHashOutput_3.NOME_VENDEDOR = insert.NOME_VENDEDOR;
					oneRow_tHashOutput_3.CD_COMBO_ORIGEM = insert.CD_COMBO_ORIGEM;
					oneRow_tHashOutput_3.VL_COMBO_ORIGEM = insert.VL_COMBO_ORIGEM;
					oneRow_tHashOutput_3.COD_ITEM = insert.COD_ITEM;
					oneRow_tHashOutput_3.ITEM = insert.ITEM;
					oneRow_tHashOutput_3.DATA = insert.DATA;
					oneRow_tHashOutput_3.DATA_ANO = insert.DATA_ANO;
					oneRow_tHashOutput_3.DATA_MES = insert.DATA_MES;
					oneRow_tHashOutput_3.QTD_ITEM = insert.QTD_ITEM;
					oneRow_tHashOutput_3.VALOR_UNITARIO = insert.VALOR_UNITARIO;
					oneRow_tHashOutput_3.TOTAL_CUSTO = insert.TOTAL_CUSTO;
					oneRow_tHashOutput_3.TOTAL_CUSTO_MEDIO = insert.TOTAL_CUSTO_MEDIO;
					oneRow_tHashOutput_3.TOTAL_LITROS = insert.TOTAL_LITROS;
					oneRow_tHashOutput_3.TOTAL_VENDA = insert.TOTAL_VENDA;
					oneRow_tHashOutput_3.TOTAL_IMPOSTOS_SAIDA = insert.TOTAL_IMPOSTOS_SAIDA;
					oneRow_tHashOutput_3.CIDADE = insert.CIDADE;
					oneRow_tHashOutput_3.ESTADO = insert.ESTADO;
					oneRow_tHashOutput_3.COD_CLIENTE = insert.COD_CLIENTE;
					oneRow_tHashOutput_3.CLIENTE = insert.CLIENTE;
					oneRow_tHashOutput_3.COD_FORNECEDOR = insert.COD_FORNECEDOR;
					oneRow_tHashOutput_3.FORNECEDOR = insert.FORNECEDOR;
					oneRow_tHashOutput_3.DATA_E_HORA = insert.DATA_E_HORA;
					oneRow_tHashOutput_3.COND_PAGTO = insert.COND_PAGTO;
					oneRow_tHashOutput_3.CODCND = insert.CODCND;
					oneRow_tHashOutput_3.DT_PEDIDO = insert.DT_PEDIDO;
 ...
 */
	...
	currentComponent="tHashInput_1";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_faturamento_compras_ano_" + pid +"_tHashOutput_2");
...
System.out.println("Finalizado select na na vw_faturamento");
System.out.println("Finalizado em: "+TalendDate.getCurrentDate());
System.out.println("\n");
System.out.println("*************************************************");
System.out.println("Iniciando delete na vw_faturamento_compras");
System.out.println("Iniciado em: "+TalendDate.getCurrentDate());
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row8Struct> tHashFile_tHashInput_5 = mf_tHashInput_5.getAdvancedMemoryHashFile("tHashFile_faturamento_compras_ano_" + pid +"_tHashOutput_2");
...
while (iterator_tHashInput_5.hasNext()) {
	...
	row10.ANO = next_tHashInput_5.ANO;
	row10.MES = next_tHashInput_5.MES;
	row10.PARAMETRO = next_tHashInput_5.PARAMETRO;
	row10.DATA_START = next_tHashInput_5.DATA_START;
 ...
 */
	...
	currentComponent="tFlowToIterate_2";
            ...
            globalMap.put("row10.PARAMETRO", row10.PARAMETRO);
    	            
            globalMap.put("row10.DATA_START", row10.DATA_START);
...
query_tDBRow_1 = "\ndelete from vw_faturamento_compras  where data_ano = EXTRACT(YEAR FROM CURRENT_DATE);\ncommit;\n";
...
System.out.println("Finalizado delete na vw_faturamento_compras");
System.out.println("Finalizado em: "+TalendDate.getCurrentDate());
System.out.println("\n");
System.out.println("*************************************************");
System.out.println("Iniciando insert na vw_faturamento_compras");
System.out.println("Iniciado em: "+TalendDate.getCurrentDate());
...
public static class map2Struct implements routines.system.IPersistableRow<map2Struct> {
    ...
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_faturamento_compras_ano = new byte[0];
			    ...
			    public String COD_CND;

				public String getCOD_CND () {
					return this.COD_CND;
				}

				public Boolean COD_CNDIsNullable(){
				    return true;
				}
				public Boolean COD_CNDIsKey(){
				    return false;
				}
				public Integer COD_CNDLength(){
				    return 3;
				}
				public Integer COD_CNDPrecision(){
				    return null;
				}
				public String COD_CNDDefault(){
				
					return null;
				
				}
				public String COD_CNDComment(){
				
				    return "";
				
				}
				public String COD_CNDPattern(){
				
					return "";
				
				}
				public String COD_CNDOriginalDbColumnName(){
...
if(dbschema_tDBOutput_3 == null || dbschema_tDBOutput_3.trim().length() == 0) {
	tableName_tDBOutput_3 = ("vw_faturamento_compras").toLowerCase();
} else {
	tableName_tDBOutput_3 = dbschema_tDBOutput_3 + "\".\"" + ("vw_faturamento_compras").toLowerCase();
}
...
int count_tDBOutput_3=0;
        ...
        sb_tDBOutput_3.append("INSERT INTO \"").append(tableName_tDBOutput_3).append("\" (\"empresa\",\"numero_nota_fiscal\",\"serie\",\"cod_vendedor\",\"nome_vendedor\",\"cd_combo_origem\",\"vl_combo_origem\",\"cod_item\",\"item\",\"data\",\"data_ano\",\"data_mes\",\"qtd_item\",\"valor_unitario\",\"total_custo\",\"total_custo_medio\",\"total_litros\",\"total_venda\",\"total_impostos_saida\",\"cidade\",\"estado\",\"cod_cliente\",\"cliente\",\"cod_fornecedor\",\"fornecedor\",\"data_e_hora\",\"cond_pagto\",\"cod_cnd\",\"cnd_descri\",\"dt_pedido\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<insertStruct> tHashFile_tHashInput_4 = mf_tHashInput_4.getAdvancedMemoryHashFile("tHashFile_faturamento_compras_ano_" + pid +"_tHashOutput_3");
...
while (iterator_tHashInput_4.hasNext()) {
	...
	row7.COND_PAGTO = next_tHashInput_4.COND_PAGTO;
	row7.CODCND = next_tHashInput_4.CODCND;
	row7.DT_PEDIDO = next_tHashInput_4.DT_PEDIDO;
 					    ...
 					    boolean forceLooprow6 = false;
 							...
 							row6Struct row6ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_5 = false;
                        		    		    ...
                        		    		    row6HashKey.CND_CODIGO = row7.CODCND ;
				           		...
				           		if(tHash_Lookup_row6 != null && tHash_Lookup_row6.getCount(row6HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row6' and it contains more one result from keys :  row6.CND_CODIGO = '" + row6HashKey.CND_CODIGO + "'");
								} // G 071
...
map2_tmp.COND_PAGTO = row7.COND_PAGTO ;
map2_tmp.COD_CND = row7.CODCND ;
map2_tmp.CND_DESCRI = row6.CND_DESCRI ;
map2_tmp.DT_PEDIDO = row7.DT_PEDIDO ;
map2 = map2_tmp;
// ###############################
...
if(map2 != null) { 
	...
	currentComponent="tDBOutput_3";
        ...
        whetherReject_tDBOutput_3 = false;
                    if(map2.EMPRESA == null) {
pstmt_tDBOutput_3.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(1, map2.EMPRESA);
}

                    if(map2.NUMERO_NOTA_FISCAL == null) {
pstmt_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(2, map2.NUMERO_NOTA_FISCAL);
}

                    if(map2.SERIE == null) {
pstmt_tDBOutput_3.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(3, map2.SERIE);
}

                    if(map2.COD_VENDEDOR == null) {
pstmt_tDBOutput_3.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(4, map2.COD_VENDEDOR);
}

                    if(map2.NOME_VENDEDOR == null) {
pstmt_tDBOutput_3.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(5, map2.NOME_VENDEDOR);
}

                    if(map2.CD_COMBO_ORIGEM == null) {
pstmt_tDBOutput_3.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(6, map2.CD_COMBO_ORIGEM);
}

                    pstmt_tDBOutput_3.setBigDecimal(7, map2.VL_COMBO_ORIGEM);

                    if(map2.COD_ITEM == null) {
pstmt_tDBOutput_3.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(8, map2.COD_ITEM);
}

                    if(map2.ITEM == null) {
pstmt_tDBOutput_3.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(9, map2.ITEM);
}

                    if(map2.DATA != null) {
pstmt_tDBOutput_3.setTimestamp(10, new java.sql.Timestamp(map2.DATA.getTime()));
} else {
pstmt_tDBOutput_3.setNull(10, java.sql.Types.TIMESTAMP);
}

                    if(map2.DATA_ANO == null) {
pstmt_tDBOutput_3.setNull(11, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_3.setInt(11, map2.DATA_ANO);
}

                    if(map2.DATA_MES == null) {
pstmt_tDBOutput_3.setNull(12, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_3.setInt(12, map2.DATA_MES);
}

                    pstmt_tDBOutput_3.setBigDecimal(13, map2.QTD_ITEM);

                    pstmt_tDBOutput_3.setBigDecimal(14, map2.VALOR_UNITARIO);

                    pstmt_tDBOutput_3.setBigDecimal(15, map2.TOTAL_CUSTO);

                    pstmt_tDBOutput_3.setBigDecimal(16, map2.TOTAL_CUSTO_MEDIO);

                    pstmt_tDBOutput_3.setBigDecimal(17, map2.TOTAL_LITROS);

                    pstmt_tDBOutput_3.setBigDecimal(18, map2.TOTAL_VENDA);

                    pstmt_tDBOutput_3.setBigDecimal(19, map2.TOTAL_IMPOSTOS_SAIDA);

                    if(map2.CIDADE == null) {
pstmt_tDBOutput_3.setNull(20, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(20, map2.CIDADE);
}

                    if(map2.ESTADO == null) {
pstmt_tDBOutput_3.setNull(21, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(21, map2.ESTADO);
}

                    if(map2.COD_CLIENTE == null) {
pstmt_tDBOutput_3.setNull(22, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(22, map2.COD_CLIENTE);
}

                    if(map2.CLIENTE == null) {
pstmt_tDBOutput_3.setNull(23, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(23, map2.CLIENTE);
}

                    if(map2.COD_FORNECEDOR == null) {
pstmt_tDBOutput_3.setNull(24, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(24, map2.COD_FORNECEDOR);
}

                    if(map2.FORNECEDOR == null) {
pstmt_tDBOutput_3.setNull(25, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(25, map2.FORNECEDOR);
}

                    if(map2.DATA_E_HORA != null) {
pstmt_tDBOutput_3.setTimestamp(26, new java.sql.Timestamp(map2.DATA_E_HORA.getTime()));
} else {
pstmt_tDBOutput_3.setNull(26, java.sql.Types.TIMESTAMP);
}

                    if(map2.COND_PAGTO == null) {
pstmt_tDBOutput_3.setNull(27, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(27, map2.COND_PAGTO);
}

                    if(map2.COD_CND == null) {
pstmt_tDBOutput_3.setNull(28, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(28, map2.COD_CND);
}

                    if(map2.CND_DESCRI == null) {
pstmt_tDBOutput_3.setNull(29, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(29, map2.CND_DESCRI);
}

                    if(map2.DT_PEDIDO != null) {
pstmt_tDBOutput_3.setTimestamp(30, new java.sql.Timestamp(map2.DT_PEDIDO.getTime()));
} else {
 ...
 */
	...
	currentComponent="tHashInput_4";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_faturamento_compras_ano_" + pid +"_tHashOutput_3");
...
System.out.println("Finalizado reindex na vw_faturamento_compras");
System.out.println("\n");
System.out.println("*************************************************");
System.out.println("Finalizado atualização na vw_faturamento_compras");
System.out.println("Finalizado em: "+TalendDate.getCurrentDate());
System.out.println("*************************************************");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row4Struct> tHashFile_tHashInput_3 = mf_tHashInput_3.getAdvancedMemoryHashFile("tHashFile_faturamento_compras_ano_" + pid +"_tHashOutput_1");
 ...
 */
	...
	currentComponent="tHashInput_3";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_faturamento_compras_ano_" + pid +"_tHashOutput_1");
...
System.out.println("Finalizando JOB2 atualização vw_faturamento_compras");
System.out.println("Finalizando em: "+TalendDate.getCurrentDate());
System.out.println("*************************************************");
System.out.println("\n");
...
public static class row6Struct implements routines.system.IPersistableComparableLookupRow<row6Struct> {
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.CND_CODIGO == null) ? 0 : this.CND_CODIGO.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final row6Struct other = (row6Struct) obj;
						...
						if (this.CND_CODIGO == null) {
							if (other.CND_CODIGO != null)
								return false;
						
						} else if (!this.CND_CODIGO.equals(other.CND_CODIGO))
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
						...
						this.CND_DESCRI = readString(dis,ois);
    ...
    public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
        try {
			int length = 0;
						...
						this.CND_DESCRI = readString(dis,objectIn);
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
						...
						writeString(this.CND_DESCRI, dos, oos);
    ...
    public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut){
                try {
						...
						writeString(this.CND_DESCRI, dos, objectOut);
    ...
    public int compareTo(row6Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.CND_CODIGO, other.CND_CODIGO);
						if(returnValue != 0) {
							return returnValue;
						}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row6";
		...
		int tos_count_tAdvancedHash_row6 = 0;
			   		...
			   		// source node:tHashInput_2 - inputs:(after_tHashInput_4) outputs:(row6,row6) | target node:tAdvancedHash_row6 - inputs:(row6) outputs:()
			   		// linked node: tMap_5 - inputs:(row7,row6) outputs:(map2)
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<cadcndStruct> tHashFile_tHashInput_2 = mf_tHashInput_2.getAdvancedMemoryHashFile("tHashFile_faturamento_compras_ano_" + pid +"_tHashOutput_4");
if(tHashFile_tHashInput_2==null) {
	throw new RuntimeException("The hash is not initialized : The hash must exist before you read from it");
}
java.util.Iterator<cadcndStruct> iterator_tHashInput_2 = tHashFile_tHashInput_2.iterator();
while (iterator_tHashInput_2.hasNext()) {
    cadcndStruct next_tHashInput_2 = iterator_tHashInput_2.next();

	row6.CND_CODIGO = next_tHashInput_2.CND_CODIGO;
	row6.CND_DESCRI = next_tHashInput_2.CND_DESCRI;
 ...
 */
	...
	currentComponent="tAdvancedHash_row6";
				...
				row6_HashRow.CND_CODIGO = row6.CND_CODIGO;
				
				row6_HashRow.CND_DESCRI = row6.CND_DESCRI;
 ...
 */
	...
	currentComponent="tHashInput_2";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_faturamento_compras_ano_" + pid +"_tHashOutput_4");
 ...
 */
    ...
    public static void main(String[] args){
        final faturamento_compras_ano faturamento_compras_anoClass = new faturamento_compras_ano();

        int exitCode = faturamento_compras_anoClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = faturamento_compras_ano.class.getClassLoader().getResourceAsStream("palacio_ferramentas/faturamento_compras_ano_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = faturamento_compras_ano.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : faturamento_compras_ano");
        }
...
/************************************************************************************************
 *     544894 characters generated by Talend Open Studio for Big Data 
 *     on the 16 de abril de 2025 16:28:02 BRT
 ************************************************************************************************/