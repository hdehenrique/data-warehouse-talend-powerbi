...
package palacio_ferramentas.faturamento_ano_0_1;
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "faturamento_ano";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				faturamento_ano.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(faturamento_ano.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
System.out.println("*************************************************");
System.out.println("Iniciando select na FATURAMENTO_ANO");
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		palacio_ferramentas.vw_faturamento_ano_0_1.vw_faturamento_ano childJob_tRunJob_1 = new palacio_ferramentas.vw_faturamento_ano_0_1.vw_faturamento_ano();
	    // pass DataSources
...
System.out.println("*************************************************");
System.out.println("Iniciando select na FATURAMENTO_COMPRAS_ANO");
System.out.println("Iniciado em: "+TalendDate.getCurrentDate());
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		palacio_ferramentas.faturamento_compras_ano_0_1.faturamento_compras_ano childJob_tRunJob_2 = new palacio_ferramentas.faturamento_compras_ano_0_1.faturamento_compras_ano();
	    // pass DataSources
...
System.out.println("*************************************************");
System.out.println("Iniciando select na FATURAMENTO_CANAL_DIA");
System.out.println("Iniciado em: "+TalendDate.getCurrentDate());
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		palacio_ferramentas.updated_t_faturamento_canal_dia_0_1.updated_t_faturamento_canal_dia childJob_tRunJob_3 = new palacio_ferramentas.updated_t_faturamento_canal_dia_0_1.updated_t_faturamento_canal_dia();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final faturamento_ano faturamento_anoClass = new faturamento_ano();

        int exitCode = faturamento_anoClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = faturamento_ano.class.getClassLoader().getResourceAsStream("palacio_ferramentas/faturamento_ano_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = faturamento_ano.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : faturamento_ano");
        }
...
/************************************************************************************************
 *     58095 characters generated by Talend Open Studio for Big Data 
