...
package palacio_ferramentas.updated_t_faturamento_canal_dia_0_1;
...
/**
 * Job: updated_t_faturamento_canal_dia Purpose: <br>
 * Description:  <br>
 * @author henriquesantos@palaciodasferramentas.com.br
 * @version 8.0.1.20230922_0317-SNAPSHOT
 * @status 
 */
public class updated_t_faturamento_canal_dia implements TalendJob {
...
public String getPOSTGRES_PASSWORD(){
	...
	private final String jobName = "updated_t_faturamento_canal_dia";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				updated_t_faturamento_canal_dia.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(updated_t_faturamento_canal_dia.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_PALACIO_FERRAMENTAS_updated_t_faturamento_canal_dia = new byte[0];
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_updated_t_faturamento_canal_dia = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PALACIO_FERRAMENTAS_updated_t_faturamento_canal_dia.length) {
				if(length < 1024 && commonByteArray_PALACIO_FERRAMENTAS_updated_t_faturamento_canal_dia.length == 0) {
   					commonByteArray_PALACIO_FERRAMENTAS_updated_t_faturamento_canal_dia = new byte[1024];
				} else {
   					commonByteArray_PALACIO_FERRAMENTAS_updated_t_faturamento_canal_dia = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PALACIO_FERRAMENTAS_updated_t_faturamento_canal_dia, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_updated_t_faturamento_canal_dia, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PALACIO_FERRAMENTAS_updated_t_faturamento_canal_dia, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_updated_t_faturamento_canal_dia, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PALACIO_FERRAMENTAS_updated_t_faturamento_canal_dia) {
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_1=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_1 = "tHashFile_updated_t_faturamento_canal_dia_" + pid + "_tHashOutput_1";
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_5=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_5 = "tHashFile_updated_t_faturamento_canal_dia_" + pid + "_tHashOutput_5";
...
+"AT,\n	       CADITE ITEM\nWHERE FAT.COD_ITEM = ITEM.ITE_CODITE\n	AND FAT.DATA_ANO = YEAR(CURRENT_DATE())\nGROUP BY FAT.C"
+"OD_ITEM, FAT.NOME_VENDEDOR,	DATA;\n";
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_6=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_6 = "tHashFile_updated_t_faturamento_canal_dia_" + pid + "_tHashOutput_6";
 ...
 */
	...
	currentComponent="tDBInput_2";
		...
		int tos_count_tDBInput_2 = 0;
		    ...
		    String dbquery_tDBInput_2 = "\nselect cd_produto SKU, curva_vlr CURVA \n from dw_t_produto;\n";
...
int count_tDBOutput_4=0;
	    String update_tDBOutput_4 = "UPDATE \"" + tableName_tDBOutput_4 + "\" SET \"descricao\" = ?,\"curva\" = ?,\"canal\" = ?,\"fornecedor\" = ?,\"marca\" = ?,\"categoria\" = ?,\"faturamento\" = ?,\"qtd_pecas\" = ? WHERE \"data\" = ? AND \"empresa\" = ? AND \"sku\" = ? AND \"cod_vendedor\" = ?";
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row1Struct> tHashFile_tHashInput_6 = mf_tHashInput_6.getAdvancedMemoryHashFile("tHashFile_updated_t_faturamento_canal_dia_" + pid +"_tHashOutput_5");
...
if(Saida1 != null) { 
	...
	currentComponent="tDBOutput_4";
        ...
        whetherReject_tDBOutput_4 = false;
                    if(Saida1.DESCRICAO == null) {
pstmt_tDBOutput_4.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(1, Saida1.DESCRICAO);
}

                    if(Saida1.CURVA == null) {
pstmt_tDBOutput_4.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(2, Saida1.CURVA);
}

                    if(Saida1.CANAL == null) {
pstmt_tDBOutput_4.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(3, Saida1.CANAL);
}

                    if(Saida1.FORNECEDOR == null) {
pstmt_tDBOutput_4.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(4, Saida1.FORNECEDOR);
}

                    if(Saida1.MARCA == null) {
pstmt_tDBOutput_4.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(5, Saida1.MARCA);
}

                    if(Saida1.CATEGORIA == null) {
pstmt_tDBOutput_4.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(6, Saida1.CATEGORIA);
}

                    pstmt_tDBOutput_4.setBigDecimal(7, Saida1.FATURAMENTO);

                    if(Saida1.QTD_PECAS == null) {
pstmt_tDBOutput_4.setNull(8, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_4.setInt(8, Saida1.QTD_PECAS);
}

                    if(Saida1.DATA != null) {
pstmt_tDBOutput_4.setTimestamp(9 + count_tDBOutput_4, new java.sql.Timestamp(Saida1.DATA.getTime()));
} else {
pstmt_tDBOutput_4.setNull(9 + count_tDBOutput_4, java.sql.Types.TIMESTAMP);
}


                    if(Saida1.EMPRESA == null) {
pstmt_tDBOutput_4.setNull(10 + count_tDBOutput_4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(10 + count_tDBOutput_4, Saida1.EMPRESA);
}


                    if(Saida1.SKU == null) {
pstmt_tDBOutput_4.setNull(11 + count_tDBOutput_4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(11 + count_tDBOutput_4, Saida1.SKU);
}


                    if(Saida1.COD_VENDEDOR == null) {
pstmt_tDBOutput_4.setNull(12 + count_tDBOutput_4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(12 + count_tDBOutput_4, Saida1.COD_VENDEDOR);
}
 ...
 */
	...
	currentComponent="tHashInput_6";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_updated_t_faturamento_canal_dia_" + pid +"_tHashOutput_5");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row4Struct> tHashFile_tHashInput_1 = mf_tHashInput_1.getAdvancedMemoryHashFile("tHashFile_updated_t_faturamento_canal_dia_" + pid +"_tHashOutput_1");
 ...
 */
	...
	currentComponent="tHashInput_1";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_updated_t_faturamento_canal_dia_" + pid +"_tHashOutput_1");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row3Struct> tHashFile_tHashInput_7 = mf_tHashInput_7.getAdvancedMemoryHashFile("tHashFile_updated_t_faturamento_canal_dia_" + pid +"_tHashOutput_6");
 ...
 */
	...
	currentComponent="tHashInput_7";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_updated_t_faturamento_canal_dia_" + pid +"_tHashOutput_6");
 ...
 */
    ...
    public static void main(String[] args){
        final updated_t_faturamento_canal_dia updated_t_faturamento_canal_diaClass = new updated_t_faturamento_canal_dia();

        int exitCode = updated_t_faturamento_canal_diaClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = updated_t_faturamento_canal_dia.class.getClassLoader().getResourceAsStream("palacio_ferramentas/updated_t_faturamento_canal_dia_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = updated_t_faturamento_canal_dia.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : updated_t_faturamento_canal_dia");
        }
...
/************************************************************************************************
 *     311303 characters generated by Talend Open Studio for Big Data 
 *     on the 16 de abril de 2025 16:28:03 BRT
 ************************************************************************************************/