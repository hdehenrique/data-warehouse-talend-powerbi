...
package palacio.relatorio_marketplaces_shopee_2024_0_1;
...
public static class row5Struct implements routines.system.IPersistableRow<row5Struct> {
    final static byte[] commonByteArrayLock_PALACIO_relatorio_marketplaces_shopee_2024 = new byte[0];
    static byte[] commonByteArray_PALACIO_relatorio_marketplaces_shopee_2024 = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PALACIO_relatorio_marketplaces_shopee_2024.length) {
				if(length < 1024 && commonByteArray_PALACIO_relatorio_marketplaces_shopee_2024.length == 0) {
   					commonByteArray_PALACIO_relatorio_marketplaces_shopee_2024 = new byte[1024];
				} else {
   					commonByteArray_PALACIO_relatorio_marketplaces_shopee_2024 = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PALACIO_relatorio_marketplaces_shopee_2024, 0, length);
			strReturn = new String(commonByteArray_PALACIO_relatorio_marketplaces_shopee_2024, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PALACIO_relatorio_marketplaces_shopee_2024, 0, length);
			strReturn = new String(commonByteArray_PALACIO_relatorio_marketplaces_shopee_2024, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PALACIO_relatorio_marketplaces_shopee_2024) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = relatorio_marketplaces_shopee_2024.class.getClassLoader().getResourceAsStream("palacio/relatorio_marketplaces_shopee_2024_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     555205 characters generated by Talend Open Studio for Big Data 
 *     on the 23 de abril de 2024 01:01:04 BRT
 ************************************************************************************************/