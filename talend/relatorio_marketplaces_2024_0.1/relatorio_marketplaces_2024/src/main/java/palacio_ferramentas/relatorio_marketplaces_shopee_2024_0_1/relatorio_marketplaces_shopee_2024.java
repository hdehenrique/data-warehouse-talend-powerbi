...
package palacio_ferramentas.relatorio_marketplaces_shopee_2024_0_1;
...
/**
 * Job: relatorio_marketplaces_shopee_2024 Purpose: <br>
 * Description:  <br>
 * @author talend@talend.com
 * @version 8.0.1.20230922_0317-SNAPSHOT
 * @status 
 */
public class relatorio_marketplaces_shopee_2024 implements TalendJob {
...
public String getCaminho(){
	...
	private final String jobName = "relatorio_marketplaces_shopee_2024";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				relatorio_marketplaces_shopee_2024.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(relatorio_marketplaces_shopee_2024.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tDBConnection_3";
		...
		int tos_count_tDBConnection_3 = 0;
            ...
            String dbProperties_tDBConnection_3 = "ApplicationName=relatorio_marketplaces_shopee_2024";
...
public static class row5Struct implements routines.system.IPersistableRow<row5Struct> {
    final static byte[] commonByteArrayLock_PALACIO_FERRAMENTAS_relatorio_marketplaces_shopee_2024 = new byte[0];
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_relatorio_marketplaces_shopee_2024 = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PALACIO_FERRAMENTAS_relatorio_marketplaces_shopee_2024.length) {
				if(length < 1024 && commonByteArray_PALACIO_FERRAMENTAS_relatorio_marketplaces_shopee_2024.length == 0) {
   					commonByteArray_PALACIO_FERRAMENTAS_relatorio_marketplaces_shopee_2024 = new byte[1024];
				} else {
   					commonByteArray_PALACIO_FERRAMENTAS_relatorio_marketplaces_shopee_2024 = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PALACIO_FERRAMENTAS_relatorio_marketplaces_shopee_2024, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_relatorio_marketplaces_shopee_2024, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PALACIO_FERRAMENTAS_relatorio_marketplaces_shopee_2024, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_relatorio_marketplaces_shopee_2024, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PALACIO_FERRAMENTAS_relatorio_marketplaces_shopee_2024) {
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_1=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_1 = "tHashFile_relatorio_marketplaces_shopee_2024_" + pid + "_tHashOutput_1";
...
row15Struct row15 = new row15Struct();
	...
	currentComponent="tFileOutputExcel_6";
		...
		String fileName_tFileOutputExcel_6="/root/e_mail/MKT_PLACE_SHOPEE_REI_2024.xlsx";
...
row13Struct row13 = new row13Struct();
	...
	currentComponent="tFileOutputExcel_1";
		...
		String fileName_tFileOutputExcel_1="/root/e_mail/MKT_PLACE_SHOPEE_2024.xlsx";
    ...
    xlsxTool_tFileOutputExcel_1.setTruncateExceedingCharacters(false);
		...
		xlsxTool_tFileOutputExcel_1.addCellValue("NM_DOCUMENTO");
		
		xlsxTool_tFileOutputExcel_1.addCellValue("CD_EMPRESA");
		
		xlsxTool_tFileOutputExcel_1.addCellValue("VENDEDOR");
		
		xlsxTool_tFileOutputExcel_1.addCellValue("NOME_VENDEDOR");
		
		xlsxTool_tFileOutputExcel_1.addCellValue("PEDIDO_AUTCOM");
		
		xlsxTool_tFileOutputExcel_1.addCellValue("DESC_FULFILLMENT");
		...
		xlsxTool_tFileOutputExcel_1.addCellValue("NOTA_DEVOLUCAO");
		
		xlsxTool_tFileOutputExcel_1.addCellValue("NM_ROMANEIO");
		
		xlsxTool_tFileOutputExcel_1.addCellValue("DT_PEDIDO");
		
		xlsxTool_tFileOutputExcel_1.addCellValue("SKU");
		
		xlsxTool_tFileOutputExcel_1.addCellValue("DESC_SKU");
		
		xlsxTool_tFileOutputExcel_1.addCellValue("QTD_SKU");
		
		xlsxTool_tFileOutputExcel_1.addCellValue("VL_TOTAL_SKU");
		
		xlsxTool_tFileOutputExcel_1.addCellValue("VL_UNITARIO");
		
		xlsxTool_tFileOutputExcel_1.addCellValue("VL_DESCONTO");
		
		xlsxTool_tFileOutputExcel_1.addCellValue("VL_PRODUTOS_PEDIDO");
		
		xlsxTool_tFileOutputExcel_1.addCellValue("VL_FRETE");
		
		xlsxTool_tFileOutputExcel_1.addCellValue("VL_PEDIDO");
		
		xlsxTool_tFileOutputExcel_1.addCellValue("BASE_ICMS");
		
		xlsxTool_tFileOutputExcel_1.addCellValue("VL_ICMS");
		
		xlsxTool_tFileOutputExcel_1.addCellValue("NOME_TRANSPORTADORA");
 ...
 */
	...
	currentComponent="tDBInput_1";
		...
		int tos_count_tDBInput_1 = 0;
		    ...
		    String dbquery_tDBInput_1 = "SELECT MG.GER_CODCLI CD_CLIENTE,\n       CL.CLI_C_G_C_ NM_DOCUMENTO,\n	   MG.GER_CODEMP CD_EMPRESA,\n	   MG.GER_CODVEN "
+"VENDEDOR,\n	   OP.OPE_NOMOPE NOME_VENDEDOR,\n       FG.FGO_NUMDOC PEDIDO_AUTCOM,\n       FG.FGO_NUMPOK DESC_FULFILLMENT	"
+",\n       MG.GER_ESPDOC TIPO_NOTA,\n       MG.GER_NUMDOC NUMERO_NOTA,\n       MG.GER_SERIE_ SERIE_NOTA,\n       (SELECT "
+"MAX( DEV.DET_NUMDOC) FROM MOVDET DEV\n           WHERE DEV.DET_DOCDEV = MG.GER_NUMDOC \n           AND DEV.DET_EMPDEV = "
+"MG.GER_CODEMP \n           AND DEV.DET_ESPDEV = MG.GER_ESPDOC \n           AND DEV.DET_CODVEN = MG.GER_CODVEN\n         "
...
+".GER_CODEMP = '001'\n  AND MG.GER_DTAENT >= '2024-01-01';\n";
		    ...
		    while (rs_tDBInput_1.next()) {
		        nb_line_tDBInput_1++;
							...
							if(colQtyInRs_tDBInput_1 < 1) {
								row2.CD_CLIENTE = null;
							} else {
		                          
            row2.CD_CLIENTE = rs_tDBInput_1.getInt(1);
            if(rs_tDBInput_1.wasNull()){
                    row2.CD_CLIENTE = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								row2.NM_DOCUMENTO = null;
							} else {
	                         		
        	row2.NM_DOCUMENTO = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 3) {
								row2.CD_EMPRESA = null;
							} else {
	                         		
        	row2.CD_EMPRESA = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 4) {
								row2.VENDEDOR = null;
							} else {
	                         		
        	row2.VENDEDOR = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 5) {
								row2.NOME_VENDEDOR = null;
							} else {
	                         		
        	row2.NOME_VENDEDOR = routines.system.JDBCUtil.getString(rs_tDBInput_1, 5, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 6) {
								row2.PEDIDO_AUTCOM = null;
							} else {
	                         		
        	row2.PEDIDO_AUTCOM = routines.system.JDBCUtil.getString(rs_tDBInput_1, 6, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 7) {
								row2.DESC_FULFILLMENT = null;
							} else {
	                         		
        	row2.DESC_FULFILLMENT = routines.system.JDBCUtil.getString(rs_tDBInput_1, 7, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 8) {
								row2.TIPO_NOTA = null;
							} else {
	                         		
        	row2.TIPO_NOTA = routines.system.JDBCUtil.getString(rs_tDBInput_1, 8, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 9) {
								row2.NUMERO_NOTA = null;
							} else {
	                         		
        	row2.NUMERO_NOTA = routines.system.JDBCUtil.getString(rs_tDBInput_1, 9, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 10) {
								row2.SERIE_NOTA = null;
							} else {
	                         		
        	row2.SERIE_NOTA = routines.system.JDBCUtil.getString(rs_tDBInput_1, 10, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 11) {
								row2.NOTA_DEVOLUCAO = null;
							} else {
	                         		
        	row2.NOTA_DEVOLUCAO = routines.system.JDBCUtil.getString(rs_tDBInput_1, 11, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 12) {
								row2.NM_ROMANEIO = null;
							} else {
	                         		
        	row2.NM_ROMANEIO = routines.system.JDBCUtil.getString(rs_tDBInput_1, 12, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 13) {
								row2.DT_PEDIDO = null;
							} else {
	                         		
        	row2.DT_PEDIDO = routines.system.JDBCUtil.getString(rs_tDBInput_1, 13, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 14) {
								row2.SKU = null;
							} else {
	                         		
        	row2.SKU = routines.system.JDBCUtil.getString(rs_tDBInput_1, 14, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 15) {
								row2.DESC_SKU = null;
							} else {
	                         		
        	row2.DESC_SKU = routines.system.JDBCUtil.getString(rs_tDBInput_1, 15, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 16) {
								row2.QTD_SKU = null;
							} else {
	                         		
            row2.QTD_SKU = rs_tDBInput_1.getDouble(16);
            if(rs_tDBInput_1.wasNull()){
                    row2.QTD_SKU = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 17) {
								row2.VL_TOTAL_SKU = null;
							} else {
	                         		
            row2.VL_TOTAL_SKU = rs_tDBInput_1.getDouble(17);
            if(rs_tDBInput_1.wasNull()){
                    row2.VL_TOTAL_SKU = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 18) {
								row2.VL_UNITARIO = null;
							} else {
	                         		
            row2.VL_UNITARIO = rs_tDBInput_1.getDouble(18);
            if(rs_tDBInput_1.wasNull()){
                    row2.VL_UNITARIO = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 19) {
								row2.VL_DESCONTO = null;
							} else {
	                         		
            row2.VL_DESCONTO = rs_tDBInput_1.getDouble(19);
            if(rs_tDBInput_1.wasNull()){
                    row2.VL_DESCONTO = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 20) {
								row2.VL_PRODUTOS_PEDIDO = null;
							} else {
	                         		
            row2.VL_PRODUTOS_PEDIDO = rs_tDBInput_1.getDouble(20);
            if(rs_tDBInput_1.wasNull()){
                    row2.VL_PRODUTOS_PEDIDO = null;
            }
		                    }
            ...
            row2.VL_FRETE = rs_tDBInput_1.getDouble(21);
            if(rs_tDBInput_1.wasNull()){
                    row2.VL_FRETE = null;
            }
		                    }
            ...
            row2.VL_PEDIDO = rs_tDBInput_1.getDouble(22);
            if(rs_tDBInput_1.wasNull()){
                    row2.VL_PEDIDO = null;
            }
		                    }
            ...
            row2.BASE_ICMS = rs_tDBInput_1.getDouble(23);
            if(rs_tDBInput_1.wasNull()){
                    row2.BASE_ICMS = null;
            }
		                    }
            ...
            row2.VL_ICMS = rs_tDBInput_1.getDouble(24);
            if(rs_tDBInput_1.wasNull()){
                    row2.VL_ICMS = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 25) {
								row2.NOME_TRANSPORTADORA = null;
							} else {
	                         		
        	row2.NOME_TRANSPORTADORA = routines.system.JDBCUtil.getString(rs_tDBInput_1, 25, false);
		                    }
...
// # Output table : 'map'
map_tmp.CD_CLIENTE = row2.CD_CLIENTE ;
map_tmp.NM_DOCUMENTO = row2.NM_DOCUMENTO ;
map_tmp.CD_EMPRESA = row2.CD_EMPRESA ;
map_tmp.VENDEDOR = row2.VENDEDOR ;
map_tmp.NOME_VENDEDOR = row2.NOME_VENDEDOR ;
map_tmp.PEDIDO_AUTCOM = row2.PEDIDO_AUTCOM ;
map_tmp.DESC_FULFILLMENT = row2.DESC_FULFILLMENT ;
map_tmp.TIPO_NOTA = row2.TIPO_NOTA ;
map_tmp.NUMERO_NOTA = row2.NUMERO_NOTA ;
map_tmp.SERIE_NOTA = row2.SERIE_NOTA ;
map_tmp.NOTA_DEVOLUCAO = row2.NOTA_DEVOLUCAO ;
map_tmp.NM_ROMANEIO = row2.NM_ROMANEIO ;
map_tmp.DT_PEDIDO = row2.DT_PEDIDO ;
map_tmp.SKU = row2.SKU ;
map_tmp.DESC_SKU = row2.DESC_SKU ;
map_tmp.QTD_SKU = row2.QTD_SKU ;
map_tmp.VL_TOTAL_SKU = row2.VL_TOTAL_SKU ;
map_tmp.VL_UNITARIO = row2.VL_UNITARIO ;
map_tmp.VL_DESCONTO = row2.VL_DESCONTO ;
map_tmp.VL_PRODUTOS_PEDIDO = row2.VL_PRODUTOS_PEDIDO ;
map_tmp.VL_FRETE = row2.VL_FRETE ;
map_tmp.VL_PEDIDO = row2.VL_PEDIDO ;
map_tmp.BASE_ICMS = row2.BASE_ICMS ;
map_tmp.VL_ICMS = row2.VL_ICMS ;
map_tmp.NOME_TRANSPORTADORA = row2.NOME_TRANSPORTADORA ;
map = map_tmp;
// ###############################
...
row13 = null;			
finder_tUniqRow_5.CD_CLIENTE = map.CD_CLIENTE;
if(map.NM_DOCUMENTO == null){
	finder_tUniqRow_5.NM_DOCUMENTO = null;
}else{
	finder_tUniqRow_5.NM_DOCUMENTO = map.NM_DOCUMENTO.toLowerCase();
}
if(map.CD_EMPRESA == null){
	finder_tUniqRow_5.CD_EMPRESA = null;
}else{
	finder_tUniqRow_5.CD_EMPRESA = map.CD_EMPRESA.toLowerCase();
}
if(map.VENDEDOR == null){
	finder_tUniqRow_5.VENDEDOR = null;
}else{
	finder_tUniqRow_5.VENDEDOR = map.VENDEDOR.toLowerCase();
}
if(map.NOME_VENDEDOR == null){
	finder_tUniqRow_5.NOME_VENDEDOR = null;
}else{
	finder_tUniqRow_5.NOME_VENDEDOR = map.NOME_VENDEDOR.toLowerCase();
}
if(map.PEDIDO_AUTCOM == null){
	finder_tUniqRow_5.PEDIDO_AUTCOM = null;
}else{
	finder_tUniqRow_5.PEDIDO_AUTCOM = map.PEDIDO_AUTCOM.toLowerCase();
}
if(map.DESC_FULFILLMENT == null){
	finder_tUniqRow_5.DESC_FULFILLMENT = null;
}else{
	finder_tUniqRow_5.DESC_FULFILLMENT = map.DESC_FULFILLMENT.toLowerCase();
}
if(map.TIPO_NOTA == null){
	finder_tUniqRow_5.TIPO_NOTA = null;
}else{
	finder_tUniqRow_5.TIPO_NOTA = map.TIPO_NOTA.toLowerCase();
}
if(map.NUMERO_NOTA == null){
	finder_tUniqRow_5.NUMERO_NOTA = null;
}else{
	finder_tUniqRow_5.NUMERO_NOTA = map.NUMERO_NOTA.toLowerCase();
}
if(map.SERIE_NOTA == null){
	finder_tUniqRow_5.SERIE_NOTA = null;
}else{
	finder_tUniqRow_5.SERIE_NOTA = map.SERIE_NOTA.toLowerCase();
}
if(map.NOTA_DEVOLUCAO == null){
	finder_tUniqRow_5.NOTA_DEVOLUCAO = null;
}else{
	finder_tUniqRow_5.NOTA_DEVOLUCAO = map.NOTA_DEVOLUCAO.toLowerCase();
}
if(map.NM_ROMANEIO == null){
	finder_tUniqRow_5.NM_ROMANEIO = null;
}else{
	finder_tUniqRow_5.NM_ROMANEIO = map.NM_ROMANEIO.toLowerCase();
}
if(map.DT_PEDIDO == null){
	finder_tUniqRow_5.DT_PEDIDO = null;
}else{
	finder_tUniqRow_5.DT_PEDIDO = map.DT_PEDIDO.toLowerCase();
}
if(map.SKU == null){
	finder_tUniqRow_5.SKU = null;
}else{
	finder_tUniqRow_5.SKU = map.SKU.toLowerCase();
}
if(map.DESC_SKU == null){
	finder_tUniqRow_5.DESC_SKU = null;
}else{
	finder_tUniqRow_5.DESC_SKU = map.DESC_SKU.toLowerCase();
}
finder_tUniqRow_5.QTD_SKU = map.QTD_SKU;
finder_tUniqRow_5.VL_TOTAL_SKU = map.VL_TOTAL_SKU;
finder_tUniqRow_5.VL_UNITARIO = map.VL_UNITARIO;
finder_tUniqRow_5.VL_DESCONTO = map.VL_DESCONTO;
finder_tUniqRow_5.VL_PRODUTOS_PEDIDO = map.VL_PRODUTOS_PEDIDO;
finder_tUniqRow_5.VL_FRETE = map.VL_FRETE;
finder_tUniqRow_5.VL_PEDIDO = map.VL_PEDIDO;
finder_tUniqRow_5.BASE_ICMS = map.BASE_ICMS;
finder_tUniqRow_5.VL_ICMS = map.VL_ICMS;
if(map.NOME_TRANSPORTADORA == null){
	finder_tUniqRow_5.NOME_TRANSPORTADORA = null;
}else{
	finder_tUniqRow_5.NOME_TRANSPORTADORA = map.NOME_TRANSPORTADORA.toLowerCase();
}	
...
new_tUniqRow_5.CD_CLIENTE = map.CD_CLIENTE;
if(map.NM_DOCUMENTO == null){
	new_tUniqRow_5.NM_DOCUMENTO = null;
}else{
	new_tUniqRow_5.NM_DOCUMENTO = map.NM_DOCUMENTO.toLowerCase();
}
if(map.CD_EMPRESA == null){
	new_tUniqRow_5.CD_EMPRESA = null;
}else{
	new_tUniqRow_5.CD_EMPRESA = map.CD_EMPRESA.toLowerCase();
}
if(map.VENDEDOR == null){
	new_tUniqRow_5.VENDEDOR = null;
}else{
	new_tUniqRow_5.VENDEDOR = map.VENDEDOR.toLowerCase();
}
if(map.NOME_VENDEDOR == null){
	new_tUniqRow_5.NOME_VENDEDOR = null;
}else{
	new_tUniqRow_5.NOME_VENDEDOR = map.NOME_VENDEDOR.toLowerCase();
}
if(map.PEDIDO_AUTCOM == null){
	new_tUniqRow_5.PEDIDO_AUTCOM = null;
}else{
	new_tUniqRow_5.PEDIDO_AUTCOM = map.PEDIDO_AUTCOM.toLowerCase();
}
if(map.DESC_FULFILLMENT == null){
	new_tUniqRow_5.DESC_FULFILLMENT = null;
}else{
	new_tUniqRow_5.DESC_FULFILLMENT = map.DESC_FULFILLMENT.toLowerCase();
}
if(map.TIPO_NOTA == null){
	new_tUniqRow_5.TIPO_NOTA = null;
}else{
	new_tUniqRow_5.TIPO_NOTA = map.TIPO_NOTA.toLowerCase();
}
if(map.NUMERO_NOTA == null){
	new_tUniqRow_5.NUMERO_NOTA = null;
}else{
	new_tUniqRow_5.NUMERO_NOTA = map.NUMERO_NOTA.toLowerCase();
}
if(map.SERIE_NOTA == null){
	new_tUniqRow_5.SERIE_NOTA = null;
}else{
	new_tUniqRow_5.SERIE_NOTA = map.SERIE_NOTA.toLowerCase();
}
if(map.NOTA_DEVOLUCAO == null){
	new_tUniqRow_5.NOTA_DEVOLUCAO = null;
}else{
	new_tUniqRow_5.NOTA_DEVOLUCAO = map.NOTA_DEVOLUCAO.toLowerCase();
}
if(map.NM_ROMANEIO == null){
	new_tUniqRow_5.NM_ROMANEIO = null;
}else{
	new_tUniqRow_5.NM_ROMANEIO = map.NM_ROMANEIO.toLowerCase();
}
if(map.DT_PEDIDO == null){
	new_tUniqRow_5.DT_PEDIDO = null;
}else{
	new_tUniqRow_5.DT_PEDIDO = map.DT_PEDIDO.toLowerCase();
}
if(map.SKU == null){
	new_tUniqRow_5.SKU = null;
}else{
	new_tUniqRow_5.SKU = map.SKU.toLowerCase();
}
if(map.DESC_SKU == null){
	new_tUniqRow_5.DESC_SKU = null;
}else{
	new_tUniqRow_5.DESC_SKU = map.DESC_SKU.toLowerCase();
}
new_tUniqRow_5.QTD_SKU = map.QTD_SKU;
new_tUniqRow_5.VL_TOTAL_SKU = map.VL_TOTAL_SKU;
new_tUniqRow_5.VL_UNITARIO = map.VL_UNITARIO;
new_tUniqRow_5.VL_DESCONTO = map.VL_DESCONTO;
new_tUniqRow_5.VL_PRODUTOS_PEDIDO = map.VL_PRODUTOS_PEDIDO;
new_tUniqRow_5.VL_FRETE = map.VL_FRETE;
new_tUniqRow_5.VL_PEDIDO = map.VL_PEDIDO;
new_tUniqRow_5.BASE_ICMS = map.BASE_ICMS;
new_tUniqRow_5.VL_ICMS = map.VL_ICMS;
if(map.NOME_TRANSPORTADORA == null){
	new_tUniqRow_5.NOME_TRANSPORTADORA = null;
}else{
	new_tUniqRow_5.NOME_TRANSPORTADORA = map.NOME_TRANSPORTADORA.toLowerCase();
}
		
		keystUniqRow_5.add(new_tUniqRow_5);if(row13 == null){ 
	
	row13 = new row13Struct();
}row13.CD_CLIENTE = map.CD_CLIENTE;			row13.NM_DOCUMENTO = map.NM_DOCUMENTO;			row13.CD_EMPRESA = map.CD_EMPRESA;			row13.VENDEDOR = map.VENDEDOR;			row13.NOME_VENDEDOR = map.NOME_VENDEDOR;			row13.PEDIDO_AUTCOM = map.PEDIDO_AUTCOM;			row13.DESC_FULFILLMENT = map.DESC_FULFILLMENT;			row13.TIPO_NOTA = map.TIPO_NOTA;			row13.NUMERO_NOTA = map.NUMERO_NOTA;			row13.SERIE_NOTA = map.SERIE_NOTA;			row13.NOTA_DEVOLUCAO = map.NOTA_DEVOLUCAO;			row13.NM_ROMANEIO = map.NM_ROMANEIO;			row13.DT_PEDIDO = map.DT_PEDIDO;			row13.SKU = map.SKU;			row13.DESC_SKU = map.DESC_SKU;			row13.QTD_SKU = map.QTD_SKU;			row13.VL_TOTAL_SKU = map.VL_TOTAL_SKU;			row13.VL_UNITARIO = map.VL_UNITARIO;			row13.VL_DESCONTO = map.VL_DESCONTO;			row13.VL_PRODUTOS_PEDIDO = map.VL_PRODUTOS_PEDIDO;			row13.VL_FRETE = map.VL_FRETE;			row13.VL_PEDIDO = map.VL_PEDIDO;			row13.BASE_ICMS = map.BASE_ICMS;			row13.VL_ICMS = map.VL_ICMS;			row13.NOME_TRANSPORTADORA = map.NOME_TRANSPORTADORA;					
...
if(row13 != null) { 
	...
	currentComponent="tFileOutputExcel_1";
				...
				xlsxTool_tFileOutputExcel_1.addRow();
	    				...
	    				if(row13.CD_CLIENTE != null) {
    				
							xlsxTool_tFileOutputExcel_1.addCellValue(Double.parseDouble(String.valueOf(row13.CD_CLIENTE)));
	    				} else {
	    					xlsxTool_tFileOutputExcel_1.addCellNullValue();
	    				}
					
									   				
	    				if(row13.NM_DOCUMENTO != null) {
    				
							xlsxTool_tFileOutputExcel_1.addCellValue(String.valueOf(row13.NM_DOCUMENTO));
	    				} else {
	    					xlsxTool_tFileOutputExcel_1.addCellNullValue();
	    				}
					
									   				
	    				if(row13.CD_EMPRESA != null) {
    				
							xlsxTool_tFileOutputExcel_1.addCellValue(String.valueOf(row13.CD_EMPRESA));
	    				} else {
	    					xlsxTool_tFileOutputExcel_1.addCellNullValue();
	    				}
					
									   				
	    				if(row13.VENDEDOR != null) {
    				
							xlsxTool_tFileOutputExcel_1.addCellValue(String.valueOf(row13.VENDEDOR));
	    				} else {
	    					xlsxTool_tFileOutputExcel_1.addCellNullValue();
	    				}
					
									   				
	    				if(row13.NOME_VENDEDOR != null) {
    				
							xlsxTool_tFileOutputExcel_1.addCellValue(String.valueOf(row13.NOME_VENDEDOR));
	    				} else {
	    					xlsxTool_tFileOutputExcel_1.addCellNullValue();
	    				}
					
									   				
	    				if(row13.PEDIDO_AUTCOM != null) {
    				
							xlsxTool_tFileOutputExcel_1.addCellValue(String.valueOf(row13.PEDIDO_AUTCOM));
	    				} else {
	    					xlsxTool_tFileOutputExcel_1.addCellNullValue();
	    				}
					
									   				
	    				if(row13.DESC_FULFILLMENT != null) {
    				
							xlsxTool_tFileOutputExcel_1.addCellValue(String.valueOf(row13.DESC_FULFILLMENT));
	    				} else {
	    					xlsxTool_tFileOutputExcel_1.addCellNullValue();
	    				}
					
									   				
	    				if(row13.TIPO_NOTA != null) {
    				
							xlsxTool_tFileOutputExcel_1.addCellValue(String.valueOf(row13.TIPO_NOTA));
	    				} else {
	    					xlsxTool_tFileOutputExcel_1.addCellNullValue();
	    				}
					
									   				
	    				if(row13.NUMERO_NOTA != null) {
    				
							xlsxTool_tFileOutputExcel_1.addCellValue(String.valueOf(row13.NUMERO_NOTA));
	    				} else {
	    					xlsxTool_tFileOutputExcel_1.addCellNullValue();
	    				}
					
									   				
	    				if(row13.SERIE_NOTA != null) {
    				
							xlsxTool_tFileOutputExcel_1.addCellValue(String.valueOf(row13.SERIE_NOTA));
	    				} else {
	    					xlsxTool_tFileOutputExcel_1.addCellNullValue();
	    				}
					
									   				
	    				if(row13.NOTA_DEVOLUCAO != null) {
    				
							xlsxTool_tFileOutputExcel_1.addCellValue(String.valueOf(row13.NOTA_DEVOLUCAO));
	    				} else {
	    					xlsxTool_tFileOutputExcel_1.addCellNullValue();
	    				}
					
									   				
	    				if(row13.NM_ROMANEIO != null) {
    				
							xlsxTool_tFileOutputExcel_1.addCellValue(String.valueOf(row13.NM_ROMANEIO));
	    				} else {
	    					xlsxTool_tFileOutputExcel_1.addCellNullValue();
	    				}
					
									   				
	    				if(row13.DT_PEDIDO != null) {
    				
							xlsxTool_tFileOutputExcel_1.addCellValue(String.valueOf(row13.DT_PEDIDO));
	    				} else {
	    					xlsxTool_tFileOutputExcel_1.addCellNullValue();
	    				}
	    				...
	    				if(row13.SKU != null) {
							...
							xlsxTool_tFileOutputExcel_1.addCellValue(String.valueOf(row13.SKU));
	    				} else {
	    					xlsxTool_tFileOutputExcel_1.addCellNullValue();
	    				}
					
									   				
	    				if(row13.DESC_SKU != null) {
    				
							xlsxTool_tFileOutputExcel_1.addCellValue(String.valueOf(row13.DESC_SKU));
	    				} else {
	    					xlsxTool_tFileOutputExcel_1.addCellNullValue();
	    				}
					
									   				
	    				if(row13.QTD_SKU != null) {
    				
							xlsxTool_tFileOutputExcel_1.addCellValue(row13.QTD_SKU);
	    				} else {
	    					xlsxTool_tFileOutputExcel_1.addCellNullValue();
	    				}
					
									   				
	    				if(row13.VL_TOTAL_SKU != null) {
    				
							xlsxTool_tFileOutputExcel_1.addCellValue(row13.VL_TOTAL_SKU);
	    				} else {
	    					xlsxTool_tFileOutputExcel_1.addCellNullValue();
	    				}
					
									   				
	    				if(row13.VL_UNITARIO != null) {
    				
							xlsxTool_tFileOutputExcel_1.addCellValue(row13.VL_UNITARIO);
	    				} else {
	    					xlsxTool_tFileOutputExcel_1.addCellNullValue();
	    				}
					
									   				
	    				if(row13.VL_DESCONTO != null) {
    				
							xlsxTool_tFileOutputExcel_1.addCellValue(row13.VL_DESCONTO);
	    				} else {
	    					xlsxTool_tFileOutputExcel_1.addCellNullValue();
	    				}
					
									   				
	    				if(row13.VL_PRODUTOS_PEDIDO != null) {
    				
							xlsxTool_tFileOutputExcel_1.addCellValue(row13.VL_PRODUTOS_PEDIDO);
	    				} else {
	    					xlsxTool_tFileOutputExcel_1.addCellNullValue();
	    				}
					
									   				
	    				if(row13.VL_FRETE != null) {
    				
							xlsxTool_tFileOutputExcel_1.addCellValue(row13.VL_FRETE);
	    				} else {
	    					xlsxTool_tFileOutputExcel_1.addCellNullValue();
	    				}
					
									   				
	    				if(row13.VL_PEDIDO != null) {
    				
							xlsxTool_tFileOutputExcel_1.addCellValue(row13.VL_PEDIDO);
	    				} else {
	    					xlsxTool_tFileOutputExcel_1.addCellNullValue();
	    				}
					
									   				
	    				if(row13.BASE_ICMS != null) {
    				
							xlsxTool_tFileOutputExcel_1.addCellValue(row13.BASE_ICMS);
	    				} else {
	    					xlsxTool_tFileOutputExcel_1.addCellNullValue();
	    				}
					
									   				
	    				if(row13.VL_ICMS != null) {
    				
							xlsxTool_tFileOutputExcel_1.addCellValue(row13.VL_ICMS);
	    				} else {
	    					xlsxTool_tFileOutputExcel_1.addCellNullValue();
	    				}
					
									   				
	    				if(row13.NOME_TRANSPORTADORA != null) {
    				
							xlsxTool_tFileOutputExcel_1.addCellValue(String.valueOf(row13.NOME_TRANSPORTADORA));
	    				} else {
	    					xlsxTool_tFileOutputExcel_1.addCellNullValue();
	    				}
...
+"),',') email\n  from dw_t_relatorio_email\nwhere job = '"+context.programa+"'\n group by job, nm_relatorio, caminho";
        	...
        	row1.job = routines.system.JDBCUtil.getString(rs_tDBInput_2, 1, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 2) {
								row1.nm_relatorio = null;
							} else {
	                         		
        	row1.nm_relatorio = routines.system.JDBCUtil.getString(rs_tDBInput_2, 2, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 3) {
								row1.caminho = null;
							} else {
	                         		
        	row1.caminho = routines.system.JDBCUtil.getString(rs_tDBInput_2, 3, false);
		                    }
...
row3.job = row1.job;
row3.nm_relatorio = row1.nm_relatorio;
row3.caminho = row1.caminho;
...
///////////////////////		
	    		...
	    		if(row3.nm_relatorio != null) { //              
                    							
       
				strBuffer_tLogRow_1.append(
				                String.valueOf(row3.nm_relatorio)							
				);
	    		...
	    		if(row3.caminho != null) { //              
                    							
       
				strBuffer_tLogRow_1.append(
				                String.valueOf(row3.caminho)							
				);
 ...
 */
    ...
    String subject_tSendMail_1 = ("[Ad Hoc] Relatório Pedidos Shopee&2024");
	...
	java.util.List<String> contentTransferEncoding_tSendMail_1 = new java.util.ArrayList<String>();
		attachments_tSendMail_1.add("/root/e_mail/MKT_PLACE_SHOPEE_REI_2024.xlsx");
		contentTransferEncoding_tSendMail_1.add("DEFAULT");	
		attachments_tSendMail_1.add("/root/e_mail/MKT_PLACE_SHOPEE_2024.xlsx");
		contentTransferEncoding_tSendMail_1.add("DEFAULT");	

	String message_tSendMail_1 = (("Olá, bom dia!\n\nSegue em anexo o relatório referente as vendas Shopee de 2024.\n\nAtt,\n\nPlataforma de Dados | BI\nPa"
...
class DeleteFoldertFileDelete_1{
    ...
    java.io.File file_tFileDelete_1=new java.io.File("/root/e_mail/MKT_PLACE_SHOPEE_REI_2024.xlsx");
	...
	globalMap.put("tFileDelete_1_DELETE_PATH","/root/e_mail/MKT_PLACE_SHOPEE_REI_2024.xlsx");
...
class DeleteFoldertFileDelete_2{
    ...
    java.io.File file_tFileDelete_2=new java.io.File("/root/e_mail/MKT_PLACE_SHOPEE_2024.xlsx");
	...
	globalMap.put("tFileDelete_2_DELETE_PATH","/root/e_mail/MKT_PLACE_SHOPEE_2024.xlsx");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row5Struct> tHashFile_tHashInput_1 = mf_tHashInput_1.getAdvancedMemoryHashFile("tHashFile_relatorio_marketplaces_shopee_2024_" + pid +"_tHashOutput_1");
 ...
 */
	...
	currentComponent="tHashInput_1";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_relatorio_marketplaces_shopee_2024_" + pid +"_tHashOutput_1");
 ...
 */
	...
	System.err.println("Erro envio email - relatorio_marketplaces_shopee_2024");
	
	globalMap.put("tDie_1_DIE_MESSAGE", "Erro envio email - relatorio_marketplaces_shopee_2024");
	globalMap.put("tDie_1_DIE_MESSAGES", "Erro envio email - relatorio_marketplaces_shopee_2024");
 ...
 */
    ...
    public static void main(String[] args){
        final relatorio_marketplaces_shopee_2024 relatorio_marketplaces_shopee_2024Class = new relatorio_marketplaces_shopee_2024();

        int exitCode = relatorio_marketplaces_shopee_2024Class.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = relatorio_marketplaces_shopee_2024.class.getClassLoader().getResourceAsStream("palacio_ferramentas/relatorio_marketplaces_shopee_2024_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = relatorio_marketplaces_shopee_2024.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_2.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : relatorio_marketplaces_shopee_2024");
        }
...
/************************************************************************************************
 *     557593 characters generated by Talend Open Studio for Big Data 
 *     on the 21 de maio de 2024 11:30:05 BRT
 ************************************************************************************************/