...
package palacio_ferramentas.dw_t_cross_selling_0_1;
...
/**
 * Job: dw_t_cross_selling Purpose: <br>
 * Description:  <br>
 * @author talend@talend.com
 * @version 8.0.1.20230922_0317-SNAPSHOT
 * @status 
 */
public class dw_t_cross_selling implements TalendJob {
...
public String getPOSTGRES_USER(){
	...
	private final String jobName = "dw_t_cross_selling";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				dw_t_cross_selling.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(dw_t_cross_selling.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tDBConnection_1";
		...
		int tos_count_tDBConnection_1 = 0;
            ...
            String dbProperties_tDBConnection_1 = "ApplicationName=dw_cross_selling";
...
System.out.println("************** 03 - dw_cross_selling **************");
System.out.println("Iniciando JOB3 atualização dw_cross_selling");
...
public static class row38Struct implements routines.system.IPersistableRow<row38Struct> {
    final static byte[] commonByteArrayLock_PALACIO_FERRAMENTAS_dw_t_cross_selling = new byte[0];
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_dw_t_cross_selling = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PALACIO_FERRAMENTAS_dw_t_cross_selling.length) {
				if(length < 1024 && commonByteArray_PALACIO_FERRAMENTAS_dw_t_cross_selling.length == 0) {
   					commonByteArray_PALACIO_FERRAMENTAS_dw_t_cross_selling = new byte[1024];
				} else {
   					commonByteArray_PALACIO_FERRAMENTAS_dw_t_cross_selling = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PALACIO_FERRAMENTAS_dw_t_cross_selling, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_dw_t_cross_selling, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PALACIO_FERRAMENTAS_dw_t_cross_selling, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_dw_t_cross_selling, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PALACIO_FERRAMENTAS_dw_t_cross_selling) {
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_1=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row38Struct> tHashFile_tHashOutput_1 = null;
		String hashKey_tHashOutput_1 = "tHashFile_dw_t_cross_selling_" + pid + "_tHashOutput_1";
			synchronized(org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.get(hashKey_tHashOutput_1)){
			    if(mf_tHashOutput_1.getResourceMap().get(hashKey_tHashOutput_1) == null){
	      		    mf_tHashOutput_1.getResourceMap().put(hashKey_tHashOutput_1, new org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row38Struct>(org.talend.designer.components.hashfile.common.MATCHING_MODE.KEEP_ALL));
...
if(dbschema_tDBOutput_13 == null || dbschema_tDBOutput_13.trim().length() == 0) {
	tableName_tDBOutput_13 = ("dw_log_execucao").toLowerCase();
} else {
	tableName_tDBOutput_13 = dbschema_tDBOutput_13 + "\".\"" + ("dw_log_execucao").toLowerCase();
}
...
int count_tDBOutput_13=0;
        ...
        sb_tDBOutput_13.append("INSERT INTO \"").append(tableName_tDBOutput_13).append("\" (\"nm_programa\",\"data_inicio_execucao\",\"data_termino_execucao\",\"mensagem\",\"uuid\",\"versao\") VALUES (?,?,?,?,?,?)");
...
class tRowGenerator_1Randomizer {
	...
	for (int itRowGenerator_1=0; itRowGenerator_1<nb_max_row_tRowGenerator_1 ;itRowGenerator_1++) {
		row37.datainicio = randtRowGenerator_1.getRandomdatainicio();
...
insert_log_tmp.data_inicio_execucao = row37.datainicio ;
...
} else {pstmt_tDBOutput_13.setString(1, insert_log.nm_programa);
}

                    if(insert_log.data_inicio_execucao != null) {
pstmt_tDBOutput_13.setTimestamp(2, new java.sql.Timestamp(insert_log.data_inicio_execucao.getTime()));
} else {
pstmt_tDBOutput_13.setNull(2, java.sql.Types.TIMESTAMP);
}

                    if(insert_log.data_termino_execucao != null) {
pstmt_tDBOutput_13.setTimestamp(3, new java.sql.Timestamp(insert_log.data_termino_execucao.getTime()));
} else {
pstmt_tDBOutput_13.setNull(3, java.sql.Types.TIMESTAMP);
}

                    if(insert_log.mensagem == null) {
pstmt_tDBOutput_13.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_13.setString(4, insert_log.mensagem);
}

                    if(insert_log.uuid == null) {
pstmt_tDBOutput_13.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_13.setString(5, insert_log.uuid);
}

                    if(insert_log.versao == null) {
pstmt_tDBOutput_13.setNull(6, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_13.setInt(6, insert_log.versao);
}
            ...
            try {
                ...
                int processedCount_tDBOutput_13 = pstmt_tDBOutput_13.executeUpdate();
...
globalMap.put("tDBOutput_13_ERROR_MESSAGE",e.getMessage());
            ...
            if(!whetherReject_tDBOutput_13) {
                            row38 = new row38Struct();
                                row38.nm_programa = insert_log.nm_programa;
                                row38.data_inicio_execucao = insert_log.data_inicio_execucao;
                                row38.data_termino_execucao = insert_log.data_termino_execucao;
                                row38.mensagem = insert_log.mensagem;
                                row38.uuid = insert_log.uuid;
                                row38.versao = insert_log.versao;
            }
...
if(row38 != null) { 
	...
	currentComponent="tHashOutput_1";
		...
		row38Struct oneRow_tHashOutput_1 = new row38Struct();
				
					oneRow_tHashOutput_1.nm_programa = row38.nm_programa;
					oneRow_tHashOutput_1.data_inicio_execucao = row38.data_inicio_execucao;
					oneRow_tHashOutput_1.data_termino_execucao = row38.data_termino_execucao;
					oneRow_tHashOutput_1.mensagem = row38.mensagem;
					oneRow_tHashOutput_1.uuid = row38.uuid;
					oneRow_tHashOutput_1.versao = row38.versao;
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    ...
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_dw_t_cross_selling = new byte[0];
				...
				public String getSKU_A () {
					return this.SKU_A;
				}

				public Boolean SKU_AIsNullable(){
				    return true;
				}
				public Boolean SKU_AIsKey(){
				    return false;
				}
				public Integer SKU_ALength(){
				    return 5;
				}
				public Integer SKU_APrecision(){
				    return null;
				}
				public String SKU_ADefault(){
				
					return null;
				
				}
				public String SKU_AComment(){
				
				    return "";
				
				}
				public String SKU_APattern(){
				
					return "";
				
				}
				public String SKU_AOriginalDbColumnName(){
			    ...
			    public String DESC_SKU_A;

				public String getDESC_SKU_A () {
					return this.DESC_SKU_A;
				}

				public Boolean DESC_SKU_AIsNullable(){
				    return true;
				}
				public Boolean DESC_SKU_AIsKey(){
				    return false;
				}
				public Integer DESC_SKU_ALength(){
				    return 100;
				}
				public Integer DESC_SKU_APrecision(){
				    return null;
				}
				public String DESC_SKU_ADefault(){
				
					return null;
				
				}
				public String DESC_SKU_AComment(){
				
				    return "";
				
				}
				public String DESC_SKU_APattern(){
				
					return "";
				
				}
				public String DESC_SKU_AOriginalDbColumnName(){
				...
				public String getSKU_B () {
					return this.SKU_B;
				}

				public Boolean SKU_BIsNullable(){
				    return true;
				}
				public Boolean SKU_BIsKey(){
				    return false;
				}
				public Integer SKU_BLength(){
				    return 5;
				}
				public Integer SKU_BPrecision(){
				    return null;
				}
				public String SKU_BDefault(){
				
					return null;
				
				}
				public String SKU_BComment(){
				
				    return "";
				
				}
				public String SKU_BPattern(){
				
					return "";
				
				}
				public String SKU_BOriginalDbColumnName(){
			    ...
			    public String DES_SKU_B;

				public String getDES_SKU_B () {
					return this.DES_SKU_B;
				}

				public Boolean DES_SKU_BIsNullable(){
				    return true;
				}
				public Boolean DES_SKU_BIsKey(){
				    return false;
				}
				public Integer DES_SKU_BLength(){
				    return 100;
				}
				public Integer DES_SKU_BPrecision(){
				    return null;
				}
				public String DES_SKU_BDefault(){
				
					return null;
				
				}
				public String DES_SKU_BComment(){
				
				    return "";
				
				}
				public String DES_SKU_BPattern(){
				
					return "";
				
				}
				public String DES_SKU_BOriginalDbColumnName(){
		...
		synchronized(commonByteArrayLock_PALACIO_FERRAMENTAS_dw_t_cross_selling) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.SKU_A = readString(dis);
					
					this.DESC_SKU_A = readString(dis);
					
					this.SKU_B = readString(dis);
					
					this.DES_SKU_B = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.SKU_A,dos);
					
					// String
				
						writeString(this.DESC_SKU_A,dos);
					
					// String
				
						writeString(this.SKU_B,dos);
					
					// String
				
						writeString(this.DES_SKU_B,dos);
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("SKU_A="+SKU_A);
		sb.append(",DESC_SKU_A="+DESC_SKU_A);
		sb.append(",SKU_B="+SKU_B);
		sb.append(",DES_SKU_B="+DES_SKU_B);
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_2=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_2 = "tHashFile_dw_t_cross_selling_" + pid + "_tHashOutput_2";
		...
		class KeyStruct_tUniqRow_1 {
			...
			public int hashCode() {
				if (this.hashCodeDirty) {
					...
					int result = DEFAULT_HASHCODE;
								...
								result = prime * result + ((this.SKU_A == null) ? 0 : this.SKU_A.hashCode());
								
								result = prime * result + ((this.DESC_SKU_A == null) ? 0 : this.DESC_SKU_A.hashCode());
								
								result = prime * result + ((this.SKU_B == null) ? 0 : this.SKU_B.hashCode());
								
								result = prime * result + ((this.DES_SKU_B == null) ? 0 : this.DES_SKU_B.hashCode());
			...
			public boolean equals(Object obj) {
				...
				final KeyStruct_tUniqRow_1 other = (KeyStruct_tUniqRow_1) obj;
									...
									} else if (!this.SKU_A.equals(other.SKU_A))
								 
										return false;
								
									if (this.DESC_SKU_A == null) {
										if (other.DESC_SKU_A != null) 
											return false;
								
									} else if (!this.DESC_SKU_A.equals(other.DESC_SKU_A))
									...
									} else if (!this.SKU_B.equals(other.SKU_B))
								 
										return false;
								
									if (this.DES_SKU_B == null) {
										if (other.DES_SKU_B != null) 
											return false;
								
									} else if (!this.DES_SKU_B.equals(other.DES_SKU_B))
 ...
 */
	...
	currentComponent="tDBInput_3";
		...
		int tos_count_tDBInput_3 = 0;
		    ...
		    String dbquery_tDBInput_3 = "\nSELECT \n    A.COD_ITEM AS SKU_A,\n    A.ITEM AS DESC_SKU_A,\n    B.COD_ITEM AS SKU_B,\n    B.ITEM AS DES_SKU_B,\n   "
+" COUNT(*) AS QUANTIDADE\nFROM VW_FATURAMENTO A\nINNER JOIN VW_FATURAMENTO B ON\n    A.NUMERO_NOTA_FISCAL = B.NUMERO_NOTA"
+"_FISCAL AND A.EMPRESA = B.EMPRESA\nWHERE\n    A.COD_ITEM <> B.COD_ITEM -- CONDIÇÃO SKU A < SKU B\n    AND A.DATA_ANO = D"
+"ATE_PART('YEAR', CURRENT_TIMESTAMP)\n    AND B.DATA_ANO = DATE_PART('YEAR', CURRENT_TIMESTAMP)\n    AND A.VL_COMBO_ORIGE"
+"M = 0\n    AND B.VL_COMBO_ORIGEM = 0\n    AND A.QTD_ITEM > 0\n    AND B.QTD_ITEM > 0\n    AND A.COD_ITEM <> '75544'\n   "
+" AND A.COD_CLIENTE NOT IN ('11791872', '12578222', '12433365', '12930383', '12579961')\n    AND B.COD_CLIENTE NOT IN ('1"
+"1791872', '12578222', '12433365', '12930383', '12579961')\n    AND NOT EXISTS (\n        SELECT 1\n        FROM VW_FATUR"
+"AMENTO C\n        WHERE A.NUMERO_NOTA_FISCAL = C.NUMERO_NOTA_FISCAL AND A.EMPRESA = C.EMPRESA AND C.COD_ITEM < A.COD_ITE"
+"M AND C.COD_ITEM > B.COD_ITEM AND A.COD_ITEM <> B.COD_ITEM\n    )\nGROUP BY\n    A.COD_ITEM,\n    A.ITEM,\n    B.COD_ITE"
+"M,\n    B.ITEM\n HAVING \n     COUNT(*) >= 40\n";
        	...
        	row4.SKU_A = routines.system.JDBCUtil.getString(rs_tDBInput_3, 1, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 2) {
								row4.DESC_SKU_A = null;
							} else {
	                         		
        	row4.DESC_SKU_A = routines.system.JDBCUtil.getString(rs_tDBInput_3, 2, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 3) {
								row4.SKU_B = null;
							} else {
	                         		
        	row4.SKU_B = routines.system.JDBCUtil.getString(rs_tDBInput_3, 3, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 4) {
								row4.DES_SKU_B = null;
							} else {
	                         		
        	row4.DES_SKU_B = routines.system.JDBCUtil.getString(rs_tDBInput_3, 4, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 5) {
								row4.QUANTIDADE = null;
							} else {
		                          
            row4.QUANTIDADE = rs_tDBInput_3.getInt(5);
...
// # Output table : 'out1'
out1_tmp.SKU_A = row4.SKU_A ;
out1_tmp.DESC_SKU_A = row4.DESC_SKU_A ;
out1_tmp.SKU_B = row4.SKU_B ;
out1_tmp.DES_SKU_B = row4.DES_SKU_B ;
out1_tmp.QUANTIDADE = row4.QUANTIDADE ;
out1 = out1_tmp;
// ###############################
...
row1 = null;			
if(out1.SKU_A == null){
	finder_tUniqRow_1.SKU_A = null;
}else{
	finder_tUniqRow_1.SKU_A = out1.SKU_A.toLowerCase();
}
if(out1.DESC_SKU_A == null){
	finder_tUniqRow_1.DESC_SKU_A = null;
}else{
	finder_tUniqRow_1.DESC_SKU_A = out1.DESC_SKU_A.toLowerCase();
}
if(out1.SKU_B == null){
	finder_tUniqRow_1.SKU_B = null;
}else{
	finder_tUniqRow_1.SKU_B = out1.SKU_B.toLowerCase();
}
if(out1.DES_SKU_B == null){
	finder_tUniqRow_1.DES_SKU_B = null;
}else{
	finder_tUniqRow_1.DES_SKU_B = out1.DES_SKU_B.toLowerCase();
}
finder_tUniqRow_1.QUANTIDADE = out1.QUANTIDADE;	
...
if(out1.SKU_A == null){
	new_tUniqRow_1.SKU_A = null;
}else{
	new_tUniqRow_1.SKU_A = out1.SKU_A.toLowerCase();
}
if(out1.DESC_SKU_A == null){
	new_tUniqRow_1.DESC_SKU_A = null;
}else{
	new_tUniqRow_1.DESC_SKU_A = out1.DESC_SKU_A.toLowerCase();
}
if(out1.SKU_B == null){
	new_tUniqRow_1.SKU_B = null;
}else{
	new_tUniqRow_1.SKU_B = out1.SKU_B.toLowerCase();
}
if(out1.DES_SKU_B == null){
	new_tUniqRow_1.DES_SKU_B = null;
}else{
	new_tUniqRow_1.DES_SKU_B = out1.DES_SKU_B.toLowerCase();
}
new_tUniqRow_1.QUANTIDADE = out1.QUANTIDADE;
		
		keystUniqRow_1.add(new_tUniqRow_1);if(row1 == null){ 
	
	row1 = new row1Struct();
}row1.SKU_A = out1.SKU_A;			row1.DESC_SKU_A = out1.DESC_SKU_A;			row1.SKU_B = out1.SKU_B;			row1.DES_SKU_B = out1.DES_SKU_B;			row1.QUANTIDADE = out1.QUANTIDADE;					
...
if(row1 != null) { 
	...
	currentComponent="tHashOutput_2";
		...
		row1Struct oneRow_tHashOutput_2 = new row1Struct();
					...
					oneRow_tHashOutput_2.SKU_A = row1.SKU_A;
					oneRow_tHashOutput_2.DESC_SKU_A = row1.DESC_SKU_A;
					oneRow_tHashOutput_2.SKU_B = row1.SKU_B;
					oneRow_tHashOutput_2.DES_SKU_B = row1.DES_SKU_B;
					oneRow_tHashOutput_2.QUANTIDADE = row1.QUANTIDADE;
...
if(dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
	tableName_tDBOutput_2 = ("dw_t_cross_selling").toLowerCase();
} else {
	tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "\".\"" + ("dw_t_cross_selling").toLowerCase();
}
...
int count_tDBOutput_2=0;
        ...
        sb_tDBOutput_2.append("INSERT INTO \"").append(tableName_tDBOutput_2).append("\" (\"sku_a\",\"desc_sku_a\",\"sku_b\",\"des_sku_b\",\"quantidade\",\"dt_atualizacao\") VALUES (?,?,?,?,?,?)");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row1Struct> tHashFile_tHashInput_1 = mf_tHashInput_1.getAdvancedMemoryHashFile("tHashFile_dw_t_cross_selling_" + pid +"_tHashOutput_2");
...
while (iterator_tHashInput_1.hasNext()) {
	...
	row2.SKU_A = next_tHashInput_1.SKU_A;
	row2.DESC_SKU_A = next_tHashInput_1.DESC_SKU_A;
	row2.SKU_B = next_tHashInput_1.SKU_B;
	row2.DES_SKU_B = next_tHashInput_1.DES_SKU_B;
	row2.QUANTIDADE = next_tHashInput_1.QUANTIDADE;
...
// # Output table : 'out2'
out2_tmp.SKU_A = row2.SKU_A ;
out2_tmp.DESC_SKU_A = row2.DESC_SKU_A ;
out2_tmp.SKU_B = row2.SKU_B ;
out2_tmp.DES_SKU_B = row2.DES_SKU_B ;
out2_tmp.QUANTIDADE = row2.QUANTIDADE ;
out2_tmp.DT_ATUALIZACAO = TalendDate.getCurrentDate();
out2 = out2_tmp;
// ###############################
...
} else {pstmt_tDBOutput_2.setString(1, out2.SKU_A);
}

                    if(out2.DESC_SKU_A == null) {
pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(2, out2.DESC_SKU_A);
}

                    if(out2.SKU_B == null) {
pstmt_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(3, out2.SKU_B);
}

                    if(out2.DES_SKU_B == null) {
pstmt_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(4, out2.DES_SKU_B);
}

                    if(out2.QUANTIDADE == null) {
pstmt_tDBOutput_2.setNull(5, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_2.setInt(5, out2.QUANTIDADE);
}

                    if(out2.DT_ATUALIZACAO != null) {
pstmt_tDBOutput_2.setTimestamp(6, new java.sql.Timestamp(out2.DT_ATUALIZACAO.getTime()));
} else {
 ...
 */
	...
	currentComponent="tHashInput_1";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_dw_t_cross_selling_" + pid +"_tHashOutput_2");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row38Struct> tHashFile_tHashInput_4 = mf_tHashInput_4.getAdvancedMemoryHashFile("tHashFile_dw_t_cross_selling_" + pid +"_tHashOutput_1");
if(tHashFile_tHashInput_4==null) {
	throw new RuntimeException("The hash is not initialized : The hash must exist before you read from it");
}
java.util.Iterator<row38Struct> iterator_tHashInput_4 = tHashFile_tHashInput_4.iterator();
while (iterator_tHashInput_4.hasNext()) {
    row38Struct next_tHashInput_4 = iterator_tHashInput_4.next();

	row5.nm_programa = next_tHashInput_4.nm_programa;
	row5.data_inicio_execucao = next_tHashInput_4.data_inicio_execucao;
	row5.data_termino_execucao = next_tHashInput_4.data_termino_execucao;
	row5.mensagem = next_tHashInput_4.mensagem;
	row5.uuid = next_tHashInput_4.uuid;
...
} else {pstmt_tDBOutput_1.setString(1, update_log.nm_programa);
}

                    if(update_log.data_inicio_execucao != null) {
pstmt_tDBOutput_1.setTimestamp(2, new java.sql.Timestamp(update_log.data_inicio_execucao.getTime()));
} else {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.TIMESTAMP);
}

                    if(update_log.data_termino_execucao != null) {
pstmt_tDBOutput_1.setTimestamp(3, new java.sql.Timestamp(update_log.data_termino_execucao.getTime()));
} else {
...
} else {pstmt_tDBOutput_1.setString(4, update_log.mensagem);
}

                    if(update_log.uuid == null) {
pstmt_tDBOutput_1.setNull(5 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5 + count_tDBOutput_1, update_log.uuid);
}
 ...
 */
	...
	currentComponent="tHashInput_4";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_dw_t_cross_selling_" + pid +"_tHashOutput_1");
...
System.out.println("Finalizando JOB2 atualização dw_cross_selling");
 ...
 */
    ...
    public static void main(String[] args){
        final dw_t_cross_selling dw_t_cross_sellingClass = new dw_t_cross_selling();

        int exitCode = dw_t_cross_sellingClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = dw_t_cross_selling.class.getClassLoader().getResourceAsStream("palacio_ferramentas/dw_t_cross_selling_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = dw_t_cross_selling.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dw_t_cross_selling");
        }
...
/************************************************************************************************
 *     239358 characters generated by Talend Open Studio for Big Data 
 *     on the 12 de agosto de 2024 08:42:11 BRT
 ************************************************************************************************/