...
package palacio_ferramentas.integracao_estoque_batch_0_1;
...
/**
 * Job: integracao_estoque_batch Purpose: <br>
 * Description:  <br>
 * @author henriquesantos@palaciodasferramentas.com.br
 * @version 8.0.1.20230922_0317-SNAPSHOT
 * @status 
 */
public class integracao_estoque_batch implements TalendJob {
...
public String getJDBC_PARAMETERS(){
	...
	private final String jobName = "integracao_estoque_batch";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				integracao_estoque_batch.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(integracao_estoque_batch.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row16Struct implements routines.system.IPersistableRow<row16Struct> {
    final static byte[] commonByteArrayLock_PALACIO_FERRAMENTAS_integracao_estoque_batch = new byte[0];
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_integracao_estoque_batch = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PALACIO_FERRAMENTAS_integracao_estoque_batch.length) {
				if(length < 1024 && commonByteArray_PALACIO_FERRAMENTAS_integracao_estoque_batch.length == 0) {
   					commonByteArray_PALACIO_FERRAMENTAS_integracao_estoque_batch = new byte[1024];
				} else {
   					commonByteArray_PALACIO_FERRAMENTAS_integracao_estoque_batch = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PALACIO_FERRAMENTAS_integracao_estoque_batch, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_integracao_estoque_batch, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PALACIO_FERRAMENTAS_integracao_estoque_batch, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_integracao_estoque_batch, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PALACIO_FERRAMENTAS_integracao_estoque_batch) {
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_5=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_5 = "tHashFile_integracao_estoque_batch_" + pid + "_tHashOutput_5";
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_3=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_3 = "tHashFile_integracao_estoque_batch_" + pid + "_tHashOutput_3";
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_7=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_7 = "tHashFile_integracao_estoque_batch_" + pid + "_tHashOutput_7";
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row3Struct> tHashFile_tHashInput_2 = mf_tHashInput_2.getAdvancedMemoryHashFile("tHashFile_integracao_estoque_batch_" + pid +"_tHashOutput_3");
 ...
 */
	...
	currentComponent="tHashInput_2";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_integracao_estoque_batch_" + pid +"_tHashOutput_3");
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_1=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_1 = "tHashFile_integracao_estoque_batch_" + pid + "_tHashOutput_1";
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row11Struct> tHashFile_tHashInput_6 = mf_tHashInput_6.getAdvancedMemoryHashFile("tHashFile_integracao_estoque_batch_" + pid +"_tHashOutput_7");
 ...
 */
	...
	currentComponent="tHashInput_6";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_integracao_estoque_batch_" + pid +"_tHashOutput_7");
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_2=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_2 = "tHashFile_integracao_estoque_batch_" + pid + "_tHashOutput_2";
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row11Struct> tHashFile_tHashInput_1 = mf_tHashInput_1.getAdvancedMemoryHashFile("tHashFile_integracao_estoque_batch_" + pid +"_tHashOutput_7");
...
} else {pstmt_tDBOutput_5.setString(1, Atualizacao1.CD_EMP);
}

                    if(Atualizacao1.CD_ITEM == null) {
pstmt_tDBOutput_5.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_5.setString(2, Atualizacao1.CD_ITEM);
}

                    if(Atualizacao1.DESC_ITEM == null) {
pstmt_tDBOutput_5.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_5.setString(3, Atualizacao1.DESC_ITEM);
}

                    if(Atualizacao1.SALDO_ANTERIOR == null) {
pstmt_tDBOutput_5.setNull(4, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_5.setInt(4, Atualizacao1.SALDO_ANTERIOR);
}

                    if(Atualizacao1.SALDO_ATUAL == null) {
pstmt_tDBOutput_5.setNull(5, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_5.setInt(5, Atualizacao1.SALDO_ATUAL);
}

                    if(Atualizacao1.DATA_ULT_ATUALIZACAO != null) {
pstmt_tDBOutput_5.setTimestamp(6, new java.sql.Timestamp(Atualizacao1.DATA_ULT_ATUALIZACAO.getTime()));
} else {
pstmt_tDBOutput_5.setNull(6, java.sql.Types.TIMESTAMP);
}

                    if(Atualizacao1.DATA_EXECUCAO != null) {
pstmt_tDBOutput_5.setTimestamp(7, new java.sql.Timestamp(Atualizacao1.DATA_EXECUCAO.getTime()));
} else {
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<winspareStruct> tHashFile_tHashInput_7 = mf_tHashInput_7.getAdvancedMemoryHashFile("tHashFile_integracao_estoque_batch_" + pid +"_tHashOutput_2");
 ...
 */
	...
	currentComponent="tHashInput_7";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_integracao_estoque_batch_" + pid +"_tHashOutput_2");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row16Struct> tHashFile_tHashInput_4 = mf_tHashInput_4.getAdvancedMemoryHashFile("tHashFile_integracao_estoque_batch_" + pid +"_tHashOutput_5");
 ...
 */
	...
	currentComponent="tHashInput_4";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_integracao_estoque_batch_" + pid +"_tHashOutput_5");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row4Struct> tHashFile_tHashInput_3 = mf_tHashInput_3.getAdvancedMemoryHashFile("tHashFile_integracao_estoque_batch_" + pid +"_tHashOutput_1");
 ...
 */
	...
	currentComponent="tHashInput_3";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_integracao_estoque_batch_" + pid +"_tHashOutput_1");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row4Struct> tHashFile_tHashInput_5 = mf_tHashInput_5.getAdvancedMemoryHashFile("tHashFile_integracao_estoque_batch_" + pid +"_tHashOutput_1");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row4Struct> tHashFile_tHashInput_8 = mf_tHashInput_8.getAdvancedMemoryHashFile("tHashFile_integracao_estoque_batch_" + pid +"_tHashOutput_1");
 ...
 */
    ...
    public static void main(String[] args){
        final integracao_estoque_batch integracao_estoque_batchClass = new integracao_estoque_batch();

        int exitCode = integracao_estoque_batchClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = integracao_estoque_batch.class.getClassLoader().getResourceAsStream("palacio_ferramentas/integracao_estoque_batch_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = integracao_estoque_batch.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : integracao_estoque_batch");
        }
...
/************************************************************************************************
 *     579544 characters generated by Talend Open Studio for Big Data 
 *     on the 22 de agosto de 2024 13:06:27 BRT
 ************************************************************************************************/