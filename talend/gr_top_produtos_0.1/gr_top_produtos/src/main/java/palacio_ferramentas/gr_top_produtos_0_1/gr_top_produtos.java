...
package palacio_ferramentas.gr_top_produtos_0_1;
...
public String getJDBC_PARAMETERS(){
	...
	private final String jobName = "gr_top_produtos";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				gr_top_produtos.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(gr_top_produtos.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row5Struct implements routines.system.IPersistableRow<row5Struct> {
    final static byte[] commonByteArrayLock_PALACIO_FERRAMENTAS_gr_top_produtos = new byte[0];
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_gr_top_produtos = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PALACIO_FERRAMENTAS_gr_top_produtos.length) {
				if(length < 1024 && commonByteArray_PALACIO_FERRAMENTAS_gr_top_produtos.length == 0) {
   					commonByteArray_PALACIO_FERRAMENTAS_gr_top_produtos = new byte[1024];
				} else {
   					commonByteArray_PALACIO_FERRAMENTAS_gr_top_produtos = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PALACIO_FERRAMENTAS_gr_top_produtos, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_gr_top_produtos, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PALACIO_FERRAMENTAS_gr_top_produtos, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_gr_top_produtos, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PALACIO_FERRAMENTAS_gr_top_produtos) {
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_1=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_1 = "tHashFile_gr_top_produtos_" + pid + "_tHashOutput_1";
        	...
        	try {
        		...
        		int length = 0;
					...
					this.ITEM = readString(dis);
						...
						this.TOTAL_PEDIDO = readInteger(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Integer
						...
						writeInteger(this.TOTAL_PEDIDO,dos);
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_2=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_2 = "tHashFile_gr_top_produtos_" + pid + "_tHashOutput_2";
...
+"TA\n";
        	...
        	row1.COD_ITEM = routines.system.JDBCUtil.getString(rs_tDBInput_2, 1, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 2) {
								row1.ITEM = null;
							} else {
	                         		
        	row1.ITEM = routines.system.JDBCUtil.getString(rs_tDBInput_2, 2, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 3) {
								row1.TOTAL_PEDIDO = null;
							} else {
		                          
            row1.TOTAL_PEDIDO = rs_tDBInput_2.getInt(3);
            if(rs_tDBInput_2.wasNull()){
				...
				if(rs_tDBInput_2.getString(4) != null) {
					...
					if (!("0000-00-00").equals(dateString_tDBInput_2) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_2)) {
						row1.DATA = rs_tDBInput_2.getTimestamp(4);
					} else {
						row1.DATA = (java.util.Date) year0_tDBInput_2.clone();
					}
				} else {
					row1.DATA =  null;
				}
 ...
 */
	...
	currentComponent="tHashOutput_2";
		...
		row1Struct oneRow_tHashOutput_2 = new row1Struct();
					...
					oneRow_tHashOutput_2.TOTAL_PEDIDO = row1.TOTAL_PEDIDO;
					oneRow_tHashOutput_2.DATA = row1.DATA;
...
public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
    ...
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_gr_top_produtos = new byte[0];
				...
				public Boolean url_imagemIsNullable(){
				    return true;
				}
				public Boolean url_imagemIsKey(){
				    return false;
				}
				public Integer url_imagemLength(){
				    return 255;
				}
				public Integer url_imagemPrecision(){
				    return null;
				}
				public String url_imagemDefault(){
				
					return null;
				
				}
				public String url_imagemComment(){
				
				    return "";
				
				}
				public String url_imagemPattern(){
				
					return "";
				
				}
				public String url_imagemOriginalDbColumnName(){
		...
		synchronized(commonByteArrayLock_PALACIO_FERRAMENTAS_gr_top_produtos) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.url_imagem = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.url_imagem,dos);
    ...
    public String toString() {
		...
		sb.append(",url_imagem="+url_imagem);
	    sb.append("]");
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_4=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_4 = "tHashFile_gr_top_produtos_" + pid + "_tHashOutput_4";
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row1Struct> tHashFile_tHashInput_3 = mf_tHashInput_3.getAdvancedMemoryHashFile("tHashFile_gr_top_produtos_" + pid +"_tHashOutput_2");
...
while (iterator_tHashInput_3.hasNext()) {
	...
	row7.COD_ITEM = next_tHashInput_3.COD_ITEM;
	row7.ITEM = next_tHashInput_3.ITEM;
	row7.TOTAL_PEDIDO = next_tHashInput_3.TOTAL_PEDIDO;
	row7.DATA = next_tHashInput_3.DATA;
 					    ...
 					    boolean forceLooprow8 = false;
 							...
 							row8Struct row8ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row8HashKey.cd_produto = row7.COD_ITEM ;
...
// # Output table : 'out1'
out1_tmp.COD_ITEM = row7.COD_ITEM ;
out1_tmp.ITEM = row7.ITEM ;
out1_tmp.DATA = row7.DATA ;
out1_tmp.TOTAL_PEDIDO = row7.TOTAL_PEDIDO;
out1_tmp.curva_vlr = row8.curva_vlr ;
out1_tmp.lancamento = row8.lancamento ;
out1_tmp.url_imagem = row8.url_imagem ;
out1 = out1_tmp;
...
if(out1 != null) { 
	...
	currentComponent="tHashOutput_4";
		...
		out1Struct oneRow_tHashOutput_4 = new out1Struct();
					...
					oneRow_tHashOutput_4.COD_ITEM = out1.COD_ITEM;
					oneRow_tHashOutput_4.ITEM = out1.ITEM;
					oneRow_tHashOutput_4.DATA = out1.DATA;
					oneRow_tHashOutput_4.TOTAL_PEDIDO = out1.TOTAL_PEDIDO;
					oneRow_tHashOutput_4.curva_vlr = out1.curva_vlr;
					oneRow_tHashOutput_4.lancamento = out1.lancamento;
					oneRow_tHashOutput_4.url_imagem = out1.url_imagem;
 ...
 */
	...
	currentComponent="tHashInput_3";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_gr_top_produtos_" + pid +"_tHashOutput_2");
...
public static class insertStruct implements routines.system.IPersistableRow<insertStruct> {
    ...
    public String loopKey;
				...
				public Boolean last_updated_byIsNullable(){
				    return true;
				}
				public Boolean last_updated_byIsKey(){
				    return false;
				}
				public Integer last_updated_byLength(){
				    return null;
				}
				public Integer last_updated_byPrecision(){
				    return null;
				}
				...
				public String last_updated_byComment(){
				
				    return "";
				
				}
				public String last_updated_byPattern(){
				
					return "";
				
				}
				public String last_updated_byOriginalDbColumnName(){
				...
				public Boolean last_updated_atIsNullable(){
				    return true;
				}
				public Boolean last_updated_atIsKey(){
				    return false;
				}
				public Integer last_updated_atLength(){
				    return null;
				}
				public Integer last_updated_atPrecision(){
				    return null;
				}
				public String last_updated_atDefault(){
				
					return null;
				
				}
				public String last_updated_atComment(){
				
				    return "";
				
				}
				public String last_updated_atPattern(){
				
					return "yyyy-MM-dd HH:mm:ss";
				
				}
				public String last_updated_atOriginalDbColumnName(){
	...
	public void copyDataTo(insertStruct other) {
		...
		other.COD_ITEM = this.COD_ITEM;
	            ...
	            other.url_imagem = this.url_imagem;
	            other.created_by = this.created_by;
	            other.created_at = this.created_at;
	            other.last_updated_by = this.last_updated_by;
    ...
    public int compareTo(insertStruct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.DATA, other.DATA);
						if(returnValue != 0) {
							return returnValue;
						}
...
if(dbschema_tDBOutput_4 == null || dbschema_tDBOutput_4.trim().length() == 0) {
	tableName_tDBOutput_4 = ("gr_top_produtos").toLowerCase();
} else {
	tableName_tDBOutput_4 = dbschema_tDBOutput_4 + "\".\"" + ("gr_top_produtos").toLowerCase();
}

        int updateKeyCount_tDBOutput_4 = 2;
        if(updateKeyCount_tDBOutput_4 < 1) {
            throw new RuntimeException("For update, Schema must have a key");
        } else if (updateKeyCount_tDBOutput_4 == 11 && true) {
...
int count_tDBOutput_4=0;
	    java.sql.PreparedStatement pstmt_tDBOutput_4 = conn_tDBOutput_4.prepareStatement("SELECT COUNT(1) FROM \"" + tableName_tDBOutput_4 + "\" WHERE \"cod_item\" = ? AND \"data\" = ?");
	    resourceMap.put("pstmt_tDBOutput_4", pstmt_tDBOutput_4);
	    String insert_tDBOutput_4 = "INSERT INTO \"" + tableName_tDBOutput_4 + "\" (\"cod_item\",\"item\",\"data\",\"total_pedido\",\"curva_vlr\",\"lancamento\",\"url_imagem\",\"created_by\",\"created_at\",\"last_updated_by\",\"last_updated_at\") VALUES (?,?,?,?,?,?,?,?,?,?,?)";
	    ...
	    String update_tDBOutput_4 = "UPDATE \"" + tableName_tDBOutput_4 + "\" SET \"item\" = ?,\"total_pedido\" = ?,\"curva_vlr\" = ?,\"lancamento\" = ?,\"url_imagem\" = ?,\"created_by\" = ?,\"created_at\" = ?,\"last_updated_by\" = ?,\"last_updated_at\" = ? WHERE \"cod_item\" = ? AND \"data\" = ?";
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<out1Struct> tHashFile_tHashInput_5 = mf_tHashInput_5.getAdvancedMemoryHashFile("tHashFile_gr_top_produtos_" + pid +"_tHashOutput_4");
if(tHashFile_tHashInput_5==null) {
	throw new RuntimeException("The hash is not initialized : The hash must exist before you read from it");
}
java.util.Iterator<out1Struct> iterator_tHashInput_5 = tHashFile_tHashInput_5.iterator();
while (iterator_tHashInput_5.hasNext()) {
    out1Struct next_tHashInput_5 = iterator_tHashInput_5.next();

	row9.COD_ITEM = next_tHashInput_5.COD_ITEM;
	row9.ITEM = next_tHashInput_5.ITEM;
	row9.DATA = next_tHashInput_5.DATA;
	row9.TOTAL_PEDIDO = next_tHashInput_5.TOTAL_PEDIDO;
	row9.curva_vlr = next_tHashInput_5.curva_vlr;
	row9.lancamento = next_tHashInput_5.lancamento;
	row9.url_imagem = next_tHashInput_5.url_imagem;
...
insert_tmp.DATA = row9.DATA;
insert_tmp.TOTAL_PEDIDO = row9.TOTAL_PEDIDO;
insert_tmp.curva_vlr = row9.curva_vlr;
insert_tmp.lancamento = row9.lancamento;
insert_tmp.url_imagem = row9.url_imagem;
insert_tmp.created_by = "talend";
insert_tmp.created_at = TalendDate.getCurrentDate();
insert_tmp.last_updated_by = "talend";
insert_tmp.last_updated_at = TalendDate.getCurrentDate();
insert = insert_tmp;
// ###############################
...
} else {pstmt_tDBOutput_4.setString(1, insert.COD_ITEM);
}

                    if(insert.DATA != null) {
pstmt_tDBOutput_4.setTimestamp(2, new java.sql.Timestamp(insert.DATA.getTime()));
} else {
...
} else {pstmtUpdate_tDBOutput_4.setString(1, insert.ITEM);
}

                        if(insert.TOTAL_PEDIDO == null) {
pstmtUpdate_tDBOutput_4.setNull(2, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_4.setInt(2, insert.TOTAL_PEDIDO);
}

                        if(insert.curva_vlr == null) {
pstmtUpdate_tDBOutput_4.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_4.setString(3, insert.curva_vlr);
}

                        if(insert.lancamento == null) {
pstmtUpdate_tDBOutput_4.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_4.setString(4, insert.lancamento);
}

                        if(insert.url_imagem == null) {
pstmtUpdate_tDBOutput_4.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_4.setString(5, insert.url_imagem);
}

                        if(insert.created_by == null) {
pstmtUpdate_tDBOutput_4.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_4.setString(6, insert.created_by);
}

                        if(insert.created_at != null) {
pstmtUpdate_tDBOutput_4.setTimestamp(7, new java.sql.Timestamp(insert.created_at.getTime()));
} else {
pstmtUpdate_tDBOutput_4.setNull(7, java.sql.Types.TIMESTAMP);
}

                        if(insert.last_updated_by == null) {
pstmtUpdate_tDBOutput_4.setNull(8, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_4.setString(8, insert.last_updated_by);
}

                        if(insert.last_updated_at != null) {
pstmtUpdate_tDBOutput_4.setTimestamp(9, new java.sql.Timestamp(insert.last_updated_at.getTime()));
} else {
pstmtUpdate_tDBOutput_4.setNull(9, java.sql.Types.TIMESTAMP);
}

                        if(insert.COD_ITEM == null) {
pstmtUpdate_tDBOutput_4.setNull(10 + count_tDBOutput_4, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_4.setString(10 + count_tDBOutput_4, insert.COD_ITEM);
}

                        if(insert.DATA != null) {
pstmtUpdate_tDBOutput_4.setTimestamp(11 + count_tDBOutput_4, new java.sql.Timestamp(insert.DATA.getTime()));
} else {
pstmtUpdate_tDBOutput_4.setNull(11 + count_tDBOutput_4, java.sql.Types.TIMESTAMP);
}
...
} else {pstmtInsert_tDBOutput_4.setString(1, insert.COD_ITEM);
}

                        if(insert.ITEM == null) {
pstmtInsert_tDBOutput_4.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_4.setString(2, insert.ITEM);
}

                        if(insert.DATA != null) {
pstmtInsert_tDBOutput_4.setTimestamp(3, new java.sql.Timestamp(insert.DATA.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_4.setInt(4, insert.TOTAL_PEDIDO);
}

                        if(insert.curva_vlr == null) {
pstmtInsert_tDBOutput_4.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_4.setString(5, insert.curva_vlr);
}

                        if(insert.lancamento == null) {
pstmtInsert_tDBOutput_4.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_4.setString(6, insert.lancamento);
}

                        if(insert.url_imagem == null) {
pstmtInsert_tDBOutput_4.setNull(7, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_4.setString(7, insert.url_imagem);
}

                        if(insert.created_by == null) {
pstmtInsert_tDBOutput_4.setNull(8, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_4.setString(8, insert.created_by);
}

                        if(insert.created_at != null) {
pstmtInsert_tDBOutput_4.setTimestamp(9, new java.sql.Timestamp(insert.created_at.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_4.setString(10, insert.last_updated_by);
}

                        if(insert.last_updated_at != null) {
pstmtInsert_tDBOutput_4.setTimestamp(11, new java.sql.Timestamp(insert.last_updated_at.getTime()));
} else {
 ...
 */
	...
	currentComponent="tHashInput_5";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_gr_top_produtos_" + pid +"_tHashOutput_4");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row5Struct> tHashFile_tHashInput_1 = mf_tHashInput_1.getAdvancedMemoryHashFile("tHashFile_gr_top_produtos_" + pid +"_tHashOutput_1");
 ...
 */
	...
	currentComponent="tHashInput_1";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_gr_top_produtos_" + pid +"_tHashOutput_1");
...
public static class row8Struct implements routines.system.IPersistableComparableLookupRow<row8Struct> {
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
						...
						this.url_imagem = readString(dis,ois);
    ...
    public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
        try {
			int length = 0;
						...
						this.url_imagem = readString(dis,objectIn);
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
						...
						writeString(this.url_imagem, dos, oos);
    ...
    public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut){
                try {
						...
						writeString(this.url_imagem, dos, objectOut);
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row8";
		...
		int tos_count_tAdvancedHash_row8 = 0;
			   		...
			   		// source node:tHashInput_4 - inputs:(after_tHashInput_3) outputs:(row8,row8) | target node:tAdvancedHash_row8 - inputs:(row8) outputs:()
			   		// linked node: tMap_1 - inputs:(row7,row8) outputs:(out1)
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row3Struct> tHashFile_tHashInput_4 = mf_tHashInput_4.getAdvancedMemoryHashFile("tHashFile_gr_top_produtos_" + pid +"_tHashOutput_3");
...
while (iterator_tHashInput_4.hasNext()) {
	...
	row8.cd_produto = next_tHashInput_4.cd_produto;
	row8.curva_vlr = next_tHashInput_4.curva_vlr;
	row8.lancamento = next_tHashInput_4.lancamento;
	row8.url_imagem = next_tHashInput_4.url_imagem;
 ...
 */
	...
	currentComponent="tAdvancedHash_row8";
				...
				row8_HashRow.curva_vlr = row8.curva_vlr;
				
				row8_HashRow.lancamento = row8.lancamento;
				
				row8_HashRow.url_imagem = row8.url_imagem;
 ...
 */
	...
	currentComponent="tHashInput_4";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_gr_top_produtos_" + pid +"_tHashOutput_3");
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_3=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_3 = "tHashFile_gr_top_produtos_" + pid + "_tHashOutput_3";
...
+"agem\n      FROM dw_t_produto p \n left join url_produtos up on up.cd_sku = p.cd_produto\n";
        	...
        	row3.cd_produto = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								row3.curva_vlr = null;
							} else {
	                         		
        	row3.curva_vlr = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 3) {
								row3.lancamento = null;
							} else {
	                         		
        	row3.lancamento = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 4) {
								row3.url_imagem = null;
							} else {
	                         		
        	row3.url_imagem = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, false);
		                    }
 ...
 */
	...
	currentComponent="tHashOutput_3";
		...
		row3Struct oneRow_tHashOutput_3 = new row3Struct();
					...
					oneRow_tHashOutput_3.curva_vlr = row3.curva_vlr;
					oneRow_tHashOutput_3.lancamento = row3.lancamento;
					oneRow_tHashOutput_3.url_imagem = row3.url_imagem;
 ...
 */
    ...
    public static void main(String[] args){
        final gr_top_produtos gr_top_produtosClass = new gr_top_produtos();

        int exitCode = gr_top_produtosClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = gr_top_produtos.class.getClassLoader().getResourceAsStream("palacio_ferramentas/gr_top_produtos_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = gr_top_produtos.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : gr_top_produtos");
        }
...
/************************************************************************************************
 *     327678 characters generated by Talend Open Studio for Big Data 
 *     on the 27 de janeiro de 2025 23:40:48 BRT
 ************************************************************************************************/