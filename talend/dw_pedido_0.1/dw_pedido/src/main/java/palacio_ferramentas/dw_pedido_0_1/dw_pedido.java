...
package palacio_ferramentas.dw_pedido_0_1;
...
/**
 * Job: dw_pedido Purpose: <br>
 * Description:  <br>
 * @author talend@talend.com
 * @version 8.0.1.20230922_0317-SNAPSHOT
 * @status 
 */
public class dw_pedido implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "dw_pedido";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(dw_pedido.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		palacio_ferramentas.dw_t_pedido_0_1.dw_t_pedido childJob_tRunJob_2 = new palacio_ferramentas.dw_t_pedido_0_1.dw_t_pedido();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		palacio_ferramentas.dw_t_item_pedido_0_1.dw_t_item_pedido childJob_tRunJob_1 = new palacio_ferramentas.dw_t_item_pedido_0_1.dw_t_item_pedido();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final dw_pedido dw_pedidoClass = new dw_pedido();

        int exitCode = dw_pedidoClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = dw_pedido.class.getClassLoader().getResourceAsStream("palacio_ferramentas/dw_pedido_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = dw_pedido.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dw_pedido");
        }
...
/************************************************************************************************
 *     43647 characters generated by Talend Open Studio for Big Data 
 *     on the 28 de março de 2025 22:55:07 BRT
 ************************************************************************************************/