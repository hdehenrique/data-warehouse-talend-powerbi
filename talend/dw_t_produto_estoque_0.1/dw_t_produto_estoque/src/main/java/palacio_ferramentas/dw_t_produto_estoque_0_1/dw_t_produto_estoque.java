...
package palacio_ferramentas.dw_t_produto_estoque_0_1;
...
/**
 * Job: dw_t_produto_estoque Purpose: <br>
 * Description:  <br>
 * @author henriquesantos@palaciodasferramentas.com.br
 * @version 8.0.1.20230922_0317-SNAPSHOT
 * @status 
 */
public class dw_t_produto_estoque implements TalendJob {
...
public String getJDBC_PARAMETERS(){
	...
	private final String jobName = "dw_t_produto_estoque";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				dw_t_produto_estoque.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(dw_t_produto_estoque.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row5Struct implements routines.system.IPersistableRow<row5Struct> {
    final static byte[] commonByteArrayLock_PALACIO_FERRAMENTAS_dw_t_produto_estoque = new byte[0];
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_dw_t_produto_estoque = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PALACIO_FERRAMENTAS_dw_t_produto_estoque.length) {
				if(length < 1024 && commonByteArray_PALACIO_FERRAMENTAS_dw_t_produto_estoque.length == 0) {
   					commonByteArray_PALACIO_FERRAMENTAS_dw_t_produto_estoque = new byte[1024];
				} else {
   					commonByteArray_PALACIO_FERRAMENTAS_dw_t_produto_estoque = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PALACIO_FERRAMENTAS_dw_t_produto_estoque, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_dw_t_produto_estoque, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PALACIO_FERRAMENTAS_dw_t_produto_estoque, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_dw_t_produto_estoque, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PALACIO_FERRAMENTAS_dw_t_produto_estoque) {
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_1=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_1 = "tHashFile_dw_t_produto_estoque_" + pid + "_tHashOutput_1";
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_3=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_3 = "tHashFile_dw_t_produto_estoque_" + pid + "_tHashOutput_3";
			synchronized(org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.get(hashKey_tHashOutput_3)){
			    if(mf_tHashOutput_3.getResourceMap().get(hashKey_tHashOutput_3) == null){
	      		    mf_tHashOutput_3.getResourceMap().put(hashKey_tHashOutput_3, new org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row9Struct>(org.talend.designer.components.hashfile.common.MATCHING_MODE.KEEP_ALL));
 ...
 */
	...
	currentComponent="tDBInput_4";
		...
		int tos_count_tDBInput_4 = 0;
		    ...
		    String dbquery_tDBInput_4 = "\n  SELECT IG002.ITE_CODEMP ,\n         IG002.ITE_CODITE ,\n         IG002.ITE_SALDOS - IG002.ITE_SALEXT - IFNULL(IG002"
+".ITE_SALREG,0) - (IFNULL(IG002.ITE_QTPD_V,0) + IFNULL(IG002.ITE_QTPD_F,0) + IFNULL(IG002.ITE_QTPD_P,0)) AS ESTOQUE\n    "
+"FROM ITEGER IG002\n--   WHERE IG002.ITE_CODITE in ('82769', '59537')\n";
		    ...
		    while (rs_tDBInput_4.next()) {
		        nb_line_tDBInput_4++;
							...
							if(colQtyInRs_tDBInput_4 < 1) {
								row7.ITE_CODEMP = null;
							} else {
	                         		
        	row7.ITE_CODEMP = routines.system.JDBCUtil.getString(rs_tDBInput_4, 1, false);
		                    }
							if(colQtyInRs_tDBInput_4 < 2) {
								row7.ITE_CODITE = null;
							} else {
	                         		
        	row7.ITE_CODITE = routines.system.JDBCUtil.getString(rs_tDBInput_4, 2, false);
		                    }
							if(colQtyInRs_tDBInput_4 < 3) {
								row7.ESTOQUE = null;
							} else {
		                          
            row7.ESTOQUE = rs_tDBInput_4.getInt(3);
...
row9 = null;			
if(row7.ITE_CODEMP == null){
	finder_tUniqRow_3.ITE_CODEMP = null;
}else{
	finder_tUniqRow_3.ITE_CODEMP = row7.ITE_CODEMP.toLowerCase();
}
if(row7.ITE_CODITE == null){
	finder_tUniqRow_3.ITE_CODITE = null;
}else{
	finder_tUniqRow_3.ITE_CODITE = row7.ITE_CODITE.toLowerCase();
}
finder_tUniqRow_3.ESTOQUE = row7.ESTOQUE;	
...
if(row7.ITE_CODEMP == null){
	new_tUniqRow_3.ITE_CODEMP = null;
}else{
	new_tUniqRow_3.ITE_CODEMP = row7.ITE_CODEMP.toLowerCase();
}
if(row7.ITE_CODITE == null){
	new_tUniqRow_3.ITE_CODITE = null;
}else{
	new_tUniqRow_3.ITE_CODITE = row7.ITE_CODITE.toLowerCase();
}
new_tUniqRow_3.ESTOQUE = row7.ESTOQUE;
		
		keystUniqRow_3.add(new_tUniqRow_3);if(row9 == null){ 
	
	row9 = new row9Struct();
}row9.ITE_CODEMP = row7.ITE_CODEMP;			row9.ITE_CODITE = row7.ITE_CODITE;			row9.ESTOQUE = row7.ESTOQUE;					
...
if(row9 != null) { 
	...
	currentComponent="tHashOutput_3";
		...
		row9Struct oneRow_tHashOutput_3 = new row9Struct();
					...
					oneRow_tHashOutput_3.ITE_CODEMP = row9.ITE_CODEMP;
					oneRow_tHashOutput_3.ITE_CODITE = row9.ITE_CODITE;
					oneRow_tHashOutput_3.ESTOQUE = row9.ESTOQUE;
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_2=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_2 = "tHashFile_dw_t_produto_estoque_" + pid + "_tHashOutput_2";
		...
		class KeyStruct_tUniqRow_2 {
			...
			public int hashCode() {
				if (this.hashCodeDirty) {
					...
					int result = DEFAULT_HASHCODE;
								...
								result = prime * result + ((this.MEDIA_VENDA == null) ? 0 : this.MEDIA_VENDA.hashCode());
			...
			public boolean equals(Object obj) {
				...
				final KeyStruct_tUniqRow_2 other = (KeyStruct_tUniqRow_2) obj;
									...
									if (this.MEDIA_VENDA == null) {
										if (other.MEDIA_VENDA != null) 
											return false;
								
									} else if (!this.MEDIA_VENDA.equals(other.MEDIA_VENDA))
...
+"HERE FAT.DATA >= SUBDATE(CURDATE(), 90)\nGROUP BY EMPRESA, FAT.COD_ITEM\n";
        	...
        	row1.COD_ITEM = routines.system.JDBCUtil.getString(rs_tDBInput_2, 2, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 3) {
								row1.MEDIA_VENDA = null;
							} else {
		                          
            row1.MEDIA_VENDA = rs_tDBInput_2.getInt(3);
...
row3 = null;			
if(row1.EMPRESA == null){
	finder_tUniqRow_2.EMPRESA = null;
}else{
	finder_tUniqRow_2.EMPRESA = row1.EMPRESA.toLowerCase();
}
if(row1.COD_ITEM == null){
	finder_tUniqRow_2.COD_ITEM = null;
}else{
	finder_tUniqRow_2.COD_ITEM = row1.COD_ITEM.toLowerCase();
}
finder_tUniqRow_2.MEDIA_VENDA = row1.MEDIA_VENDA;	
...
if(row1.EMPRESA == null){
	...
	new_tUniqRow_2.EMPRESA = row1.EMPRESA.toLowerCase();
}
if(row1.COD_ITEM == null){
	new_tUniqRow_2.COD_ITEM = null;
}else{
	new_tUniqRow_2.COD_ITEM = row1.COD_ITEM.toLowerCase();
}
new_tUniqRow_2.MEDIA_VENDA = row1.MEDIA_VENDA;
		
		keystUniqRow_2.add(new_tUniqRow_2);if(row3 == null){ 
	
	row3 = new row3Struct();
}row3.EMPRESA = row1.EMPRESA;			row3.COD_ITEM = row1.COD_ITEM;			row3.MEDIA_VENDA = row1.MEDIA_VENDA;					
...
if(row3 != null) { 
	...
	currentComponent="tHashOutput_2";
		...
		row3Struct oneRow_tHashOutput_2 = new row3Struct();
					...
					oneRow_tHashOutput_2.EMPRESA = row3.EMPRESA;
					oneRow_tHashOutput_2.COD_ITEM = row3.COD_ITEM;
					oneRow_tHashOutput_2.MEDIA_VENDA = row3.MEDIA_VENDA;
...
public static class updateStruct implements routines.system.IPersistableRow<updateStruct> {
    ...
    public String loopKey;
			    ...
			    public Integer media_diaria_venda;

				public Integer getMedia_diaria_venda () {
					return this.media_diaria_venda;
				}

				public Boolean media_diaria_vendaIsNullable(){
				    return true;
				}
				public Boolean media_diaria_vendaIsKey(){
				    return false;
				}
				public Integer media_diaria_vendaLength(){
				    return null;
				}
				public Integer media_diaria_vendaPrecision(){
				    return null;
				}
				public String media_diaria_vendaDefault(){
				
					return null;
				
				}
				public String media_diaria_vendaComment(){
				
				    return "";
				
				}
				public String media_diaria_vendaPattern(){
				
					return "";
				
				}
				public String media_diaria_vendaOriginalDbColumnName(){
				
					return "media_diaria_venda";
	...
	public void copyDataTo(updateStruct other) {
		...
		other.EMPRESA = this.EMPRESA;
	            ...
	            other.media_diaria_venda = this.media_diaria_venda;
        	...
        	try {
        		...
        		int length = 0;
					...
					this.COD_ITEM = readString(dis);
						...
						this.media_diaria_venda = readInteger(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Integer
						...
						writeInteger(this.media_diaria_venda,dos);
    ...
    public String toString() {
		...
		sb.append(",COD_ITEM="+COD_ITEM);
		sb.append(",ESTOQUE="+String.valueOf(ESTOQUE));
		sb.append(",media_diaria_venda="+String.valueOf(media_diaria_venda));
...
if(dbschema_tDBOutput_3 == null || dbschema_tDBOutput_3.trim().length() == 0) {
	tableName_tDBOutput_3 = ("dw_t_produto_estoque").toLowerCase();
} else {
	tableName_tDBOutput_3 = dbschema_tDBOutput_3 + "\".\"" + ("dw_t_produto_estoque").toLowerCase();
}
...
int count_tDBOutput_3=0;
	    String update_tDBOutput_3 = "UPDATE \"" + tableName_tDBOutput_3 + "\" SET \"estoque\" = ?,\"media_diaria_venda\" = ?,\"cobertura\" = ? WHERE \"empresa\" = ? AND \"cod_item\" = ?";
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row3Struct> tHashFile_tHashInput_3 = mf_tHashInput_3.getAdvancedMemoryHashFile("tHashFile_dw_t_produto_estoque_" + pid +"_tHashOutput_2");
...
while (iterator_tHashInput_3.hasNext()) {
	...
	row2.EMPRESA = next_tHashInput_3.EMPRESA;
	row2.COD_ITEM = next_tHashInput_3.COD_ITEM;
	row2.MEDIA_VENDA = next_tHashInput_3.MEDIA_VENDA;
 					    ...
 					    boolean forceLooprow16 = false;
 							...
 							row16Struct row16ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_6 = false;
                        		    		    ...
                        		    		    row16HashKey.ITE_CODEMP = row2.EMPRESA ;
                        		    		
                        		    		    row16HashKey.ITE_CODITE = row2.COD_ITEM ;
								  ...
								  if(!tHash_Lookup_row16.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row16 != null && tHash_Lookup_row16.getCount(row16HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row16' and it contains more one result from keys :  row16.ITE_CODEMP = '" + row16HashKey.ITE_CODEMP + "', row16.ITE_CODITE = '" + row16HashKey.ITE_CODITE + "'");
								} // G 071
...
// # Output table : 'out3'
out3_tmp.EMPRESA = row2.EMPRESA ;
out3_tmp.COD_ITEM = row2.COD_ITEM ;
out3_tmp.ESTOQUE = row16.ESTOQUE ;
out3_tmp.MEDIA_VENDA = row2.MEDIA_VENDA ;
out3 = out3_tmp;
...
row11.EMPRESA = out3.EMPRESA;
row11.COD_ITEM = out3.COD_ITEM;
row11.ESTOQUE = out3.ESTOQUE;
row11.MEDIA_VENDA = out3.MEDIA_VENDA;


if (out3.MEDIA_VENDA == 0 || row11.ESTOQUE == 0) {

row11.COBERTURA = out3.ESTOQUE/1;

} else{

row11.COBERTURA = out3.ESTOQUE/out3.MEDIA_VENDA;
...
// # Output table : 'update'
update_tmp.EMPRESA = row11.EMPRESA;
update_tmp.COD_ITEM = row11.COD_ITEM;
update_tmp.ESTOQUE = row11.ESTOQUE;
update_tmp.media_diaria_venda = row11.MEDIA_VENDA ;
update_tmp.COBERTURA = row11.COBERTURA;
update = update_tmp;
// ###############################
...
} else {pstmt_tDBOutput_3.setInt(1, update.ESTOQUE);
}

                    if(update.media_diaria_venda == null) {
pstmt_tDBOutput_3.setNull(2, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_3.setInt(2, update.media_diaria_venda);
}

                    if(update.COBERTURA == null) {
pstmt_tDBOutput_3.setNull(3, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_3.setInt(3, update.COBERTURA);
}

                    if(update.EMPRESA == null) {
pstmt_tDBOutput_3.setNull(4 + count_tDBOutput_3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(4 + count_tDBOutput_3, update.EMPRESA);
}


                    if(update.COD_ITEM == null) {
pstmt_tDBOutput_3.setNull(5 + count_tDBOutput_3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(5 + count_tDBOutput_3, update.COD_ITEM);
}
 ...
 */
	...
	currentComponent="tHashInput_3";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_dw_t_produto_estoque_" + pid +"_tHashOutput_2");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row5Struct> tHashFile_tHashInput_1 = mf_tHashInput_1.getAdvancedMemoryHashFile("tHashFile_dw_t_produto_estoque_" + pid +"_tHashOutput_1");
 ...
 */
	...
	currentComponent="tHashInput_1";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_dw_t_produto_estoque_" + pid +"_tHashOutput_1");
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row16";
		...
		int tos_count_tAdvancedHash_row16 = 0;
			   		...
			   		// source node:tHashInput_6 - inputs:(after_tHashInput_3) outputs:(row16,row16) | target node:tAdvancedHash_row16 - inputs:(row16) outputs:()
			   		// linked node: tMap_6 - inputs:(row2,row16) outputs:(out3)
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row9Struct> tHashFile_tHashInput_6 = mf_tHashInput_6.getAdvancedMemoryHashFile("tHashFile_dw_t_produto_estoque_" + pid +"_tHashOutput_3");
...
while (iterator_tHashInput_6.hasNext()) {
	...
	row16.ITE_CODEMP = next_tHashInput_6.ITE_CODEMP;
	row16.ITE_CODITE = next_tHashInput_6.ITE_CODITE;
	row16.ESTOQUE = next_tHashInput_6.ESTOQUE;
 ...
 */
	...
	currentComponent="tAdvancedHash_row16";
				...
				row16_HashRow.ITE_CODEMP = row16.ITE_CODEMP;
				
				row16_HashRow.ITE_CODITE = row16.ITE_CODITE;
				
				row16_HashRow.ESTOQUE = row16.ESTOQUE;
 ...
 */
	...
	currentComponent="tHashInput_6";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_dw_t_produto_estoque_" + pid +"_tHashOutput_3");
 ...
 */
    ...
    public static void main(String[] args){
        final dw_t_produto_estoque dw_t_produto_estoqueClass = new dw_t_produto_estoque();

        int exitCode = dw_t_produto_estoqueClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = dw_t_produto_estoque.class.getClassLoader().getResourceAsStream("palacio_ferramentas/dw_t_produto_estoque_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = dw_t_produto_estoque.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dw_t_produto_estoque");
        }
...
/************************************************************************************************
 *     316398 characters generated by Talend Open Studio for Big Data 
 *     on the 17 de setembro de 2024 23:13:18 BRT
 ************************************************************************************************/