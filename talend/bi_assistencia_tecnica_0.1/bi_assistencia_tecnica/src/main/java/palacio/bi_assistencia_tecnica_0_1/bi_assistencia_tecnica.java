...
package palacio.bi_assistencia_tecnica_0_1;
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_PALACIO_bi_assistencia_tecnica = new byte[0];
    static byte[] commonByteArray_PALACIO_bi_assistencia_tecnica = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PALACIO_bi_assistencia_tecnica.length) {
				if(length < 1024 && commonByteArray_PALACIO_bi_assistencia_tecnica.length == 0) {
   					commonByteArray_PALACIO_bi_assistencia_tecnica = new byte[1024];
				} else {
   					commonByteArray_PALACIO_bi_assistencia_tecnica = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PALACIO_bi_assistencia_tecnica, 0, length);
			strReturn = new String(commonByteArray_PALACIO_bi_assistencia_tecnica, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PALACIO_bi_assistencia_tecnica, 0, length);
			strReturn = new String(commonByteArray_PALACIO_bi_assistencia_tecnica, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PALACIO_bi_assistencia_tecnica) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = bi_assistencia_tecnica.class.getClassLoader().getResourceAsStream("palacio/bi_assistencia_tecnica_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     362134 characters generated by Talend Open Studio for Big Data 
 *     on the 22 de abril de 2024 09:18:24 BRT
 ************************************************************************************************/