...
package palacio_ferramentas.billing_job_0_1;
...
/**
 * Job: billing_job Purpose: <br>
 * Description:  <br>
 * @author talend@talend.com
 * @version 8.0.1.20230922_0317-SNAPSHOT
 * @status 
 */
public class billing_job implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "billing_job";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(billing_job.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		palacio_ferramentas.vw_faturamento_0_1.vw_faturamento childJob_tRunJob_1 = new palacio_ferramentas.vw_faturamento_0_1.vw_faturamento();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		palacio_ferramentas.vw_faturamento_compras_0_1.vw_faturamento_compras childJob_tRunJob_2 = new palacio_ferramentas.vw_faturamento_compras_0_1.vw_faturamento_compras();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		palacio_ferramentas.vw_faturamento_calc_0_1.vw_faturamento_calc childJob_tRunJob_4 = new palacio_ferramentas.vw_faturamento_calc_0_1.vw_faturamento_calc();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final billing_job billing_jobClass = new billing_job();

        int exitCode = billing_jobClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = billing_job.class.getClassLoader().getResourceAsStream("palacio_ferramentas/billing_job_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = billing_job.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : billing_job");
        }
...
/************************************************************************************************
 *     46456 characters generated by Talend Open Studio for Big Data 
