...
package palacio_ferramentas.vw_faturamento_calc_0_1;
...
/**
 * Job: vw_faturamento_calc Purpose: <br>
 * Description:  <br>
 * @author talend@talend.com
 * @version 8.0.1.20230922_0317-SNAPSHOT
 * @status 
 */
public class vw_faturamento_calc implements TalendJob {
...
public String getPOSTGRES_USER(){
	...
	private final String jobName = "vw_faturamento_calc";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				vw_faturamento_calc.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(vw_faturamento_calc.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
System.out.println("************* 04 - vw_faturamento_calc ************");
System.out.println("Iniciando JOB4 atualização vw_faturamento_calc");
...
public static class row38Struct implements routines.system.IPersistableRow<row38Struct> {
    final static byte[] commonByteArrayLock_PALACIO_FERRAMENTAS_vw_faturamento_calc = new byte[0];
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_vw_faturamento_calc = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PALACIO_FERRAMENTAS_vw_faturamento_calc.length) {
				if(length < 1024 && commonByteArray_PALACIO_FERRAMENTAS_vw_faturamento_calc.length == 0) {
   					commonByteArray_PALACIO_FERRAMENTAS_vw_faturamento_calc = new byte[1024];
				} else {
   					commonByteArray_PALACIO_FERRAMENTAS_vw_faturamento_calc = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PALACIO_FERRAMENTAS_vw_faturamento_calc, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_vw_faturamento_calc, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PALACIO_FERRAMENTAS_vw_faturamento_calc, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_vw_faturamento_calc, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PALACIO_FERRAMENTAS_vw_faturamento_calc) {
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_1=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_1 = "tHashFile_vw_faturamento_calc_" + pid + "_tHashOutput_1";
...
public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
    ...
    public String loopKey;
				...
				public Boolean cicloIsNullable(){
				    return true;
				}
				public Boolean cicloIsKey(){
				    return true;
				}
				public Integer cicloLength(){
				    return null;
				}
				public Integer cicloPrecision(){
				    return null;
				}
				public String cicloDefault(){
				
					return null;
				
				}
				public String cicloComment(){
				
				    return "";
				
				}
				public String cicloPattern(){
				
					return "";
				
				}
				public String cicloOriginalDbColumnName(){
			    ...
			    public Integer qtd_vendas;

				public Integer getQtd_vendas () {
					return this.qtd_vendas;
				}

				public Boolean qtd_vendasIsNullable(){
				    return true;
				}
				public Boolean qtd_vendasIsKey(){
				    return false;
				}
				public Integer qtd_vendasLength(){
				    return null;
				}
				public Integer qtd_vendasPrecision(){
				    return null;
				}
				public String qtd_vendasDefault(){
				
					return null;
				
				}
				public String qtd_vendasComment(){
				
				    return "";
				
				}
				public String qtd_vendasPattern(){
				
					return "";
				
				}
				public String qtd_vendasOriginalDbColumnName(){
			    ...
			    public Integer qtd_sku;

				public Integer getQtd_sku () {
					return this.qtd_sku;
				}
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.ciclo == null) ? 0 : this.ciclo.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final out1Struct other = (out1Struct) obj;
						...
						} else if (!this.ciclo.equals(other.ciclo))
	...
	public void copyDataTo(out1Struct other) {
		...
		other.ciclo = this.ciclo;
	            ...
	            other.qtd_vendas = this.qtd_vendas;
	            other.qtd_sku = this.qtd_sku;
		...
		synchronized(commonByteArrayLock_PALACIO_FERRAMENTAS_vw_faturamento_calc) {
        	...
        	try {
        		...
        		int length = 0;
						...
						this.qtd_vendas = readInteger(dis);
					
						this.qtd_sku = readInteger(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Integer
						...
						writeInteger(this.qtd_vendas,dos);
					
					// Integer
				
						writeInteger(this.qtd_sku,dos);
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("ciclo="+String.valueOf(ciclo));
		...
		sb.append(",qtd_vendas="+String.valueOf(qtd_vendas));
    ...
    public int compareTo(out1Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.ciclo, other.ciclo);
						if(returnValue != 0) {
							return returnValue;
						}
...
if(dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
	tableName_tDBOutput_2 = ("vw_faturamento_calc").toLowerCase();
} else {
	tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "\".\"" + ("vw_faturamento_calc").toLowerCase();
}
...
int count_tDBOutput_2=0;
	    java.sql.PreparedStatement pstmt_tDBOutput_2 = conn_tDBOutput_2.prepareStatement("SELECT COUNT(1) FROM \"" + tableName_tDBOutput_2 + "\" WHERE \"ciclo\" = ?");
	    resourceMap.put("pstmt_tDBOutput_2", pstmt_tDBOutput_2);
	    String insert_tDBOutput_2 = "INSERT INTO \"" + tableName_tDBOutput_2 + "\" (\"ciclo\",\"data_ano\",\"data_mes\",\"faturamento\",\"qtd_vendas\",\"qtd_sku\",\"dt_atualizacao\") VALUES (?,?,?,?,?,?,?)";
	    ...
	    String update_tDBOutput_2 = "UPDATE \"" + tableName_tDBOutput_2 + "\" SET \"data_ano\" = ?,\"data_mes\" = ?,\"faturamento\" = ?,\"qtd_vendas\" = ?,\"qtd_sku\" = ?,\"dt_atualizacao\" = ? WHERE \"ciclo\" = ?";
 ...
 */
	...
	currentComponent="tDBInput_3";
		...
		int tos_count_tDBInput_3 = 0;
		    ...
		    String dbquery_tDBInput_3 = "\nselect concat(data_ano, lpad(cast(data_mes as varchar),2,'0')) as ciclo,\n       data_ano as ano,\n       data_mes as"
+" mes,\n       sum(total_venda) as faturamento,\n       count(distinct numero_nota_fiscal) as qtd_vendas,\n       count(d"
+"istinct cod_item) as qtd_sku\n              from vw_faturamento\nwhere data >=  date_trunc('month', current_date - inter"
+"val '1 month')\ngroup by data_ano ,data_mes \n";
            ...
            row4.ciclo = rs_tDBInput_3.getInt(1);
            ...
            row4.data_ano = rs_tDBInput_3.getInt(2);
            if(rs_tDBInput_3.wasNull()){
                    row4.data_ano = null;
            }
		                    }
            ...
            row4.data_mes = rs_tDBInput_3.getInt(3);
            if(rs_tDBInput_3.wasNull()){
                    row4.data_mes = null;
            }
		                    }
							if(colQtyInRs_tDBInput_3 < 4) {
								row4.faturamento = null;
							} else {
		                          
            row4.faturamento = rs_tDBInput_3.getBigDecimal(4);
            if(rs_tDBInput_3.wasNull()){
                    row4.faturamento = null;
            }
		                    }
							if(colQtyInRs_tDBInput_3 < 5) {
								row4.qtd_vendas = null;
							} else {
		                          
            row4.qtd_vendas = rs_tDBInput_3.getInt(5);
            if(rs_tDBInput_3.wasNull()){
                    row4.qtd_vendas = null;
            }
		                    }
            ...
            row4.qtd_sku = rs_tDBInput_3.getInt(6);
            if(rs_tDBInput_3.wasNull()){
                    row4.qtd_sku = null;
            }
		                    }
...
// # Output table : 'out1'
out1_tmp.ciclo = row4.ciclo ;
out1_tmp.data_ano = row4.data_ano ;
out1_tmp.data_mes = row4.data_mes ;
out1_tmp.faturamento = row4.faturamento ;
out1_tmp.qtd_vendas = row4.qtd_vendas ;
out1_tmp.qtd_sku = row4.qtd_sku ;
out1_tmp.dt_atualizacao = TalendDate.getCurrentDate();
out1 = out1_tmp;
// ###############################
...
pstmt_tDBOutput_2.setNull(1, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_2.setInt(1, out1.ciclo);
}
            ...
            if(checkCount_tDBOutput_2 > 0) {
                        if(out1.data_ano == null) {
pstmtUpdate_tDBOutput_2.setNull(1, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_2.setInt(1, out1.data_ano);
}

                        if(out1.data_mes == null) {
pstmtUpdate_tDBOutput_2.setNull(2, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_2.setInt(2, out1.data_mes);
}

                        pstmtUpdate_tDBOutput_2.setBigDecimal(3, out1.faturamento);

                        if(out1.qtd_vendas == null) {
pstmtUpdate_tDBOutput_2.setNull(4, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_2.setInt(4, out1.qtd_vendas);
}

                        if(out1.qtd_sku == null) {
pstmtUpdate_tDBOutput_2.setNull(5, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_2.setInt(5, out1.qtd_sku);
}

                        if(out1.dt_atualizacao != null) {
pstmtUpdate_tDBOutput_2.setTimestamp(6, new java.sql.Timestamp(out1.dt_atualizacao.getTime()));
} else {
pstmtUpdate_tDBOutput_2.setNull(6, java.sql.Types.TIMESTAMP);
}

                        if(out1.ciclo == null) {
pstmtUpdate_tDBOutput_2.setNull(7 + count_tDBOutput_2, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_2.setInt(7 + count_tDBOutput_2, out1.ciclo);
}
...
} else {pstmtInsert_tDBOutput_2.setInt(1, out1.ciclo);
}

                        if(out1.data_ano == null) {
pstmtInsert_tDBOutput_2.setNull(2, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_2.setInt(2, out1.data_ano);
}

                        if(out1.data_mes == null) {
pstmtInsert_tDBOutput_2.setNull(3, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_2.setInt(3, out1.data_mes);
}

                        pstmtInsert_tDBOutput_2.setBigDecimal(4, out1.faturamento);

                        if(out1.qtd_vendas == null) {
pstmtInsert_tDBOutput_2.setNull(5, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_2.setInt(5, out1.qtd_vendas);
}

                        if(out1.qtd_sku == null) {
pstmtInsert_tDBOutput_2.setNull(6, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_2.setInt(6, out1.qtd_sku);
}

                        if(out1.dt_atualizacao != null) {
pstmtInsert_tDBOutput_2.setTimestamp(7, new java.sql.Timestamp(out1.dt_atualizacao.getTime()));
} else {
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row38Struct> tHashFile_tHashInput_4 = mf_tHashInput_4.getAdvancedMemoryHashFile("tHashFile_vw_faturamento_calc_" + pid +"_tHashOutput_1");
 ...
 */
	...
	currentComponent="tHashInput_4";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_vw_faturamento_calc_" + pid +"_tHashOutput_1");
 ...
 */
    ...
    public static void main(String[] args){
        final vw_faturamento_calc vw_faturamento_calcClass = new vw_faturamento_calc();

        int exitCode = vw_faturamento_calcClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = vw_faturamento_calc.class.getClassLoader().getResourceAsStream("palacio_ferramentas/vw_faturamento_calc_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = vw_faturamento_calc.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : vw_faturamento_calc");
        }
...
/************************************************************************************************
 *     189740 characters generated by Talend Open Studio for Big Data 
