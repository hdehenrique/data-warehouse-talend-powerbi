...
package palacio_ferramentas.vw_faturamento_compras_0_1;
...
/**
 * Job: vw_faturamento_compras Purpose: <br>
 * Description:  <br>
 * @author talend@talend.com
 * @version 8.0.1.20230922_0317-SNAPSHOT
 * @status 
 */
public class vw_faturamento_compras implements TalendJob {
...
public String getJDBC_PARAMETERS(){
	...
	private final String jobName = "vw_faturamento_compras";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				vw_faturamento_compras.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(vw_faturamento_compras.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class map3Struct implements routines.system.IPersistableRow<map3Struct> {
    final static byte[] commonByteArrayLock_PALACIO_FERRAMENTAS_vw_faturamento_compras = new byte[0];
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_vw_faturamento_compras = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PALACIO_FERRAMENTAS_vw_faturamento_compras) {
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_2=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_2 = "tHashFile_vw_faturamento_compras_" + pid + "_tHashOutput_2";
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PALACIO_FERRAMENTAS_vw_faturamento_compras.length) {
				if(length < 1024 && commonByteArray_PALACIO_FERRAMENTAS_vw_faturamento_compras.length == 0) {
   					commonByteArray_PALACIO_FERRAMENTAS_vw_faturamento_compras = new byte[1024];
				} else {
   					commonByteArray_PALACIO_FERRAMENTAS_vw_faturamento_compras = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PALACIO_FERRAMENTAS_vw_faturamento_compras, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_vw_faturamento_compras, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PALACIO_FERRAMENTAS_vw_faturamento_compras, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_vw_faturamento_compras, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_1=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_1 = "tHashFile_vw_faturamento_compras_" + pid + "_tHashOutput_1";
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_4=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_4 = "tHashFile_vw_faturamento_compras_" + pid + "_tHashOutput_4";
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row8Struct> tHashFile_tHashInput_1 = mf_tHashInput_1.getAdvancedMemoryHashFile("tHashFile_vw_faturamento_compras_" + pid +"_tHashOutput_2");
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_3=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_3 = "tHashFile_vw_faturamento_compras_" + pid + "_tHashOutput_3";
...
+"RA,\nCOND_PAGTO,\nCODCND,\nDT_PEDIDO\nFROM VW_FATURAMENTO\nWHERE DATA_ANO= "+ ((Integer)globalMap.get("row9.ANO")) +"\n      AND DATA_MES = "+ ((Integer)globalMap.get("row9.MES")) +"\n";
 ...
 */
	...
	currentComponent="tHashInput_1";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_vw_faturamento_compras_" + pid +"_tHashOutput_2");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row8Struct> tHashFile_tHashInput_5 = mf_tHashInput_5.getAdvancedMemoryHashFile("tHashFile_vw_faturamento_compras_" + pid +"_tHashOutput_2");
...
query_tDBRow_1 = "\ndelete from vw_faturamento_compras\n  where data_ano = "+ ((Integer)globalMap.get("row10.ANO")) +"\n     and data_mes = "+ ((Integer)globalMap.get("row10.MES")) +";\ncommit;\n";
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<insertStruct> tHashFile_tHashInput_4 = mf_tHashInput_4.getAdvancedMemoryHashFile("tHashFile_vw_faturamento_compras_" + pid +"_tHashOutput_3");
 ...
 */
	...
	currentComponent="tHashInput_4";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_vw_faturamento_compras_" + pid +"_tHashOutput_3");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row4Struct> tHashFile_tHashInput_3 = mf_tHashInput_3.getAdvancedMemoryHashFile("tHashFile_vw_faturamento_compras_" + pid +"_tHashOutput_1");
 ...
 */
	...
	currentComponent="tHashInput_3";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_vw_faturamento_compras_" + pid +"_tHashOutput_1");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<cadcndStruct> tHashFile_tHashInput_2 = mf_tHashInput_2.getAdvancedMemoryHashFile("tHashFile_vw_faturamento_compras_" + pid +"_tHashOutput_4");
 ...
 */
	...
	currentComponent="tHashInput_2";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_vw_faturamento_compras_" + pid +"_tHashOutput_4");
 ...
 */
    ...
    public static void main(String[] args){
        final vw_faturamento_compras vw_faturamento_comprasClass = new vw_faturamento_compras();

        int exitCode = vw_faturamento_comprasClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = vw_faturamento_compras.class.getClassLoader().getResourceAsStream("palacio_ferramentas/vw_faturamento_compras_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = vw_faturamento_compras.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : vw_faturamento_compras");
        }
...
/************************************************************************************************
 *     541351 characters generated by Talend Open Studio for Big Data 
 *     on the 17 de setembro de 2024 23:01:12 BRT
 ************************************************************************************************/