...
package palacio_ferramentas.vw_faturamento_0_1;
...
/**
 * Job: vw_faturamento Purpose: <br>
 * Description:  <br>
 * @author talend@talend.com
 * @version 8.0.1.20230922_0317-SNAPSHOT
 * @status 
 */
public class vw_faturamento implements TalendJob {
...
public String getJDBC_PARAMETERS(){
	...
	private final String jobName = "vw_faturamento";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				vw_faturamento.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(vw_faturamento.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
System.out.println("*************** 01 - vw_faturamento ***************");
System.out.println("Iniciando JOB1 atualização vw_faturamento");
...
public static class row11Struct implements routines.system.IPersistableRow<row11Struct> {
    final static byte[] commonByteArrayLock_PALACIO_FERRAMENTAS_vw_faturamento = new byte[0];
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_vw_faturamento = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PALACIO_FERRAMENTAS_vw_faturamento) {
...
row8Struct row11 = row8;
	...
	///////////////////////
        ...
        util_tLogRow_2.addRow(new String[]{"ANO","MES","DIA",});        
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_2=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_2 = "tHashFile_vw_faturamento_" + pid + "_tHashOutput_2";
            ...
            if(rs_tDBInput_2.wasNull()){
				...
				if(rs_tDBInput_2.getString(3) != null) {
					...
					if (!("0000-00-00").equals(dateString_tDBInput_2) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_2)) {
						row8.DIA = rs_tDBInput_2.getTimestamp(3);
					} else {
						row8.DIA = (java.util.Date) year0_tDBInput_2.clone();
					}
				} else {
					row8.DIA =  null;
				}
...
///////////////////////		
	    		...
	    		if(row11.DIA != null) { //              
                 row_tLogRow_2[2]=    						
								FormatterUtils.format_Date(row11.DIA, "yyyy-MM-dd")
					          ;	
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PALACIO_FERRAMENTAS_vw_faturamento.length) {
				if(length < 1024 && commonByteArray_PALACIO_FERRAMENTAS_vw_faturamento.length == 0) {
   					commonByteArray_PALACIO_FERRAMENTAS_vw_faturamento = new byte[1024];
				} else {
   					commonByteArray_PALACIO_FERRAMENTAS_vw_faturamento = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PALACIO_FERRAMENTAS_vw_faturamento, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_vw_faturamento, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PALACIO_FERRAMENTAS_vw_faturamento, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_vw_faturamento, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_1=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_1 = "tHashFile_vw_faturamento_" + pid + "_tHashOutput_1";
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_4=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_4 = "tHashFile_vw_faturamento_" + pid + "_tHashOutput_4";
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_5=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_5 = "tHashFile_vw_faturamento_" + pid + "_tHashOutput_5";
 ...
 */
	...
	currentComponent="tDBInput_4";
		...
		int tos_count_tDBInput_4 = 0;
		    ...
		    String dbquery_tDBInput_4 = "\nSELECT\n	FGO_NUMFAT,\n	FGO_EMPFAT,\n	FGO_CODCLI ,\n	CONCAT(FGO_DTAENT, ' ', FGO_HORENT) DT_PEDIDO\nFROM\n	FATGOR\nwhe"
+"re\n	FGO_DTAENT >= SUBDATE(CURDATE(), 5)\n";
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row8Struct> tHashFile_tHashInput_1 = mf_tHashInput_1.getAdvancedMemoryHashFile("tHashFile_vw_faturamento_" + pid +"_tHashOutput_2");
...
while (iterator_tHashInput_1.hasNext()) {
	...
	row9.DIA = next_tHashInput_1.DIA;
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_3=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_3 = "tHashFile_vw_faturamento_" + pid + "_tHashOutput_3";
...
+"\nESTADO,\nCOD_CLIENTE,\nCLIENTE,\nCOD_FORNECEDOR,\nFORNECEDOR,\nNUMERO_NOTA_FISCAL,\nSERIE,\nDATA_E_HORA,\nUNITARIO_COMB"
+"O\n FROM AUTCOM.VW_FATURAMENTO\n   WHERE DATA >= '"+ ((java.util.Date)globalMap.get("row9.DIA")) +"';\n";
 ...
 */
	...
	currentComponent="tHashInput_1";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_vw_faturamento_" + pid +"_tHashOutput_2");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row8Struct> tHashFile_tHashInput_2 = mf_tHashInput_2.getAdvancedMemoryHashFile("tHashFile_vw_faturamento_" + pid +"_tHashOutput_2");
...
while (iterator_tHashInput_2.hasNext()) {
	...
	row10.DIA = next_tHashInput_2.DIA;
...
query_tDBRow_1 = "\nDELETE FROM vw_faturamento\nWHERE  DATA >= '"+ ((java.util.Date)globalMap.get("row10.DIA")) +"';\nCOMMIT;\n"
;
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row2Struct> tHashFile_tHashInput_4 = mf_tHashInput_4.getAdvancedMemoryHashFile("tHashFile_vw_faturamento_" + pid +"_tHashOutput_3");
 ...
 */
	...
	currentComponent="tHashInput_4";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_vw_faturamento_" + pid +"_tHashOutput_3");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row4Struct> tHashFile_tHashInput_3 = mf_tHashInput_3.getAdvancedMemoryHashFile("tHashFile_vw_faturamento_" + pid +"_tHashOutput_1");
 ...
 */
	...
	currentComponent="tHashInput_3";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_vw_faturamento_" + pid +"_tHashOutput_1");
...
System.out.println("Finalizando JOB1 atualização vw_faturamento");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<map1Struct> tHashFile_tHashInput_5 = mf_tHashInput_5.getAdvancedMemoryHashFile("tHashFile_vw_faturamento_" + pid +"_tHashOutput_4");
 ...
 */
	...
	currentComponent="tHashInput_5";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_vw_faturamento_" + pid +"_tHashOutput_4");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<copyOfmap1Struct> tHashFile_tHashInput_6 = mf_tHashInput_6.getAdvancedMemoryHashFile("tHashFile_vw_faturamento_" + pid +"_tHashOutput_5");
 ...
 */
	...
	currentComponent="tHashInput_6";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_vw_faturamento_" + pid +"_tHashOutput_5");
 ...
 */
    ...
    public static void main(String[] args){
        final vw_faturamento vw_faturamentoClass = new vw_faturamento();

        int exitCode = vw_faturamentoClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = vw_faturamento.class.getClassLoader().getResourceAsStream("palacio_ferramentas/vw_faturamento_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = vw_faturamento.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : vw_faturamento");
        }
...
/************************************************************************************************
 *     657919 characters generated by Talend Open Studio for Big Data 
 *     on the 17 de setembro de 2024 23:01:11 BRT
 ************************************************************************************************/