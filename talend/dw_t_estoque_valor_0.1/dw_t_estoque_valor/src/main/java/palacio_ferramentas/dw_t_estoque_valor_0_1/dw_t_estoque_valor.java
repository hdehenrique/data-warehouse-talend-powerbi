...
package palacio_ferramentas.dw_t_estoque_valor_0_1;
...
public String getPOSTGRES_PASSWORD(){
	...
	private final String jobName = "dw_t_estoque_valor";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				dw_t_estoque_valor.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(dw_t_estoque_valor.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_PALACIO_FERRAMENTAS_dw_t_estoque_valor = new byte[0];
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_dw_t_estoque_valor = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PALACIO_FERRAMENTAS_dw_t_estoque_valor.length) {
				if(length < 1024 && commonByteArray_PALACIO_FERRAMENTAS_dw_t_estoque_valor.length == 0) {
   					commonByteArray_PALACIO_FERRAMENTAS_dw_t_estoque_valor = new byte[1024];
				} else {
   					commonByteArray_PALACIO_FERRAMENTAS_dw_t_estoque_valor = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PALACIO_FERRAMENTAS_dw_t_estoque_valor, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_dw_t_estoque_valor, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PALACIO_FERRAMENTAS_dw_t_estoque_valor, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_dw_t_estoque_valor, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PALACIO_FERRAMENTAS_dw_t_estoque_valor) {
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_1=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_1 = "tHashFile_dw_t_estoque_valor_" + pid + "_tHashOutput_1";
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_5=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_5 = "tHashFile_dw_t_estoque_valor_" + pid + "_tHashOutput_5";
 ...
 */
	...
	currentComponent="tDBInput_3";
		...
		int tos_count_tDBInput_3 = 0;
		    ...
		    String dbquery_tDBInput_3 = "SELECT 	REPLACE(LPAD( now(), 7, '0'), '-', '') AS ANOMES,\n		IG002.ITE_CODEMP EMPRESA,\n         IG002.ITE_CODITE SKU,"
+"\n         round(IG002.ITE_PREMED,2) PRECO_MEDIO,\n         IG002.ITE_SALDOS - IG002.ITE_SALEXT - IFNULL(IG002.ITE_SALREG"
+",0) - (IFNULL(IG002.ITE_QTPD_V,0) + IFNULL(IG002.ITE_QTPD_F,0) + IFNULL(IG002.ITE_QTPD_P,0)) ESTOQUE,\n         (round(I"
+"G002.ITE_PREMED,2)) * (IG002.ITE_SALDOS - IG002.ITE_SALEXT - IFNULL(IG002.ITE_SALREG,0) - (IFNULL(IG002.ITE_QTPD_V,0) + "
+"IFNULL(IG002.ITE_QTPD_F,0) + IFNULL(IG002.ITE_QTPD_P,0))) AS VL_ESTOQUE\n    FROM ITEGER IG002 \n-- WHERE IG002.ITE_CODI"
+"TE = '69655';\n";
        	...
        	row1.EMPRESA = routines.system.JDBCUtil.getString(rs_tDBInput_3, 2, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 3) {
								row1.SKU = null;
							} else {
	                         		
        	row1.SKU = routines.system.JDBCUtil.getString(rs_tDBInput_3, 3, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 4) {
								row1.PRECO_MEDIO = null;
							} else {
		                          
            row1.PRECO_MEDIO = rs_tDBInput_3.getBigDecimal(4);
            if(rs_tDBInput_3.wasNull()){
                    row1.PRECO_MEDIO = null;
            }
		                    }
            ...
            row1.ESTOQUE = rs_tDBInput_3.getInt(5);
            if(rs_tDBInput_3.wasNull()){
                    row1.ESTOQUE = null;
            }
		                    }
							if(colQtyInRs_tDBInput_3 < 6) {
								row1.VL_ESTOQUE = null;
							} else {
		                          
            row1.VL_ESTOQUE = rs_tDBInput_3.getBigDecimal(6);
            if(rs_tDBInput_3.wasNull()){
                    row1.VL_ESTOQUE = null;
            }
		                    }
 ...
 */
	...
	currentComponent="tHashOutput_5";
		...
		row1Struct oneRow_tHashOutput_5 = new row1Struct();
					...
					oneRow_tHashOutput_5.PRECO_MEDIO = row1.PRECO_MEDIO;
					oneRow_tHashOutput_5.ESTOQUE = row1.ESTOQUE;
					oneRow_tHashOutput_5.VL_ESTOQUE = row1.VL_ESTOQUE;
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_2=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_2 = "tHashFile_dw_t_estoque_valor_" + pid + "_tHashOutput_2";
 ...
 */
	...
	currentComponent="tDBInput_1";
		...
		int tos_count_tDBInput_1 = 0;
		    ...
		    String dbquery_tDBInput_1 = "\nselect anomes , empresa , sku \n  from dw_t_estoque_valor\n  where anomes = (to_char(now(), 'yyyymm'))::int;\n";
            ...
            row3.anomes = rs_tDBInput_1.getInt(1);
        	...
        	row3.empresa = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 3) {
								row3.sku = null;
							} else {
	                         		
        	row3.sku = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
		                    }
...
row8 = null;			
finder_tUniqRow_1.anomes = row3.anomes;
if(row3.empresa == null){
	finder_tUniqRow_1.empresa = null;
}else{
	finder_tUniqRow_1.empresa = row3.empresa.toLowerCase();
}
if(row3.sku == null){
	finder_tUniqRow_1.sku = null;
}else{
	finder_tUniqRow_1.sku = row3.sku.toLowerCase();
}	
...
new_tUniqRow_1.anomes = row3.anomes;
if(row3.empresa == null){
	new_tUniqRow_1.empresa = null;
}else{
	new_tUniqRow_1.empresa = row3.empresa.toLowerCase();
}
if(row3.sku == null){
	new_tUniqRow_1.sku = null;
}else{
	new_tUniqRow_1.sku = row3.sku.toLowerCase();
}
		
		keystUniqRow_1.add(new_tUniqRow_1);if(row8 == null){ 
	
	row8 = new row8Struct();
}row8.anomes = row3.anomes;			row8.empresa = row3.empresa;			row8.sku = row3.sku;					
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("dw_t_estoque_valor").toLowerCase();
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("dw_t_estoque_valor").toLowerCase();
}
...
int count_tDBOutput_1=0;
        ...
        sb_tDBOutput_1.append("INSERT INTO \"").append(tableName_tDBOutput_1).append("\" (\"anomes\",\"empresa\",\"sku\",\"preco_medio\",\"estoque\",\"vl_estoque\",\"dt_ult_atualizacao\") VALUES (?,?,?,?,?,?,?)");
		...
		class KeyStruct_tUniqRow_2 {
			...
			public int hashCode() {
				if (this.hashCodeDirty) {
					...
					int result = DEFAULT_HASHCODE;
								...
								result = prime * result + ((this.PRECO_MEDIO == null) ? 0 : this.PRECO_MEDIO.hashCode());
								
								result = prime * result + ((this.ESTOQUE == null) ? 0 : this.ESTOQUE.hashCode());
								
								result = prime * result + ((this.VL_ESTOQUE == null) ? 0 : this.VL_ESTOQUE.hashCode());
			...
			public boolean equals(Object obj) {
				...
				final KeyStruct_tUniqRow_2 other = (KeyStruct_tUniqRow_2) obj;
									...
									if (this.PRECO_MEDIO == null) {
										if (other.PRECO_MEDIO != null) 
											return false;
								
									} else if (!this.PRECO_MEDIO.equals(other.PRECO_MEDIO))
									...
									} else if (!this.ESTOQUE.equals(other.ESTOQUE))
								 
										return false;
								
									if (this.VL_ESTOQUE == null) {
										if (other.VL_ESTOQUE != null) 
											return false;
								
									} else if (!this.VL_ESTOQUE.equals(other.VL_ESTOQUE))
...
if(dbschema_tDBOutput_4 == null || dbschema_tDBOutput_4.trim().length() == 0) {
	tableName_tDBOutput_4 = ("dw_t_estoque_valor").toLowerCase();
} else {
	tableName_tDBOutput_4 = dbschema_tDBOutput_4 + "\".\"" + ("dw_t_estoque_valor").toLowerCase();
}
...
int count_tDBOutput_4=0;
	    String update_tDBOutput_4 = "UPDATE \"" + tableName_tDBOutput_4 + "\" SET \"preco_medio\" = ?,\"estoque\" = ?,\"vl_estoque\" = ?,\"dt_ult_atualizacao\" = ? WHERE \"anomes\" = ? AND \"empresa\" = ? AND \"sku\" = ?";
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row1Struct> tHashFile_tHashInput_6 = mf_tHashInput_6.getAdvancedMemoryHashFile("tHashFile_dw_t_estoque_valor_" + pid +"_tHashOutput_5");
...
while (iterator_tHashInput_6.hasNext()) {
	...
	row12.PRECO_MEDIO = next_tHashInput_6.PRECO_MEDIO;
	row12.ESTOQUE = next_tHashInput_6.ESTOQUE;
	row12.VL_ESTOQUE = next_tHashInput_6.VL_ESTOQUE;
 					    ...
 					    boolean forceLooprow6 = false;
 							...
 							row6Struct row6ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_4 = false;
                        		    		    ...
                        		    		    row6HashKey.anomes = row12.ANOMES ;
                        		    		
                        		    		    row6HashKey.empresa = row12.EMPRESA ;
                        		    		
                        		    		    row6HashKey.sku = row12.SKU ;
...
// # Output table : 'update'
update_tmp.ANOMES = row12.ANOMES;
update_tmp.EMPRESA = row12.EMPRESA;
update_tmp.SKU = row12.SKU;
update_tmp.PRECO_MEDIO = row12.PRECO_MEDIO;
update_tmp.ESTOQUE = row12.ESTOQUE;
update_tmp.VL_ESTOQUE = row12.VL_ESTOQUE;
update_tmp.DT_ULT_ATUALIZACAO = TalendDate.getCurrentDate();
update = update_tmp;
...
// # Filter conditions 
if( rejectedInnerJoin_tMap_4 ) {
insert_tmp.ANOMES = row12.ANOMES ;
insert_tmp.EMPRESA = row12.EMPRESA ;
insert_tmp.SKU = row12.SKU ;
insert_tmp.PRECO_MEDIO = row12.PRECO_MEDIO ;
insert_tmp.ESTOQUE = row12.ESTOQUE ;
insert_tmp.VL_ESTOQUE = row12.VL_ESTOQUE ;
insert_tmp.DT_ULT_ATUALIZACAO = TalendDate.getCurrentDate();
insert = insert_tmp;
...
row7 = null;			
finder_tUniqRow_2.ANOMES = insert.ANOMES;
if(insert.EMPRESA == null){
	finder_tUniqRow_2.EMPRESA = null;
}else{
	finder_tUniqRow_2.EMPRESA = insert.EMPRESA.toLowerCase();
}
if(insert.SKU == null){
	finder_tUniqRow_2.SKU = null;
}else{
	finder_tUniqRow_2.SKU = insert.SKU.toLowerCase();
}
finder_tUniqRow_2.PRECO_MEDIO = insert.PRECO_MEDIO;
finder_tUniqRow_2.ESTOQUE = insert.ESTOQUE;
finder_tUniqRow_2.VL_ESTOQUE = insert.VL_ESTOQUE;	
finder_tUniqRow_2.hashCodeDirty = true;
if (!keystUniqRow_2.contains(finder_tUniqRow_2)) {
		KeyStruct_tUniqRow_2 new_tUniqRow_2 = new KeyStruct_tUniqRow_2();

		
new_tUniqRow_2.ANOMES = insert.ANOMES;
if(insert.EMPRESA == null){
	new_tUniqRow_2.EMPRESA = null;
}else{
	new_tUniqRow_2.EMPRESA = insert.EMPRESA.toLowerCase();
}
if(insert.SKU == null){
	new_tUniqRow_2.SKU = null;
}else{
	new_tUniqRow_2.SKU = insert.SKU.toLowerCase();
}
new_tUniqRow_2.PRECO_MEDIO = insert.PRECO_MEDIO;
new_tUniqRow_2.ESTOQUE = insert.ESTOQUE;
new_tUniqRow_2.VL_ESTOQUE = insert.VL_ESTOQUE;
		
		keystUniqRow_2.add(new_tUniqRow_2);if(row7 == null){ 
	
	row7 = new row7Struct();
}row7.ANOMES = insert.ANOMES;			row7.EMPRESA = insert.EMPRESA;			row7.SKU = insert.SKU;			row7.PRECO_MEDIO = insert.PRECO_MEDIO;			row7.ESTOQUE = insert.ESTOQUE;			row7.VL_ESTOQUE = insert.VL_ESTOQUE;			row7.DT_ULT_ATUALIZACAO = insert.DT_ULT_ATUALIZACAO;					
...
} else {pstmt_tDBOutput_1.setInt(1, row7.ANOMES);
}

                    if(row7.EMPRESA == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, row7.EMPRESA);
}

                    if(row7.SKU == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, row7.SKU);
}

                    pstmt_tDBOutput_1.setBigDecimal(4, row7.PRECO_MEDIO);

                    if(row7.ESTOQUE == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(5, row7.ESTOQUE);
}

                    pstmt_tDBOutput_1.setBigDecimal(6, row7.VL_ESTOQUE);

                    if(row7.DT_ULT_ATUALIZACAO != null) {
pstmt_tDBOutput_1.setTimestamp(7, new java.sql.Timestamp(row7.DT_ULT_ATUALIZACAO.getTime()));
} else {
...
if(update != null) { 
	...
	currentComponent="tDBOutput_4";
        ...
        whetherReject_tDBOutput_4 = false;
                    pstmt_tDBOutput_4.setBigDecimal(1, update.PRECO_MEDIO);

                    if(update.ESTOQUE == null) {
pstmt_tDBOutput_4.setNull(2, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_4.setInt(2, update.ESTOQUE);
}

                    pstmt_tDBOutput_4.setBigDecimal(3, update.VL_ESTOQUE);

                    if(update.DT_ULT_ATUALIZACAO != null) {
pstmt_tDBOutput_4.setTimestamp(4, new java.sql.Timestamp(update.DT_ULT_ATUALIZACAO.getTime()));
} else {
pstmt_tDBOutput_4.setNull(4, java.sql.Types.TIMESTAMP);
}

                    if(update.ANOMES == null) {
pstmt_tDBOutput_4.setNull(5 + count_tDBOutput_4, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_4.setInt(5 + count_tDBOutput_4, update.ANOMES);
}


                    if(update.EMPRESA == null) {
pstmt_tDBOutput_4.setNull(6 + count_tDBOutput_4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(6 + count_tDBOutput_4, update.EMPRESA);
}


                    if(update.SKU == null) {
pstmt_tDBOutput_4.setNull(7 + count_tDBOutput_4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(7 + count_tDBOutput_4, update.SKU);
}
 ...
 */
	...
	currentComponent="tHashInput_6";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_dw_t_estoque_valor_" + pid +"_tHashOutput_5");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row4Struct> tHashFile_tHashInput_1 = mf_tHashInput_1.getAdvancedMemoryHashFile("tHashFile_dw_t_estoque_valor_" + pid +"_tHashOutput_1");
 ...
 */
	...
	currentComponent="tHashInput_1";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_dw_t_estoque_valor_" + pid +"_tHashOutput_1");
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row6";
		...
		int tos_count_tAdvancedHash_row6 = 0;
			   		...
			   		// source node:tHashInput_2 - inputs:(after_tHashInput_6) outputs:(row6,row6) | target node:tAdvancedHash_row6 - inputs:(row6) outputs:()
			   		// linked node: tMap_4 - inputs:(row12,row6) outputs:(insert,update)
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row8Struct> tHashFile_tHashInput_2 = mf_tHashInput_2.getAdvancedMemoryHashFile("tHashFile_dw_t_estoque_valor_" + pid +"_tHashOutput_2");
...
while (iterator_tHashInput_2.hasNext()) {
	...
	row6.anomes = next_tHashInput_2.anomes;
	row6.empresa = next_tHashInput_2.empresa;
	row6.sku = next_tHashInput_2.sku;
 ...
 */
	...
	currentComponent="tAdvancedHash_row6";
				...
				row6_HashRow.anomes = row6.anomes;
				
				row6_HashRow.empresa = row6.empresa;
				
				row6_HashRow.sku = row6.sku;
 ...
 */
	...
	currentComponent="tHashInput_2";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_dw_t_estoque_valor_" + pid +"_tHashOutput_2");
 ...
 */
    ...
    public static void main(String[] args){
        final dw_t_estoque_valor dw_t_estoque_valorClass = new dw_t_estoque_valor();

        int exitCode = dw_t_estoque_valorClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = dw_t_estoque_valor.class.getClassLoader().getResourceAsStream("palacio_ferramentas/dw_t_estoque_valor_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = dw_t_estoque_valor.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dw_t_estoque_valor");
        }
...
/************************************************************************************************
 *     350015 characters generated by Talend Open Studio for Big Data 
 *     on the 5 de dezembro de 2024 13:59:39 BRT
 ************************************************************************************************/