...
package palacio_ferramentas.dw_t_indicador_diario_0_1;
...
/**
 * Job: dw_t_indicador_diario Purpose: <br>
 * Description:  <br>
 * @author talend@talend.com
 * @version 8.0.1.20230922_0317-SNAPSHOT
 * @status 
 */
public class dw_t_indicador_diario implements TalendJob {
...
public String getPOSTGRES_PASSWORD(){
	...
	private final String jobName = "dw_t_indicador_diario";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				dw_t_indicador_diario.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(dw_t_indicador_diario.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	try {
				tLogCatcher_1.addMessage("tDie", "tDie_1", 5, "Erro na Conexão com o Banco", 2);
				tLogCatcher_1Process(globalMap);
				
	globalMap.put("tDie_1_DIE_PRIORITY", 5);
	System.err.println("Erro na Conexão com o Banco");
	
	globalMap.put("tDie_1_DIE_MESSAGE", "Erro na Conexão com o Banco");
	globalMap.put("tDie_1_DIE_MESSAGES", "Erro na Conexão com o Banco");
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_PALACIO_FERRAMENTAS_dw_t_indicador_diario = new byte[0];
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_dw_t_indicador_diario = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PALACIO_FERRAMENTAS_dw_t_indicador_diario.length) {
				if(length < 1024 && commonByteArray_PALACIO_FERRAMENTAS_dw_t_indicador_diario.length == 0) {
   					commonByteArray_PALACIO_FERRAMENTAS_dw_t_indicador_diario = new byte[1024];
				} else {
   					commonByteArray_PALACIO_FERRAMENTAS_dw_t_indicador_diario = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PALACIO_FERRAMENTAS_dw_t_indicador_diario, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_dw_t_indicador_diario, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PALACIO_FERRAMENTAS_dw_t_indicador_diario, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_dw_t_indicador_diario, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PALACIO_FERRAMENTAS_dw_t_indicador_diario) {
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_1=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_1 = "tHashFile_dw_t_indicador_diario_" + pid + "_tHashOutput_1";
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row4Struct> tHashFile_tHashInput_1 = mf_tHashInput_1.getAdvancedMemoryHashFile("tHashFile_dw_t_indicador_diario_" + pid +"_tHashOutput_1");
 ...
 */
	...
	currentComponent="tHashInput_1";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_dw_t_indicador_diario_" + pid +"_tHashOutput_1");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row4Struct> tHashFile_tHashInput_2 = mf_tHashInput_2.getAdvancedMemoryHashFile("tHashFile_dw_t_indicador_diario_" + pid +"_tHashOutput_1");
...
public static class qtde_pedido2Struct implements routines.system.IPersistableRow<qtde_pedido2Struct> {
    final static byte[] commonByteArrayLock_PALACIO_FERRAMENTAS_dw_t_indicador_diario = new byte[0];
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_dw_t_indicador_diario = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final qtde_pedido2Struct other = (qtde_pedido2Struct) obj;
	...
	public void copyDataTo(qtde_pedido2Struct other) {
	...
	public void copyKeysDataTo(qtde_pedido2Struct other) {
     ...
     * Compare keys
     */
    public int compareTo(qtde_pedido2Struct other) {
...
public static class Faturamento2Struct implements routines.system.IPersistableRow<Faturamento2Struct> {
    final static byte[] commonByteArrayLock_PALACIO_FERRAMENTAS_dw_t_indicador_diario = new byte[0];
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_dw_t_indicador_diario = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final Faturamento2Struct other = (Faturamento2Struct) obj;
	...
	public void copyDataTo(Faturamento2Struct other) {
	...
	public void copyKeysDataTo(Faturamento2Struct other) {
     ...
     * Compare keys
     */
    public int compareTo(Faturamento2Struct other) {
...
qtde_pedido2Struct qtde_pedido2 = new qtde_pedido2Struct();
Faturamento2Struct Faturamento2 = new Faturamento2Struct();
	...
	currentComponent="tDBOutput_12";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"qtde_pedido2");
					}
...
if(dbschema_tDBOutput_12 == null || dbschema_tDBOutput_12.trim().length() == 0) {
	tableName_tDBOutput_12 = ("dw_t_indicador_diario").toLowerCase();
} else {
	tableName_tDBOutput_12 = dbschema_tDBOutput_12 + "\".\"" + ("dw_t_indicador_diario").toLowerCase();
}
...
int count_tDBOutput_12=0;
        java.lang.StringBuilder sb_tDBOutput_12 = new java.lang.StringBuilder();
        sb_tDBOutput_12.append("INSERT INTO \"").append(tableName_tDBOutput_12).append("\" (\"dia\",\"cd_tipo\",\"cd_indicador\",\"valor\",\"data_atualizacao\") VALUES (?,?,?,?,?)");

        String insert_tDBOutput_12 = sb_tDBOutput_12.toString();
 ...
 */
	...
	currentComponent="tDBOutput_10";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"Faturamento2");
					}
...
if(dbschema_tDBOutput_10 == null || dbschema_tDBOutput_10.trim().length() == 0) {
	tableName_tDBOutput_10 = ("dw_t_indicador_diario").toLowerCase();
} else {
	tableName_tDBOutput_10 = dbschema_tDBOutput_10 + "\".\"" + ("dw_t_indicador_diario").toLowerCase();
}
...
int count_tDBOutput_10=0;
        ...
        sb_tDBOutput_10.append("INSERT INTO \"").append(tableName_tDBOutput_10).append("\" (\"dia\",\"cd_tipo\",\"cd_indicador\",\"valor\",\"data_atualizacao\") VALUES (?,?,?,?,?)");
...
// ###############################
// # Outputs initialization
qtde_pedido2Struct qtde_pedido2_tmp = new qtde_pedido2Struct();
Faturamento2Struct Faturamento2_tmp = new Faturamento2Struct();
// ###############################
 ...
 */
	...
	currentComponent="tDBInput_8";
		...
		int tos_count_tDBInput_8 = 0;
		    ...
		    String dbquery_tDBInput_8 = "select to_date(to_char(tfv.DT_VENDA, 'YYYY/MM/DD'), 'YYYY/MM/DD') dia,\n       tfv.UF UF,\n       count(tfv.NUMERO_NOTA"
+") qtde_pedidos,\n       ROUND (sum(tfv.VL_NOTA),2) Faturamento\n  from dw_t_fato_venda tfv\n where tfv.TIPO_NOTA = 'NF'"
+"\n   and tfv.DT_VENDA >= CURRENT_DATE-10\n group by to_date(to_char(tfv.DT_VENDA, 'YYYY/MM/DD'), 'YYYY/MM/DD'), tfv.UF";
			...
			row14.dia = routines.system.JDBCUtil.getDate(rs_tDBInput_8, 1);
		                    }
							if(colQtyInRs_tDBInput_8 < 2) {
								row14.UF = null;
							} else {
	                         		
        	row14.UF = routines.system.JDBCUtil.getString(rs_tDBInput_8, 2, false);
		                    }
							if(colQtyInRs_tDBInput_8 < 3) {
								row14.qtde_pedidos = null;
							} else {
	                         		
            row14.qtde_pedidos = rs_tDBInput_8.getDouble(3);
            if(rs_tDBInput_8.wasNull()){
                    row14.qtde_pedidos = null;
            }
		                    }
							if(colQtyInRs_tDBInput_8 < 4) {
								row14.Faturamento = null;
							} else {
	                         		
            row14.Faturamento = rs_tDBInput_8.getDouble(4);
            if(rs_tDBInput_8.wasNull()){
                    row14.Faturamento = null;
            }
		                    }
...
// # Output table : 'qtde_pedido2'
qtde_pedido2_tmp.DIA = row14.dia ;
qtde_pedido2_tmp.CD_TIPO = row14.UF ;
qtde_pedido2_tmp.CD_INDICADOR = 102;
qtde_pedido2_tmp.VALOR = row14.qtde_pedidos ;
qtde_pedido2_tmp.DATA_ATUALIZACAO = TalendDate.getCurrentDate();
qtde_pedido2 = qtde_pedido2_tmp;

// # Output table : 'Faturamento2'
Faturamento2_tmp.DIA = row14.dia;
Faturamento2_tmp.CD_TIPO = row14.UF ;
Faturamento2_tmp.CD_INDICADOR = 103;
Faturamento2_tmp.VALOR = row14.Faturamento ;
Faturamento2_tmp.DATA_ATUALIZACAO = TalendDate.getCurrentDate();
Faturamento2 = Faturamento2_tmp;
// ###############################
 ...
 */
// Start of branch "qtde_pedido2"
if(qtde_pedido2 != null) { 
	...
	currentComponent="tDBOutput_12";
        ...
        whetherReject_tDBOutput_12 = false;
                    if(qtde_pedido2.DIA != null) {
pstmt_tDBOutput_12.setTimestamp(1, new java.sql.Timestamp(qtde_pedido2.DIA.getTime()));
} else {
pstmt_tDBOutput_12.setNull(1, java.sql.Types.TIMESTAMP);
}

                    if(qtde_pedido2.CD_TIPO == null) {
pstmt_tDBOutput_12.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_12.setString(2, qtde_pedido2.CD_TIPO);
}

                    if(qtde_pedido2.CD_INDICADOR == null) {
pstmt_tDBOutput_12.setNull(3, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_12.setInt(3, qtde_pedido2.CD_INDICADOR);
}

                    if(qtde_pedido2.VALOR == null) {
pstmt_tDBOutput_12.setNull(4, java.sql.Types.DOUBLE);
} else {pstmt_tDBOutput_12.setDouble(4, qtde_pedido2.VALOR);
}

                    if(qtde_pedido2.DATA_ATUALIZACAO != null) {
pstmt_tDBOutput_12.setTimestamp(5, new java.sql.Timestamp(qtde_pedido2.DATA_ATUALIZACAO.getTime()));
} else {
pstmt_tDBOutput_12.setNull(5, java.sql.Types.TIMESTAMP);
}
...
} // End of branch "qtde_pedido2"




// Start of branch "Faturamento2"
if(Faturamento2 != null) { 
	...
	currentComponent="tDBOutput_10";
        ...
        whetherReject_tDBOutput_10 = false;
                    if(Faturamento2.DIA != null) {
pstmt_tDBOutput_10.setTimestamp(1, new java.sql.Timestamp(Faturamento2.DIA.getTime()));
} else {
pstmt_tDBOutput_10.setNull(1, java.sql.Types.TIMESTAMP);
}

                    if(Faturamento2.CD_TIPO == null) {
pstmt_tDBOutput_10.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_10.setString(2, Faturamento2.CD_TIPO);
}

                    if(Faturamento2.CD_INDICADOR == null) {
pstmt_tDBOutput_10.setNull(3, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_10.setInt(3, Faturamento2.CD_INDICADOR);
}

                    if(Faturamento2.VALOR == null) {
pstmt_tDBOutput_10.setNull(4, java.sql.Types.DOUBLE);
} else {pstmt_tDBOutput_10.setDouble(4, Faturamento2.VALOR);
}

                    if(Faturamento2.DATA_ATUALIZACAO != null) {
pstmt_tDBOutput_10.setTimestamp(5, new java.sql.Timestamp(Faturamento2.DATA_ATUALIZACAO.getTime()));
} else {
...
globalMap.put("tDBOutput_12_ERROR_MESSAGE",e_tDBOutput_12.getMessage());
	...
	nb_line_rejected_tDBOutput_12=nb_line_rejected_tDBOutput_12 + rejectedCount_tDBOutput_12;
        ...
        globalMap.put("tDBOutput_12_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_12);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"qtde_pedido2");
			  	}
...
globalMap.put("tDBOutput_10_ERROR_MESSAGE",e_tDBOutput_10.getMessage());
	...
	nb_line_rejected_tDBOutput_10=nb_line_rejected_tDBOutput_10 + rejectedCount_tDBOutput_10;
        ...
        globalMap.put("tDBOutput_10_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_10);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"Faturamento2");
			  	}
...
public static class Qtde_Pedido4Struct implements routines.system.IPersistableRow<Qtde_Pedido4Struct> {
    final static byte[] commonByteArrayLock_PALACIO_FERRAMENTAS_dw_t_indicador_diario = new byte[0];
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_dw_t_indicador_diario = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final Qtde_Pedido4Struct other = (Qtde_Pedido4Struct) obj;
	...
	public void copyDataTo(Qtde_Pedido4Struct other) {
	...
	public void copyKeysDataTo(Qtde_Pedido4Struct other) {
     ...
     * Compare keys
     */
    public int compareTo(Qtde_Pedido4Struct other) {
...
public static class Faturamento4Struct implements routines.system.IPersistableRow<Faturamento4Struct> {
    final static byte[] commonByteArrayLock_PALACIO_FERRAMENTAS_dw_t_indicador_diario = new byte[0];
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_dw_t_indicador_diario = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final Faturamento4Struct other = (Faturamento4Struct) obj;
	...
	public void copyDataTo(Faturamento4Struct other) {
	...
	public void copyKeysDataTo(Faturamento4Struct other) {
     ...
     * Compare keys
     */
    public int compareTo(Faturamento4Struct other) {
...
Qtde_Pedido4Struct Qtde_Pedido4 = new Qtde_Pedido4Struct();
Faturamento4Struct Faturamento4 = new Faturamento4Struct();
	...
	currentComponent="tDBOutput_16";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"Qtde_Pedido4");
					}
...
if(dbschema_tDBOutput_16 == null || dbschema_tDBOutput_16.trim().length() == 0) {
	tableName_tDBOutput_16 = ("dw_t_indicador_diario").toLowerCase();
} else {
	tableName_tDBOutput_16 = dbschema_tDBOutput_16 + "\".\"" + ("dw_t_indicador_diario").toLowerCase();
}
...
int count_tDBOutput_16=0;
        java.lang.StringBuilder sb_tDBOutput_16 = new java.lang.StringBuilder();
        sb_tDBOutput_16.append("INSERT INTO \"").append(tableName_tDBOutput_16).append("\" (\"dia\",\"cd_tipo\",\"cd_indicador\",\"valor\",\"data_atualizacao\") VALUES (?,?,?,?,?)");

        String insert_tDBOutput_16 = sb_tDBOutput_16.toString();
 ...
 */
	...
	currentComponent="tDBOutput_13";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"Faturamento4");
					}
...
if(dbschema_tDBOutput_13 == null || dbschema_tDBOutput_13.trim().length() == 0) {
	tableName_tDBOutput_13 = ("dw_t_indicador_diario").toLowerCase();
} else {
	tableName_tDBOutput_13 = dbschema_tDBOutput_13 + "\".\"" + ("dw_t_indicador_diario").toLowerCase();
}
...
int count_tDBOutput_13=0;
        java.lang.StringBuilder sb_tDBOutput_13 = new java.lang.StringBuilder();
        sb_tDBOutput_13.append("INSERT INTO \"").append(tableName_tDBOutput_13).append("\" (\"dia\",\"cd_tipo\",\"cd_indicador\",\"valor\",\"data_atualizacao\") VALUES (?,?,?,?,?)");

        String insert_tDBOutput_13 = sb_tDBOutput_13.toString();
...
// ###############################
// # Outputs initialization
Qtde_Pedido4Struct Qtde_Pedido4_tmp = new Qtde_Pedido4Struct();
Faturamento4Struct Faturamento4_tmp = new Faturamento4Struct();
// ###############################
 ...
 */
	...
	currentComponent="tDBInput_11";
		...
		int tos_count_tDBInput_11 = 0;
		    ...
		    String dbquery_tDBInput_11 = "SELECT to_date(to_char(p.DT_PEDIDO, 'YYYY/MM/DD'), 'YYYY/MM/DD') dia,\n        p.CD_VENDEDOR,\n        count(p.NUMERO_N"
+"OTA) qtde_pedidos,\n        sum(p.VL_PEDIDO) Faturamento\n   FROM dw_t_pedido p\n  where p.TIPO_NOTA = 'NF'\n     and p."
+"DT_PEDIDO >= CURRENT_DATE-10\n  group by to_date(to_char(p.DT_PEDIDO, 'YYYY/MM/DD'), 'YYYY/MM/DD'), p.CD_VENDEDOR";
			...
			row28.dia = routines.system.JDBCUtil.getDate(rs_tDBInput_11, 1);
		                    }
							if(colQtyInRs_tDBInput_11 < 2) {
								row28.CD_VENDEDOR = null;
							} else {
	                         		
        	row28.CD_VENDEDOR = routines.system.JDBCUtil.getString(rs_tDBInput_11, 2, false);
		                    }
							if(colQtyInRs_tDBInput_11 < 3) {
								row28.qtde_pedidos = null;
							} else {
	                         		
            row28.qtde_pedidos = rs_tDBInput_11.getDouble(3);
            if(rs_tDBInput_11.wasNull()){
                    row28.qtde_pedidos = null;
            }
		                    }
							if(colQtyInRs_tDBInput_11 < 4) {
								row28.Faturamento = null;
							} else {
	                         		
            row28.Faturamento = rs_tDBInput_11.getDouble(4);
            if(rs_tDBInput_11.wasNull()){
                    row28.Faturamento = null;
            }
		                    }
...
// # Output table : 'Qtde_Pedido4'
Qtde_Pedido4_tmp.dia = row28.dia ;
Qtde_Pedido4_tmp.CD_TIPO = row28.CD_VENDEDOR ;
Qtde_Pedido4_tmp.CD_INDICADOR = 104;
Qtde_Pedido4_tmp.VALOR = row28.qtde_pedidos ;
Qtde_Pedido4_tmp.DATA_ATUALIZACAO = TalendDate.getCurrentDate();
Qtde_Pedido4 = Qtde_Pedido4_tmp;

// # Output table : 'Faturamento4'
Faturamento4_tmp.dia = row28.dia ;
Faturamento4_tmp.CD_TIPO = row28.CD_VENDEDOR ;
Faturamento4_tmp.CD_INDICADOR = 105;
Faturamento4_tmp.VALOR = row28.Faturamento ;
Faturamento4_tmp.DATA_ATUALIZACAO = TalendDate.getCurrentDate();
Faturamento4 = Faturamento4_tmp;
// ###############################
 ...
 */
// Start of branch "Qtde_Pedido4"
if(Qtde_Pedido4 != null) { 
	...
	currentComponent="tDBOutput_16";
        ...
        whetherReject_tDBOutput_16 = false;
                    if(Qtde_Pedido4.dia != null) {
pstmt_tDBOutput_16.setTimestamp(1, new java.sql.Timestamp(Qtde_Pedido4.dia.getTime()));
} else {
pstmt_tDBOutput_16.setNull(1, java.sql.Types.TIMESTAMP);
}

                    if(Qtde_Pedido4.CD_TIPO == null) {
pstmt_tDBOutput_16.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_16.setString(2, Qtde_Pedido4.CD_TIPO);
}

                    if(Qtde_Pedido4.CD_INDICADOR == null) {
pstmt_tDBOutput_16.setNull(3, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_16.setInt(3, Qtde_Pedido4.CD_INDICADOR);
}

                    if(Qtde_Pedido4.VALOR == null) {
pstmt_tDBOutput_16.setNull(4, java.sql.Types.DOUBLE);
} else {pstmt_tDBOutput_16.setDouble(4, Qtde_Pedido4.VALOR);
}

                    if(Qtde_Pedido4.DATA_ATUALIZACAO != null) {
pstmt_tDBOutput_16.setTimestamp(5, new java.sql.Timestamp(Qtde_Pedido4.DATA_ATUALIZACAO.getTime()));
} else {
pstmt_tDBOutput_16.setNull(5, java.sql.Types.TIMESTAMP);
}
...
} // End of branch "Qtde_Pedido4"




// Start of branch "Faturamento4"
if(Faturamento4 != null) { 
	...
	currentComponent="tDBOutput_13";
        ...
        whetherReject_tDBOutput_13 = false;
                    if(Faturamento4.dia != null) {
pstmt_tDBOutput_13.setTimestamp(1, new java.sql.Timestamp(Faturamento4.dia.getTime()));
} else {
pstmt_tDBOutput_13.setNull(1, java.sql.Types.TIMESTAMP);
}

                    if(Faturamento4.CD_TIPO == null) {
pstmt_tDBOutput_13.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_13.setString(2, Faturamento4.CD_TIPO);
}

                    if(Faturamento4.CD_INDICADOR == null) {
pstmt_tDBOutput_13.setNull(3, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_13.setInt(3, Faturamento4.CD_INDICADOR);
}

                    if(Faturamento4.VALOR == null) {
pstmt_tDBOutput_13.setNull(4, java.sql.Types.DOUBLE);
} else {pstmt_tDBOutput_13.setDouble(4, Faturamento4.VALOR);
}

                    if(Faturamento4.DATA_ATUALIZACAO != null) {
pstmt_tDBOutput_13.setTimestamp(5, new java.sql.Timestamp(Faturamento4.DATA_ATUALIZACAO.getTime()));
} else {
pstmt_tDBOutput_13.setNull(5, java.sql.Types.TIMESTAMP);
}
...
globalMap.put("tDBOutput_16_ERROR_MESSAGE",e_tDBOutput_16.getMessage());
	...
	nb_line_rejected_tDBOutput_16=nb_line_rejected_tDBOutput_16 + rejectedCount_tDBOutput_16;
        ...
        globalMap.put("tDBOutput_16_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_16);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"Qtde_Pedido4");
			  	}
...
globalMap.put("tDBOutput_13_ERROR_MESSAGE",e_tDBOutput_13.getMessage());
	...
	nb_line_rejected_tDBOutput_13=nb_line_rejected_tDBOutput_13 + rejectedCount_tDBOutput_13;
        ...
        globalMap.put("tDBOutput_13_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_13);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"Faturamento4");
			  	}
...
public static class Qtde_Pedido6Struct implements routines.system.IPersistableRow<Qtde_Pedido6Struct> {
    final static byte[] commonByteArrayLock_PALACIO_FERRAMENTAS_dw_t_indicador_diario = new byte[0];
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_dw_t_indicador_diario = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final Qtde_Pedido6Struct other = (Qtde_Pedido6Struct) obj;
	...
	public void copyDataTo(Qtde_Pedido6Struct other) {
	...
	public void copyKeysDataTo(Qtde_Pedido6Struct other) {
     ...
     * Compare keys
     */
    public int compareTo(Qtde_Pedido6Struct other) {
...
public static class Faturamento6Struct implements routines.system.IPersistableRow<Faturamento6Struct> {
    final static byte[] commonByteArrayLock_PALACIO_FERRAMENTAS_dw_t_indicador_diario = new byte[0];
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_dw_t_indicador_diario = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final Faturamento6Struct other = (Faturamento6Struct) obj;
	...
	public void copyDataTo(Faturamento6Struct other) {
	...
	public void copyKeysDataTo(Faturamento6Struct other) {
     ...
     * Compare keys
     */
    public int compareTo(Faturamento6Struct other) {
...
Qtde_Pedido6Struct Qtde_Pedido6 = new Qtde_Pedido6Struct();
Faturamento6Struct Faturamento6 = new Faturamento6Struct();
	...
	currentComponent="tDBOutput_23";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"Qtde_Pedido6");
					}
...
if(dbschema_tDBOutput_23 == null || dbschema_tDBOutput_23.trim().length() == 0) {
	tableName_tDBOutput_23 = ("dw_t_indicador_diario").toLowerCase();
} else {
	tableName_tDBOutput_23 = dbschema_tDBOutput_23 + "\".\"" + ("dw_t_indicador_diario").toLowerCase();
}
...
int count_tDBOutput_23=0;
        java.lang.StringBuilder sb_tDBOutput_23 = new java.lang.StringBuilder();
        sb_tDBOutput_23.append("INSERT INTO \"").append(tableName_tDBOutput_23).append("\" (\"dia\",\"cd_tipo\",\"cd_indicador\",\"valor\",\"data_atualizacao\") VALUES (?,?,?,?,?)");

        String insert_tDBOutput_23 = sb_tDBOutput_23.toString();
 ...
 */
	...
	currentComponent="tDBOutput_24";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"Faturamento6");
					}
...
String dbschema_tDBOutput_24 = null;
	dbschema_tDBOutput_24 = (String)globalMap.get("schema_" + "tDBConnection_2");
	

String tableName_tDBOutput_24 = null;
if(dbschema_tDBOutput_24 == null || dbschema_tDBOutput_24.trim().length() == 0) {
	tableName_tDBOutput_24 = ("dw_t_indicador_diario").toLowerCase();
} else {
	tableName_tDBOutput_24 = dbschema_tDBOutput_24 + "\".\"" + ("dw_t_indicador_diario").toLowerCase();
}
...
int rowsToCommitCount_tDBOutput_24=0;
...
String dbUser_tDBOutput_24 = null;
	...
	conn_tDBOutput_24 = (java.sql.Connection)globalMap.get("conn_tDBConnection_2");
...
int count_tDBOutput_24=0;
        java.lang.StringBuilder sb_tDBOutput_24 = new java.lang.StringBuilder();
        sb_tDBOutput_24.append("INSERT INTO \"").append(tableName_tDBOutput_24).append("\" (\"dia\",\"cd_tipo\",\"cd_indicador\",\"valor\",\"data_atualizacao\") VALUES (?,?,?,?,?)");

        String insert_tDBOutput_24 = sb_tDBOutput_24.toString();
...
// ###############################
// # Outputs initialization
Qtde_Pedido6Struct Qtde_Pedido6_tmp = new Qtde_Pedido6Struct();
Faturamento6Struct Faturamento6_tmp = new Faturamento6Struct();
// ###############################
	...
	currentComponent="tDBInput_19";
		...
		int tos_count_tDBInput_19 = 0;
		    ...
		    java.sql.Connection conn_tDBInput_19 = null;
				conn_tDBInput_19 = (java.sql.Connection)globalMap.get("conn_tDBConnection_2");
				
		    
			java.sql.Statement stmt_tDBInput_19 = conn_tDBInput_19.createStatement();

		    String dbquery_tDBInput_19 = "select to_date(to_char(ped.DT_PEDIDO, 'YYYY/MM/DD'), 'YYYY/MM/DD') dia,\n        item.CD_ITEM,\n        sum(item.QTD_IT"
+"EM) qtde_pedidos,\n        sum(item.QTD_ITEM * item.VL_UNITARIO) Faturamento\n  from dw_t_item_pedido item,\n       dw_t"
+"_pedido ped,\n       dw_t_fato_venda venda\n where item.pedido_autcom  = ped.pedido_autcom \n   and venda.numero_nota = "
+"ped.numero_nota \n   and venda.serie_nf  = ped.serie_nota\n   and venda.cd_empresa = ped.cd_empresa_origem\n   and ped.c"
+"d_empresa_origem = item.cd_emp_origem\n--   and cd_item = 69655\n   and item.TIPO_NOTA = ped.TIPO_NOTA\n   and item.ESPE"
+"CIE_AUTCOM = 'PD'\n   and item.TIPO_NOTA = 'NF'\n   and ped.DT_PEDIDO >= CURRENT_DATE-10\n group by to_date(to_char(ped."
+"DT_PEDIDO, 'YYYY/MM/DD'), 'YYYY/MM/DD'), item.CD_ITEM";
			...
			row46.dia = routines.system.JDBCUtil.getDate(rs_tDBInput_19, 1);
		                    }
							if(colQtyInRs_tDBInput_19 < 2) {
								row46.CD_ITEM = null;
							} else {
	                         		
        	row46.CD_ITEM = routines.system.JDBCUtil.getString(rs_tDBInput_19, 2, false);
		                    }
							if(colQtyInRs_tDBInput_19 < 3) {
								row46.qtde_pedidos = null;
							} else {
	                         		
            row46.qtde_pedidos = rs_tDBInput_19.getDouble(3);
            if(rs_tDBInput_19.wasNull()){
                    row46.qtde_pedidos = null;
            }
		                    }
							if(colQtyInRs_tDBInput_19 < 4) {
								row46.Faturamento = null;
							} else {
	                         		
            row46.Faturamento = rs_tDBInput_19.getDouble(4);
            if(rs_tDBInput_19.wasNull()){
                    row46.Faturamento = null;
            }
		                    }
...
// # Output table : 'Qtde_Pedido6'
Qtde_Pedido6_tmp.dia = row46.dia ;
Qtde_Pedido6_tmp.CD_TIPO = row46.CD_ITEM ;
Qtde_Pedido6_tmp.CD_INDICADOR = 106;
Qtde_Pedido6_tmp.VALOR = row46.qtde_pedidos ;
Qtde_Pedido6_tmp.DATA_ATUALIZACAO = TalendDate.getCurrentDate();
Qtde_Pedido6 = Qtde_Pedido6_tmp;

// # Output table : 'Faturamento6'
Faturamento6_tmp.dia = row46.dia  ;
Faturamento6_tmp.CD_TIPO = row46.CD_ITEM ;
Faturamento6_tmp.CD_INDICADOR = 107;
Faturamento6_tmp.VALOR = row46.Faturamento ;
Faturamento6_tmp.DATA_ATUALIZACAO = TalendDate.getCurrentDate();
Faturamento6 = Faturamento6_tmp;
// ###############################
 ...
 */
// Start of branch "Qtde_Pedido6"
if(Qtde_Pedido6 != null) { 
	...
	currentComponent="tDBOutput_23";
        ...
        whetherReject_tDBOutput_23 = false;
                    if(Qtde_Pedido6.dia != null) {
pstmt_tDBOutput_23.setTimestamp(1, new java.sql.Timestamp(Qtde_Pedido6.dia.getTime()));
} else {
pstmt_tDBOutput_23.setNull(1, java.sql.Types.TIMESTAMP);
}

                    if(Qtde_Pedido6.CD_TIPO == null) {
pstmt_tDBOutput_23.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_23.setString(2, Qtde_Pedido6.CD_TIPO);
}

                    if(Qtde_Pedido6.CD_INDICADOR == null) {
pstmt_tDBOutput_23.setNull(3, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_23.setInt(3, Qtde_Pedido6.CD_INDICADOR);
}

                    if(Qtde_Pedido6.VALOR == null) {
pstmt_tDBOutput_23.setNull(4, java.sql.Types.DOUBLE);
} else {pstmt_tDBOutput_23.setDouble(4, Qtde_Pedido6.VALOR);
}

                    if(Qtde_Pedido6.DATA_ATUALIZACAO != null) {
pstmt_tDBOutput_23.setTimestamp(5, new java.sql.Timestamp(Qtde_Pedido6.DATA_ATUALIZACAO.getTime()));
} else {
pstmt_tDBOutput_23.setNull(5, java.sql.Types.TIMESTAMP);
}
...
} // End of branch "Qtde_Pedido6"




// Start of branch "Faturamento6"
if(Faturamento6 != null) { 
	...
	currentComponent="tDBOutput_24";
        ...
        whetherReject_tDBOutput_24 = false;
                    if(Faturamento6.dia != null) {
pstmt_tDBOutput_24.setTimestamp(1, new java.sql.Timestamp(Faturamento6.dia.getTime()));
} else {
pstmt_tDBOutput_24.setNull(1, java.sql.Types.TIMESTAMP);
}

                    if(Faturamento6.CD_TIPO == null) {
pstmt_tDBOutput_24.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_24.setString(2, Faturamento6.CD_TIPO);
}

                    if(Faturamento6.CD_INDICADOR == null) {
pstmt_tDBOutput_24.setNull(3, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_24.setInt(3, Faturamento6.CD_INDICADOR);
}

                    if(Faturamento6.VALOR == null) {
pstmt_tDBOutput_24.setNull(4, java.sql.Types.DOUBLE);
} else {pstmt_tDBOutput_24.setDouble(4, Faturamento6.VALOR);
}

                    if(Faturamento6.DATA_ATUALIZACAO != null) {
pstmt_tDBOutput_24.setTimestamp(5, new java.sql.Timestamp(Faturamento6.DATA_ATUALIZACAO.getTime()));
} else {
pstmt_tDBOutput_24.setNull(5, java.sql.Types.TIMESTAMP);
}
    		...
    		nb_line_tDBOutput_24++;
    		  ...
    		  batchSizeCounter_tDBOutput_24++;
                ...
                try {
				    	...
				    	rowsToCommitCount_tDBOutput_24 += countSum_tDBOutput_24;
...
globalMap.put("tDBOutput_24_ERROR_MESSAGE",e_tDBOutput_24.getMessage());
...
globalMap.put("tDBOutput_23_ERROR_MESSAGE",e_tDBOutput_23.getMessage());
	...
	nb_line_rejected_tDBOutput_23=nb_line_rejected_tDBOutput_23 + rejectedCount_tDBOutput_23;
        ...
        globalMap.put("tDBOutput_23_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_23);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"Qtde_Pedido6");
			  	}
...
globalMap.put("tDBOutput_24_ERROR_MESSAGE",e_tDBOutput_24.getMessage());
	...
	nb_line_rejected_tDBOutput_24=nb_line_rejected_tDBOutput_24 + rejectedCount_tDBOutput_24;
        ...
        globalMap.put("tDBOutput_24_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_24);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"Faturamento6");
			  	}
...
public static class qtde_pedidoStruct implements routines.system.IPersistableRow<qtde_pedidoStruct> {
    final static byte[] commonByteArrayLock_PALACIO_FERRAMENTAS_dw_t_indicador_diario = new byte[0];
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_dw_t_indicador_diario = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final qtde_pedidoStruct other = (qtde_pedidoStruct) obj;
	...
	public void copyDataTo(qtde_pedidoStruct other) {
	...
	public void copyKeysDataTo(qtde_pedidoStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(qtde_pedidoStruct other) {
...
public static class FaturamentoStruct implements routines.system.IPersistableRow<FaturamentoStruct> {
    final static byte[] commonByteArrayLock_PALACIO_FERRAMENTAS_dw_t_indicador_diario = new byte[0];
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_dw_t_indicador_diario = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final FaturamentoStruct other = (FaturamentoStruct) obj;
	...
	public void copyDataTo(FaturamentoStruct other) {
	...
	public void copyKeysDataTo(FaturamentoStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(FaturamentoStruct other) {
...
qtde_pedidoStruct qtde_pedido = new qtde_pedidoStruct();
FaturamentoStruct Faturamento = new FaturamentoStruct();
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"qtde_pedido");
					}
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("dw_t_indicador_diario").toLowerCase();
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("dw_t_indicador_diario").toLowerCase();
}
...
int count_tDBOutput_1=0;
	    java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1.prepareStatement("SELECT COUNT(1) FROM \"" + tableName_tDBOutput_1 + "\" WHERE \"dia\" = ? AND \"cd_tipo\" = ? AND \"cd_indicador\" = ?");
	    resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"dia\",\"cd_tipo\",\"cd_indicador\",\"valor\",\"data_atualizacao\") VALUES (?,?,?,?,?)";
	    java.sql.PreparedStatement pstmtInsert_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(insert_tDBOutput_1);
	    resourceMap.put("pstmtInsert_tDBOutput_1", pstmtInsert_tDBOutput_1);
	    String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"valor\" = ?,\"data_atualizacao\" = ? WHERE \"dia\" = ? AND \"cd_tipo\" = ? AND \"cd_indicador\" = ?";
 ...
 */
	...
	currentComponent="tDBOutput_8";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"Faturamento");
					}
...
if(dbschema_tDBOutput_8 == null || dbschema_tDBOutput_8.trim().length() == 0) {
	tableName_tDBOutput_8 = ("dw_t_indicador_diario").toLowerCase();
} else {
	tableName_tDBOutput_8 = dbschema_tDBOutput_8 + "\".\"" + ("dw_t_indicador_diario").toLowerCase();
}
...
int count_tDBOutput_8=0;
        ...
        sb_tDBOutput_8.append("INSERT INTO \"").append(tableName_tDBOutput_8).append("\" (\"dia\",\"cd_tipo\",\"cd_indicador\",\"valor\",\"data_atualizacao\") VALUES (?,?,?,?,?)");
...
// ###############################
// # Outputs initialization
qtde_pedidoStruct qtde_pedido_tmp = new qtde_pedidoStruct();
FaturamentoStruct Faturamento_tmp = new FaturamentoStruct();
// ###############################
 ...
 */
	...
	currentComponent="tDBInput_1";
		...
		int tos_count_tDBInput_1 = 0;
		    ...
		    String dbquery_tDBInput_1 = "select to_date(to_char(tfv.DT_VENDA, 'YYYY/MM/DD'), 'YYYY/MM/DD') dia,\n       count(tfv.NUMERO_NOTA) qtde_pedidos,\n  "
+"     ROUND (sum(tfv.VL_NOTA),2) Faturamento\n  from dw_t_fato_venda tfv\n where tfv.TIPO_NOTA = 'NF'\n     and tfv.DT_VE"
+"NDA >= CURRENT_DATE-10\n group by to_date(to_char(tfv.DT_VENDA, 'YYYY/MM/DD'), 'YYYY/MM/DD')";
			...
			row1.dia = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 1);
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								row1.qtde_pedidos = null;
							} else {
	                         		
            row1.qtde_pedidos = rs_tDBInput_1.getDouble(2);
            ...
            row1.Faturamento = rs_tDBInput_1.getDouble(3);
            if(rs_tDBInput_1.wasNull()){
                    row1.Faturamento = null;
            }
		                    }
...
// # Output table : 'qtde_pedido'
qtde_pedido_tmp.DIA = row1.dia ;
qtde_pedido_tmp.CD_TIPO = "BR";
qtde_pedido_tmp.CD_INDICADOR = 100;
qtde_pedido_tmp.VALOR = row1.qtde_pedidos ;
qtde_pedido_tmp.DATA_ATUALIZACAO = TalendDate.getCurrentDate();
qtde_pedido = qtde_pedido_tmp;

// # Output table : 'Faturamento'
Faturamento_tmp.DIA = row1.dia;
Faturamento_tmp.CD_TIPO = "BR";
Faturamento_tmp.CD_INDICADOR = 101;
Faturamento_tmp.VALOR = row1.Faturamento ;
Faturamento_tmp.DATA_ATUALIZACAO = TalendDate.getCurrentDate();
Faturamento = Faturamento_tmp;
// ###############################
...
if(qtde_pedido != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(qtde_pedido.DIA != null) {
pstmt_tDBOutput_1.setTimestamp(1, new java.sql.Timestamp(qtde_pedido.DIA.getTime()));
} else {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.TIMESTAMP);
}

                    if(qtde_pedido.CD_TIPO == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, qtde_pedido.CD_TIPO);
}

                    if(qtde_pedido.CD_INDICADOR == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(3, qtde_pedido.CD_INDICADOR);
}
            ...
            if(checkCount_tDBOutput_1 > 0) {
                        if(qtde_pedido.VALOR == null) {
pstmtUpdate_tDBOutput_1.setNull(1, java.sql.Types.DOUBLE);
} else {pstmtUpdate_tDBOutput_1.setDouble(1, qtde_pedido.VALOR);
}

                        if(qtde_pedido.DATA_ATUALIZACAO != null) {
pstmtUpdate_tDBOutput_1.setTimestamp(2, new java.sql.Timestamp(qtde_pedido.DATA_ATUALIZACAO.getTime()));
} else {
pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.TIMESTAMP);
}

                        if(qtde_pedido.DIA != null) {
pstmtUpdate_tDBOutput_1.setTimestamp(3 + count_tDBOutput_1, new java.sql.Timestamp(qtde_pedido.DIA.getTime()));
} else {
pstmtUpdate_tDBOutput_1.setNull(3 + count_tDBOutput_1, java.sql.Types.TIMESTAMP);
}

                        if(qtde_pedido.CD_TIPO == null) {
pstmtUpdate_tDBOutput_1.setNull(4 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(4 + count_tDBOutput_1, qtde_pedido.CD_TIPO);
}

                        if(qtde_pedido.CD_INDICADOR == null) {
pstmtUpdate_tDBOutput_1.setNull(5 + count_tDBOutput_1, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_1.setInt(5 + count_tDBOutput_1, qtde_pedido.CD_INDICADOR);
}
...
globalMap.put("tDBOutput_1_ERROR_MESSAGE",e.getMessage());
                    ...
                    whetherReject_tDBOutput_1 = true;
                        ...
                        if(qtde_pedido.DIA != null) {
pstmtInsert_tDBOutput_1.setTimestamp(1, new java.sql.Timestamp(qtde_pedido.DIA.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_1.setString(2, qtde_pedido.CD_TIPO);
}

                        if(qtde_pedido.CD_INDICADOR == null) {
pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_1.setInt(3, qtde_pedido.CD_INDICADOR);
}

                        if(qtde_pedido.VALOR == null) {
pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.DOUBLE);
} else {pstmtInsert_tDBOutput_1.setDouble(4, qtde_pedido.VALOR);
}

                        if(qtde_pedido.DATA_ATUALIZACAO != null) {
pstmtInsert_tDBOutput_1.setTimestamp(5, new java.sql.Timestamp(qtde_pedido.DATA_ATUALIZACAO.getTime()));
} else {
...
} // End of branch "qtde_pedido"




// Start of branch "Faturamento"
if(Faturamento != null) { 
	...
	currentComponent="tDBOutput_8";
        ...
        whetherReject_tDBOutput_8 = false;
                    if(Faturamento.DIA != null) {
pstmt_tDBOutput_8.setTimestamp(1, new java.sql.Timestamp(Faturamento.DIA.getTime()));
} else {
pstmt_tDBOutput_8.setNull(1, java.sql.Types.TIMESTAMP);
}

                    if(Faturamento.CD_TIPO == null) {
pstmt_tDBOutput_8.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_8.setString(2, Faturamento.CD_TIPO);
}

                    if(Faturamento.CD_INDICADOR == null) {
pstmt_tDBOutput_8.setNull(3, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_8.setInt(3, Faturamento.CD_INDICADOR);
}

                    if(Faturamento.VALOR == null) {
pstmt_tDBOutput_8.setNull(4, java.sql.Types.DOUBLE);
} else {pstmt_tDBOutput_8.setDouble(4, Faturamento.VALOR);
}

                    if(Faturamento.DATA_ATUALIZACAO != null) {
pstmt_tDBOutput_8.setTimestamp(5, new java.sql.Timestamp(Faturamento.DATA_ATUALIZACAO.getTime()));
} else {
pstmt_tDBOutput_8.setNull(5, java.sql.Types.TIMESTAMP);
}
 ...
 */
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"qtde_pedido");
			  	}
...
globalMap.put("tDBOutput_8_ERROR_MESSAGE",e_tDBOutput_8.getMessage());
	...
	nb_line_rejected_tDBOutput_8=nb_line_rejected_tDBOutput_8 + rejectedCount_tDBOutput_8;
        ...
        globalMap.put("tDBOutput_8_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_8);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"Faturamento");
			  	}
 ...
 */
    ...
    public static void main(String[] args){
        final dw_t_indicador_diario dw_t_indicador_diarioClass = new dw_t_indicador_diario();

        int exitCode = dw_t_indicador_diarioClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = dw_t_indicador_diario.class.getClassLoader().getResourceAsStream("palacio_ferramentas/dw_t_indicador_diario_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = dw_t_indicador_diario.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
((java.util.Map) threadLocal.get()).put("status", "failure");throw e_tDBInput_8;
        ...
        new Thread(){
            public void run() {
                ...
                try {
((java.util.Map) threadLocal.get()).put("errorCode", null);tDBInput_11Process(globalMap);
if ( !"failure".equals(((java.util.Map)threadLocal.get()).get("status")) ) {
((java.util.Map) threadLocal.get()).put("status", "end");
}
...
}catch (java.lang.Error e_tDBInput_11) {
globalMap.put("tDBInput_11_SUBPROCESS_STATE", -1);
((java.util.Map) threadLocal.get()).put("status", "failure");throw e_tDBInput_11;
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dw_t_indicador_diario");
        }
...
/************************************************************************************************
 *     532917 characters generated by Talend Open Studio for Big Data 
 *     on the 20 de maio de 2024 22:32:37 BRT
 ************************************************************************************************/