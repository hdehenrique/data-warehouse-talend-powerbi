...
package palacio_ferramentas.stg_cademp_0_1;
...
public String getJDBC_PARAMETERS(){
	...
	private final String jobName = "stg_cademp";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(stg_cademp.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_PALACIO_FERRAMENTAS_stg_cademp = new byte[0];
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_stg_cademp = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PALACIO_FERRAMENTAS_stg_cademp.length) {
				if(length < 1024 && commonByteArray_PALACIO_FERRAMENTAS_stg_cademp.length == 0) {
   					commonByteArray_PALACIO_FERRAMENTAS_stg_cademp = new byte[1024];
				} else {
   					commonByteArray_PALACIO_FERRAMENTAS_stg_cademp = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PALACIO_FERRAMENTAS_stg_cademp, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_stg_cademp, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PALACIO_FERRAMENTAS_stg_cademp, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_stg_cademp, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PALACIO_FERRAMENTAS_stg_cademp) {
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_1=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_1 = "tHashFile_stg_cademp_" + pid + "_tHashOutput_1";
...
public static class TABLEStruct implements routines.system.IPersistableRow<TABLEStruct> {
    ...
    public String loopKey;
			    ...
			    public String EMP_CODEMP;

				public String getEMP_CODEMP () {
					return this.EMP_CODEMP;
				}

				public Boolean EMP_CODEMPIsNullable(){
				    return true;
				}
				public Boolean EMP_CODEMPIsKey(){
				    return true;
				}
				public Integer EMP_CODEMPLength(){
				    return 3;
				}
				public Integer EMP_CODEMPPrecision(){
				    return null;
				}
				public String EMP_CODEMPDefault(){
				
					return null;
				
				}
				public String EMP_CODEMPComment(){
				
				    return "";
				
				}
				public String EMP_CODEMPPattern(){
				
					return "";
				
				}
				public String EMP_CODEMPOriginalDbColumnName(){
			    ...
			    public String EMP_NOMEMP;

				public String getEMP_NOMEMP () {
					return this.EMP_NOMEMP;
				}

				public Boolean EMP_NOMEMPIsNullable(){
				    return true;
				}
				public Boolean EMP_NOMEMPIsKey(){
				    return false;
				}
				public Integer EMP_NOMEMPLength(){
				    return 100;
				}
				public Integer EMP_NOMEMPPrecision(){
				    return null;
				}
				public String EMP_NOMEMPDefault(){
				
					return null;
				
				}
				public String EMP_NOMEMPComment(){
				
				    return "";
				
				}
				public String EMP_NOMEMPPattern(){
				
					return "";
				
				}
				public String EMP_NOMEMPOriginalDbColumnName(){
			    ...
			    public String EMP_NOMFAN;

				public String getEMP_NOMFAN () {
					return this.EMP_NOMFAN;
				}

				public Boolean EMP_NOMFANIsNullable(){
				    return true;
				}
				public Boolean EMP_NOMFANIsKey(){
				    return false;
				}
				public Integer EMP_NOMFANLength(){
				    return 100;
				}
				public Integer EMP_NOMFANPrecision(){
				    return null;
				}
				public String EMP_NOMFANDefault(){
				
					return null;
				
				}
				public String EMP_NOMFANComment(){
				
				    return "";
				
				}
				public String EMP_NOMFANPattern(){
				
					return "";
				
				}
				public String EMP_NOMFANOriginalDbColumnName(){
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.EMP_CODEMP == null) ? 0 : this.EMP_CODEMP.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final TABLEStruct other = (TABLEStruct) obj;
						...
						if (this.EMP_CODEMP == null) {
							if (other.EMP_CODEMP != null)
								return false;
						
						} else if (!this.EMP_CODEMP.equals(other.EMP_CODEMP))
	...
	public void copyDataTo(TABLEStruct other) {
		...
		other.EMP_CODEMP = this.EMP_CODEMP;
	            other.EMP_NOMEMP = this.EMP_NOMEMP;
	            other.EMP_NOMFAN = this.EMP_NOMFAN;
		...
		synchronized(commonByteArrayLock_PALACIO_FERRAMENTAS_stg_cademp) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.EMP_CODEMP = readString(dis);
					
					this.EMP_NOMEMP = readString(dis);
					
					this.EMP_NOMFAN = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.EMP_CODEMP,dos);
					
					// String
				
						writeString(this.EMP_NOMEMP,dos);
					
					// String
				
						writeString(this.EMP_NOMFAN,dos);
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("EMP_CODEMP="+EMP_CODEMP);
		sb.append(",EMP_NOMEMP="+EMP_NOMEMP);
		sb.append(",EMP_NOMFAN="+EMP_NOMFAN);
	    sb.append("]");
    ...
    public int compareTo(TABLEStruct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.EMP_CODEMP, other.EMP_CODEMP);
						if(returnValue != 0) {
							return returnValue;
						}
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_2=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_2 = "tHashFile_stg_cademp_" + pid + "_tHashOutput_2";
		    ...
		    while (rs_tDBInput_3.next()) {
		        nb_line_tDBInput_3++;
							...
							if(colQtyInRs_tDBInput_3 < 1) {
								row5.EMP_CODEMP = null;
							} else {
	                         		
        	row5.EMP_CODEMP = routines.system.JDBCUtil.getString(rs_tDBInput_3, 1, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 2) {
								row5.EMP_NOMEMP = null;
							} else {
	                         		
        	row5.EMP_NOMEMP = routines.system.JDBCUtil.getString(rs_tDBInput_3, 2, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 3) {
								row5.EMP_NOMFAN = null;
							} else {
	                         		
        	row5.EMP_NOMFAN = routines.system.JDBCUtil.getString(rs_tDBInput_3, 3, false);
		                    }
...
// # Output table : 'TABLE'
TABLE_tmp.EMP_CODEMP = row5.EMP_CODEMP ;
TABLE_tmp.EMP_NOMEMP = row5.EMP_NOMEMP ;
TABLE_tmp.EMP_NOMFAN = row5.EMP_NOMFAN ;
TABLE = TABLE_tmp;
// ###############################
...
if(TABLE != null) { 
	...
	currentComponent="tHashOutput_2";
		...
		TABLEStruct oneRow_tHashOutput_2 = new TABLEStruct();
					...
					oneRow_tHashOutput_2.EMP_CODEMP = TABLE.EMP_CODEMP;
					oneRow_tHashOutput_2.EMP_NOMEMP = TABLE.EMP_NOMEMP;
					oneRow_tHashOutput_2.EMP_NOMFAN = TABLE.EMP_NOMFAN;
...
if(dbschema_tDBOutput_4 == null || dbschema_tDBOutput_4.trim().length() == 0) {
	tableName_tDBOutput_4 = ("stg_cademp").toLowerCase();
} else {
	tableName_tDBOutput_4 = dbschema_tDBOutput_4 + "\".\"" + ("stg_cademp").toLowerCase();
}
...
int count_tDBOutput_4=0;
	    java.sql.PreparedStatement pstmt_tDBOutput_4 = conn_tDBOutput_4.prepareStatement("SELECT COUNT(1) FROM \"" + tableName_tDBOutput_4 + "\" WHERE \"emp_codemp\" = ?");
	    resourceMap.put("pstmt_tDBOutput_4", pstmt_tDBOutput_4);
	    String insert_tDBOutput_4 = "INSERT INTO \"" + tableName_tDBOutput_4 + "\" (\"emp_codemp\",\"emp_nomemp\",\"emp_nomfan\") VALUES (?,?,?)";
	    ...
	    String update_tDBOutput_4 = "UPDATE \"" + tableName_tDBOutput_4 + "\" SET \"emp_nomemp\" = ?,\"emp_nomfan\" = ? WHERE \"emp_codemp\" = ?";
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<TABLEStruct> tHashFile_tHashInput_2 = mf_tHashInput_2.getAdvancedMemoryHashFile("tHashFile_stg_cademp_" + pid +"_tHashOutput_2");
...
while (iterator_tHashInput_2.hasNext()) {
	...
	row2.EMP_CODEMP = next_tHashInput_2.EMP_CODEMP;
	row2.EMP_NOMEMP = next_tHashInput_2.EMP_NOMEMP;
	row2.EMP_NOMFAN = next_tHashInput_2.EMP_NOMFAN;
...
insert_table_tmp.EMP_CODEMP = row2.EMP_CODEMP ;
insert_table_tmp.EMP_NOMEMP = row2.EMP_NOMEMP ;
insert_table_tmp.EMP_NOMFAN = row2.EMP_NOMFAN ;
...
if(insert_table != null) { 
	...
	currentComponent="tDBOutput_4";
        ...
        whetherReject_tDBOutput_4 = false;
                    if(insert_table.EMP_CODEMP == null) {
pstmt_tDBOutput_4.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(1, insert_table.EMP_CODEMP);
}
            ...
            if(checkCount_tDBOutput_4 > 0) {
                        if(insert_table.EMP_NOMEMP == null) {
pstmtUpdate_tDBOutput_4.setNull(1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_4.setString(1, insert_table.EMP_NOMEMP);
}

                        if(insert_table.EMP_NOMFAN == null) {
pstmtUpdate_tDBOutput_4.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_4.setString(2, insert_table.EMP_NOMFAN);
}

                        if(insert_table.EMP_CODEMP == null) {
pstmtUpdate_tDBOutput_4.setNull(3 + count_tDBOutput_4, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_4.setString(3 + count_tDBOutput_4, insert_table.EMP_CODEMP);
}
...
} else {pstmtInsert_tDBOutput_4.setString(1, insert_table.EMP_CODEMP);
}

                        if(insert_table.EMP_NOMEMP == null) {
pstmtInsert_tDBOutput_4.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_4.setString(2, insert_table.EMP_NOMEMP);
}

                        if(insert_table.EMP_NOMFAN == null) {
pstmtInsert_tDBOutput_4.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_4.setString(3, insert_table.EMP_NOMFAN);
}
 ...
 */
	...
	currentComponent="tHashInput_2";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_stg_cademp_" + pid +"_tHashOutput_2");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row1Struct> tHashFile_tHashInput_1 = mf_tHashInput_1.getAdvancedMemoryHashFile("tHashFile_stg_cademp_" + pid +"_tHashOutput_1");
 ...
 */
	...
	currentComponent="tHashInput_1";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_stg_cademp_" + pid +"_tHashOutput_1");
 ...
 */
    ...
    public static void main(String[] args){
        final stg_cademp stg_cadempClass = new stg_cademp();

        int exitCode = stg_cadempClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = stg_cademp.class.getClassLoader().getResourceAsStream("palacio_ferramentas/stg_cademp_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = stg_cademp.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : stg_cademp");
        }
...
/************************************************************************************************
 *     216385 characters generated by Talend Open Studio for Big Data 
 *     on the 26 de junho de 2024 13:19:13 BRT
 ************************************************************************************************/