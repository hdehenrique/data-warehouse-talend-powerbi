...
package palacio_ferramentas.dw_t_marca_0_1;
...
/**
 * Job: dw_t_marca Purpose: <br>
 * Description:  <br>
 * @author talend@talend.com
 * @version 8.0.1.20230922_0317-SNAPSHOT
 * @status 
 */
public class dw_t_marca implements TalendJob {
...
public String getPOSTGRES_USER(){
	...
	private final String jobName = "dw_t_marca";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(dw_t_marca.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_PALACIO_FERRAMENTAS_dw_t_marca = new byte[0];
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_dw_t_marca = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PALACIO_FERRAMENTAS_dw_t_marca.length) {
				if(length < 1024 && commonByteArray_PALACIO_FERRAMENTAS_dw_t_marca.length == 0) {
   					commonByteArray_PALACIO_FERRAMENTAS_dw_t_marca = new byte[1024];
				} else {
   					commonByteArray_PALACIO_FERRAMENTAS_dw_t_marca = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PALACIO_FERRAMENTAS_dw_t_marca, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_dw_t_marca, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PALACIO_FERRAMENTAS_dw_t_marca, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_dw_t_marca, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PALACIO_FERRAMENTAS_dw_t_marca) {
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_1=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_1 = "tHashFile_dw_t_marca_" + pid + "_tHashOutput_1";
...
public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
    ...
    public String loopKey;
				...
				public Boolean NM_MARCAIsNullable(){
				    return true;
				}
				public Boolean NM_MARCAIsKey(){
				    return true;
				}
				public Integer NM_MARCALength(){
				    return 40;
				}
				public Integer NM_MARCAPrecision(){
				    return null;
				}
				public String NM_MARCADefault(){
				
					return null;
				
				}
				public String NM_MARCAComment(){
				
				    return "";
				
				}
				public String NM_MARCAPattern(){
				
					return "";
				
				}
				public String NM_MARCAOriginalDbColumnName(){
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.NM_MARCA == null) ? 0 : this.NM_MARCA.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final out1Struct other = (out1Struct) obj;
						...
						if (this.NM_MARCA == null) {
							if (other.NM_MARCA != null)
								return false;
						
						} else if (!this.NM_MARCA.equals(other.NM_MARCA))
    ...
    public int compareTo(out1Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.CD_MARCA, other.CD_MARCA);
						if(returnValue != 0) {
							return returnValue;
						}

					
						returnValue = checkNullsAndCompare(this.NM_MARCA, other.NM_MARCA);
						if(returnValue != 0) {
							return returnValue;
						}
...
if(dbschema_tDBOutput_4 == null || dbschema_tDBOutput_4.trim().length() == 0) {
	tableName_tDBOutput_4 = ("dw_t_marca").toLowerCase();
} else {
	tableName_tDBOutput_4 = dbschema_tDBOutput_4 + "\".\"" + ("dw_t_marca").toLowerCase();
}
...
int count_tDBOutput_4=0;
        ...
        sb_tDBOutput_4.append("INSERT INTO \"").append(tableName_tDBOutput_4).append("\" (\"cd_marca\",\"nm_marca\",\"dt_ultima_atualizacao\") VALUES (?,?,?)");
	...
	currentComponent="tUniqRow_1";
		...
		class KeyStruct_tUniqRow_1 {
		    ...
		    public boolean hashCodeDirty = true;
					...
					String CD_MARCA;
					String NM_MARCA;
					java.util.Date DT_ULTIMA_ATUALIZACAO;        
			...
			public int hashCode() {
				if (this.hashCodeDirty) {
					...
					int result = DEFAULT_HASHCODE;
								...
								result = prime * result + ((this.DT_ULTIMA_ATUALIZACAO == null) ? 0 : this.DT_ULTIMA_ATUALIZACAO.hashCode());
			...
			public boolean equals(Object obj) {
				...
				final KeyStruct_tUniqRow_1 other = (KeyStruct_tUniqRow_1) obj;
									...
									if (this.DT_ULTIMA_ATUALIZACAO == null) {
										if (other.DT_ULTIMA_ATUALIZACAO != null) 
											return false;
								
									} else if (!this.DT_ULTIMA_ATUALIZACAO.equals(other.DT_ULTIMA_ATUALIZACAO))
 ...
 */
	...
	currentComponent="tDBInput_2";
		...
		int tos_count_tDBInput_2 = 0;
		    ...
		    String dbquery_tDBInput_2 = "select MAR_CODMAR CD_MARCA,\n       MAR_DESMAR NM_MARCA,\n       MAR_ULTALT DT_ULTIMA_ATUALIZACAO\n  from CADMAR";
        	...
        	row1.CD_MARCA = routines.system.JDBCUtil.getString(rs_tDBInput_2, 1, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 2) {
								row1.NM_MARCA = null;
							} else {
	                         		
        	row1.NM_MARCA = routines.system.JDBCUtil.getString(rs_tDBInput_2, 2, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 3) {
								row1.DT_ULTIMA_ATUALIZACAO = null;
							} else {
				...
				if(rs_tDBInput_2.getString(3) != null) {
					...
					if (!("0000-00-00").equals(dateString_tDBInput_2) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_2)) {
						row1.DT_ULTIMA_ATUALIZACAO = rs_tDBInput_2.getTimestamp(3);
					} else {
						row1.DT_ULTIMA_ATUALIZACAO = (java.util.Date) year0_tDBInput_2.clone();
					}
				} else {
					row1.DT_ULTIMA_ATUALIZACAO =  null;
				}
...
if(row1.CD_MARCA == null){
	finder_tUniqRow_1.CD_MARCA = null;
}else{
	finder_tUniqRow_1.CD_MARCA = row1.CD_MARCA.toLowerCase();
}
if(row1.NM_MARCA == null){
	finder_tUniqRow_1.NM_MARCA = null;
}else{
	finder_tUniqRow_1.NM_MARCA = row1.NM_MARCA.toLowerCase();
}
finder_tUniqRow_1.DT_ULTIMA_ATUALIZACAO = row1.DT_ULTIMA_ATUALIZACAO;	
...
if(row1.CD_MARCA == null){
	new_tUniqRow_1.CD_MARCA = null;
}else{
	new_tUniqRow_1.CD_MARCA = row1.CD_MARCA.toLowerCase();
}
if(row1.NM_MARCA == null){
	new_tUniqRow_1.NM_MARCA = null;
}else{
	new_tUniqRow_1.NM_MARCA = row1.NM_MARCA.toLowerCase();
}
new_tUniqRow_1.DT_ULTIMA_ATUALIZACAO = row1.DT_ULTIMA_ATUALIZACAO;
		
		keystUniqRow_1.add(new_tUniqRow_1);if(row3 == null){ 
	
	row3 = new row3Struct();
}row3.CD_MARCA = row1.CD_MARCA;			row3.NM_MARCA = row1.NM_MARCA;			row3.DT_ULTIMA_ATUALIZACAO = row1.DT_ULTIMA_ATUALIZACAO;					
...
// # Output table : 'out1'
out1_tmp.CD_MARCA = row3.CD_MARCA ;
out1_tmp.NM_MARCA = row3.NM_MARCA ;
out1_tmp.DT_ULTIMA_ATUALIZACAO = row3.DT_ULTIMA_ATUALIZACAO ;
out1 = out1_tmp;
// ###############################
...
if(out1 != null) { 
	...
	currentComponent="tDBOutput_4";
        ...
        whetherReject_tDBOutput_4 = false;
                    if(out1.CD_MARCA == null) {
pstmt_tDBOutput_4.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(1, out1.CD_MARCA);
}

                    if(out1.NM_MARCA == null) {
pstmt_tDBOutput_4.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(2, out1.NM_MARCA);
}

                    if(out1.DT_ULTIMA_ATUALIZACAO != null) {
pstmt_tDBOutput_4.setTimestamp(3, new java.sql.Timestamp(out1.DT_ULTIMA_ATUALIZACAO.getTime()));
} else {
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row2Struct> tHashFile_tHashInput_1 = mf_tHashInput_1.getAdvancedMemoryHashFile("tHashFile_dw_t_marca_" + pid +"_tHashOutput_1");
 ...
 */
	...
	currentComponent="tHashInput_1";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_dw_t_marca_" + pid +"_tHashOutput_1");
 ...
 */
    ...
    public static void main(String[] args){
        final dw_t_marca dw_t_marcaClass = new dw_t_marca();

        int exitCode = dw_t_marcaClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = dw_t_marca.class.getClassLoader().getResourceAsStream("palacio_ferramentas/dw_t_marca_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = dw_t_marca.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dw_t_marca");
        }
...
/************************************************************************************************
 *     206441 characters generated by Talend Open Studio for Big Data 
 *     on the 20 de maio de 2024 15:26:40 BRT
 ************************************************************************************************/