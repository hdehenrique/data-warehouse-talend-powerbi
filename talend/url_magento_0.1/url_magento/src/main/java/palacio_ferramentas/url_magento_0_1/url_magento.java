...
package palacio_ferramentas.url_magento_0_1;
...
/**
 * Job: url_magento Purpose: <br>
 * Description: SELECT pro.sku cd_sku,
url.request_path url,
cpev.value url_imagem
from bqlsikbsazzjc.url_rewrite url
inner join bqlsikbsazzjc.catalog_product_entity pro on pro.entity_id = url.entity_id
inner join bqlsikbsazzjc.catalog_product_entity_varchar cpev on pro.entity_id = cpev.row_id and cpev.attribute_id = 259 <br>
 * @author henriquesantos@palaciodasferramentas.com.br
 * @version 8.0.1.20230922_0317-SNAPSHOT
 * @status 
 */
public class url_magento implements TalendJob {
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext(){
			...
			if(MAGENTO_DB != null){
					...
					this.setProperty("MAGENTO_DB", MAGENTO_DB.toString());
				
			}
			
			if(MAGENTO_HOST != null){
				
					this.setProperty("MAGENTO_HOST", MAGENTO_HOST.toString());
				
			}
			
			if(MAGENTO_PASSWORD != null){
				
					this.setProperty("MAGENTO_PASSWORD", MAGENTO_PASSWORD.toString());
				
			}
			
			if(MAGENTO_PORT != null){
				
					this.setProperty("MAGENTO_PORT", MAGENTO_PORT.toString());
				
			}
			
			if(MAGENTO_USER != null){
				
					this.setProperty("MAGENTO_USER", MAGENTO_USER.toString());
...
public String MAGENTO_DB;
public String getMAGENTO_DB(){
	return this.MAGENTO_DB;
}
public String MAGENTO_HOST;
public String getMAGENTO_HOST(){
	return this.MAGENTO_HOST;
}
public String MAGENTO_PASSWORD;
public String getMAGENTO_PASSWORD(){
	return this.MAGENTO_PASSWORD;
}
public String MAGENTO_PORT;
public String getMAGENTO_PORT(){
	return this.MAGENTO_PORT;
}
public String MAGENTO_USER;
public String getMAGENTO_USER(){
	return this.MAGENTO_USER;
}
...
public Integer getVersao(){
	...
	private final String jobName = "url_magento";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(url_magento.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tDBConnection_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tDBConnection_2";
        ...
        String properties_tDBConnection_2 = "noDatetimeStringSync=true&useSSL=false&requireSSL=false&jdbcCompliantTruncation=false&allowPublicKeyRetrieval=true";
        ...
        String url_tDBConnection_2 = "jdbc:mysql://" + context.MAGENTO_HOST + ":" + context.MAGENTO_PORT + "/" + context.MAGENTO_DB + "?" + properties_tDBConnection_2;
	String dbUser_tDBConnection_2 = context.MAGENTO_USER;
	
	
		
	final String decryptedPassword_tDBConnection_2 = context.MAGENTO_PASSWORD; 
	...
	globalMap.put("db_tDBConnection_2",context.MAGENTO_DB);
...
public static class row16Struct implements routines.system.IPersistableRow<row16Struct> {
    final static byte[] commonByteArrayLock_PALACIO_FERRAMENTAS_url_magento = new byte[0];
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_url_magento = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PALACIO_FERRAMENTAS_url_magento.length) {
				if(length < 1024 && commonByteArray_PALACIO_FERRAMENTAS_url_magento.length == 0) {
   					commonByteArray_PALACIO_FERRAMENTAS_url_magento = new byte[1024];
				} else {
   					commonByteArray_PALACIO_FERRAMENTAS_url_magento = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PALACIO_FERRAMENTAS_url_magento, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_url_magento, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PALACIO_FERRAMENTAS_url_magento, 0, length);
			strReturn = new String(commonByteArray_PALACIO_FERRAMENTAS_url_magento, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PALACIO_FERRAMENTAS_url_magento) {
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_1=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_1 = "tHashFile_url_magento_" + pid + "_tHashOutput_1";
...
if(row16 != null) { 
	...
	currentComponent="tHashOutput_1";
		...
		row16Struct oneRow_tHashOutput_1 = new row16Struct();
					...
					oneRow_tHashOutput_1.nm_programa = row16.nm_programa;
					oneRow_tHashOutput_1.data_inicio_execucao = row16.data_inicio_execucao;
					oneRow_tHashOutput_1.data_termino_execucao = row16.data_termino_execucao;
					oneRow_tHashOutput_1.mensagem = row16.mensagem;
					oneRow_tHashOutput_1.uuid = row16.uuid;
					oneRow_tHashOutput_1.versao = row16.versao;
...
public static class insertStruct implements routines.system.IPersistableRow<insertStruct> {
    ...
    public String loopKey;
			    ...
			    public String cd_sku;

				public String getCd_sku () {
					return this.cd_sku;
				}

				public Boolean cd_skuIsNullable(){
				    return true;
				}
				public Boolean cd_skuIsKey(){
				    return true;
				}
				public Integer cd_skuLength(){
				    return 64;
				}
				public Integer cd_skuPrecision(){
				    return null;
				}
				public String cd_skuDefault(){
				
					return null;
				
				}
				public String cd_skuComment(){
				
				    return "";
				
				}
				public String cd_skuPattern(){
				
					return "";
				
				}
				public String cd_skuOriginalDbColumnName(){
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.cd_sku == null) ? 0 : this.cd_sku.hashCode());
					
						result = prime * result + ((this.url == null) ? 0 : this.url.hashCode());
					
						result = prime * result + ((this.url_imagem == null) ? 0 : this.url_imagem.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final insertStruct other = (insertStruct) obj;
						...
						if (this.cd_sku == null) {
							if (other.cd_sku != null)
								return false;
						
						} else if (!this.cd_sku.equals(other.cd_sku))
						...
						if (this.url_imagem == null) {
							if (other.url_imagem != null)
								return false;
						
						} else if (!this.url_imagem.equals(other.url_imagem))
    ...
    public int compareTo(insertStruct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.cd_sku, other.cd_sku);
						if(returnValue != 0) {
							return returnValue;
						}
						...
						returnValue = checkNullsAndCompare(this.url_imagem, other.url_imagem);
						if(returnValue != 0) {
							return returnValue;
						}
...
if(dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
	tableName_tDBOutput_2 = ("url_produtos_temp").toLowerCase();
} else {
	tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "\".\"" + ("url_produtos_temp").toLowerCase();
}
...
int count_tDBOutput_2=0;
        ...
        sb_tDBOutput_2.append("INSERT INTO \"").append(tableName_tDBOutput_2).append("\" (\"cd_sku\",\"url\",\"url_imagem\") VALUES (?,?,?)");
 ...
 */
	...
	currentComponent="tDBInput_2";
		...
		int tos_count_tDBInput_2 = 0;
		    ...
		    String dbquery_tDBInput_2 = "\nSELECT pro.sku cd_sku,\nurl.request_path url,\ncpev.value url_imagem\nfrom bqlsikbsazzjc.url_rewrite url\ninner join "
+"bqlsikbsazzjc.catalog_product_entity pro on pro.entity_id = url.entity_id\ninner join bqlsikbsazzjc.catalog_product_enti"
+"ty_varchar cpev on pro.entity_id = cpev.row_id and cpev.attribute_id = 259\n";
        	...
        	row1.cd_sku = routines.system.JDBCUtil.getString(rs_tDBInput_2, 1, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 2) {
								row1.url = null;
							} else {
	                         		
        	row1.url = routines.system.JDBCUtil.getString(rs_tDBInput_2, 2, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 3) {
								row1.url_imagem = null;
							} else {
	                         		
        	row1.url_imagem = routines.system.JDBCUtil.getString(rs_tDBInput_2, 3, false);
		                    }
...
row2 = null;			
if(row1.cd_sku == null){
	finder_tUniqRow_1.cd_sku = null;
}else{
	finder_tUniqRow_1.cd_sku = row1.cd_sku.toLowerCase();
}
if(row1.url == null){
	finder_tUniqRow_1.url = null;
}else{
	finder_tUniqRow_1.url = row1.url.toLowerCase();
}
if(row1.url_imagem == null){
	finder_tUniqRow_1.url_imagem = null;
}else{
	finder_tUniqRow_1.url_imagem = row1.url_imagem.toLowerCase();
}	
...
if(row1.cd_sku == null){
	new_tUniqRow_1.cd_sku = null;
}else{
	new_tUniqRow_1.cd_sku = row1.cd_sku.toLowerCase();
}
if(row1.url == null){
	new_tUniqRow_1.url = null;
}else{
	new_tUniqRow_1.url = row1.url.toLowerCase();
}
if(row1.url_imagem == null){
	new_tUniqRow_1.url_imagem = null;
}else{
	new_tUniqRow_1.url_imagem = row1.url_imagem.toLowerCase();
}
		
		keystUniqRow_1.add(new_tUniqRow_1);if(row2 == null){ 
	
	row2 = new row2Struct();
}row2.cd_sku = row1.cd_sku;			row2.url = row1.url;			row2.url_imagem = row1.url_imagem;					
...
// # Output table : 'insert'
insert_tmp.cd_sku = row2.cd_sku;
insert_tmp.url = row2.url;
insert_tmp.url_imagem = row2.url_imagem;
insert = insert_tmp;
// ###############################
...
if(insert != null) { 
	...
	currentComponent="tDBOutput_2";
        ...
        whetherReject_tDBOutput_2 = false;
                    if(insert.cd_sku == null) {
pstmt_tDBOutput_2.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(1, insert.cd_sku);
}

                    if(insert.url == null) {
pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(2, insert.url);
}

                    if(insert.url_imagem == null) {
pstmt_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(3, insert.url_imagem);
}
...
public static class insert_urlStruct implements routines.system.IPersistableRow<insert_urlStruct> {
    final static byte[] commonByteArrayLock_PALACIO_FERRAMENTAS_url_magento = new byte[0];
    static byte[] commonByteArray_PALACIO_FERRAMENTAS_url_magento = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final insert_urlStruct other = (insert_urlStruct) obj;
	...
	public void copyDataTo(insert_urlStruct other) {
	...
	public void copyKeysDataTo(insert_urlStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(insert_urlStruct other) {
...
insert_urlStruct insert_url = new insert_urlStruct();
	...
	currentComponent="tDBOutput_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"insert_url");
					}
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("url_produtos").toLowerCase();
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("url_produtos").toLowerCase();
}
...
int count_tDBOutput_1=0;
        ...
        sb_tDBOutput_1.append("INSERT INTO \"").append(tableName_tDBOutput_1).append("\" (\"cd_sku\",\"url\",\"url_imagem\",\"dt_ultima_atualizacao\") VALUES (?,?,?,?)");
...
// ###############################
// # Outputs initialization
insert_urlStruct insert_url_tmp = new insert_urlStruct();
// ###############################
 ...
 */
	...
	currentComponent="tDBInput_1";
		...
		int tos_count_tDBInput_1 = 0;
		    ...
		    String dbquery_tDBInput_1 = "\nselect REPLACE(cd_sku,'\"\','') as cd_sku,\n       url, url_imagem\nfrom url_produtos_temp\n";
        	...
        	row3.cd_sku = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								row3.url = null;
							} else {
	                         		
        	row3.url = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 3) {
								row3.url_imagem = null;
							} else {
	                         		
        	row3.url_imagem = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
		                    }
...
// # Output table : 'insert_url'
insert_url_tmp.cd_sku = row3.cd_sku;
insert_url_tmp.url = row3.url;
insert_url_tmp.url_imagem = row3.url_imagem;
insert_url_tmp.dt_ultima_atualizacao = TalendDate.getCurrentDate();
insert_url = insert_url_tmp;
// ###############################
...
if(insert_url != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(insert_url.cd_sku == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, insert_url.cd_sku);
}

                    if(insert_url.url == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, insert_url.url);
}

                    if(insert_url.url_imagem == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, insert_url.url_imagem);
}

                    if(insert_url.dt_ultima_atualizacao != null) {
pstmt_tDBOutput_1.setTimestamp(4, new java.sql.Timestamp(insert_url.dt_ultima_atualizacao.getTime()));
} else {
...
globalMap.put("tDBOutput_1_ERROR_MESSAGE",e_tDBOutput_1.getMessage());
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"insert_url");
			  	}
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row16Struct> tHashFile_tHashInput_1 = mf_tHashInput_1.getAdvancedMemoryHashFile("tHashFile_url_magento_" + pid +"_tHashOutput_1");
 ...
 */
	...
	currentComponent="tHashInput_1";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_url_magento_" + pid +"_tHashOutput_1");
 ...
 */
    ...
    public static void main(String[] args){
        final url_magento url_magentoClass = new url_magento();

        int exitCode = url_magentoClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = url_magento.class.getClassLoader().getResourceAsStream("palacio_ferramentas/url_magento_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = url_magento.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
            ...
            class ContextProcessing {
                private void processContext_0() {
                        ...
                        context.setContextType("MAGENTO_DB", "id_String");
                        if(context.getStringValue("MAGENTO_DB") == null) {
                            context.MAGENTO_DB = null;
                        } else {
                            context.MAGENTO_DB=(String) context.getProperty("MAGENTO_DB");
                        }
                        context.setContextType("MAGENTO_HOST", "id_String");
                        if(context.getStringValue("MAGENTO_HOST") == null) {
                            context.MAGENTO_HOST = null;
                        } else {
                            context.MAGENTO_HOST=(String) context.getProperty("MAGENTO_HOST");
                        }
                        context.setContextType("MAGENTO_PASSWORD", "id_String");
                        if(context.getStringValue("MAGENTO_PASSWORD") == null) {
                            context.MAGENTO_PASSWORD = null;
                        } else {
                            context.MAGENTO_PASSWORD=(String) context.getProperty("MAGENTO_PASSWORD");
                        }
                        context.setContextType("MAGENTO_PORT", "id_String");
                        if(context.getStringValue("MAGENTO_PORT") == null) {
                            context.MAGENTO_PORT = null;
                        } else {
                            context.MAGENTO_PORT=(String) context.getProperty("MAGENTO_PORT");
                        }
                        context.setContextType("MAGENTO_USER", "id_String");
                        if(context.getStringValue("MAGENTO_USER") == null) {
                            context.MAGENTO_USER = null;
                        } else {
                            context.MAGENTO_USER=(String) context.getProperty("MAGENTO_USER");
                        }
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("POSTGRES_DB")) {
            ...
            }if (parentContextMap.containsKey("MAGENTO_DB")) {
                context.MAGENTO_DB = (String) parentContextMap.get("MAGENTO_DB");
            }if (parentContextMap.containsKey("MAGENTO_HOST")) {
                context.MAGENTO_HOST = (String) parentContextMap.get("MAGENTO_HOST");
            }if (parentContextMap.containsKey("MAGENTO_PASSWORD")) {
                context.MAGENTO_PASSWORD = (String) parentContextMap.get("MAGENTO_PASSWORD");
            }if (parentContextMap.containsKey("MAGENTO_PORT")) {
                context.MAGENTO_PORT = (String) parentContextMap.get("MAGENTO_PORT");
            }if (parentContextMap.containsKey("MAGENTO_USER")) {
                context.MAGENTO_USER = (String) parentContextMap.get("MAGENTO_USER");
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : url_magento");
        }
...
/************************************************************************************************
 *     241608 characters generated by Talend Open Studio for Big Data 
 *     on the 5 de março de 2025 09:12:50 BRT
 ************************************************************************************************/